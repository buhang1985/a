...
public class GetNurOperaBp {
	...
	private List<DiagInfoDTO> getPatNurInfo(String id_ent) throws Exception {
		...
		strBuffer.append(" from NMR_NM_BCH_CARDOPERA  nurpl                                           ");
		strBuffer.append(" left join  NMR_NM_BCH_CARDOPERAITM itm on nurpl.id_cardopera = itm .id_cardopera  ");
