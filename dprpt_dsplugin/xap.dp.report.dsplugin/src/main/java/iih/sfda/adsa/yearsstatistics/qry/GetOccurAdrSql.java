...
public class GetOccurAdrSql implements ITransQry {
	String startTime;
	String endTime;
	String sd_coll_ref;
	String id_org;
	...
	public GetOccurAdrSql(String startTime,String endTime, String sd_coll_ref, String id_org, String id_grp, String wherePart) {
	...
	public String getQrySQLStr() {
		...
		sqlStr.append(" left outer join bd_udidoc udi_imprd                ");
		sqlStr.append(" on aerev.id_occur_adr = udi_imprd.id_udidoc        ");
		if (GetConstant.getOccurDate().equals(sd_coll_ref)) {
