...
public class GetEventLevelSql implements ITransQry {
	...
	public GetEventLevelSql(String sd_attribute, String startTime,String endTime, String sd_coll_ref, String id_org,
	...
	public String getQrySQLStr() {
		...
		if (GetConstant.getOccurDate().equals(sd_coll_ref)) {
			sqlStr.append(" ev_lvl.dt_occur dateTime                            ");
			sqlStr.append(" from bd_udidoc udi_imprd                                               ");
			sqlStr.append(" left join (select id_ev_lvl, aerev.dt_occur dt_occur               ");
			...
			sqlStr.append(" ev_lvl.dateTime dateTime                         ");
			sqlStr.append(" from bd_udidoc udi_imprd                                               ");
			sqlStr.append(" left join (select id_ev_lvl, aerev.createdtime dateTime               ");
			sqlStr.append(" from SFDA_AER_EV aerev                   ");
			sqlStr.append(" left outer join bd_psndoc psndoc on psndoc.id_psndoc = aerev.id_psndoc                  ");
		...
		sqlStr.append(" ) ev_lvl    ");
		sqlStr.append(" on ev_lvl.id_ev_lvl = udi_imprd.id_udidoc     ");
