...
public class QryEventLevelSql implements ITransQry {
	String sd_attribute;
	String id_org;
	String id_grp;
	String wherePart;

	public QryEventLevelSql(String sd_attribute, String id_org,
	...
	public String getQrySQLStr() {
		...
		sqlStr.append(" nvl(ev_lvl.ev_count, 0) count                                                        ");
		sqlStr.append(" from bd_udidoc udi_imprd                                               ");
		sqlStr.append(" left join (select id_ev_lvl, count(id_ev_lvl) ev_count               ");
		...
		sqlStr.append(" group by id_ev_lvl) ev_lvl    ");
