 ...
 * 
 */
public class MmOutDetailAccDTO extends BaseDTO {
	 ...
	 * @return FDouble
	 */
	public FDouble getOut_quan() {
		return ((FDouble) getAttrVal("Out_quan"));
	}
	/**
	 * 出库数量
	 * @param Out_quan
	 */
	public void setOut_quan(FDouble Out_quan) {
		setAttrVal("Out_quan", Out_quan);
	}
	/**
	 * 出库金额
	 * @return FDouble
	 */
	public FDouble getOut_amt() {
		return ((FDouble) getAttrVal("Out_amt"));
	}
	/**
	 * 出库金额
	 * @param Out_amt
	 */
	public void setOut_amt(FDouble Out_amt) {
		setAttrVal("Out_amt", Out_amt);
	}
}