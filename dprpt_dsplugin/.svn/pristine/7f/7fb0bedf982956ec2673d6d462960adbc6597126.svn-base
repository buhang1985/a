...
public class GetNurOutBp {
	...
	private List<DiagInfoDTO> getPatNurInfo(String id_ent) throws Exception {
		...
		strBuffer.append(" from NMR_NM_BCH_CARDOUT  nurpl                                           ");
		strBuffer.append(" left join  NMR_NM_BCH_CARDOUTITM itm on nurpl.id_cardout = itm .id_cardout  ");
