...
public class OrdPresDTO {
	 ...
	 * 药房地址信息
	 */
	private String Address_dep_wh;
	
	public String getAddress_dep_wh() {
		return Address_dep_wh;
	}
	public void setAddress_dep_wh(String address_dep_wh) {
		Address_dep_wh = address_dep_wh;
	}
	/**
	 ...
	 * 中医诊断名称拼接
	 */
	private String ChineseDiag;
	/**
	 * 西医诊断名称拼接
	 */
	private String WesternDiag;
	public String getChineseDiag() {
		return ChineseDiag;
	}
	public void setChineseDiag(String chineseDiag) {
		ChineseDiag = chineseDiag;
	}
	public String getWesternDiag() {
		return WesternDiag;
	}
	public void setWesternDiag(String westernDiag) {
		WesternDiag = westernDiag;
	}
	 ...
	 * 患者的价格分类
	 */
	private String Name_patprica;
	public String getName_patprica(){
		return this.Name_patprica;
	}
	public void setName_patprica(String Name_patprica){
		this.Name_patprica = Name_patprica;
	}
	/**
	 * 特殊病标识
	 */
