...
public class GetDiagInfoBp {
	...
	private List<DiagInfoDTO> getPatNurInfo(String id_ent) throws Exception {
		...
		strBuffer.append(" from nmr_nm_bch_nurpl  nurpl                                           ");
		strBuffer.append(" left join  nmr_nm_bch_nurpl_itm itm on nurpl.id_nurpl = itm .id_nurpl  ");
