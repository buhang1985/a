...
public class QueryIPPathgySql implements ITransQry {
	
	private PathgyApplyParamDTO paramDTO;
	private String patId;
	public QueryIPPathgySql(PathgyApplyParamDTO paramDTO, String patId) {
		super();
	...
	public String getQrySQLStr() {
		...
		sqlStr.append("  pat.dt_birth as Age,                                                    ");//出生日期  用来计算年龄
