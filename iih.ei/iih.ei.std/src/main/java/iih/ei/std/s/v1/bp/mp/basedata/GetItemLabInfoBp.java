...
/**
 * 
* @ClassName: GetItemLabInfoBp
* @Description: 获取检验申请项目数据
* @author zhy
* @date 2019年9月24日
*
 */
public class GetItemLabInfoBp extends IIHServiceBaseBP<BaseParamDTO, ItemSrvInfoResultDTO> {
	...
	protected ItemSrvInfoResultDTO process(BaseParamDTO param) throws BizException {
		...
		ItemLabInfoSql sql = new ItemLabInfoSql();
