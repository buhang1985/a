package iih.ei.std.s.v1.bp.mp.lisrpt;
 ...
 *
 */
public class LisRptBp extends IIHServiceBaseBP<LisRptInfoDTO, NoParamDTO>{
	...
	protected NoParamDTO process(LisRptInfoDTO param) throws BizException {
		...
		SaveLisReportDataBp bp = new SaveLisReportDataBp();
