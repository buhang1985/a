...
public class UpdatePeOrderStatusBp extends IIHServiceBaseBP<UpdateStatusParamDTO, NoParamDTO> {
	...
	protected NoParamDTO process(UpdateStatusParamDTO param) throws BizException {
		...
		UpdatePeOrderStatusAndChargeBp bp = new UpdatePeOrderStatusAndChargeBp();
