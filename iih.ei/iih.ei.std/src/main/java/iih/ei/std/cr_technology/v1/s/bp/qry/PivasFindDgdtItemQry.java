...
public class PivasFindDgdtItemQry implements ITransQry {
	
	private List<String> id_or_pr_srvs;
	
	public PivasFindDgdtItemQry(List<String> id_or_pr_srvs) {
		this.id_or_pr_srvs = id_or_pr_srvs;
	}
	...
	private String _getQrySQLStr() {
		...
		SqlStr.append(" and " + SqlUtils.getInSqlByBigIds("dt.id_or_pr_srv", id_or_pr_srvs.toArray(new String[0])));
