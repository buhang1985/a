 ...
 * 
 * @author dj.zhang
 * @data 2018年8月12日下午11:01:01
 * 
 */
@XmlRootElement(name = "ROOT")
@XmlAccessorType(XmlAccessType.FIELD)
public class PharmDgLocDateBeanList implements Serializable {
	...
	@XmlElement(name = "CONSIS_BASIC_LOCATIONVW")
	private PharmDgLocDateBean[] _pPharmDgLocDateBeans;
	 ...
	 * @return
	 */
	public PharmDgLocDateBean[] get_pPharmDgLocDateBeans() {
		return _pPharmDgLocDateBeans;
	}

	/**
	 * 药房药品货位JavaBean集合
	 * 
	 * @param _pPharmDgLocDateBeans
	 */
	public void set_pPharmDgLocDateBeans(PharmDgLocDateBean[] _pPharmDgLocDateBeans) {
		this._pPharmDgLocDateBeans = _pPharmDgLocDateBeans;
	}
