...
public class GetPatAptListBP {

	public GetPatAptListBean[] exec(String patCode,String beginDate,String endDate,String chlType) throws BizException{
		...
		.append(" left join sc_apt_appl appl on apt.id_apt = appl.id_scapt")
