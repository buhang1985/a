...
public class GetMtPatAptListBP extends IIHServiceBaseBP<MtPatAptListParamDTO, MtPatAptListResultDTO>{

	@Override
	protected void checkParam(MtPatAptListParamDTO param) throws BizException {
		validData(param.getDate_begin(),param.getDate_end());
	}
	@Override
	protected MtPatAptListResultDTO process(MtPatAptListParamDTO param) throws BizException {
		return getResult(param.getCode_pat(), param.getDate_begin(),param.getDate_end(),param.getChl_type());
	}
	
	@SuppressWarnings("unchecked")
	public MtPatAptListResultDTO getResult(String patCode,FDateTime beginDate,FDateTime endDate,String chlType) throws BizException{
		...
		MtPatAptListResultDTO resultDTO = new MtPatAptListResultDTO();
	 ...
	 * @date 2018年10月30日
	 */
	private void validData (FDateTime beginDate,FDateTime endDate) throws BizException{
		if(null == beginDate){
