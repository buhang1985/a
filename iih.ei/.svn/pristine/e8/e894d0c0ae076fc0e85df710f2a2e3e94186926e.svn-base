package iih.ei.std.s.v1.bp.pe.crisisvalue;
...
*
 */
public class CrisisPeValuePackageBp extends IIHServiceBaseBP<LisCrisisParamDTO, NoParamDTO>{
	...
	protected NoParamDTO process(LisCrisisParamDTO param) throws BizException {
		UpdatePeCrisisValueBp bp = new UpdatePeCrisisValueBp();
		bp.exec(param);
