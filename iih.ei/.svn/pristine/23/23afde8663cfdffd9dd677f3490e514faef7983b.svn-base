...
import iih.ei.std.s.v1.bp.mp.basedata.qry.ItemBloodInfoSql;
...
/**
 * 
* @ClassName: GetItemBloodInfoBp
* @Description: 获取血申请项目数据
* @author zhy
* @date 2019年9月25日
*
 */
public class GetItemBloodInfoBp extends IIHServiceBaseBP<BaseParamDTO, ItemSrvInfoResultDTO>{
	...
	protected ItemSrvInfoResultDTO process(BaseParamDTO param) throws BizException {
		...
		ItemBloodInfoSql sql = new ItemBloodInfoSql();
