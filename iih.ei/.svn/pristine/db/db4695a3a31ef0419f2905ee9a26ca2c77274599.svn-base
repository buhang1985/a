...
public class FindItfExcludeCateQry implements ITransQry {

	private String _itfCateId;
	private String _whereStr;
	private String _orderStr;

	public FindItfExcludeCateQry(String itfCateId, String whereStr, String orderStr) {
	...
	private String getBaseSql() {
		StringBuilder sqlBuilder = new StringBuilder();
		sqlBuilder.append("SELECT EI_ITF.ID_ITF,"); // 接口id
		sqlBuilder.append("EI_ITF.ID_GRP,"); // 所属集团
		sqlBuilder.append("EI_ITF.ID_ORG,"); // 所属组织
		...
		sqlBuilder.append("EI_ITF.CREATEDBY,"); // 创建人
		sqlBuilder.append("EI_ITF.CREATEDTIME,"); // 创建时间
		sqlBuilder.append("EI_ITF.MODIFIEDBY,"); // 最后修改人
		sqlBuilder.append("EI_ITF.MODIFIEDTIME,"); // 最后修改时间
		...
		sqlBuilder.append("LEFT JOIN EI_ITF_CATE_ITM ");
	...
	private String getWherePart() {
		StringBuilder wherePartBuilder = new StringBuilder("EI_ITF_CATE_ITM.ID_ITFCATE = ? and EI_ITF_CATE_ITM.ID_ITFCATE_ITM is null");
	...
	private String getOrderPart() {
		StringBuilder orderPartBuilder = new StringBuilder("EI_ITF.PYCODE,EI_ITF.ID_ITF");

		if (StringUtils.isNotBlank(this._orderStr)) {
			orderPartBuilder.append(",");
			orderPartBuilder.append(this._orderStr);
		}
