...
*
 */
public class GetPePathgyApplyInfoBp extends IIHServiceBaseBP<PathgyApplyParamDTO, PathgyApplyInfoResultDTO>{
	...
	protected PathgyApplyInfoResultDTO process(PathgyApplyParamDTO param) throws BizException {
		QueryPePathgyDataBp bp = new QueryPePathgyDataBp();
