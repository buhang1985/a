 ...
 *
 */
public class EcInvoiceIpParam implements Serializable{
	...
	private String payerType;//人员类别
	private String category;//入院科室名称
	private String categoryCode;//入院科室编码
	private String leaveCategory;//出院科室名称
	private String leaveCategoryCode;//出院科室编码
	private String hospitalNo;//患者住院号
	private String visitNo;//就诊编号
	private String patientId;//患者唯一ID
	private String patientNo;//患者就诊编号
	private String consultationDate;//就诊日期
	private String sex;//性别
	private String age;//年龄
	private String hospitalArea;//病区
	private String bedNo;//床号
	private String caseNumber;//病历号
	private String inHospitalDate;//住院日期
	private String outHospitalDate;//出院日期
	private Integer hospitalDays;//住院天数
