...
import iih.sc.sch.s.bp.mt.apt.bp.auto.OccupyTicks4TimeMd4AutoBP;
import iih.sc.sch.s.bp.mt.apt.bp.auto.OccupyTicks4TimeMd4AutoLocateBP;
...
public class OccupyChlTimeBySch4AutoLocateBP {
	...
	private void occupySch(String id_sch, SchTickMdTimeDTO schTickMdTime, Integer polcn) throws BizException {
		...
		schBP.occupyTick4AutoLocate(id_sch, polcn, mins);
	}
	...
	private ScSchTickDO occupyTick(String id_scsrv, ScSchTicksDO schTicks, Integer polcn) throws BizException {
		...
		ScSchTickDO[] schTickDOs = ep.insert4TimeMd4AutoLocate(schTicks, polcn, id_scsrv);
	...
	private ScSchTicksDO occupyTicks(String id_scsrv, String id_sch, SchTickMdTimeDTO schTickMdTime)
			throws BizException {
		OccupyTicks4TimeMd4AutoLocateBP bp = new OccupyTicks4TimeMd4AutoLocateBP();
