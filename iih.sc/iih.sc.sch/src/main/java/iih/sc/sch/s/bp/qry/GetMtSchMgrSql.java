 ...
 *
 */
public class GetMtSchMgrSql implements ITransQry {
	...
	public GetMtSchMgrSql(FDate dt_b, FDate dt_e, String depId, String scresId, String srvId,String sd_sctp,String loadType) {
		this.Dt_b = dt_b;
		this.Dt_e = dt_e;
		this.DepId = depId;
	...
	public String getQrySQLStr() {
		...
		sb.append(str);
		if(!StringUtil.isEmptyWithTrim(loadType) && "2".equals(loadType)){
			sb.append(" order by sch.d_sch,name_dayslot,name_srv,name_res");
		}
		sb.append(" ) a");
		return sb.toString();
	}
