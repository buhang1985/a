 ...
 * 
 */
public class OccupyTicks4TimeMd4AutoLocateBP {
	/**
	 * 预约选择的时间点是否未使用
	 * 
	 * @author liubin
	...
	public ScSchTicksDO exec(String id_scsrv,String id_sch, SchTickMdTimeDTO schTickMdTime) throws BizException{
		//1.验证
		boolean success = validate(id_sch, schTickMdTime);
	...
	private ScSchTicksDO splitTicks(String id_scsrv,ScSchTicksDO schTicksDo, ScSchDO schDo, SchTickMdTimeDTO schTickMdTime) throws BizException{
		...
		//TicksEP ticksEP = new TicksEP();
		ScSchTicksDO[] ticksDOs = ticksDOList.toArray(new ScSchTicksDO[0]);
	 ...
	 * @throws BizException
	 */
	private boolean validate(String id_sch, SchTickMdTimeDTO schTickMdTime) throws BizException {
