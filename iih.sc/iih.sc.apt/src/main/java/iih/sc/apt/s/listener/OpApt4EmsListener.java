...
import iih.sc.pub.listener.IOpApt4EmsListener;
 ...
 *
 */
public class OpApt4EmsListener extends IOpApt4EmsListener {
	/**
	 * 执行
	 */
	@Override
	...
	private void sendMsg(OpApt4SmsDTO aptDTO) throws BizException{
		...
		smsMsg.exec(aptDTO.getMobile(),IScSmsConst.SC_APT_MSG_TEMPLATE, aptDTO);
	}
}
