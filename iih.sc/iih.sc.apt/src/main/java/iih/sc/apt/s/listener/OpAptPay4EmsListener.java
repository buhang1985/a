...
import iih.sc.pub.listener.IOpAptPay4EmsListener;
 ...
 *
 */
public class OpAptPay4EmsListener implements IOpAptPay4EmsListener {
	/**
	 * 执行
	 */
	@Override
	...
	private void sendMsg(OpApt4SmsDTO aptDTO) throws BizException{
		...
		smsMsg.exec(aptDTO.getMobile(),IScSmsConst.SC_PAY_FOR_APT_MSG_TEMPLATE, aptDTO);
	}
}
