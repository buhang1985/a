 ...
 *
 */
public class GetChlSchApptAmountBP {
	 ...
	 * @throws BizException
	 */
	public Map<String, Map<Integer,Integer>> exec(List<String> schIdList, String id_scchl) throws BizException {
		...
		for (ScSchDO schDO : schDOs) {
			...
			apptMap.put(key, this.calcChlApptAmount(schDO, tickMap, chlPolcnMap, id_scchl));
		}
		return apptMap;
	}
	...
	private Map<Integer,Integer> calcChlApptAmount(ScSchDO schDO, Map<String, List<ScSchTickDO>> tickMap,
			Map<String, List<ScSchChlDO>> chlPolcnMap, String id_scchl) throws BizException {
