 ...
 *
 */
public class OptAptCancConfirmEvent {
	/**
	 * 科室手术取消确认事件
	 * 
	 * @param 科室手术取消确认事件源DTOiih.sc.apt.dto.d.OptApt4OrmDTO
	 * @throws BizException
	 */
	public void invoke(List<OptApt4OrmDTO> optApt4OrmList) throws BizException {
		BusinessEvent mtAptEvent = new BusinessEvent(IScEventConst.EVENT_SOURCE_SC_OPT_APT, IScEventConst.EVENT_SC_OPT_CANC_APT_CONFIRM,
				optApt4OrmList);
