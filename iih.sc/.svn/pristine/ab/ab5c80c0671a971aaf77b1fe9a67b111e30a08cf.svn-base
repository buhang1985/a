...
public class OpAptAndPayEvent {
	...
	public void invoke(OpApt4EsDTO apt4EsDTO) throws BizException {
		BusinessEvent opRegEvent = new BusinessEvent(IScEventConst.EVENT_SOURCE_SOURCE_SC_OP_APT, IScEventConst.EVENT_SC_OP_APT_AND_PAY,
				apt4EsDTO);
