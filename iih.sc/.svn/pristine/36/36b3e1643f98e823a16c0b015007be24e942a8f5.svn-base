...
public class SchChl4MtAptEP {
	 ...
	 * @throws BizException
	 */
	public ScSchChlDO[] getSchChl(String id_sch, String id_scchl,String idEnttp) throws BizException {
		if (StringUtil.isEmptyWithTrim(id_sch) || StringUtil.isEmptyWithTrim(id_scchl)) {
			return null;
		}
		IScSchChlDORService qryService = ServiceFinder.find(IScSchChlDORService.class);
		...
		ScSchDO schDO = schService.findById(id_sch);
	 ...
	 * @throws BizException
	 */
	public void assemlySchChls(String schId, List<ScSchChlDO> uiSchChls, List<ScSchChlDO> schChls) throws BizException{
