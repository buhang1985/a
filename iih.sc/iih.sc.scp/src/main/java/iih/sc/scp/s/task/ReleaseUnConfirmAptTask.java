...
import iih.sc.scp.s.task.bp.ReleaseUnConfirmAptBP;
 ...
 */
public class ReleaseUnConfirmAptTask implements IBackgroundWorkPlugin {
	...
	public PreAlertObject executeTask(BgWorkingContext paramBgWorkingContext) throws BizException {
		ReleaseUnConfirmAptBP taskBP = new ReleaseUnConfirmAptBP();
