...
import iih.sc.scp.s.task.bp.ReleaseUnFeeAptBP;
 ...
 */
public class ReleaseUnFeeAptTask implements IBackgroundWorkPlugin {
	...
	public PreAlertObject executeTask(BgWorkingContext paramBgWorkingContext) throws BizException {
		ReleaseUnFeeAptBP taskBP = new ReleaseUnFeeAptBP();
