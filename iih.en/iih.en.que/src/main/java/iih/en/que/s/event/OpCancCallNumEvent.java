 ...
 *
 */
public class OpCancCallNumEvent {
	/**
	 * 触发医生取消叫号事件
	 * 
	...
	public void invoke(OpQue4EsDTO opQue4EsDTO) throws BizException {
		BusinessEvent opRegEvent = new BusinessEvent(IEnEventConst.EVENT_SOURCE_EN_OP_QUE, IEnEventConst.EVENT_EN_OP_CANC_CALLNUM,
				opQue4EsDTO);
		Logger.info("发送取消叫号事件: " + opQue4EsDTO);
