...
public class OpCallNumEvent {
	...
	public void invoke(OpQue4EsDTO opQue4EsDTO) throws BizException {
		BusinessEvent opRegEvent = new BusinessEvent(IEnEventConst.EVENT_SOURCE_EN_OP_QUE, IEnEventConst.EVENT_EN_OP_CALLNUM,
				opQue4EsDTO);
		Logger.info("发送叫号事件: " + opQue4EsDTO);
