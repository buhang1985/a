 ...
 *
 */
public class EnIpDocChgInEnter4IpListener  implements IBusinessListener {
	/**
	 * 执行
	 */
	@Override
	public void doAction(IBusinessEvent event) throws BizException {
		...
		EnterDept4EsDTO esDTO = (EnterDept4EsDTO) bizUserObj.getUserObj();
		WrapChgDoc4IpBP wrapBP = new WrapChgDoc4IpBP();
		ChgDoctor4IpDTO  chgDocDTO= wrapBP.exec(esDTO.getId_ent());
		DomainBusinessUserObj buo = new DomainBusinessUserObj(chgDocDTO, BusiType.ZY,
				"071", "0");
