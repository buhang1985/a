...
public class OpAcptEvent {
	...
	public void invoke(OpQue4EsDTO opQue4EsDTO) throws BizException {
		BusinessEvent opRegEvent = new BusinessEvent(IEnEventConst.EVENT_SOURCE_EN_OP_QUE, IEnEventConst.EVENT_EN_OP_DOC_ACPT,
				opQue4EsDTO);
		Logger.info("发送接诊事件: " + opQue4EsDTO);
