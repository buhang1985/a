 ...
 *
 */
public class GetTransOutPatsBP {
	/**
	 * 查询转科患者
	 * 
	 * @param deptId
	 ...
	 * @throws BizException 
	 */
	public PatientsDTO[] exec(String deptId,FDate begin,FDate end) throws BizException{
		if (EnValidator.isEmpty(deptId)
				|| EnValidator.isEmpty(begin)
				|| EnValidator.isEmpty(end)) {
			return null;
		}
		return getTransOutPats(deptId, begin, end);
	}
     ...
     * @throws BizException
     */
     private PatientsDTO[] getTransOutPats(String deptId,FDate begin,FDate end) throws BizException{
