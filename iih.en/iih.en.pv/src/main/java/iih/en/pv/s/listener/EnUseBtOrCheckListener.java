...
import iih.ci.ord.pub.listener.UseBtOrCheckListener;
 ...
 * 
 */
public class EnUseBtOrCheckListener extends UseBtOrCheckListener {
	@Override
	protected void doYourActionAfterOrCheck(CiOrderDO[] ors) throws BizException {
		...
		for (CiOrderDO or : ors) {
			...
			entStateDTO.setSd_enstatetp(IBdFcDictCodeConst.SD_ENSTATE_USEBLOOD);//
