...
public class EnErBasicInfoBP {
	 ...
	 * @throws BizException
	 */
	public void setContactInfo(EnErBasic4EditDTO dto, int type) throws BizException {
	 ...
	 * @throws BizException
	 */
	public void saveEntContInfo(EnErBasic4EditDTO dto, int type) throws BizException {
		if (null == dto) {
			return;
		}
		// 保存患者联系人
	 ...
	 * @throws BizException
	 */
	private void savePatContInfo(EnErBasic4EditDTO dto, int type) throws BizException {
	 ...
	 * @throws BizException
	 */
	private void setPatContData(EnErBasic4EditDTO dto, PiPatContDO contDO, int type)
			throws BizException {
		if (null == contDO) {
			return;
		}
	 ...
	 * @throws BizException
	 */
	private void setEntContData(EnErBasic4EditDTO dto, EntContDO contDO, int type)
			throws BizException {
		if (null == contDO) {
			return;
		}
	...
	private int queryMaxBySql(String sql, SqlParam param) throws BizException {
		Integer max = (Integer) new DAFacade().execQuery(sql, param, new ColumnHandler());
