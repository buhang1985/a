...
public class PmpDataConvertBP   implements IPmpDataconvert{
	PmpAliDataConvertBP aliconvert=new PmpAliDataConvertBP();
	PmpWXDataConvertBP wxconvert=new PmpWXDataConvertBP();
