 ...
 *
 */
public class WXMicropayErrorCodeConst {
...
//	public final static String NOTSUPORTCARD__DES="不支持卡类型;用户使用卡种不支持当前支付形式;请用户重新选择卡种 建议：商户系统返回给收银台的提示为“该卡不支持当前支付，提示用户换卡支付或绑新卡支付”";
	...
	public static String getExtErrorDes(String name){
        switch(name){
        case WXMicropayErrorCodeConst.NOAUTH:
        	return WXMicropayErrorCodeConst.NOAUTH__DES;
        case WXMicropayErrorCodeConst.NOTENOUGH:
        	return WXMicropayErrorCodeConst.NOTENOUGH__DES;
        case WXMicropayErrorCodeConst.ORDERPAID:
        	return WXMicropayErrorCodeConst.ORDERPAID__DES;
        case WXMicropayErrorCodeConst.ORDERCLOSED:
        	return WXMicropayErrorCodeConst.ORDERCLOSED__DES;
        case WXMicropayErrorCodeConst.SYSTEMERROR:
        	return WXMicropayErrorCodeConst.SYSTEMERROR__DES;
        case WXMicropayErrorCodeConst.APPID_NOT_EXIST:
        	return WXMicropayErrorCodeConst.APPID_NOT_EXIST__DES;
        case WXMicropayErrorCodeConst.MCHID_NOT_EXIST:
        	return WXMicropayErrorCodeConst.MCHID_NOT_EXIST__DES;
        case WXMicropayErrorCodeConst.APPID_MCHID_NOT_MATCH:
        	return WXMicropayErrorCodeConst.APPID_MCHID_NOT_MATCH__DES;
        case WXMicropayErrorCodeConst.LACK_PARAMS:
        	return WXMicropayErrorCodeConst.LACK_PARAMS__DES;
        case WXMicropayErrorCodeConst.OUT_TRADE_NO_USED:
        	return WXMicropayErrorCodeConst.OUT_TRADE_NO_USED__DES;
        case WXMicropayErrorCodeConst.SIGNERROR:
        	return WXMicropayErrorCodeConst.SIGNERROR__DES;
        case WXMicropayErrorCodeConst.XML_FORMAT_ERROR:
        	return WXMicropayErrorCodeConst.XML_FORMAT_ERROR__DES;
        case WXMicropayErrorCodeConst.REQUIRE_POST_METHOD:
        	return WXMicropayErrorCodeConst.REQUIRE_POST_METHOD__DES;
        case WXMicropayErrorCodeConst.NOT_UTF8:
        	return WXMicropayErrorCodeConst.NOT_UTF8__DES;
        case WXMicropayErrorCodeConst.PARAM_ERROR:
        	return WXMicropayErrorCodeConst.PARAM_ERROR__DES;
        case WXMicropayErrorCodeConst.AUTHCODEEXPIRE:
        	return WXMicropayErrorCodeConst.AUTHCODEEXPIRE__DES;
        case WXMicropayErrorCodeConst.NOTSUPORTCARD:
        	return WXMicropayErrorCodeConst.NOTSUPORTCARD__DES;
        case WXMicropayErrorCodeConst.ORDERREVERSED:
        	return WXMicropayErrorCodeConst.ORDERREVERSED__DES;
        case WXMicropayErrorCodeConst.BANKERROR:
        	return WXMicropayErrorCodeConst.BANKERROR__DES;
        case WXMicropayErrorCodeConst.USERPAYING:
        	return WXMicropayErrorCodeConst.USERPAYING__DES;
        case WXMicropayErrorCodeConst.AUTH_CODE_ERROR:
        	return WXMicropayErrorCodeConst.AUTH_CODE_ERROR__DES;
        case WXMicropayErrorCodeConst.AUTH_CODE_INVALID:
        	return WXMicropayErrorCodeConst.AUTH_CODE_INVALID__DES;
        case WXMicropayErrorCodeConst.BUYER_MISMATCH:
        	return WXMicropayErrorCodeConst.BUYER_MISMATCH__DES;
        case WXMicropayErrorCodeConst.INVALID_REQUEST:
        	return WXMicropayErrorCodeConst.INVALID_REQUEST__DES;
        case WXMicropayErrorCodeConst.TRADE_ERROR:
        	return WXMicropayErrorCodeConst.TRADE_ERROR__DES;
        }
		return null;
	}
	...
	{
		String rst=Errordes+";";
		String exdes=WXMicropayErrorCodeConst.getExtErrorDes(errorcode);
		if(exdes!=null)
			rst=rst+exdes;
		return rst;
	}
