 ...
 *
 */
public class WXUnifiedErrorCodeConst {
	...
	public static String getExtErrorDes(String name){
        switch(name){
        case WXUnifiedErrorCodeConst.NOAUTH:
        	return WXUnifiedErrorCodeConst.NOAUTH__DES;
        case WXUnifiedErrorCodeConst.NOTENOUGH:
        	return WXUnifiedErrorCodeConst.NOTENOUGH__DES;
        case WXUnifiedErrorCodeConst.ORDERPAID:
        	return WXUnifiedErrorCodeConst.ORDERPAID__DES;
        case WXUnifiedErrorCodeConst.ORDERCLOSED:
        	return WXUnifiedErrorCodeConst.ORDERCLOSED__DES;
        case WXUnifiedErrorCodeConst.SYSTEMERROR:
        	return WXUnifiedErrorCodeConst.SYSTEMERROR__DES;
        case WXUnifiedErrorCodeConst.APPID_NOT_EXIST:
        	return WXUnifiedErrorCodeConst.APPID_NOT_EXIST__DES;
        case WXUnifiedErrorCodeConst.MCHID_NOT_EXIST:
        	return WXUnifiedErrorCodeConst.MCHID_NOT_EXIST__DES;
        case WXUnifiedErrorCodeConst.APPID_MCHID_NOT_MATCH:
        	return WXUnifiedErrorCodeConst.APPID_MCHID_NOT_MATCH__DES;
        case WXUnifiedErrorCodeConst.LACK_PARAMS:
        	return WXUnifiedErrorCodeConst.LACK_PARAMS__DES;
        case WXUnifiedErrorCodeConst.OUT_TRADE_NO_USED:
        	return WXUnifiedErrorCodeConst.OUT_TRADE_NO_USED__DES;
        case WXUnifiedErrorCodeConst.SIGNERROR:
        	return WXUnifiedErrorCodeConst.SIGNERROR__DES;
        case WXUnifiedErrorCodeConst.XML_FORMAT_ERROR:
        	return WXUnifiedErrorCodeConst.XML_FORMAT_ERROR__DES;
        case WXUnifiedErrorCodeConst.REQUIRE_POST_METHOD:
        	return WXUnifiedErrorCodeConst.REQUIRE_POST_METHOD__DES;
        case WXUnifiedErrorCodeConst.POST_DATA_EMPTY:
        	return WXUnifiedErrorCodeConst.POST_DATA_EMPTY__DES;
        case WXUnifiedErrorCodeConst.NOT_UTF8:
        	return WXUnifiedErrorCodeConst.NOT_UTF8__DES;
        }
		return null;
	}
	...
	{
		String rst=Errordes+";";
		String exdes=WXUnifiedErrorCodeConst.getExtErrorDes(errorcode);
		if(exdes!=null)
			rst=rst+exdes;
		return rst;
	}
