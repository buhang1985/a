...
public class PmpBarcodePayBP {
	...
	public OrdRstDTO doBarcodePay(OrdReqDTO dto) throws BizException {
		...
		Map<String, Object> data = dataconvert.getBarcodeParam(dto, ord, tra);
		rnt = new PmpPayBP(pay,dataconvert).dobarcodepay(data, tra, ord, dto);
		return rnt;
	}
