...
public class WXReFundErrorCode2 {
	...
	public static String getExtErrorDes(String name){
        switch(name){
        case WXReFundErrorCode2.SYSTEMERROR:
        	return WXReFundErrorCode2.SYSTEMERROR__DES;  
        case WXReFundErrorCode2.BIZERR_NEED_RETRY:
        	return WXReFundErrorCode2.BIZERR_NEED_RETRY__DES; 
        case WXReFundErrorCode2.TRADE_OVERDUE:
        	return WXReFundErrorCode2.TRADE_OVERDUE__DES; 
        case WXReFundErrorCode2.ERROR:
        	return WXReFundErrorCode2.ERROR__DES; 
        case WXReFundErrorCode2.USER_ACCOUNT_ABNORMAL:
        	return WXReFundErrorCode2.USER_ACCOUNT_ABNORMAL__DES; 
        case WXReFundErrorCode2.INVALID_REQ_TOO_MUCH:
        	return WXReFundErrorCode2.INVALID_REQ_TOO_MUCH__DES; 
        case WXReFundErrorCode2.NOTENOUGH:
        	return WXReFundErrorCode2.NOTENOUGH__DES; 
        case WXReFundErrorCode2.INVALID_TRANSACTIONID:
        	return WXReFundErrorCode2.INVALID_TRANSACTIONID__DES; 
        case WXReFundErrorCode2.PARAM_ERROR:
        	return WXReFundErrorCode2.PARAM_ERROR__DES; 
        case WXReFundErrorCode2.APPID_NOT_EXIST:
        	return WXReFundErrorCode2.APPID_NOT_EXIST__DES; 
        case WXReFundErrorCode2.MCHID_NOT_EXIST:
        	return WXReFundErrorCode2.MCHID_NOT_EXIST__DES; 
        case WXReFundErrorCode2.REQUIRE_POST_METHOD:
        	return WXReFundErrorCode2.REQUIRE_POST_METHOD__DES; 
        case WXReFundErrorCode2.SIGNERROR:
        	return WXReFundErrorCode2.SIGNERROR__DES; 
        case WXReFundErrorCode2.XML_FORMAT_ERROR:
        	return WXReFundErrorCode2.XML_FORMAT_ERROR__DES; 
        case WXReFundErrorCode2.FREQUENCY_LIMITED:
        	return WXReFundErrorCode2.FREQUENCY_LIMITED__DES; 
	...
	{
		String rst=Errordes+";";
		String exdes=WXReFundErrorCode2.getExtErrorDes(errorcode);
		if(exdes!=null)
			rst=rst+exdes;
		return rst;
	}
