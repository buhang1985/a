...
abstract class AbsAlipayTradeService extends AbsAlipayService implements AlipayTradeService {
	...
	protected AlipayTradeQueryResponse tradeQuery(AlipayTradeQueryRequestBuilder builder) throws AlipayApiException {
	...
	protected AlipayF2FPayResult checkQueryAndCancel(String outTradeNo, String appAuthToken, AlipayF2FPayResult result,
			AlipayTradeQueryResponse queryResponse) throws AlipayApiException {
	...
	protected AlipayTradeCancelResponse tradeCancel(AlipayTradeCancelRequestBuilder builder) throws AlipayApiException {
		validateBuilder(builder);
