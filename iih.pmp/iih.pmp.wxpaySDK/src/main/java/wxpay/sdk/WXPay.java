...
//		reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
		reqData.put("sign", WXPayUtil.generateSignature(reqData, getSignKey(), this.signType));
		return reqData;
	}
...
//		return WXPayUtil.isSignatureValid(reqData, this.config.getKey(), signType);
		return WXPayUtil.isSignatureValid(reqData, this.getSignKey(), signType);
	}
	 ...
	 * @param readTimeoutMs    连接超时时间，单位是毫秒
	 * @return API返回数据
	 * @throws Exception
	 */
	...
	public String getSignKey() throws Exception {
		...
		reqData.put("nonce_str", WXPayUtil.generateUUID());
		reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
		String respXml = this.requestWithoutCert(url, reqData, config.getHttpConnectTimeoutMs(),
				config.getHttpReadTimeoutMs());
		Map<String, String> r = WXPayUtil.xmlToMap(respXml);
		;
		String returnCode = r.get("return_code");
		if (returnCode.equals("SUCCESS")) {

			if (r.containsKey("sandbox_signkey")) {
				return r.get("sandbox_signkey");
			}
		}
		return null;
	}
