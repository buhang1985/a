...
public class HttpClientWithCAHelp {
	...
	public static String proxyIp = WXProConfig.getProperty("proxyIp");
	public static Integer proxyPort = WXProConfig.getProperty("proxyPort") == null ? null
			: Integer.parseInt(WXProConfig.getProperty("proxyPort"));

	private static HttpClientWithCAHelp httpClientHelper = null;

	private HttpClientWithCAHelp() {
		init();
	}

	private static synchronized void syncInit() {
		if (httpClientHelper == null) {
			httpClientHelper = new HttpClientWithCAHelp();
		}
	}

	public static HttpClientWithCAHelp getInstance() {
		if (httpClientHelper == null) {
			syncInit();
		}
	...
	public void init() {
		try {
			...
			// 证书
			char[] password = WXPayConfigImpl.getInstance().getMchID().toCharArray();
			InputStream certStream = WXPayConfigImpl.getInstance().getCertStream();
