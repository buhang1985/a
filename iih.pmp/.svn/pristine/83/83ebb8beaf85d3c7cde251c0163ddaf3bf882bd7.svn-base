...
public class WXQueryErrorcode {
	...
	public static String getExtErrorDes(String name){
        switch(name){
        case WXQueryErrorcode.ORDERNOTEXIST:
        	return WXQueryErrorcode.ORDERNOTEXIST__DES;
        case WXQueryErrorcode.SYSTEMERROR:
        	return WXQueryErrorcode.SYSTEMERROR__DES;        
        }
		return null;
	}
	...
	{
		String rst=Errordes+";";
		String exdes=WXQueryErrorcode.getExtErrorDes(errorcode);
		if(exdes!=null)
			rst=rst+exdes;
		return rst;
	}
