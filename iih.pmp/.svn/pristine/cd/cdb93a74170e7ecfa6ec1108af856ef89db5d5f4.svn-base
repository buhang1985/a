...
public class AlipayTradeWithHBServiceImpl extends AbsAlipayTradeService {
	...
	public static class ClientBuilder {
		...
		public AlipayTradeWithHBServiceImpl build() throws NumberFormatException, BizException {
	...
	public AlipayTradeWithHBServiceImpl(ClientBuilder builder) throws NumberFormatException, BizException {
