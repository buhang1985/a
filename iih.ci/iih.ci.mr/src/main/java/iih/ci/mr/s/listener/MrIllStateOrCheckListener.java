...
public class MrIllStateOrCheckListener extends IllStateOrCheckListener{
	//病危医嘱下达
	@Override
	protected void doYourActionAfterOrCheck(CiOrderDO[] ors) throws BizException {
		...
		for (int j = 0; j < ors.length; j++) {
			...
			MrTaskRuleDO[] rkRuleDoArr=ruleService.find(" code_udidoc='"+ICiMrDictCodeConst.SD_MR_TASK_EVENT_BINGWEI+"' and fg_active='Y'", "", FBoolean.FALSE);
