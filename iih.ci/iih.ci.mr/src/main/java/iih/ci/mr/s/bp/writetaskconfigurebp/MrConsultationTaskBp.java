...
public class MrConsultationTaskBp {

	public void writeTask(CiOrderDO[] ors,MrTaskRuleDO[] rkRuleDoArr,Boolean flag) throws BizException{
		if(flag){
			createConsultationTask(ors,rkRuleDoArr);
		}else{
			cancelConsultationTask(ors,rkRuleDoArr); 
		}
	}
	
	public void createConsultationTask(CiOrderDO[] ors,MrTaskRuleDO[] rkRuleDoArr)  throws BizException{
	...
	public void cancelConsultationTask(CiOrderDO[] ors,MrTaskRuleDO[] rkRuleDoArr)  throws BizException{
