 ...
 */
public class MrOutDeptAndHospitalListener implements IBusinessListener{
	...
	public void doAction(IBusinessEvent event) throws BizException {
		...
		LvHos4EsDTO enterDept4EsDTO = (LvHos4EsDTO) bizUserObj.getUserObj();
	...
	private void InsertMrtaskByEnOutDept(InpatientDO[] inPatients) throws BizException{
		...
		MrTaskRuleDO[] rkRuleDoArr=ruleService.find(" code_udidoc='"+ICiMrDictCodeConst.SD_MR_TASK_EVENT_CHUYUAN+"' and fg_active='Y'", "", FBoolean.FALSE);
