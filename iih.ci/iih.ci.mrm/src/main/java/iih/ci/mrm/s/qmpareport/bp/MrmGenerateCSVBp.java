...
public class MrmGenerateCSVBp {
	...
	public List<CiMrmDirHeaReportDTO> getDataList(String[] idEnts, int typeFile) throws BizException {
		...
		for (int i = 0; i < idEnts.length; i++) {
			...
			sb.append("select patc.name as yblx ");
			sb.append(" from en_ent ent, pi_pat_ca patc ");
			sb.append(" where ent.id_patca = patc.id_patca ");
			sb.append(" and ent.id_ent = ? ");
			
			SqlParam s  = new SqlParam();
			s.addParam(idEnts[i]);
			
			DAFacade da = new DAFacade();
			List<CiMrmDirHeaReportDTO> reportDTOList = 
					(List<CiMrmDirHeaReportDTO>) da.execQuery(sb.toString(), s, new BeanListHandler(CiMrmDirHeaReportDTO.class));
			t = reportDTOList.get(0);
			...
			if(c.getAge()!=null&&!"".equals(c.getAge())&&!"-".equals(c.getAge())){
			 ...
			 * t.setH23(t.getJbbm1()); t.setBlzd(c.getName_dipathology());
			 * t.setJbbm2(c.getSd_dipathology());//病理诊断的疾病编码
			 * t.setJbmm(t.getJbbm2()); t.setBlh(c.getNum_patho());
			 */
			...
			if (sug.length > 1) {
				...
				if (sug[1].getDt_start_sug() != null) {
					// 手术及操作日期有开始和结束不知道选哪个
					t.setSsjczrq2(sug[1].getDt_start_sug().toString(TimeZone.getDefault(), format2));
				}
				// 手术级别
			...
			if (list3 != null && list3.size() > 0) {
				for (ValueContrastDetailDO valueDetailDo : list3) {
					if (!StringUtil.isEmptyWithTrim(sd_sug)
							&& sd_sug.equals(valueDetailDo.getCode_source())) {
						t.setSsjczbm1(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_sug1)
							&& sd_sug1.equals(valueDetailDo.getCode_source())) {
						t.setSsjczbm2(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_sug2)
							&& sd_sug2.equals(valueDetailDo.getCode_source())) {
						t.setSsjczbm3(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_sug3)
							&& sd_sug3.equals(valueDetailDo.getCode_source())) {
						t.setSsjczbm4(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_sug4)
							&& sd_sug4.equals(valueDetailDo.getCode_source())) {
						t.setSsjczbm5(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_sug5)
							&& sd_sug5.equals(valueDetailDo.getCode_source())) {
						t.setSsjczbm6(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_sug6)
							&& sd_sug6.equals(valueDetailDo.getCode_source())) {
						t.setSsjczbm7(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_sug7)
							&& sd_sug7.equals(valueDetailDo.getCode_source())) {
						t.setSsjczbm8(valueDetailDo.getCode_goal());
					}
				}
			}
			if (!StringUtil.isEmptyWithTrim(sd_sug)
					&& StringUtil.isEmptyWithTrim(t.getSsjczbm1())) {
				t.setSsjczbm1(sd_sug);
				name_NoContrast += " 手术及操作编码1—" + sd_sug;
			}
			if (!StringUtil.isEmptyWithTrim(sd_sug1)
					&& StringUtil.isEmptyWithTrim(t.getSsjczbm2())) {
				t.setSsjczbm2(sd_sug1);
				name_NoContrast += " 手术及操作编码2—" + sd_sug1;
			}
			if (!StringUtil.isEmptyWithTrim(sd_sug2)
					&& StringUtil.isEmptyWithTrim(t.getSsjczbm3())) {
				t.setSsjczbm3(sd_sug2);
				name_NoContrast += " 手术及操作编码3—" + sd_sug2;
			}
			if (!StringUtil.isEmptyWithTrim(sd_sug3)
					&& StringUtil.isEmptyWithTrim(t.getSsjczbm4())) {
				t.setSsjczbm4(sd_sug3);
				name_NoContrast += " 手术及操作编码4—" + sd_sug3;
			}
			if (!StringUtil.isEmptyWithTrim(sd_sug4)
					&& StringUtil.isEmptyWithTrim(t.getSsjczbm5())) {
				t.setSsjczbm5(sd_sug4);
				name_NoContrast += " 手术及操作编码5—" + sd_sug4;
			}
			if (!StringUtil.isEmptyWithTrim(sd_sug5)
					&& StringUtil.isEmptyWithTrim(t.getSsjczbm6())) {
				t.setSsjczbm6(sd_sug5);
				name_NoContrast += " 手术及操作编码6—" + sd_sug5;
			}
			if (!StringUtil.isEmptyWithTrim(sd_sug6)
					&& StringUtil.isEmptyWithTrim(t.getSsjczbm7())) {
				t.setSsjczbm7(sd_sug6);
				name_NoContrast += " 手术及操作编码7—" + sd_sug6;
			}
			if (!StringUtil.isEmptyWithTrim(sd_sug7)
					&& StringUtil.isEmptyWithTrim(t.getSsjczbm8())) {
			...
			if (list5 != null && list5.size() > 0) {
				for (ValueContrastDetailDO valueDetailDo : list5) {
					if (!StringUtil.isEmptyWithTrim(sd_incision_level)
							&& sd_incision_level.equals(valueDetailDo.getCode_source())) {
						t.setQkdj1(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_incision1_level)
							&& sd_incision1_level.equals(valueDetailDo.getCode_source())) {
						t.setQkdj2(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_incision2_level)
							&& sd_incision2_level.equals(valueDetailDo.getCode_source())) {
						t.setQkdj3(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_incision3_level)
							&& sd_incision3_level.equals(valueDetailDo.getCode_source())) {
						t.setQkdj4(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_incision4_level)
							&& sd_incision4_level.equals(valueDetailDo.getCode_source())) {
						t.setQkdj5(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_incision5_level)
							&& sd_incision5_level.equals(valueDetailDo.getCode_source())) {
						t.setQkdj6(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_incision6_level)
							&& sd_incision6_level.equals(valueDetailDo.getCode_source())) {
						t.setQkdj7(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_incision7_level)
							&& sd_incision7_level.equals(valueDetailDo.getCode_source())) {
						t.setQkdj8(valueDetailDo.getCode_goal());
					}
				}
			}
			if (!StringUtil.isEmptyWithTrim(sd_incision_level)
					&& StringUtil.isEmptyWithTrim(t.getQkdj1())) {
				t.setQkdj1(sd_incision_level);
				name_NoContrast += " 切口等级1—" + sd_incision_level;
			}
			if (!StringUtil.isEmptyWithTrim(sd_incision1_level)
					&& StringUtil.isEmptyWithTrim(t.getQkdj2())) {
				t.setQkdj2(sd_incision1_level);
				name_NoContrast += " 切口等级2—" + sd_incision1_level;
			}
			if (!StringUtil.isEmptyWithTrim(sd_incision2_level)
					&& StringUtil.isEmptyWithTrim(t.getQkdj3())) {
				t.setQkdj3(sd_incision2_level);
				name_NoContrast += " 切口等级3—" + sd_incision2_level;
			}
			if (!StringUtil.isEmptyWithTrim(sd_incision3_level)
					&& StringUtil.isEmptyWithTrim(t.getQkdj4())) {
				t.setQkdj4(sd_incision3_level);
				name_NoContrast += " 切口等级4—" + sd_incision3_level;
			}
			if (!StringUtil.isEmptyWithTrim(sd_incision4_level)
					&& StringUtil.isEmptyWithTrim(t.getQkdj5())) {
				t.setQkdj5(sd_incision4_level);
				name_NoContrast += " 切口等级5—" + sd_incision4_level;
			}
			if (!StringUtil.isEmptyWithTrim(sd_incision5_level)
					&& StringUtil.isEmptyWithTrim(t.getQkdj6())) {
				t.setQkdj6(sd_incision5_level);
				name_NoContrast += " 切口等级6—" + sd_incision5_level;
			}
			if (!StringUtil.isEmptyWithTrim(sd_incision6_level)
					&& StringUtil.isEmptyWithTrim(t.getQkdj7())) {
				t.setQkdj7(sd_incision6_level);
				name_NoContrast += " 切口等级7—" + sd_incision6_level;
			}
			if (!StringUtil.isEmptyWithTrim(sd_incision7_level)
					&& StringUtil.isEmptyWithTrim(t.getQkdj8())) {
			...
			if (list6 != null && list6.size() > 0) {
				for (ValueContrastDetailDO valueDetailDo : list6) {
					if (!StringUtil.isEmptyWithTrim(sd_heal_category)
							&& sd_heal_category.equals(valueDetailDo.getCode_source())) {
						t.setQkyhlb1(valueDetailDo.getCode_goal());
						t.setQkylb1(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_heal1_category)
							&& sd_heal1_category.equals(valueDetailDo.getCode_source())) {
						t.setQkyhlb2(valueDetailDo.getCode_goal());
						t.setQkylb2(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_heal2_category)
							&& sd_heal2_category.equals(valueDetailDo.getCode_source())) {
						t.setQkyhlb3(valueDetailDo.getCode_goal());
						t.setQkylb3(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_heal3_category)
							&& sd_heal3_category.equals(valueDetailDo.getCode_source())) {
						t.setQkyhlb4(valueDetailDo.getCode_goal());
						t.setQkylb4(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_heal4_category)
							&& sd_heal4_category.equals(valueDetailDo.getCode_source())) {
						t.setQkyhlb5(valueDetailDo.getCode_goal());
						t.setQkylb5(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_heal5_category)
							&& sd_heal5_category.equals(valueDetailDo.getCode_source())) {
						t.setQkyhlb6(valueDetailDo.getCode_goal());
						t.setQkylb6(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_heal6_category)
							&& sd_heal6_category.equals(valueDetailDo.getCode_source())) {
						t.setQkyhlb7(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_heal7_category)
							&& sd_heal7_category.equals(valueDetailDo.getCode_source())) {
			...
			if (list7 != null && list7.size() > 0) {
				for (ValueContrastDetailDO valueDetailDo : list7) {
					if (!StringUtil.isEmptyWithTrim(sd_anaesthesia_mode)
							&& sd_anaesthesia_mode.equals(valueDetailDo.getCode_source())) {
						t.setMzfs1(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_anaesthesia1_mode)
							&& sd_anaesthesia1_mode.equals(valueDetailDo.getCode_source())) {
						t.setMzfs2(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_anaesthesia2_mode)
							&& sd_anaesthesia2_mode.equals(valueDetailDo.getCode_source())) {
						t.setMzfs3(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_anaesthesia3_mode)
							&& sd_anaesthesia3_mode.equals(valueDetailDo.getCode_source())) {
						t.setMzfs4(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_anaesthesia4_mode)
							&& sd_anaesthesia4_mode.equals(valueDetailDo.getCode_source())) {
						t.setMzfs5(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_anaesthesia5_mode)
							&& sd_anaesthesia5_mode.equals(valueDetailDo.getCode_source())) {
						t.setMzfs6(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_anaesthesia6_mode)
							&& sd_anaesthesia6_mode.equals(valueDetailDo.getCode_source())) {
						t.setMzfs7(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_anaesthesia7_mode)
							&& sd_anaesthesia7_mode.equals(valueDetailDo.getCode_source())) {
						t.setMzfs8(valueDetailDo.getCode_goal());
					}
				}
			}
			if (!StringUtil.isEmptyWithTrim(sd_anaesthesia_mode)
					&& StringUtil.isEmptyWithTrim(t.getMzfs1())) {
				t.setMzfs1(sd_anaesthesia_mode);
				name_NoContrast += " 麻醉方式1—" + sd_anaesthesia_mode;
			}
			if (!StringUtil.isEmptyWithTrim(sd_anaesthesia1_mode)
					&& StringUtil.isEmptyWithTrim(t.getMzfs2())) {
				t.setMzfs2(sd_anaesthesia1_mode);
				name_NoContrast += " 麻醉方式2—" + sd_anaesthesia1_mode;
			}
			if (!StringUtil.isEmptyWithTrim(sd_anaesthesia2_mode)
					&& StringUtil.isEmptyWithTrim(t.getMzfs3())) {
				t.setMzfs3(sd_anaesthesia2_mode);
				name_NoContrast += " 麻醉方式3—" + sd_anaesthesia2_mode;
			}
			if (!StringUtil.isEmptyWithTrim(sd_anaesthesia3_mode)
					&& StringUtil.isEmptyWithTrim(t.getMzfs4())) {
				t.setMzfs4(sd_anaesthesia3_mode);
				name_NoContrast += " 麻醉方式4—" + sd_anaesthesia3_mode;
			}
			if (!StringUtil.isEmptyWithTrim(sd_anaesthesia4_mode)
					&& StringUtil.isEmptyWithTrim(t.getMzfs5())) {
				t.setMzfs5(sd_anaesthesia4_mode);
				name_NoContrast += " 麻醉方式5—" + sd_anaesthesia4_mode;
			}
			if (!StringUtil.isEmptyWithTrim(sd_anaesthesia5_mode)
					&& StringUtil.isEmptyWithTrim(t.getMzfs6())) {
				t.setMzfs6(sd_anaesthesia5_mode);
				name_NoContrast += " 麻醉方式6—" + sd_anaesthesia5_mode;
			}
			if (!StringUtil.isEmptyWithTrim(sd_anaesthesia6_mode)
					&& StringUtil.isEmptyWithTrim(t.getMzfs7())) {
				t.setMzfs7(sd_anaesthesia6_mode);
				name_NoContrast += " 麻醉方式7—" + sd_anaesthesia6_mode;
			}
			if (!StringUtil.isEmptyWithTrim(sd_anaesthesia7_mode)
					&& StringUtil.isEmptyWithTrim(t.getMzfs8())) {
			...
			if (list8 != null && list8.size() > 0) {
				for (ValueContrastDetailDO valueDetailDo : list8) {
					if (!StringUtil.isEmptyWithTrim(sd_class_sug)
							&& sd_class_sug.equals(valueDetailDo.getCode_source())) {
						t.setSslx1(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_class_sug1)
							&& sd_class_sug1.equals(valueDetailDo.getCode_source())) {
						t.setSslx2(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_class_sug2)
							&& sd_class_sug2.equals(valueDetailDo.getCode_source())) {
						t.setSslx3(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_class_sug3)
							&& sd_class_sug3.equals(valueDetailDo.getCode_source())) {
						t.setSslx4(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_class_sug4)
							&& sd_class_sug4.equals(valueDetailDo.getCode_source())) {
						t.setSslx5(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_class_sug5)
							&& sd_class_sug5.equals(valueDetailDo.getCode_source())) {
						t.setSslx6(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_class_sug6)
							&& sd_class_sug6.equals(valueDetailDo.getCode_source())) {
						t.setSslx7(valueDetailDo.getCode_goal());
					}
					if (!StringUtil.isEmptyWithTrim(sd_class_sug7)
							&& sd_class_sug7.equals(valueDetailDo.getCode_source())) {
			...
			t.setRyq_t(c.getComa_time_bef_inhos_days() == null ? "0" : c
					.getComa_time_bef_inhos_days().toString());
			t.setRyq_xs(c.getComa_time_bef_inhos_hours() == null ? "0" : c
					.getComa_time_bef_inhos_hours().toString());
			t.setRyq_fz(c.getComa_time_bef_inhos_mins() == null ? "0" : c
					.getComa_time_bef_inhos_mins().toString());
			t.setRyh_f(t.getRyq_fz());
			t.setRyh_t(c.getComa_time_inhos_days() == null ? "0" : c
					.getComa_time_inhos_days().toString());
			t.setRyh_xs(c.getComa_time_inhos_hours() == null ? "0" : c
					.getComa_time_inhos_hours().toString());
			t.setRyh_fz(c.getComa_time_inhos_mins() == null ? "0" : c
					.getComa_time_inhos_mins().toString());

			t.setZfy(c.getAmount() == null ? null : c.getAmount().toString());
			t.setZfje(c.getCms_spamount() == null ? null : c.getCms_spamount()
					.toString());
			t.setYlfwf(c.getCms_gmsfee() == null ? null : c.getCms_gmsfee()
					.toString());
			t.setYlfuf(t.getYlfwf());
			t.setBzlzf(c.getCms_decnfee() == null ? null : c.getCms_decnfee()
					.toString());
			t.setZyblzhzf(c.getCms_decfee() == null ? null : c.getCms_decfee()
					.toString());
			t.setZlczf(c.getCms_gtofee() == null ? null : c.getCms_gtofee()
					.toString());
			t.setHlf(c.getCms_nurfee() == null ? null : c.getCms_nurfee()
					.toString());
			t.setQtfy(c.getCms_otherfee() == null ? null : c.getCms_otherfee()
					.toString());
			t.setBlzdf(c.getDi_pdifee() == null ? null : c.getDi_pdifee()
					.toString());
			t.setKff(c.getRc_rcfee() == null ? null : c.getRc_rcfee()
					.toString());

			t.setZdf(c.getDi_ldifee() == null ? null : c.getDi_ldifee()
					.toString());
			t.setSyszdf(t.getZdf());
			t.setYxxzdf(c.getDi_idifee() == null ? null : c.getDi_idifee()
					.toString());
			t.setLczdxmf(c.getDi_cdifee() == null ? null : c.getDi_cdifee()
					.toString());
			t.setFsszlxmf(c.getTc_nstpfee() == null ? null : c.getTc_nstpfee()
					.toString());
			t.setZlf(c.getTc_cptfee() == null ? null : c.getTc_cptfee()
					.toString());
			t.setWlzlf(t.getZlf());
			t.setSszlf(c.getTc_stfee() == null ? null : c.getTc_stfee()
					.toString());
			t.setMzf(c.getTc_anfee() == null ? null : c.getTc_anfee()
					.toString());
			t.setMaf(t.getMzf());
			t.setSsf(c.getTc_opfee() == null ? null : c.getTc_opfee()
					.toString());
			t.setZyl_zyzd(c.getTcm_difee() == null ? null : c.getTcm_difee()
					.toString());

			t.setZyzl(c.getTcm_cmtfee() == null ? null : c.getTcm_cmtfee()
					.toString());
			t.setZyzlf(t.getZyzl());
			t.setZywz(c.getTcm_etfee() == null ? null : c.getTcm_etfee()
					.toString());
			t.setZygs(c.getTcm_bffee() == null ? null : c.getTcm_bffee()
					.toString());
			t.setZcyjf(c.getTcm_tcmfee() == null ? null : c.getTcm_tcmfee()
					.toString());
			t.setZytnzl(c.getTcm_mnpfee() == null ? null : c.getTcm_mnpfee()
					.toString());
			t.setZygczl(c.getTcm_anrfee() == null ? null : c.getTcm_anrfee()
					.toString());
			t.setZytszl(c.getTcm_spcialfee() == null ? null : c
					.getTcm_spcialfee().toString());
			t.setZyqt(c.getTcm_otherfee() == null ? null : c.getTcm_otherfee()
					.toString());
			t.setZytstpjg(c.getTcm_allocationfee() == null ? null : c
					.getTcm_allocationfee().toString());
			t.setBzss(c.getTcm_dcfee() == null ? null : c.getTcm_dcfee()
					.toString());
			t.setXyf(c.getWm_wmfee() == null ? null : c.getWm_wmfee()
					.toString());
			t.setKjywf(c.getWm_agfee() == null ? null : c.getWm_agfee()
					.toString());
			t.setZcyf(c.getTcmt_cpmfee() == null ? null : c.getTcmt_cpmfee()
					.toString());
			t.setZyzjf(c.getTcmt_ppafee() == null ? null : c.getTcmt_ppafee()
					.toString());// 医疗机构中药制剂费
			t.setZcyf1(c.getTcmt_chmfee() == null ? null : c.getTcmt_chmfee()
					.toString());
			t.setXf(c.getBabp_bfee() == null ? null : c.getBabp_bfee()
					.toString());
			t.setBdblzpf(c.getBabp_apfee() == null ? null : c.getBabp_apfee()
					.toString());
			t.setQdblzpf(c.getBabp_gpfee() == null ? null : c.getBabp_gpfee()
					.toString());
			t.setNxyzlzpf(c.getBabp_bcffee() == null ? null : c
					.getBabp_bcffee().toString());
			t.setXbyzlzpf(c.getBabp_cflfee() == null ? null : c
					.getBabp_cflfee().toString());
			t.setJcyyclf(c.getSc_dmmfifee() == null ? null : c.getSc_dmmfifee()
					.toString());
			t.setHcyyclf(t.getJcyyclf());
			t.setYyclf(c.getSc_dmmftfee() == null ? null : c.getSc_dmmftfee()
					.toString());
			// t.setHcyyclf(t.getYyclf());
			t.setSsycxclf(c.getSc_dmmfsfee() == null ? null : c
					.getSc_dmmfsfee().toString());
			t.setYcxyyclf(t.getSsycxclf());
			t.setQtf(c.getOc_ocfee() == null ? null : c.getOc_ocfee()
					.toString());
	 ...
	 */
	/*
	 * private String sd_diConvert(String sd_di) { String newSd_di = null;
	 * if(sd_di!=null) { int len = sd_di.length(); newSd_di = sd_di.substring(0,
	 * len<7?len:7); } return newSd_di; }
	 */
	...
	private List<ValueContrastDetailDO> contrastClassify(CiMrFpDTO c) throws BizException {
		...
		sb.append(" where cc.code='" + code
				+ "' and cvc.comparison_code_source='" + dep + "' ");
		...
		@SuppressWarnings("unchecked")
		List<ValueContrastDetailDO> list = (List<ValueContrastDetailDO>) daf
				.execQuery(sb.toString(), sp, new BeanListHandler(ValueContrastDetailDO.class));
		return list;
	}
	 ...
	 * @throws DAException
	 */
	private List<ValueContrastDetailDO> dataContrastClassify(List<String> list,
			String contrastcode) throws BizException {
		// 卫统4对照编码
		String code = "cs003";
		DAFacade daf = new DAFacade();
		StringBuilder sb = new StringBuilder();
		...
		sb.append(" on cc.id_comparison=cvc.id_comparison ");
		sb.append(" where cc.code='" + code
				+ "' and cvc.comparison_code_source='" + contrastcode + "'");
		sb.append(" and cd.code_source in ( ");
		sb.append(inwhere);

		@SuppressWarnings("unchecked")
		List<ValueContrastDetailDO> listData = (List<ValueContrastDetailDO>) daf
				.execQuery(sb.toString(), new BeanListHandler(ValueContrastDetailDO.class));
		return listData;
	}
	...
	public List<CiMrmDirHeaReportDTO> getDatas(QryRootNodeDTO qryRootNodeDTO, String sqlWhere) throws BizException {
		...
		String Name_src = "";
		int result = CiMrMParamUtils.GetSysParamCIMRFP_REPORT_DATA_SRC(Context.get().getOrgId());
		String qryRootNode = service.getQueryStringWithoutDesc(qryRootNodeDTO);
		...
		if (qryRootNode != null && !"".equals(qryRootNode)) {
		...
		DAFacade da = new DAFacade();
		@SuppressWarnings("unchecked")
		List<PatiVisitDO> lstMrFpPat = 
			(List<PatiVisitDO>) da.execQuery(sql.toString(), new BeanListHandler(PatiVisitDO.class));
		
		MrmGenerateListBp CiMrmGenList = new MrmGenerateListBp();
		String[] arrIdEnt = CiMrmGenList.getIdEntFromBlCgIp(lstMrFpPat);
		MrmGenerateCSVBp cimrmlist = new MrmGenerateCSVBp();
	...
	public String[] getHeaders() {
		int res = CiMrMParamUtils.GetSysParamMRM_FP_TYPE(Context.get()
				.getOrgId());
		String[] fs = { "username", "ylfkfs", "jkkh", "zycs", "bah", "xm",
				"xb", "csrq", "nl", "gj", "bzyzs_nl", "xsetz", "xserytz",
				"csd", "gg", "mz", "sfzh", "zy", "hy", "xzz", "dh", "yb1",
				"hkdz", "yb2", "gzdwjdz", "dwdh", "yb3", "lxrxm", "gx", "dz",
				"dh1", "rytj", "zllb", "rysj", "rysj_s", "rykb", "rybf",
				"zkkb", "cysj", "cysj_s", "cykb", "cybf", "sjzy", "mzd_zyzd",
				"jbdm", "mzd_xyzd", "jbbm", "sslclj", "zyyj", "zyzlsb",
				"zyzljs", "bzsh", "zb", "zb_jbbm", "zb_rybq", "zyzd",
				"zyzd_jbbm", "xy_rybq", "zz1", "zz_jbbm1", "zz_rybq1", "qtzd1",
				"zyzd_jbbm1", "rybq1", "zz2", "zz_jbbm2", "zz_rybq2", "qtzd2",
				"zyzd_jbbm2", "rybq2", "zz3", "zz_jbbm3", "zz_rybq3", "qtzd3",
				"zyzd_jbbm3", "rybq3", "zz4", "zz_jbbm4", "zz_rybq4", "qtzd4",
				"zyzd_jbbm4", "rybq4", "zz5", "zz_jbbm5", "zz_rybq5", "qtzd5",
				"zyzd_jbbm5", "rybq5", "zz6", "zz_jbbm6", "zz_rybq6", "qtzd6",
				"zyzd_jbbm6", "rybq6", "zz7", "zz_jbbm7", "zz_rybq7", "qtzd7",
				"zyzd_jbbm7", "rybq7", "wbyy", "jbbm1", "blzd", "jbbm2", "blh",
				"ywgm", "gmyw", "sj", "xx", "rh", "kzr", "zrys", "zzys",
				"zyys", "zrhs", "jxys", "sxys", "bmy", "bazl", "zkys", "zkhs",
				"zkrq", "ssjczbm1", "ssjczrq1", "shjb1", "ssjczmc1", "sz1",
				"yz1", "ez1", "qkdj1", "qkylb1", "mzfs1", "mzys1", "ssjczbm2",
				"ssjczrq2", "shjb2", "ssjczmc2", "sz2", "yz2", "ez2", "qkdj2",
				"qkylb2", "mzfs2", "mzys2", "ssjczbm3", "ssjczrq3", "shjb3",
				"ssjczmc3", "sz3", "yz3", "ez3", "qkdj3", "qkylb3", "mzfs3",
				"mzys3", "ssjczbm4", "ssjczrq4", "shjb4", "ssjczmc4", "sz4",
				"yz4", "ez4", "qkdj4", "qkylb4", "mzfs4", "mzys4", "ssjczbm5",
				"ssjczrq5", "shjb5", "ssjczmc5", "sz5", "yz5", "ez5", "qkdj5",
				"qkylb5", "mzfs5", "mzys5", "ssjczbm6", "ssjczrq6", "shjb6",
				"ssjczmc6", "sz6", "yz6", "ez6", "qkdj6", "qkylb6", "mzfs6",
				"mzys6", "lyfs", "yzzy_jgmc", "wsy_jgmc", "zzyjh", "md",
				"ryq_t", "ryq_xs", "ryq_fz", "ryh_t", "ryh_xs", "ryh_fz",
				"zfy", "zfje", "ylfwf", "bzlzf", "zyblzhzf", "zlczf", "hlf",
				"qtfy", "blzdf", "zdf", "yxxzdf", "lczdxmf", "fsszlxmf", "zlf",
				"sszlf", "mzf", "ssf", "kff", "zyl_zyzd", "zyzl", "zywz",
				"zygs", "zcyjf", "zytnzl", "zygczl", "zytszl", "zyqt",
				"zytstpjg", "bzss", "xyf", "kjywf", "zcyf", "zyzjf", "zcyf1",
				"xf", "bdblzpf", "qdblzpf", "nxyzlzpf", "xbyzlzpf", "jcyyclf",
				"yyclf", "ssycxclf", "qtf" };
		if (res == 0) {
			fs = new String[] { "username", "ylfkfs", "jkkh", "zycs", "bah",
					"xm", "xb", "csrq", "nl", "gj", "bzyzsnl", "xsecstz",
					"xserytz", "csd", "gg", "mz", "sfzh", "zy", "hy", "xzz",
					"dh", "yb1", "hkdz", "yb2", "gzdwjdz", "dwdh", "yb3",
					"lxrxm", "gx", "dz", "dh2", "rytj", "rysj", "rysjs",
					"rykb", "rybf", "zkkb", "cysj", "cysjs", "cykb", "cybf",
					"sjzyts", "mzzd", "jbbm", "zyzd", "jbdm", "rybq", "qtzd8",
					"jbdm8", "rybq8", "qtzd1", "jbdm1", "rybq1", "qtzd9",
					"jbdm9", "rybq9", "qtzd2", "jbdm2", "rybq2", "qtzd10",
					"jbdm10", "rybq10", "qtzd3", "jbdm3", "rybq3", "qtzd11",
					"jbdm11", "rybq11", "qtzd4", "jbdm4", "rybq4", "qtzd12",
					"jbdm12", "rybq12", "qtzd5", "jbdm5", "rybq5", "qtzd13",
					"jbdm13", "rybq13", "qtzd6", "jbdm6", "rybq6", "qtzd14",
					"jbdm14", "rybq14", "qtzd7", "jbdm7", "rybq7", "qtzd15",
					"jbdm15", "rybq15", "wbyy", "h23", "blzd", "jbmm", "blh",
					"ywgm", "gmyw", "swhzsj", "xx", "rh", "kzr", "zrys",
					"zzys", "zyys", "zrhs", "jxys", "sxys", "bmy", "bazl",
					"zkys", "zkhs", "zkrq", "ssjczbm1", "ssjczrq1", "ssjb1",
					"ssjczmc1", "sz1", "yz1", "ez1", "qkdj1", "qkyhlb1",
					"mzfs1", "mzys1", "ssjczbm2", "ssjczrq2", "ssjb2",
					"ssjczmc2", "sz2", "yz2", "ez2", "qkdj2", "qkyhlb2",
					"mzfs2", "mzys2", "ssjczbm3", "ssjczrq3", "ssjb3",
					"ssjczmc3", "sz3", "yz3", "ez3", "qkdj3", "qkyhlb3",
					"mzfs3", "mzys3", "ssjczbm4", "ssjczrq4", "ssjb4",
					"ssjczmc4", "sz4", "yz4", "ez4", "qkdj4", "qkyhlb4",
					"mzfs4", "mzys4", "ssjczbm5", "ssjczrq5", "ssjb5",
					"ssjczmc5", "sz5", "yz5", "ez5", "qkdj5", "qkyhlb5",
					"mzfs5", "mzys5", "ssjczbm6", "ssjczrq6", "ssjb6",
					"ssjczmc6", "sz6", "yz6", "ez6", "qkdj6", "qkyhlb6",
					"mzfs6", "mzys6", "ssjczbm7", "ssjczrq7", "ssjb7",
					"ssjczmc7", "sz7", "yz7", "ez7", "qkdj7", "qkyhlb7",
					"mzfs7", "mzys7", "lyfs", "yzzy_yljg", "wsy_yljg",
					"sfzzyjh", "md", "ryq_t", "ryq_xs", "ryq_f", "ryh_t",
					"ryh_xs", "ryh_f", "zfy", "zfje", "ylfuf", "zlczf", "hlf",
					"qtfy", "blzdf", "syszdf", "yxxzdf", "lczdxmf", "fsszlxmf",
					"wlzlf", "sszlf", "maf", "ssf", "kff", "zyzlf", "xyf",
					"kjywf", "zcyf", "zcyf1", "xf", "bdblzpf", "qdblzpf",
					"nxyzlzpf", "xbyzlzpf", "hcyyclf", "yyclf", "ycxyyclf",
					"qtf" };
		}
		return fs;
	}
