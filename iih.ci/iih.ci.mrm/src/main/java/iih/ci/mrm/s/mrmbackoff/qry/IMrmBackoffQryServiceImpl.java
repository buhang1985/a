...
import iih.ci.mrm.i.mrmbackoff.qry.IMrmBackoffQryService;
...
@Service(serviceInterfaces={IMrmBackoffQryService.class}, binding=Binding.JSONRPC)
public class IMrmBackoffQryServiceImpl extends PagingServiceImpl<CiMrmQryListDTO> implements IMrmBackoffQryService{

	@Override
	public PagingRtnData<CiMrmQryListDTO> getMrmBackoffDTOList(
	...
	public void SendBackoffMsg(MrmBackoffMsgDTO backoffdto) throws BizException {
		...
		msgMap.put("CIMRMBACKOFF",backoffdto);
		msgService.GenerateMessageAndMap("CIMRMBACKOFF", msgMap, null);
	}
