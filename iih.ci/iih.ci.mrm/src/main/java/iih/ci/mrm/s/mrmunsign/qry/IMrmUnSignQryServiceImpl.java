package iih.ci.mrm.s.mrmunsign.qry;

import iih.bd.bc.udi.pub.IBdFcDictCodeConst;
import iih.ci.mrm.dto.cimrmqrylist.d.CiMrmQryListDTO;
import iih.ci.mrm.i.mrmunsign.qry.IMrmUnSignQryService;
...
@Service(serviceInterfaces={IMrmUnSignQryService.class}, binding=Binding.JSONRPC)
public class IMrmUnSignQryServiceImpl extends PagingServiceImpl<CiMrmQryListDTO> implements IMrmUnSignQryService{

	@Override
	public PagingRtnData<CiMrmQryListDTO> getMrmUnSignDTOList(
