...
import iih.ci.ord.s.ems.op.base.EmsMedicinesSaveBP;
...
public class EmsDrugsSaveBP extends EmsMedicinesSaveBP {
	...
	protected void mergeOrderInfo(CiEnContextDTO ctx, CiOrderDO orderInfo, Object uiModel) throws BizException {
		...
		//滴速 liyue
		orderInfo.setId_dripspeed(drugItem.getId_dripspeed());
		// by yzh 添加医嘱付数
		...
		orderInfo.setFg_quickwflow(drugItem.getFg_quickwflow());
		//诊断信息
		orderInfo.setId_didef(drugItem.getId_didef());
		orderInfo.setName_didef(drugItem.getCode_didef());
