 ...
 * @author F
 *
 * @date 2019年9月11日上午11:56:37
 *
 * @classpath iih.ci.event.ord.bps.revert.op.sql.OpRisRevertSql
 */
public class OpRisRevertSql {

	/**
	 * BS002
	 * 门诊 撤回 检查病理 1.【IEOpRisOrEnDTO】+ 【IEOpRisIllHisDTO】 2.【IEOpRisOrDTO】  3.【IEOpRisOrItmDTO】
	 * @param str_idor_path
	 * @return
	 */
	public String getOpRisWithDrawPathInfoSql(String str_idor_path ){
	    ...
	    stringBuilder.append(" '' as is_pregnancy, ");//3.是否妊娠/怀孕
	...
	/**
	 * BS002
	 * 门诊 撤回 普通检查 1.【IEOpRisOrEnDTO】+ 【IEOpRisIllHisDTO】 2.【IEOpRisOrDTO】  3.【IEOpRisOrItmDTO】
	 * @param str_idor_ris
	 * @return
	 */
	public String getOpRisWithDrawRisInfoSql(String str_idor_ris) {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
	    stringBuilder.append(" do.code as ser_type_code, ");//3.检查类型编码
	    stringBuilder.append(" do.name as ser_type_name, ");//3.检查类型名称
	...
	/**
	 * BS002
	 * 门诊撤回 获取检查联系人集合【IEOpRisOrContacterDTO】
	 * @param idOrs
	 * @return
	 */
	public String getOpRisWithDrawContacterInfoSql(String idOrs) {
		StringBuilder stringBuilder = new StringBuilder();
