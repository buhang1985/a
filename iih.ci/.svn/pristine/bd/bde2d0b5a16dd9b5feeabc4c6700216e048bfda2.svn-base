package iih.ci.mr.easyrules.core;
...
import iih.ci.mr.easyrules.util.Utils;
...
class RuleProxy implements InvocationHandler {
    ...
    /**
     * Makes the rule object implement the {@link iih.ci.mr.easyrules.api.Rule} interface.
     *
     * @param rule the annotated rule object.
     * @return a proxy that implements the {@link iih.ci.mr.easyrules.api.Rule} interface.
     */
    public static iih.ci.mr.easyrules.api.Rule asRule(final Object rule) {

        ruleDefinitionValidator.validateRuleDefinition(rule);

        return (iih.ci.mr.easyrules.api.Rule) Proxy.newProxyInstance(
                iih.ci.mr.easyrules.api.Rule.class.getClassLoader(),
                new Class[]{iih.ci.mr.easyrules.api.Rule.class, Comparable.class},
                new RuleProxy(rule));
    }
    ...
    public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
        ...
        if (method.getName().equals("compareTo")) {
            ...
            if (compareToMethod != null) {
                ...
                iih.ci.mr.easyrules.api.Rule otherRule = (iih.ci.mr.easyrules.api.Rule) args[0];
    ...
    private int compareTo(final iih.ci.mr.easyrules.api.Rule otherRule) throws Exception {
