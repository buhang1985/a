...
/**
 * 住院 签署 备血 sql查询 BS008
 * @author F
 *
 * @date 2019年8月28日上午10:17:31
 *
 * @classpath iih.ci.event.ord.bps.sign.ip.sql.IpBtSignSql
 */
public class IpBtSignSql {

	/**
	 * BS008
	 * 住院签署 备血 信息 【IEOpBtOrEnDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getIpBtSignInfoSql(String id_or4sql){
	    ...
	    stringBuilder.append(" A.Dt_Chk as confirm_date, ");//审核时间/确认时间
	    ...
	    stringBuilder.append(" b.code_amr_ip as pbarcode, ");//就诊号
	    ...
	    stringBuilder.append(" c.dt_acpt as visit_date, ");//就诊/住院时间
	    ...
	    stringBuilder.append(" W.code as respdoctor, ");//审核（主治）医师编码
	    stringBuilder.append(" W.Name as respdoctorname, ");//审核（主治）医师姓名
		...
		stringBuilder.append("                  z0.id_pat, ");
		stringBuilder.append("                  d0.code, "); 
		stringBuilder.append("                  z0.sv ");
		...
		stringBuilder.append(" where A1.Sd_Srvtp like '14%' ");
		stringBuilder.append(" and A1.id_or ");
		stringBuilder.append(id_or4sql);
		return stringBuilder.toString();
	}
	/**
	 * 联系人 现在不改是不确定联系人那能不能循环
	 * @param id_or4sql
	 * @return
	 */
	public String getIpBtSignContacterInfoSql(String id_or4sql){
		return null;
	}
}
