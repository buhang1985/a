...
public class getCiOrderAggDOBP {
	...
	private CiOrderDO CreateCiOrderDO(BlFeeCiOrderSrvDto orderSrvDto){
		...
		order.setId_excep_level_sys(orderSrvDto.getId_ecep_level_sys());
		order.setId_excep_level_pharm(orderSrvDto.getId_ecep_level_pharm());
	...
	private OrdSrvDO createOrdSrvDO(BlFeeCiOrderSrvDto orderSrvDto){
		...
		ordsrv.setDt_last_cg(orderSrvDto.getDt_last_cg());//最后记账日期
