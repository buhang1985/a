...
public class OpTreatRefundSql {
	 ...
	 * @return
	 */
	public String getOpTreatRefundEntInfoSql(String ids,String idorsrvString) {
		...
		stringBuilder.append(" left outer join ci_or_srv srv on a.id_or=srv.id_or ");
		stringBuilder.append(" where A.id_or ");
		stringBuilder.append(ids);
		stringBuilder.append(" and srv.id_orsrv ");
		stringBuilder.append(idorsrvString);
	 ...
	 * @return
	 */
	public String getOpTreatRefundOrdInfoSql(String id_ors,String idorsrvString) {
		StringBuilder stringBuilder=new StringBuilder();
		...
		stringBuilder.append(" and a1.id_orsrv ");
		stringBuilder.append(idorsrvString);
		return stringBuilder.toString();
		}
}
