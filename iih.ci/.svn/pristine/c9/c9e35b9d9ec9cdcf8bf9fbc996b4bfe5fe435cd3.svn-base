...
/**
 * 急诊抢救签署标准版 定义医嘱类型以及根据定义的医嘱类型发送事件
 * @author F
 *
 * @date 2019年11月26日上午11:14:14
 *
 * @classpath iih.ci.event.ord.listeners.sign.op.OpFstAidSignSelfDefineStandardListener
 */
public class OpFstAidSignSelfDefineStandardListener extends OpSignEnterListener{
	...
	protected boolean isOpData(CiOrderDO or){
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版,筛选急诊抢救数据");
	...
	public String defineOrdTypeBySdSrvtp(String sd_srvtp) {
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版,进入定义医嘱类型");
	...
	public void fireMessageByOrdType(Hashtable<String, String> htors8ieevent)throws BizException{
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版根据定义的医嘱类型,调用发送消息逻辑");
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版 htors8ieevent:"+htors8ieevent.toString());
		...
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-草药id_ors:"+herbIdors+",西药id_ors:"+wcIdors+",id_ent:"+id_ent);
		...
		//急诊抢救签署检查BS002
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-检查id_ors:"+htors8ieevent.get(IOrdEventSources.OP_RIS));
		...
		//急诊抢救签署病理BS452
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-病理id_ors:"+htors8ieevent.get(IOrdEventSources.OP_PATH));
		...
		//急诊抢救签署检验BS006
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-检验id_ors:"+htors8ieevent.get(IOrdEventSources.OP_LIS));
		...
		//急诊抢救签署手术BS007
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-手术id_ors:"+htors8ieevent.get(IOrdEventSources.OP_OPERATION));
		...
		//门诊备血BS008
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-备血id_ors:"+htors8ieevent.get(IOrdEventSources.OP_BT));
		...
		//急诊抢救签署用血BS309
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-用血id_ors:"+htors8ieevent.get(IOrdEventSources.OP_BU));
		...
		//急诊抢救签署治疗BS303
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-治疗id_ors:"+htors8ieevent.get(IOrdEventSources.OP_TREAT));
		...
		//急诊抢救签署治疗BS318
		OrdEventLogger.info(this.getClass().getSimpleName(), "急诊抢救签署标准版-会诊id_ors:"+htors8ieevent.get(IOrdEventSources.OP_CON));
