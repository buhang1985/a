...
import iih.ci.event.ord.bps.revert.op.query.OpConRevertDeptInfoQuery;
import iih.ci.event.ord.bps.revert.op.query.OpConRevertEntInfoQuery;
 ...
 * @author F
 *
 * @date 2019年11月19日下午4:38:22
 *
 * @classpath iih.ci.event.ord.bps.revert.op.logicbp.OpConRevertLogicDealWithBP
 */
public class OpConRevertLogicDealWithBP extends CommonParamBP{
	...
	private IEOpOpConsulationDTO[] getConsulationDTOs(String id_ors) throws BizException{
		OpConRevertEntInfoQuery ciConsulationQry = new OpConRevertEntInfoQuery(id_ors);
	...
	private IEOpOpConsultationDeptDTO[] getConsulationDeptDTOs(String id_ors) throws BizException{
		OpConRevertDeptInfoQuery ciConsulationDeptQry = new OpConRevertDeptInfoQuery(id_ors);
