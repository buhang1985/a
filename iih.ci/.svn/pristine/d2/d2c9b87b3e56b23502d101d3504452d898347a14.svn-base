...
public class CiTreatIpOrCItmQry implements ITransQry {

	private String _id_ors;
	
	public CiTreatIpOrCItmQry(String id_ors){
		this._id_ors = id_ors;
	}
	@Override
	 ...
	 */
	 private String getSql(){
		 String formatsql=new CiIEMsgRelSqlConst().CI_IE_ORTREAT_ITM_IP_SQL();
