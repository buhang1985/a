...
import iih.ci.event.ord.bps.sign.ip.query.IpBtSignInfoQuery;
 ...
 * @author F
 *
 * @date 2019年8月28日上午11:38:38
 *
 * @classpath iih.ci.event.ord.bps.sign.ip.logicbp.IpBtSignLogicDealWithBP
 */
public class IpBtSignLogicDealWithBP extends CommonParamBP{
...
//		}
	...
	private IEOpBtOrEnDTO[] getIEOpBtOrEnDTOs(String id_ors) throws BizException{		
		IpBtSignInfoQuery qry=new IpBtSignInfoQuery(id_ors);
