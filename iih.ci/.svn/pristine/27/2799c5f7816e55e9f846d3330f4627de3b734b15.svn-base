...
public class CovertTmplToMoreEmsParamBP {
	...
	public MoreEmsParamDTO exec(CiEnContextDTO envinfo, CiEmsDTO[] ciEmsDTOs, String clinicalzztz) throws BizException {
		...
		apptable.JudgeOrederTemplateAppTabel(ciEmsDTOs, envinfo, clinicalzztz);
...
//			}
	 ...
	 * @throws BizException
	 */
	void validateCiEmsDTO(CiEnContextDTO envinfo, CiEmsDTO[] ciEmsDTOs) throws BizException {
