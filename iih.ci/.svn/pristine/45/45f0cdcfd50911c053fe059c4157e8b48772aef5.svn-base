package iih.ci.ord.s.bp.assi.gj.impl;
...
//		PsnInfo psnInfo = envinfo.getPsnInfo();
		ciEmsDto.setId_emp_phy(envinfo.getId_emp_or());// 开立医生 与 envinfo.getId_emp_or()相同
		ciEmsDto.setName_emp_phy(envinfo.getName_emp_or());// 开立医生名称
