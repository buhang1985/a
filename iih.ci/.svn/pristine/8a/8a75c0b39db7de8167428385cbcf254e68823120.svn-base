 ...
 * @author F
 *
 * @date 2019年9月11日上午11:56:22
 *
 * @classpath iih.ci.event.ord.bps.revert.op.sql.OpTreatRevertSql
 */
public class OpTreatRevertSql {

	/**
	 * BS303
	 * 门诊 治疗 撤回就诊信息【IEOpTreatOrEnDTO】
	 * @return
	 */
	public String getOpTreatWithDrawEntInfoSql(String idors) {
	...
	/**
	 * BS303
	 * 门诊 治疗 撤回 医嘱信息【IEOpTreatOrDTO】
	 * @return
	 */
	public String getOpTreatWithDrawOrdInfoSql(String id_or4sql) {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.id_or as id_or,");//医嘱id
