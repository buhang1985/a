...
public class getCiorderPreviewDTOSBP {
	...
	public static final String SD_PRESSURE_SRVVT = "FJHL.000532";// 血压
	public VitalSignsDto getCiorderPreviewDTOS(String id_ent,String age) throws BizException{
	    ...
	    if(MapCode != null && MapCode.size() >0){
			...
			//血压        IMpDictCodeTypeConst.SD_PRESSURE_SRVVT
			if(MapCode.containsKey(SD_PRESSURE_SRVVT)){
				preview = MapCode.get(SD_PRESSURE_SRVVT);
