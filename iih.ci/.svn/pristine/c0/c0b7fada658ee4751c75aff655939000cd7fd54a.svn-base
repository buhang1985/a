 ...
 * （门诊）
 */
public class GetIEOpCancleMsgInfo4DrugWcBP {
	/**
	 * 生成集成平台西成医嘱服务数据信息
	 * （门诊）
	 ...
	 * @throws BizException
	 */
	public Hashtable<String,FArrayList2> exec(String id_preses,String id_ors) throws BizException{
		//有效性校验
		if(CiOrdUtils.isEmpty(id_preses))return null;
		
		// 获得西成药处方明细信息
		CiPharmOpRefundPresItmQry qry = new CiPharmOpRefundPresItmQry(id_preses,id_ors);
