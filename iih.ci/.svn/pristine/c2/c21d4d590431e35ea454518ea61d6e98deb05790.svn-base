...
/**
 * 住院 签署 治疗 sql查询 BS303
 * @author F
 *
 * @date 2019年8月29日上午11:19:23
 *
 * @classpath iih.ci.event.ord.bps.sign.ip.sql.IpTreatSignSql
 */
public class IpTreatSignSql {

	/**
	 * BS303
	 * 住院签署 治疗 就诊信息 【IEOpTreatOrEnDTO】
	 * @param id_or4sql
	 * @return
	 */
	...
	/**
	 * BS303
	 * 住院签署 治疗 医嘱项目信息 【IEOpTreatOrDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getIpTreatSignOrdInfoSql(String id_or4sql) {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
	    stringBuilder.append(" a.id_or as id_or, ");//医嘱id
	    stringBuilder.append(" '1' as Orderseqnum, ");//医嘱序号
	    stringBuilder.append(" a.code_or as order_no, ");//诊疗处方号
	    ...
	    stringBuilder.append(" A.Quan_Medu as charge_amount, ");//数量
	    ...
	    stringBuilder.append(" H.name as yz_olddept_name, ");//医嘱原科室编码
	    ...
	    stringBuilder.append(" '' as charge_gourp, ");//医保类别编码
	    stringBuilder.append(" '' as charge_group_name_external, ");//医保类别名称
	    stringBuilder.append(" A.des_or as comment1, ");//嘱托
	    stringBuilder.append(" a.sd_su_bl as payflag, ");//收费状态标识
		...
		stringBuilder.append(" left outer join bd_measdoc F ON F.Id_Measdoc = A.id_unit_med ");
		stringBuilder.append(" left outer join bd_freq G ON G.Id_Freq = A.Id_Freq ");
