...
import iih.ci.event.ord.bps.revert.op.query.OpDrugRevertEntInfoQuery;
import iih.ci.event.ord.bps.revert.op.query.OpDrugRevertPressInfoQuery;
 ...
 * @author F
 *
 * @date 2019年9月11日下午1:13:17
 *
 * @classpath iih.ci.event.ord.bps.revert.op.logicbp.OpDrugRevertLogicDealWithBP
 */
public class OpDrugRevertLogicDealWithBP extends CommonParamBP{
	...
	public IEOpPharmOrEnDTO[] exec(OrdEventFireDTO firedto) throws BizException {
		...
		//获得处方信息
		String id_preses = pharmPresInfoHandle(id_wc_ors, id_herb_ors, rtn, id_en);//"1001Z7100000000GWQMU"
		//西成药处方数据信息计算与处理
	 ...
	 * @throws BizException
	 */
	public IEOpPharmOrEnDTO[] execAgain(String id_wc_ors, String id_herb_ors, String iden,String[] idors) throws BizException {
		//有效性校验
		if (OrdEventUtil.isEmpty(id_wc_ors) && OrdEventUtil.isEmpty(id_herb_ors))
			return null;
	...
	private void ieOpPresItms4HerbHandle(String id_preses, IEOpPharmOrEnDTO rtn) throws BizException {
		...
		if (id_preses == null)
			return;
		//获得草药处方明细信息
		OpDrugRevertHerbLogicDealWithBP bp = new OpDrugRevertHerbLogicDealWithBP();
	...
	private void ieOpPresItms4DrugWcHandle(String id_preses,IEOpPharmOrEnDTO rtn) throws BizException {
		...
		if (id_preses == null)
			return;
		//获得西成药处方明细信息
		OpDrugRevertWcLogicDealWithBP bp = new OpDrugRevertWcLogicDealWithBP();
		Hashtable<String, FArrayList2> list = bp.exec(id_preses);
	...
	private IEOpPharmOrEnDTO getIEMsg4OrSignInfo(String id_wc_ors, String id_herb_ors) throws BizException {
		...
		// 医嘱数据信息查询
		OpDrugRevertEntInfoQuery qry = new OpDrugRevertEntInfoQuery(id_or);
	...
	private String pharmPresInfoHandle(String id_wc_ors, String id_herb_ors, IEOpPharmOrEnDTO rtn, String id_en)
		...
		// 医嘱数据信息查询
		OpDrugRevertPressInfoQuery qry = new OpDrugRevertPressInfoQuery(id_en);
