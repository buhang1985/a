...
public class QcRemindMsgController implements IGenerateRouserMsg {
	...
	public String getContent(Map<String, Object> arg0) throws BizException {
		...
		if (msgdto != null) {
			...
			String msg = "收到" + msgdto.getDep_phy_name() + "患者：" + msgdto.getPat_name() + "  就诊号：" + msgdto.getId_ent()
					+ "的" + "<a funcode='46504005' idrevision='" + idRevision + "'>环节质控缺陷整改通知书</a>" + "，请及时处理！";
			return msg;
		}
		return null;
	}
	...
	public QcRemindMsgDTO getMessageDataInfo(Map<String, Object> arg0) {
		...
		if (arg0 != null && arg0.size() > 0 && arg0.containsKey("CIMRLINKQC")) {
			return (QcRemindMsgDTO) arg0.get("CIMRLINKQC");
		}
		return null;
	}
