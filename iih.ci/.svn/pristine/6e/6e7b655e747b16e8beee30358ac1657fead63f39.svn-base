...
public class getPrescriptionCostDtoBP {
	//LogbackLogger  loginfo = new LogbackLogger(Logger.class);
        ...
        * @throws BizException
        */
	   public  PrescriptionCostDto[] exe(String patid,FDateTime dtSignB,FDateTime dtSignE,String[] code_entps,String Id_org)throws BizException{
		   PrescriptionCostDtoQry qry = new PrescriptionCostDtoQry(patid,dtSignB,dtSignE,code_entps,Id_org);
        ...
        * @throws BizException
        */
	   public  PrescriptionCostDto[] exeObsAndLab(String patid,FDateTime dtSignB,FDateTime dtSignE,String[] code_entps,String Id_org)throws BizException{
		   PrescriptionCostDtoObsAndLabQry qry = new PrescriptionCostDtoObsAndLabQry(patid,dtSignB,dtSignE,code_entps,Id_org);
	  ...
	  /***
		...
		private  FArrayList  getPress(Map<String,String> map)throws BizException{
		 ...
		 /**
	        ...
	        * @throws BizException
	        */
	  public PrescriptionConstBaseDto exe2(String patid,FDateTime dtSignB,FDateTime dtSignE,String[] code_entps,String Id_org) 
			  throws BizException{
		  
		  PrescriptionConstBaseDto baseDto = new PrescriptionConstBaseDto();
		  //药品
		   long StartTime = System.currentTimeMillis();
		  PrescriptionCostDto[] rtn = this.exe(patid, dtSignB, dtSignE, code_entps, Id_org);
		  CiOrdUtils.LogerOutInfo("PrescriptionConstBaseDto exe2  的this.exe  耗时 :"+(System.currentTimeMillis()- StartTime));
		  // 非药品的 
		  long StartTime2 = System.currentTimeMillis();
		  PrescriptionCostDto[] rtnobsAndLab = this.exeObsAndLab(patid, dtSignB, dtSignE, code_entps, Id_org);
