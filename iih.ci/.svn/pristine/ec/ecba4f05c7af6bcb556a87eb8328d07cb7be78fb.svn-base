 ...
 * 2019-12-09T14:31:01.401+08:00
 * Generated source version: 3.1.15
 * 
 */
public final class XmlFbPortType_XmlFbHttpSoap11Endpoint_Client {

    private static final QName SERVICE_NAME = new QName("http://paser.creating.com", "XmlFb");

    private XmlFbPortType_XmlFbHttpSoap11Endpoint_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        XmlFbPortType port = ss.getXmlFbHttpSoap11Endpoint();  
