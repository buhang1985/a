...
public class SaveCirptlabAggDOBp {
	 ...
	 */
	private void addOrgAndGrp(CirptlabAggDO cirptlabAggDOs) {
		Context context = Context.get();
		String groupId = context.getGroupId();
		String orgId = context.getOrgId();
		CiRptLabDO parentDO = cirptlabAggDOs.getParentDO();
		parentDO.setId_org(orgId);
		parentDO.setId_grp(groupId);
	}
