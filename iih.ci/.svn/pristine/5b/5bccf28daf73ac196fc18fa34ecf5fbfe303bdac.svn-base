 ...
 * @author F
 *
 * @date 2019年11月19日下午3:47:47
 *
 * @classpath iih.ci.event.ord.bps.sign.op.sql.OpConSignSql
 */
public class OpConSignSql {

	/**
	 * BS318
	 * 门诊签署 会诊 就诊信息【IEOpOpConsulationDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getOpConSignEntInfoSql(String id_or4sql){
	...
	/**
	 * BS318
	 * 门诊签署 会诊 部门信息【IEOpOpConsultationDeptDTO】
	 * @param id_or4sql
	 * @return
	 */
