...
public class CiOrdAppUtils {
	 ...
	 * @return
	 */
	public static IMedSrvExtRService getIMedSrvExtRService(){
		return (IMedSrvExtRService)ServiceFinder.find(IMedSrvExtRService.class);
	}
	/**
	 * 获得转科申请查询服务
	 * @return
	 ...
	 * @return
	 */
	public static IUsageWithBillService getUsageWithBillService(){
		return  ServiceFinder.find(IUsageWithBillService .class);
	}
	/**
	 * 病历查询主诉现病史诊断等
	 * @return
	 ...
	 * @return
	 */
	public static ICiorderreactCudService getCiorderreactCudService(){
		return ServiceFinder.find(ICiorderreactCudService.class);
	}
	/**
	 * 互斥服务查询表
	 * @return
	 */
	public static ICiorderreactRService getCiorderreactRService(){
		return ServiceFinder.find(ICiorderreactRService.class);
	}
	/**
	 * 二次手术查询服务
	 * @return
	 */
	public static IOrdApOpAgainDORService getOrdApOpAgainDORService(){
		return ServiceFinder.find(IOrdApOpAgainDORService.class);
	}
	/**
	 * 二次手术维护服务
	 * @return
	 */
	public static IOrdApOpAgainDOCudService getOrdApOpAgainDOCudService(){
		return ServiceFinder.find(IOrdApOpAgainDOCudService.class);
	}
}
