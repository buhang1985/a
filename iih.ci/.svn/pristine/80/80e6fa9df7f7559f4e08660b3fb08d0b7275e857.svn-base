...
public class RisOrContentParam extends BaseOrContentParam {
	...
	public RisOrContentParam(CiOrderDO ciOrderDO,OrdApObsDO ordApObsDO,String id_or_old) {
		this.ciOrderDO = ciOrderDO;
		this.ordApObsDO = ordApObsDO;
		this.setId_or_old(id_or_old);
		this.ordSrvDO = null;
	}
	public RisOrContentParam(CiOrderDO ciOrderDO,OrdApObsDO ordApObsDO,String id_or_old,OrdSrvDO[] dos) {
		this.ciOrderDO = ciOrderDO;
		this.ordApObsDO = ordApObsDO;
		this.setId_or_old(id_or_old);
		this.ordSrvDO = dos;
