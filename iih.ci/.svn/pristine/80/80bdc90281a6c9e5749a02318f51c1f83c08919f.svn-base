...
import iih.ci.event.ord.bps.revert.op.query.OpLisRevertAllInfoQuery;
 ...
 * @author F
 *
 * @date 2019年9月11日下午1:12:49
 *
 * @classpath iih.ci.event.ord.bps.revert.op.logicbp.OpLisRevertLogicDealWithBP
 */
public class OpLisRevertLogicDealWithBP extends CommonParamBP{
	...
	public IEOpLisOrEnDTO[] exec(OrdEventFireDTO firedto) throws BizException{
		...
		OpLisRevertAllInfoQuery qry = new OpLisRevertAllInfoQuery(firedto.getIdors());
		//获得sql串及其对应的结果集map
	...
	private void setLisOrItemDto8Map(IEOpLisOrItmDTO ielisitemdto, Map<String, Object> map) throws BizException {
		...
		ielisitemdto.setJy_applyserial(OrdEventUtil.nullHandle( map.get("jy_applyserial")));//jy_applySerial   jy_applySerial
