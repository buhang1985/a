...
public class OrderBaseCopyBP {
	 ...
	 * @throws BizException 
	 */
	protected void setCiorderAggDOs(CiorderAggDO[] aggDOs, Map<String, String> mapIdors, Map<String, String> mapIdorsrvs, FDateTime dt) throws BizException {
		if (CiOrdUtils.isEmpty(aggDOs))
			return;
		//生成ID
...
//				ordSrvDO.setQuan_total_medu(Quan_total_medu);
	 ...
	 * @param ciOrderDO
	 */
	protected void setApplyNo(CiOrderDO ciOrderDO) throws BizException{};
}
