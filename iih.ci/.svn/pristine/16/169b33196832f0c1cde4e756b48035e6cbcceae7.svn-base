...
public class GetCiOderBlSrvBP {
	...
	private OrdSrvDO[] getCiorderBlSrvId(String id_ors)throws BizException{
		ICiorderSrvDORService ciorsrvServiec=ServiceFinder.find(ICiorderSrvDORService.class);
		return ciorsrvServiec.find(" a1.id_or in ("+id_ors+") " , "a1.id_or", FBoolean.FALSE);
	}
}
