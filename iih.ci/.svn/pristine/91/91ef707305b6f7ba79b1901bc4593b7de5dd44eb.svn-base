package iih.ci.event.ord.bps.repres.op.sql;
 ...
 * @author F
 *
 * @date 2019年9月11日上午11:08:53
 *
 * @classpath iih.ci.event.ord.bps.repres.op.sql.OpDrugRePresSql
 */
public class OpDrugRePresSql {

	/**
	 * BS302
	 * 门诊 处方重新分方 【IEOpPharmOrEnDTO】
	 * @return
	 */
	public String getOpDrugReDivisionEntInfoSql() {
	...
	/**
	 * BS302
	 * 门诊处方撤回 处方信息(收费/未收费)【IEOpPharmPresDTO】
	 * @return
	 */
	public String getOpDrugReDivisonPressInfoSql() {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
		...
		stringBuilder.append("      (select distinct p.id_pres ");
		stringBuilder.append("       from ci_or_srv p ");
		stringBuilder.append("       where p.id_or in (select id_or ");
		stringBuilder.append("                         from ci_order ");
		stringBuilder.append("                         where id_en = ? ");
		stringBuilder.append("                         and fg_sign = 'Y' ");
		stringBuilder.append("                         and fg_canc = 'N' ");
		stringBuilder.append("                         and sd_srvtp like '01%' ");
	...
	/**
	 * BS302
	 * 门诊 重新分方 处方/药品金额 【IEOpPharmPresDTO】->【IEOpPharmOrFeeDTO】
	 * @return
	 */
	public String getOpDrugReDivisionPressPriceInfoSql() {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
	...
	/**
	 * BS302
	 * 门诊 处方/药品重新分方 西药信息【IEOpPharmWcOrDTO】
	 * @return
	 */
	public String getOpDrugReDivisionWcInfoSql() {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
	...
	/**
	 * BS302
	 * 门诊 重新分方 西药refund信息【IEOpPharmWcOrDTO】作用暂不清楚
	 * @return
	 */
	public String getOpDrugReDivisionWcRefundInfoSql() {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.code_or as durggid, ");//药品组号
	    stringBuilder.append(" drug.sd_dosage as drugformcode, ");//药物剂型编码
	...
	/**
	 * BS302
	 * 门诊 重新分方 草药信息【IEOpPharmHerbOrDTO】
	 * @return
	 */
	public String getOpDrugReDivisionHerbInfoSql() {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
	...
	/**
	 * BS302
	 * 门诊 处方撤回 草药refund信息【IEOpPharmHerbOrDTO】暂不清楚作用
	 * @return
	 */
	public String getOpDrugReDivisionHerbRefundInfoSql() {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" route.code as medicationmethodcode, ");//用药方法编码
	    stringBuilder.append(" route.name as medicationmethod, ");//用药方法名称
	 ...
	 * @return
	 */
	public String getOpDrugReDivisionHerbElementsInfoSql() {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
