package iih.ci.mrm.s.mrmstorage.qry;

import iih.bd.bc.udi.pub.IBdFcDictCodeConst;
import iih.ci.mrm.dto.cimrmqrylist.d.CiMrmQryListDTO;
import iih.ci.mrm.i.mrmstorage.qry.IMrmStorageQryService;
...
@Service(serviceInterfaces={IMrmStorageQryService.class}, binding=Binding.JSONRPC)
public class IMrmStorageQryServiceImpl extends PagingServiceImpl<CiMrmQryListDTO> implements IMrmStorageQryService{

	@Override
	public PagingRtnData<CiMrmQryListDTO> getMrmStorageDTOList(
