 ...
 * @author F
 *
 * @date 2020年1月20日上午9:37:30
 *
 * @classpath iih.ci.event.ord.bps.charge.op.sql.OpPathChargeSql
 */
public class OpPathChargeSql {

	/**
	 * BS452
	 * 门诊 收费 病理【IEOpPathEntDTO】
	 * @param id_pathors
	 * @return
	 */
	public String getOpPathChargeEntInfoSql(String id_pathors) {
		...
		stringBuilder.append(" b.barcode_chis as visitNo, ");//就诊号
	...
	/**
	 * BS452
	 * 门诊病理收费 获取联系人集合【IEOpPathContactDTO】
	 * @param idOrs
	 * @return
	 */
	public String getOpPathChargeContacterInfoSql(String idOrs) {
		StringBuilder stringBuilder = new StringBuilder();
	...
	/**
	 * BS452
	 *  门诊病理收费 获取申请单集合【IEOpPathApplyDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathChargeApplyInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
	...
	/**
	 * BS452
	 * 门诊病理收费 获取诊断集合【IEOpPathDiagDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathChargeDiagInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	...
	/**
	 * BS452
	 * 门诊病理收费 获取费用项目明细集合【IEOpPathSrvDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathChargeSrvInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select "); 
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	...
	/**
	 * BS452
	 * 门诊病理收费 获取医嘱项目集合【IEOpPathOrdDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathChargeOrdInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	...
	/**
	 * BS452
	 * 门诊病理收费 获取标本集合【IEOpPathSampleDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathChargeSampleInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select"); 
		stringBuilder.append(" a.id_or as id_or, ");
