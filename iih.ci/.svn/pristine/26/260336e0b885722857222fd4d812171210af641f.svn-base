package iih.ci.event.ord.bps.stop.ip.sql;
 ...
 * @author F
 *
 * @date 2019年9月3日上午10:51:23
 *
 * @classpath iih.ci.event.ord.bps.stop.ip.sql.IpStopSql
 */
public class IpStopSql {

	/**
	 * BS005 
	 * 住院停止信息1.【IEOrCancStpEnDTO】 2.【IEOrCancStpDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getIpStopSql(String id_or4sql) {
	    ...
	    stringBuilder.append(" a.dt_end as canceltime, ");//2.撤销或停止时间  [停止操作时，BS005里面停止时间应对应ci_order.dt_end]-[0177603]
	    stringBuilder.append(" L.Code  as cancelpersoncode, ");//2.撤销或停止人编码
	    stringBuilder.append(" L.Name as cancelpersonname, ");//2.撤销或停止人姓名
