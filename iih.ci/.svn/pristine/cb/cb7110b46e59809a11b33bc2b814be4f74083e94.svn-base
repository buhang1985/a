...
public interface IOrAndSrvSplitConst {
	...
	public static final String ORSRVSPLIT_OR_BASE_SSQL = "SELECT "
			...
			+ "ci_order.id_org_or as id_org_create,ci_order.id_dep_or as id_dep_create,ci_order.id_dep_chk as id_dep_nur,ci_order.id_emp_or as id_emp_create,ci_order.dt_last_bl as dt_last_bl_or,ci_order.sd_su_mp as or_mp_status,ci_order.fg_pres_outp,ci_order.quan_firday_mp,ci_order.fg_mp_in,"; // 2016-06-08医嘱新增dt_last_bl字段
																																																																										// 2016-07-27执行状态从ci_order中获取
																																																																										// ;
																																																																										// 2017-9-15
																																																																										// 16:41查询添加quan_firday_mp字段，用于计算添补首日计划执行点
																																																																										// ;
																																																																										// 2019年7月4日16:34:46查询增加在院执行fg_mp_in字段
	/***
