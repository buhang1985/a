...
public class OrderSrvMMCopyBP {
	...
	public OrdSrvMmDO[] copy(Map<String, String> mapIdorsrvs, FDateTime dt) throws BizException {
	...
	private void setOrdSrvMmDOs(OrdSrvMmDO[] ordSrvMmDOs, Map<String, String> mapIdorsrvs) {
		...
		for (OrdSrvMmDO ordSrvMmDO : ordSrvMmDOs) {
			...
			ordSrvMmDO.setQuan_bed_medu(null);
			ordSrvMmDO.setQuan_bed_transit(null);
	 ...
	 * @throws BizException
	 */
	public OrdSrvMmDO[] saveOrdSrvMmDOs(OrdSrvMmDO[] ordSrvMmDOs) throws BizException{
		if (CiOrdUtils.isEmpty(ordSrvMmDOs))
			return null;
