package iih.ci.mrm.s.mrmbind.qry;

import iih.bd.bc.udi.pub.IBdFcDictCodeConst;
import iih.ci.mrm.dto.cimrmqrylist.d.CiMrmQryListDTO;
import iih.ci.mrm.i.mrmbind.qry.IMrmBindQryService;
...
@Service(serviceInterfaces={IMrmBindQryService.class}, binding=Binding.JSONRPC)
public class IMrmBindQryServiceImpl extends PagingServiceImpl<CiMrmQryListDTO> implements IMrmBindQryService{

	@Override
	public PagingRtnData<CiMrmQryListDTO> getMrmBindDTOList(
