...
public class CiOrdersUsedHpCidiQry implements ITransQry {
	...
	public String getQrySQLStr() {
		...
		return "select id_or,name_or from ci_order where id_en = ? and des_bhpjudgerst like ? and fg_canc = 'N' and  (eu_feereversetp = null or eu_feereversetp = '"
				+ FeeReverseType.BLSTREVERSE + "' ) ";
	}
}
