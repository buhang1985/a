 ...
 *
 */
public class CiBuIpOrQry implements ITransQry {

	private String _id_ors;
	
	public CiBuIpOrQry(String id_ors){
		this._id_ors = id_ors;
	}
	@Override
	 ...
	 */
	 private String getSql(){
		 String formatsql= new CiIEMsgRelSqlConst().CI_IE_ORBU_IP_SQL();
		 ...
		 OrdBizLogger.info(ctx, "用血住院签署sql:"+formatsql+"A.id_or"+id_or4sql);
