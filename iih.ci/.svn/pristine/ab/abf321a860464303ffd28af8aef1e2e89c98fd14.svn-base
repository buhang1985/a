...
import iih.ci.ord.s.bp.iemsg.qry.CiOpDrugPres8idenPriceQry;
...
public class GetIEOpMsgInfo4Pharm8idenBP {
	...
	private String pharmPresInfoHandle(String id_wc_ors, String id_herb_ors, IEOpPharmOrEnDTO rtn, String id_en)
		...
		//查询处方金额 根据处方id进行拼接
		CiOpDrugPres8idenPriceQry priceQry = new CiOpDrugPres8idenPriceQry(id_en);
		...
		//拼接
		if(!CiOrdUtils.isEmpty(prePricedtos)) {
