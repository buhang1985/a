package iih.ci.mrm.s.mrmstatistics.qry;

import iih.bd.bc.udi.pub.IBdFcDictCodeConst;
import iih.ci.mrm.dto.cimrmqrylist.d.CiMrmQryListDTO;
import iih.ci.mrm.i.mrmstatistics.qry.IMrmStatisticsQryService;
...
@Service(serviceInterfaces={IMrmStatisticsQryService.class}, binding=Binding.JSONRPC)
public class IMrmStatisticsQryServiceImpl extends PagingServiceImpl<CiMrmQryListDTO> implements IMrmStatisticsQryService{

	@Override
	public PagingRtnData<CiMrmQryListDTO> getMrmStatisticsDTOList(
