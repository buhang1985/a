...
public class BDFreqInfoCache {
	...
	private FreqDefDO[] gets(String code_entp) throws BizException {
		...
		String sql = String.format(SQL_FREQ + "where FREQ.ds<1 and FREQ.fg_active='Y' and %s %s",
				...
				: (IBdFcDictCodeConst.SD_CODE_ENTP_ET_FLOW.equals(code_entp) ? " and FREQ.fg_use_er='Y' "
				: (IBdFcDictCodeConst.SD_CODE_ENTP_ET_FSTAID.equals(code_entp) ? " and FREQ.fg_use_er1='Y' "
				: (IBdFcDictCodeConst.SD_CODE_ENTP_ET_OBS.equals(code_entp) ? " and FREQ.fg_use_er2='Y' "
				: (IBdFcDictCodeConst.SD_CODE_ENTP_FA.equals(code_entp) ? " and FREQ.fg_use_fm='Y' "
				: (IBdFcDictCodeConst.SD_CODE_ENTP_PE.equals(code_entp) ? " and FREQ.fg_use_pe='Y' "
				: (IBdFcDictCodeConst.SD_CODE_ENTP_ES.equals(code_entp) ? " and FREQ.FG_INTERVAL='Y' " : ""))))))));
	...
	public static String GetFreCodeOfFreqInfo(String id_freq) throws BizException {
		...
		return freqInfo == null ? null : freqInfo.getFre_code();
	}
	...
	public static int GetFreqctOfFreqInfo(String id_freq) throws BizException {
		...
		return freqInfo == null ? null : freqInfo.getFreqct();
	}
