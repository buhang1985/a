package iih.ci.ord.s.bp.assi.gj.ciorcopy;
...
import iih.ci.ord.s.bp.assi.gj.JudgeOrderTemplateApplicationTable;
import iih.ci.ord.s.bp.assi.gj.emscopy.AssiToCiEmsCopy;
...
//		String str = ZKCfgMgrUtil.getCfg(String.class, "ciorderCpopy", cfgPath);
		...
		apptable.JudgeOrederTemplateAppTabel(ciEmsDTOs,ciEnContext, null);
