...
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4ApbtBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4ApbuBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4ConsBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4DrugBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4HerbsBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4LisBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4OpsBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4OtherBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4OutHospBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4PythgyBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4RisBP;
import iih.ci.ord.s.bp.validate.assi.CiEmsValidate4TransBP;
import iih.ci.ord.s.bp.validate.assi.common.IEmsValidate4OtherBP;
import xap.mw.core.data.BizException;
import xap.mw.core.utils.StringUtil;

public class OpCiEmsValidate extends CiEmsValidate {
	...
	public CiTmplValidateRstDTO exec(CiEmsDTO emsDTO,List<String> errorList) throws BizException {
		...
		if (!StringUtil.isEmpty(sd_srvtp)) {
			...
			CiTmplValidateRstDTO rst = new CiTmplValidateRstDTO();
			rst.setLevel(CiTmplValidateRstDTO.ERROR);
	...
	protected IEmsValidate4OtherBP getEmsValidateBP(String sd_srvtp) {
		if (StringUtil.isEmpty(sd_srvtp)) {
			return null;
		}
		...
		case "01": // 药品
			...
			case "01": // 西药
				return new OpCiEmsValidate4DrugBP();
			case "02":
		...
		case "02":// 检查属性
			...
			default:// 检查
				return new OpCiEmsValidate4RisBP();
			}

			// 检验
		case "03":

			return new OpCiEmsValidate4LisBP();
		...
		case "04": // 手术属性
			...
			break;*/
			return new CiEmsValidate4OpsBP();
