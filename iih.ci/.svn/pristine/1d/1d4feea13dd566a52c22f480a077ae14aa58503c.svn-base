 ...
 *
 */
public class CiLisOrNoAcountQry implements ITransQry {

	private String _id_ors;
	
	public CiLisOrNoAcountQry(String id_ors){
		this._id_ors = id_ors;
	}
	@Override
	 ...
	 */
	 private String getSql(){
		 ...
		 String formatsql=new Lis4IESql().getCiIeAppLisAllSql(id_or4sql);
		 CiEnContextDTO ctx = (CiEnContextDTO)Context.get().getAttribute("CiEnContextDTO");
		 OrdBizLogger.info(ctx, "BS006住院签署sql:"+formatsql+"param:"+"@@@@AA10000000026638,@@@@ZZ2000000000005S");
		 return formatsql;
	 }
