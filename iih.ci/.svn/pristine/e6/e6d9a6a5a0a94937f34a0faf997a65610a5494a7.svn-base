package iih.ci.mrm.s.mrmarrange.qry;

import iih.bd.bc.udi.pub.IBdFcDictCodeConst;
import iih.ci.mrm.dto.cimrmqrylist.d.CiMrmQryListDTO;
import iih.ci.mrm.i.mrmarrange.qry.IMrmArrangeQryService;
...
@Service(serviceInterfaces={IMrmArrangeQryService.class}, binding=Binding.JSONRPC)
public class IMrmArrangeQryServiceImpl extends PagingServiceImpl<CiMrmQryListDTO> implements IMrmArrangeQryService{

	@Override
	public PagingRtnData<CiMrmQryListDTO> getMrmArrangeDTOList(
