...
public class getLabItmsQry implements ITransQry{
	...
	public String getQrySQLStr() {
		// TODO Auto-generated method stub
		return "select lab.DT_RPTLAB,"
				+ "lab.ID_RPTLAB,"
				+ "itm.ID_SRV,"
				+ "itm.VAL_RSTRPTLAB,"
				+ "itm.sd_restrptlabtp, "
				+ "itm.lis_code_srv "
				+ "from ci_order cior inner join CI_RPT_LAB lab "
				+ "on lab.ID_OR=cior.ID_OR left join CI_RPT_LAB_ITM itm on itm.ID_RPTLAB=lab.ID_RPTLAB "
				+ "where cior.ID_PAT=? and lab.DT_RPTLAB<=? and lab.DT_RPTLAB>=? and itm.lis_code_srv in("+this.srvs+")"					
