...
import iih.ci.event.ord.bps.sign.op.query.OpBtSignCheckInfoQuery;
import iih.ci.event.ord.bps.sign.op.query.OpBtSignEntInfoQuery;
 ...
 * @author F
 *
 * @date 2019年8月27日下午3:47:57
 *
 * @classpath iih.ci.event.ord.bps.sign.op.logicbp.OpBtSignLogicDealWithBP
 */
public class OpBtSignLogicDealWithBP extends CommonParamBP{
	...
	private String getSQlStr(String id_apbts){
		OpBtSignCheckInfoQuery qry = new OpBtSignCheckInfoQuery(id_apbts);
	...
	private IEOpBtOrEnDTO[] getIEOpBtOrEnDTOs(String id_ors) throws BizException{		
		OpBtSignEntInfoQuery qry=new OpBtSignEntInfoQuery(id_ors);
