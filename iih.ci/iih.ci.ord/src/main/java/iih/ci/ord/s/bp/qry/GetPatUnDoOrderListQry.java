...
public class GetPatUnDoOrderListQry implements ITransQry {
	...
	public String getQrySQLStr() {
	 ...
	 private String GetSql(){
		 ...
		 sb.append(" from (");
		 sb.append("  select  distinct cior.id_or,cior.id_en,cior.id_su_or,cior.sd_su_or,  cior.content_or   as or_name,cior.des_or,cior.dt_effe, cior.dt_end, ");
		 sb.append("  cior.fg_stop,cior.sd_su_bl,cior.sd_su_mp,cior.fg_pres_outp, ");
		 ...
		 sb.append("   where   orsrv.fg_or='Y'   and cior.ds='0' ");
		 sb.append("   and (cior.fg_chk ='N' or (cior.fg_canc ='Y' and cior.fg_chk_canc='N') or (cior.fg_long = 'Y' and cior.fg_canc ='N' and cior.fg_chk_stop='N' ))");
...
//		 sb.append("  left outer join  bd_udidoc bd on  bd.id_udidoc = cior.id_su_or ");
//		 sb.append("   left join bd_measdoc  bdmea  on bdmea.id_measdoc =  orsrv.id_medu ");
//		 sb.append("  where  cior.fg_long = 'Y' and orsrv.fg_or='Y'   and cior.ds='0'");
