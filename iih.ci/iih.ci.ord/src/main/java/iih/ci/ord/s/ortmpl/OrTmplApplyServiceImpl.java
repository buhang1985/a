...
public class OrTmplApplyServiceImpl implements IOrTmplApplyService {
	 ...
	 */
	@Override
	public OrTmplDTO[] getOrTmplDTOs(String code_entp, String id_ortmplca, String sd_ortmpltp) throws BizException{
		// TODO Auto-generated method stub
		getOrTmplDTOsBP bp = new getOrTmplDTOsBP();
		return bp.exec(code_entp, id_ortmplca, sd_ortmpltp);
	}
	/**
	 * 查询医嘱模板明细
	 * @param id_ortmpl
	 ...
	 */
	@Override
	public OrderTemplateRstDTO getOrTemplateCache(String[] id_ortmpls, CiEnContextDTO ctx, FBoolean isReFresh) throws BizException{
		// TODO Auto-generated method stub
		GetOrTplNItmDTOsCacheBP bp = new GetOrTplNItmDTOsCacheBP();
		return bp.exec(id_ortmpls, ctx, isReFresh);
	}
