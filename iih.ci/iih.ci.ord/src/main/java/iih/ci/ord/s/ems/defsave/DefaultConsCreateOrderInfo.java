 ...
 *
 */
public class DefaultConsCreateOrderInfo extends DefaultSingleSrvCreateOrderInfo {
	...
	public OrderPackageInfo[] createOrderPakageInfo(CiEnContextDTO ctx, DefaultCreateParam[] szParam) throws BizException {
		...
		if(CiOrdUtils.isEmpty(srvconsdos) || srvconsdos.length==0) return szOrderPakageInfo;
