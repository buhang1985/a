...
public class CiOrOpenOrSrvReactInfoGetBP {
	...
	private String getSrv4EmsCondStr(CiEmsDTO ems){
		...
		int iN=0;
		//手术医嘱不判断附加手术等
		if(ems.getSd_srvtp() != null && ems.getSd_srvtp().startsWith(iih.bd.bc.udi.pub.IBdSrvDictCodeConst.SD_SRVTP_OP)){
			return " = "+CiOrdUtils.SQUOTE_MARK_STR+ems.getId_srv()+CiOrdUtils.SQUOTE_MARK_STR;
		}else{
