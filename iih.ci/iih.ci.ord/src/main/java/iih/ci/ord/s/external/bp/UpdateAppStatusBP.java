...
public class UpdateAppStatusBP {
	 ...
	 * @throws BizException
	 */
	private String UpdateAppObs(String id_or,Boolean status,FDateTime datetime)throws BizException{
	 ...
	 * @throws BizException
	 */
	private String UpdateAppLab(String id_or,Boolean status,FDateTime datetime)throws BizException{
	 ...
	 * @throws BizException
	 */
	private String UpdateAppOP(String id_or,Boolean status,FDateTime datetime)throws BizException{
		String whereStr =  " ID_OR ='"+id_or+"'";
	 ...
	 * @throws BizException
	 */
	private String UpdateAppTreat(String id_or,Boolean status,FDateTime datetime)throws BizException{
	 ...
	 * @throws BizException
	 */
	private String UpdateAppBingLi(String id_or,Boolean status,FDateTime datetime)throws BizException{
