...
import iih.ci.ord.s.ems.op.base.EmsSingleSaveBP;
...
public class EmsApBuSaveBP extends EmsSingleSaveBP {
	 ...
	 * @throws BizException 
	 */
	protected void mergeOrderInfo(CiEnContextDTO ctx, CiOrderDO ordo, Object uiModel) 
			throws BizException {
		EmsBuItemDO srvInfo = (EmsBuItemDO) uiModel;
		CiOrderDO btord = getApBtSrv(srvInfo.getId_or());
		ordo.setId_srv(srvInfo.getId_srv());
		ordo.setContent_or(CiOrContentUtils.create(srvInfo.getName_srv(),
				srvInfo.getName_route(), srvInfo.getQuan_medu_bu(),
				srvInfo.getName_unit()).toString());
