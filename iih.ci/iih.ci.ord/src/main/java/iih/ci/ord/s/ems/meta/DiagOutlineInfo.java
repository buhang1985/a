...
public class DiagOutlineInfo extends FMap {
	...
	public void setId_didef(String Id_didef){
		put("Id_didef", Id_didef);
	}
	public String getId_didef(){
		return (String)this.get("Id_didef");
	}
	public void setCode_didef(String Code_didef){
		put("Code_didef", Code_didef);
	}
	public String getCode_didef(){
		return (String)this.get("Code_didef");
	}
	public void setName_didef(String Name_didef){
		put("Name_didef", Name_didef);
	}
	public String getName_didef(){
		return (String)this.get("Name_didef");
	}
	public FMap toFMap(){
		FMap fMap = new FMap();
