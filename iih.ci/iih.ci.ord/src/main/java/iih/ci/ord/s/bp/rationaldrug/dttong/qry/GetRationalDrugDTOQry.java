...
public class GetRationalDrugDTOQry implements ITransQry {
	...
	private String getSql() {
		...
		String sql1 = "select "
				...
				+ "	where ord.code_entp = ? and ord.id_pat = ? and ord.fg_sign = 'Y' and ord.id_en = ? and ord.dt_effe like ?"
				+ " and "+orgsql;
		...
		String sql2 = " select "
				...
				+ "		left join bd_freq freq on srv.id_freq = freq.id_freq"
				+ "		left join bd_measdoc medu on srv.id_medu = medu.id_measdoc"
				+ "	where ord.code_entp = ? and ord.id_pat = ? and ord.id_en = ? and ord.fg_sign = 'N' "
				+ " and "+orgsql
				+ "		and ord.id_or in (";
