...
public class CiOrderStopChkBP {
	 ...
	 * @throws BizException
	 */
	public CiOrderDO[] exec(String[] id_ors,FDateTime dt_chk_stop) throws BizException{
		//有效性校验
		...
		if(!validate.exec(aggors, MethodConstants.STOP_VALIDATE)){
...
//		bp.exec(id_ors, ciors[0].getDt_end());
		...
		bp.execStop( getStopMap(ciors));
		//医嘱状态调整为停止核对
		UpdateOrdStatusInfo1BP bp1=new UpdateOrdStatusInfo1BP();
		bp1.exec(ciors, null,dt_chk_stop, ICiDictCodeConst.SD_SU_CHECKSTOP);
