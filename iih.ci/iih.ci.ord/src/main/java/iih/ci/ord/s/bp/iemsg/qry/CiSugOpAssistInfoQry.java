...
public class CiSugOpAssistInfoQry implements ITransQry {

	private String _id_or;
	
	public CiSugOpAssistInfoQry(String id_or){
		this._id_or = id_or;
	}
	@Override
	 ...
	 */
	 private String getSql(){
		 ...
		 String formatsql=new Sur4IESql().OpSugAssistInfoSql(id_or4sql);
		 CiEnContextDTO ctx = (CiEnContextDTO)Context.get().getAttribute("CiEnContextDTO");
		 OrdBizLogger.info(ctx, "BS007 门诊手术 助手护士信息 IESugAssistDTO sql:"+formatsql);
		 return formatsql;
	 }
