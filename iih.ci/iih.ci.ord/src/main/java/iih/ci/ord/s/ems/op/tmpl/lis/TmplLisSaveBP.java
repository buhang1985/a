...
import iih.ci.ord.s.ems.op.ems.lis.EmsLisSaveBP;
...
public class TmplLisSaveBP extends EmsLisSaveBP {
	...
	protected void mergeOrderInfo(CiEnContextDTO ctx, CiOrderDO orderInfo, Object uiModel) throws BizException {
		...
		// 计算总次数
				...
				Integer totalTimes = totalTimesBP.getTotalTimes(orderInfo.getDt_effe(),orderInfo.getId_freq(), drugItem.getDays_or());
