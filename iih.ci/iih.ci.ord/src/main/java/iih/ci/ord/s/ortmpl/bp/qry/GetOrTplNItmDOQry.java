...
public class GetOrTplNItmDOQry implements ITransQry {
	...
	public String getQrySQLStr() {
		...
		sb.append(
				"select ITEM.Id_ortmplitm,ITEM.Id_ortmpl,ITEM.Id_srv,ITEM.Sd_srvtp,ITEM.Id_srvtp,SRV.Name Ortplnitm_srv_name,SRV.Ismulexec,SRV.Ismuldose,");
		sb.append("ITEM.Id_mm,MM.Name Ortplnitm_mm_name,MM.spec Ortplnitm_mm_spec,");
		sb.append("ITEM.Id_boildes,ITEM.Quan_med,MEAS.Name Ortplnitm_unit_name,ITEM.Days_or,ITEM.Eu_ortplitmtp,");
		sb.append("FREQ.Name Ortplnitm_freq_name,");
		sb.append(
				"DEP.Name Ortplnitm_mp_name ,ITEM.Quan_medu_cur,ITEM.id_medu_cur,ITEM.factor_cur,ITEM.sd_excessive_reason,ITEM.id_excessive_reason,ITEM.id_route,ITEM.id_routedes,SRV.sd_totalopenmode,ITEM.TIMES,ITEM.Id_freq,ITEM.quan_total_medu,ITEM.id_total_medu ");
