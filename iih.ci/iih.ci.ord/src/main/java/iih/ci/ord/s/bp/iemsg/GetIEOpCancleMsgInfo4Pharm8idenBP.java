...
import iih.ci.ord.s.bp.iemsg.qry.CiOpCancleDrugPres8idenQry;
 ...
 */
public class GetIEOpCancleMsgInfo4Pharm8idenBP {
	 ...
	 * @throws BizException
	 */
	public IEOpPharmOrEnDTO[] exec(String id_wc_ors, String id_herb_ors, String id_en) throws BizException {
		//有效性校验
	...
	private String pharmPresInfoHandle(String id_wc_ors, String id_herb_ors, IEOpPharmOrEnDTO rtn, String id_en)
		...
		// 医嘱数据信息查询
		CiOpCancleDrugPres8idenQry qry = new CiOpCancleDrugPres8idenQry(id_en);
