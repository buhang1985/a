...
import iih.ci.ord.s.bp.exception.StrRoundmdNullException;
...
public class GetCiRelSrvInfo8RelSrvTacticBP {
	 ...
	 * @throws StrRoundmdNullException 取整模式为空
	 */
	private UsageRelFeeSrvDO getRatioRelFeeSrvDO(RelSrvTacticDO relsrvdo,BdRelSrvParamDTO param,String appScene) throws StrFactorNullException, StrFactorDefException, StrFactorDenoNullException, StrRoundmdNullException{
		UsageRelFeeSrvDO rtn=new UsageRelFeeSrvDO();
		rtn.setId_srv(relsrvdo.getId_srv());
		rtn.setId_unit(relsrvdo.getId_unit());
	 ...
	 * @throws StrRoundmdNullException 取整模式为空
	 */
	private FDouble getQuan8Factor(RelSrvTacticDO relsrvdo,BdRelSrvParamDTO param,String appScene) throws StrFactorNullException, StrFactorDefException, StrFactorDenoNullException, StrRoundmdNullException{
		if(CiOrdUtils.isEmpty(relsrvdo.getSd_roundmd()))
			throw new StrRoundmdNullException("");
