...
//		sb.append(" and not ("+tblaliasname+".fg_stop='Y' and "+tblaliasname+".fg_chk_stop='Y'))");  //2016-08-08 增加该逻辑：已经停止且核对过的长期医嘱不在医生临床阶段停嘱而是执行层面做执行取消相关操作
		...
		//2018-11-27不包含护嘱
		sb.append(" and ( "+tblaliasname+".sd_orsrcfun is null or "+tblaliasname+".sd_orsrcfun <> '2')");
		//2019-09-25不包含草药
		sb.append(" and "+tblaliasname+".sd_srvtp not like '"+IBdSrvDictCodeConst.SD_SRVTP_HERBDRUG+"%'");
		if(dt_cur != null){
