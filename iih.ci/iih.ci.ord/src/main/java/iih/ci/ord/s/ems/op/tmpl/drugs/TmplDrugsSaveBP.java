package iih.ci.ord.s.ems.op.tmpl.drugs;
...
import iih.ci.ord.s.ems.op.ems.drugs.EmsDrugsSaveBP;
...
public class TmplDrugsSaveBP extends EmsDrugsSaveBP {
	...
	protected void mergeOrderInfo(CiEnContextDTO ctx, CiOrderDO orderInfo, Object uiModel) throws BizException {
		...
		orderInfo.setFg_long(BDFreqInfoCache.GetFgLongOfFreqInfo(drugItem.getId_freq()));
...
//				srvInfo.setQuan_total_medu(drugItem.getQuan_cur());
				...
				srvInfo.setSd_frequnitct(BDFreqInfoCache.GetSDFrequnitctOfFreqInfo(drugItem.getId_freq()));
				srvInfo.setFreqct(BDFreqInfoCache.GetFreqctOfFreqInfo(drugItem.getId_freq()));
