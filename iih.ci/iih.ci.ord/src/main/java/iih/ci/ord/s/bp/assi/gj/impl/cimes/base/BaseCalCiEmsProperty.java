package iih.ci.ord.s.bp.assi.gj.impl.cimes.base;
...
import iih.ci.ord.s.bp.assi.gj.service.ciems.CalcuateCiEmsProperty;
...
public class BaseCalCiEmsProperty extends CalcuateCiEmsProperty {
	...
	protected void setTimesMpIn(CiEmsDTO ciEms) throws BizException {
		...
		if (FBoolean.TRUE.equals(ciEms.getFg_mp_in())) {
