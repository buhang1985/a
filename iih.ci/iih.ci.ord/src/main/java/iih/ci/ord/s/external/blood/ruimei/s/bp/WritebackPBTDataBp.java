...
public class WritebackPBTDataBp {
	
	public String exec(IEOpBtOrEnParamDTO param) throws BizException {
		validation(param);

 		writebackPBTData(param);

		return RstMsgBP.getRstMsgCodeMsg("0", "备血医嘱回写成功");
	}
	 ...
	 * @param param
	 */
	private void writebackPBTData(IEOpBtOrEnParamDTO param) throws BizException{
		SavewritebackPBTDataBp bp = new SavewritebackPBTDataBp();
		bp.exec(param);
	}
	 ...
	 * @throws BizException
	 */
	private List<String> validation(IEOpBtOrEnParamDTO param) throws BizException {
