 ...
 *
 */
public class GetUnchargeSrvOrdQry implements ITransQry {
	...
	public GetUnchargeSrvOrdQry(String patId, FDateTime dtSignB,
	...
	public String getQrySQLStr() {
		...
		sqlSb.append("ci_order.id_or id_pres, ");
		...
		sqlSb.append("ci_or_srv.quan_total_medu quan_med, ");
		...
		sqlSb.append("ci_order.fg_orhp fg_self, ");
		...
		sqlSb.append("ci_order.code_or, ");
		sqlSb.append("ci_order.sd_srvtp ordsd_srvtp, ");
		sqlSb.append("ci_order.name_or des, ");
		sqlSb.append("ci_order.fg_bb, ");
		sqlSb.append("ci_order.no_bb, ");
		sqlSb.append("ci_order.dt_sign, ");
		sqlSb.append("ci_or_srv.name presrption_name, ");
		sqlSb.append("ci_or_srv.fg_bl, ");
		sqlSb.append("bdudidoc.name prestp_name, ");
		...
		sqlSb.append("ci_order.applyno code, ");
		...
		sqlSb.append("inner join bd_srv bd_srv ");
		...
		sqlSb.append("left outer join bd_udidoc bdudidoc ");
		sqlSb.append("on bdudidoc.id_udidoc = ci_or_srv.id_srvtp ");
		...
		sqlSb.append("and ci_or_srv.sd_srvtp not like '01%' ");
