...
import iih.ci.ord.cons.i.ICiorappconsultMDOCudService;
import iih.ci.ord.cons.i.ICiorappconsultMDORService;
...
public class CiorappconsultMDOCrudServiceImpl extends BaseDOService<OrdApConsDO> implements ICiorappconsultMDOCudService,ICiorappconsultMDORService {
    ...
    public CiorappconsultMDOCrudServiceImpl() {
        super(DescManager.getInstance().getDODesc(OrdApConsDODesc.class),IAppFwTempTbl.tmp_iaw_16.name()); 
    }
