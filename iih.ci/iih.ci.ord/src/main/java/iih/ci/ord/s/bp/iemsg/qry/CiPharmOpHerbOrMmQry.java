...
public class CiPharmOpHerbOrMmQry implements ITransQry {
	 ...
	 */
	 private String getSql(){
		 String formatsql=new CiIEMsgRelSqlConst().CI_IE_ORDRUGHERB_MM_OP_SQL();
		 String id_or4sql=CiOrdUtils.getSqlInOrEqualStrs(_id_preses)+getFilterSql();
		 System.out.println("BS302 IEOpPharmOrMmDTO sql:"+String.format(formatsql, "A1.Id_Pres"+id_or4sql));
