...
public class CiPharmOpRefundPresItmQry implements ITransQry {
	 ...
	 */
	 private String getSql(){//IEOpPharmWcOrDTO
		 String formatsql=new CiIEMsgRelSqlConst().CI_IE_ORDRUGWC_OP_SQL();
		 ...
		 OrdBizLogger.info(null, "西药Refund信息sql："+String.format(formatsql, "A1.Id_Pres"+id_pres4sql+" and A1.id_orsrv" + id_orsrvs4sql));
