...
import iih.bd.srv.freqdef.refs.freqdefModel;
...
public class CiSugOpOrQry implements ITransQry {
	 ...
	 */
	 private String getSql(){
		 ...
		 String formatsql=new Sur4IESql().CiIeOropOpSql(id_or4sql);
		 CiEnContextDTO ctx = (CiEnContextDTO)Context.get().getAttribute("CiEnContextDTO");
		 OrdBizLogger.info(ctx, "BS007 手术 门诊签署 和收费IEOpOpOrEnDTO sql:"+formatsql+"param:"+"@@@@AA10000000026638,@@@@ZZ2000000000005S");
		 return formatsql;
	 }
