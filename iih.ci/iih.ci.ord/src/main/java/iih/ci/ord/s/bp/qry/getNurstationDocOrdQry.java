...
public class getNurstationDocOrdQry implements ITransQry{
	
	private String id_dep_nur;
	private String id_dep_phy;
	private String id_bed;
	
	public getNurstationDocOrdQry(NursOrderQueryDTO confirm){
	...
	public String getQrySQLStr() {
		...
		//String b="And CI_OR .fg_sign = 'Y' And CI_OR.fg_canc='N' AND CI_OR.fg_stop='N' AND CI_OR.dt_end >='" + begin_datatime + "'";
		String b="And CI_OR .fg_sign = 'Y' AND CI_OR.dt_end >='" + begin_datatime + "'";
