...
public class GetIpInfoByDepBp {
	


	public String exec(DepCondition param) throws BizException {
...
//		String rtn = getXmlStr(document);
	 ...
	 * @throws BizException
	 */
	private String validation(DepCondition param, List<String> listMsg) {

		HashMap<String, String> mapCond = new HashMap<String, String>();
		String code = "";
		...
		if (StringUtil.isEmptyWithTrim(param.getIpstatus())) {
			listMsg.add("“在院状态”没被赋值");
			return code;
		}
	 ...
	 * @throws BizException
	 */
	private Patientinfo[] getIpInfo(DepCondition param) throws BizException {
		QueryPatientInfoBp bp = new QueryPatientInfoBp();
		return bp.exec(param,null,null);
	}
