...
public class AgainSaveOrderBP {
	...
	public  CiorderAggDO exec()throws BizException{
		...
		if( context != null && (context.getCode_entp().equals(IBdFcDictCodeConst.SD_CODE_ENTP_OP)
				|| context.getCode_entp().equals(IBdFcDictCodeConst.SD_CODE_ENTP_ET)
			...
			//高端商保标志·
			 ...
			 String id_hp = "id_hp ='"+context.getId_hp()+"'";
		...
		}else if( context != null && context.getSd_hptp() != null && context.getSd_hptp().startsWith("1")){
