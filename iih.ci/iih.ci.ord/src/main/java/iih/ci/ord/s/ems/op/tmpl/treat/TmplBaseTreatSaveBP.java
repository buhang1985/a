...
import iih.ci.ord.s.bp.ems.save.op.CiOrDtLastBlCal4OpenBP;
...
import iih.ci.ord.s.ems.op.ems.treat.EmsTreatValidate;
...
public class TmplBaseTreatSaveBP extends EmsSetSaveBP {
	...
	protected void mergeOrderInfo(CiEnContextDTO ctx,CiOrderDO orderInfo, Object uiModel) throws BizException{
		...
		Integer totalTimes = totalTimesBP.getTotalTimes(orderInfo.getDt_effe(),orderInfo.getId_freq(), drugItemDO.getUse_days());
	...
	protected void afterMergeOrderSrvInfo(CiEnContextDTO ctx, final CiOrderDO orderInfo, OrdSrvDO srvInfo, Object uiModel)
		...
		srvInfo.setDt_last_bl(drugItemDO.getDt_begin_ui());
	}
