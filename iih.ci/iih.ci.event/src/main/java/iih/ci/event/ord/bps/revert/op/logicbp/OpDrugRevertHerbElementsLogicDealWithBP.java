...
import iih.ci.event.ord.bps.revert.op.query.OpDrugRevertHerbElementsInfoQuery;
...
/**
 * 门诊撤回处方 草药明细处理逻辑BS302
 * @author F
 *
 * @date 2019年9月11日下午1:13:45
 *
 * @classpath iih.ci.event.ord.bps.revert.op.logicbp.OpDrugRevertHerbElementsLogicDealWithBP
 */
public class OpDrugRevertHerbElementsLogicDealWithBP {
	...
	public Hashtable<String,FArrayList2> exec(String id_preses) throws BizException{
		...
		// 获得草药处方明细信息
		OpDrugRevertHerbElementsInfoQuery qry = new OpDrugRevertHerbElementsInfoQuery(id_preses);
