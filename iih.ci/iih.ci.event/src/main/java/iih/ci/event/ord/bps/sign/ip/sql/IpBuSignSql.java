 ...
 * @author F
 *
 * @date 2019年8月28日下午1:15:07
 *
 * @classpath iih.ci.event.ord.bps.sign.ip.sql.IpBuSignSql
 */
public class IpBuSignSql {

	/**
	 * BS309
	 * 住院 签署 用血sql查询【IEOpBtUseOrDTO】(该dto包含了就诊和医嘱信息)
	 * @param id_or4sql
	 * @return
	 */
	public String getIpBuSignEntAndOrdInfoSql(String id_or4sql){
	    ...
	    stringBuilder.append(" B.DT_BIRTH_HMS as brithday, ");//出生日期
