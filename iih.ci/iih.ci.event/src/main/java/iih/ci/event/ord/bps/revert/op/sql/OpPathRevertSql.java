 ...
 * @author F
 *
 * @date 2020年1月19日下午4:12:13
 *
 * @classpath iih.ci.event.ord.bps.revert.op.sql.OpPathRevertSql
 */
public class OpPathRevertSql {

	/**
	 * BS452
	 * 门诊 签署 病理【IEOpPathEntDTO】
	 * @param id_pathors
	 * @return
	 */
	public String getOpPathRevertEntInfoSql(String id_pathors) {
	...
	/**
	 * BS452
	 * 门诊病理签署 获取联系人集合【IEOpPathContactDTO】
	 * @param idOrs
	 * @return
	 */
	public String getOpPathRevertContacterInfoSql(String idOrs) {
		StringBuilder stringBuilder = new StringBuilder();
	...
	/**
	 * BS452
	 *  门诊病理签署 获取申请单集合【IEOpPathApplyDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathRevertApplyInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
	...
	/**
	 * BS452
	 * 门诊病理签署 获取诊断集合【IEOpPathDiagDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathRevertDiagInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	...
	/**
	 * BS452
	 * 门诊病理签署 获取费用项目明细集合【IEOpPathSrvDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathRevertSrvInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select "); 
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	...
	/**
	 * BS452
	 * 门诊病理签署 获取医嘱项目集合【IEOpPathOrdDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathRevertOrdInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	...
	/**
	 * BS452
	 * 门诊病理签署 获取标本集合【IEOpPathSampleDTO】
	 * @param id_ors
	 * @return
	 */
	public String getOpPathRevertSampleInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select"); 
		stringBuilder.append(" a.id_or as id_or, ");
