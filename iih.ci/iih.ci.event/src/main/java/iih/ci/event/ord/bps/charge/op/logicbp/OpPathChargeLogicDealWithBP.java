...
import iih.ci.event.ord.bps.charge.op.query.OpPathChargeApplyInfoQuery;
import iih.ci.event.ord.bps.charge.op.query.OpPathChargeContacterInfoQuery;
import iih.ci.event.ord.bps.charge.op.query.OpPathChargeDiagInfoQuery;
import iih.ci.event.ord.bps.charge.op.query.OpPathChargeEntInfoQuery;
import iih.ci.event.ord.bps.charge.op.query.OpPathChargeOrdInfoQuery;
import iih.ci.event.ord.bps.charge.op.query.OpPathChargeSampleInfoQuery;
import iih.ci.event.ord.bps.charge.op.query.OpPathChargeSrvInfoQuery;
 ...
 * @author F
 *
 * @date 2020年1月20日上午10:43:20
 *
 * @classpath iih.ci.event.ord.bps.charge.op.logicbp.OpPathChargeLogicDealWithBP
 */
public class OpPathChargeLogicDealWithBP extends CommonParamBP{
	...
	private IEOpPathEntDTO[] getIEOpPathEntDTOs(String id_ors)throws BizException{
		...
		OpPathChargeEntInfoQuery query = new OpPathChargeEntInfoQuery(id_ors);
	...
	private IEOpPathContactDTO[] getIEOpPathContactDTOs(String id_ors)throws BizException{
		...
		OpPathChargeContacterInfoQuery query = new OpPathChargeContacterInfoQuery(id_ors);
	...
	private IEOpPathApplyDTO[] getIEOpPathApplyDTOs(String id_ors)throws BizException{
		...
		OpPathChargeApplyInfoQuery query = new OpPathChargeApplyInfoQuery(id_ors);
	...
	private IEOpPathSrvDTO[] getIEOpPathSrvDTOs(String id_ors)throws BizException{
		...
		OpPathChargeSrvInfoQuery query = new OpPathChargeSrvInfoQuery(id_ors);
	...
	private IEOpPathOrdDTO[] getIEOpPathOrdDTOs(String id_ors)throws BizException{
		...
		OpPathChargeOrdInfoQuery query = new OpPathChargeOrdInfoQuery(id_ors);
	...
	private IEOpPathSampleDTO[] getIEOpPathSampleDTOs(String id_ors)throws BizException{
		...
		OpPathChargeSampleInfoQuery query = new OpPathChargeSampleInfoQuery(id_ors);
	...
	private IEOpPathDiagDTO[] getIEOpPathDiagDTOs(String id_ors)throws BizException{
		...
		OpPathChargeDiagInfoQuery query = new OpPathChargeDiagInfoQuery(id_ors);
