 ...
 * @author F
 *
 * @date 2019年8月27日下午2:09:51
 *
 * @classpath iih.ci.event.ord.bps.sign.ip.sql.IpOpSignSql
 */
public class IpOpSignSql {

	/**
	 * BS007
	 * 住院签署 手术 就诊信息 【EOpOpOrEnDTO】(该查询有一些莫名其妙的字段 不属于本层)
	 * @param id_or4sql
	 * @return
	 */
	public String getIpOpSignEntInfoSql(String id_or4sql){
		...
		stringBuilder.append(" (case ");
		stringBuilder.append("   when q.fg_er_sug = 'Y' then '急诊' ");
		...
		stringBuilder.append(" B.dt_birth as birthday, ");//
		...
		stringBuilder.append(" D.Code as op_code, ");//
		stringBuilder.append(" D.Name as op_code_name, ");//
		stringBuilder.append(" Q.name_des as op_describe, ");//--说明
		stringBuilder.append(" A.Dt_Entry as apply_date, ");//--申请日期
		stringBuilder.append(" E.code_ie as op_scale, ");//
		stringBuilder.append(" E.name as op_scale_name, ");//
		...
		stringBuilder.append(" q.sugplantime as usetime,");//预计手术用时
		stringBuilder.append(" ");//手术用时单位
		stringBuilder.append(" ");//指导者编码
		stringBuilder.append(" ");//指导者名称
		stringBuilder.append(" L.Code as op_doctor, ");//
		stringBuilder.append(" L.name as op_doctor_name, ");//
		...
		stringBuilder.append(" A.fg_skintest as isstest, ");//
		stringBuilder.append(" A.fg_skintest as stest, ");//
		stringBuilder.append(" '03' as is_em, ");//
		stringBuilder.append(" (case when A.Fg_Urgent = 'Y' then 'true' else 'false' end) as is_em_r, ");//
		stringBuilder.append(" '' as is_frozen_flag, ");//
		stringBuilder.append(" '' as frozen_flag, ");//
		stringBuilder.append(" '' as is_urgent_select_flag, ");//
		stringBuilder.append(" '' as urgent_select_flag, ");//
		...
		stringBuilder.append(" '' as response_type_code, ");//
		stringBuilder.append(" '' as response_type_name, ");//
		...
		stringBuilder.append(" '' as isyg, ");//
		stringBuilder.append(" '' as yg, ");//
		...
		stringBuilder.append(" S.name as op_nurse_name, ");//
		stringBuilder.append(" R.id_emp_helper as op_nurse_code, ");//
		stringBuilder.append(" A.Id_or as Idor ");//
		...
		stringBuilder.append(" left outer join pi_pat_card card ON A.Id_Pat = card.Id_Pat ");
	...
	/**
	 * BS007
	 * 住院 签署 手术信息【IEOperationInfoDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getIpOpSignOperationInfoSql(String id_or4sql){
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		...
		stringBuilder.append(" left outer join bd_udidoc E ON E.Id_Udidoc = Q.Id_Lvlsug ");
		stringBuilder.append(" left outer join en_ent C ON A.Id_En = C.Id_Ent ");
		stringBuilder.append(" where d.fg_or = 'Y' and A.Id_Or ");
		stringBuilder.append(id_or4sql);
		return stringBuilder.toString();
	}
	/**
	 * BS007
	 * 住院 签署 手术 助手信息 【IESugAssistDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getIpOpSignAssistInfoSql(String id_or4sql){
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		...
		stringBuilder.append(" from bd_psndoc a,ci_ap_sug_emp b,bd_udidoc c,ci_ap_sug d,ci_order e ");  
		stringBuilder.append(" where b.id_emp = Id_Psndoc ");  
		stringBuilder.append(" and b.id_role = c.id_udidoc ");  
		stringBuilder.append(" and d.id_apop= b.id_apop "); 
		stringBuilder.append(" and d.id_or = e.id_or ");  
		stringBuilder.append(" and c.code <> '00' ");   
