 ...
 * @author F
 *
 * @date 2019年9月11日上午11:57:30
 *
 * @classpath iih.ci.event.ord.bps.revert.op.sql.OpDrugRevertSql
 */
public class OpDrugRevertSql {

	/**
	 * BS302
	 * 门诊 处方/药品撤回就诊信息【IEOpPharmOrEnDTO】
	 * @return
	 */
	public String getOpDrugWithDrawEntInfoSql() {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" l.code as applydeptcode, ");//申请科室编码
	    stringBuilder.append(" A.id_en as id_iepharmoren, ");//就诊id 主键
	    ...
	    stringBuilder.append(" left outer join (select * from bd_udidoc where id_udidoclist='@@@@ZZ200000000000A2' ) H ON H.Code=G.Sd_Hptp ");  
	...
	/**
	 * BS302
	 * 门诊 处方/药品撤回 处方信息(收费/未收费)【IEOpPharmPresDTO】
	 * @return
	 */
	public String getOpDrugWithDrawPressInfoSql() {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" A.ID_PRES as id_iepharmpres, ");//处方id 主键
	    stringBuilder.append(" A.Id_En as id_iepharmoren, ");//就诊id
	    stringBuilder.append(" null as id_iepharmwcors, ");//西药ids
	...
	/**
	 * BS302
	 * 门诊 处方/药品撤回 西药信息【IEOpPharmWcOrDTO】
	 * @return
	 */
	public String getOpDrugWithDrawWcInfoSql() {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
	    ...
	    stringBuilder.append(" A1.Id_Orsrv as id_iepharmwcor, ");//主键 服务id
	    stringBuilder.append(" A1.Id_Pres as id_iepharmpres, ");//IE药品处方
	...
	/**
	 * 暂不清楚作用【IEOpPharmWcOrDTO】
	 * @return
	 */
	public String getOpDrugWithDrawWcRefundInfoSql() {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.code_or as durggid, ");//药品组号
	    stringBuilder.append(" drug.sd_dosage as drugformcode, ");//药物剂型编码
	...
	/**
	 * BS302
	 * 门诊 处方/药品撤回 草药信息【IEOpPharmHerbOrDTO】
	 * @return
	 */
	public String getOpDrugWithDrawHerbInfoSql() {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
	    ...
	    stringBuilder.append(" A1.Id_Or as id_iepharmor, ");//医嘱id 主键
	    stringBuilder.append(" A1.Id_Pres as id_iepharmpres, ");//IE药品处方
	    ...
	    stringBuilder.append(" (case when A1.FG_SKINTEST_RST = 'Y' then ");
	    stringBuilder.append("    (select ");
	    stringBuilder.append("     t1.name ");
	    stringBuilder.append("     from ci_skin_test t ");
	    stringBuilder.append("     left outer join bd_udidoc t1 on t.id_rst_skintest = t1.id_udidoc ");
	...
	/**
	 * 草药信息 暂不清楚作用【IEOpPharmHerbOrDTO】
	 * @return
	 */
	public String getOpDrawWithHerbRefundInfoSql() {
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" route.code as medicationmethodcode, ");//用药方法编码
	    stringBuilder.append(" route.name as medicationmethod, ");//用药方法名称
	...
	/**
	 * BS302
	 * 门诊 处方/药品撤回 草药明细信息【IEOpPharmOrMmDTO】
	 * @return
	 */
	public String getOpDrugWithDrawHerbElementsInfoSql() {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" A2.Id_Orsrvmm as id_iepharmormm, ");//明细主键
