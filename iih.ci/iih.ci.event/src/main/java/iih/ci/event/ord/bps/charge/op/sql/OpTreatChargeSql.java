 ...
 * @author F
 *
 * @date 2019年9月12日下午6:06:23
 *
 * @classpath iih.ci.event.ord.bps.charge.op.sql.OpTreatChargeSql
 */
public class OpTreatChargeSql {

	/**
	 * BS303
	 * 门诊 收费 治疗就诊信息【IEOpTreatOrEnDTO】
	 * @return
	 */
	public String getOpTreatChargeEntInfoSql(){
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" A.Id_En as id_ietreatoren, ");//就诊id
	    stringBuilder.append(" '' as ietreatfees, ");
	...
	/**
	 * BS303
	 * 门诊 收费 治疗医嘱项目信息【IEOpTreatOrDTO】
	 * @return
	 */
	public String getOpTreatChargeOrdItemInfoSql(){
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
