 ...
 * @author F
 *
 * @date 2019年8月22日上午10:50:54
 *
 * @classpath iih.ci.event.ord.bps.sign.op.sql.OpBtSignSql
 */
public class OpBtSignSql {

	/**
	 * BS008
	 * 门诊 签署 备血就诊/申请信息【IEOpBtOrEnDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getOpBtSignEntInfoSql(String id_or4sql){
	...
	/**
	 * BS008
	 * 门诊 签署 备血检验项目【IEOpBtCdLisItmDTO】
	 */
	public String getOpBtSignCheckInfoSql(String id_apbt){
		StringBuilder stringBuilder=new StringBuilder();
		stringBuilder.append(" select ");
