...
import iih.ci.event.ord.bps.sign.op.query.OpDrugSignHerbInfoQuery;
import iih.ci.event.ord.bps.sign.op.query.OpDrugSignHerbRefundInfoQuery;
 ...
 * @author F
 *
 * @date 2019年8月27日下午3:51:02
 *
 * @classpath iih.ci.event.ord.bps.sign.op.logicbp.OpDrugSignHerbLogicDealWithBP
 */
public class OpDrugSignHerbLogicDealWithBP {
	...
	public Hashtable<String,FArrayList2> exec(String id_preses) throws BizException{
		...
		// 获得草药信息
		OpDrugSignHerbInfoQuery qry = new OpDrugSignHerbInfoQuery(id_preses);
	...
	public Hashtable<String,FArrayList2> exec(String id_preses,String id_orsrvs) throws BizException{
		...
		// 获得草药处方明细信息
		OpDrugSignHerbRefundInfoQuery qry = new OpDrugSignHerbRefundInfoQuery(id_preses,id_orsrvs);
		IEOpPharmHerbOrDTO[] predtos=(IEOpPharmHerbOrDTO[]) AppFwUtil.getDORstWithDao(qry, IEOpPharmHerbOrDTO.class);
		if(OrdEventUtil.isEmpty(predtos))return null;
	...
	private Hashtable<String,FArrayList2> getHerbComposition(String id_preses) throws BizException{
		OpDrugSignHerbElementsLogicDealWithBP bp=new OpDrugSignHerbElementsLogicDealWithBP();
