...
import iih.ci.event.ord.bps.sign.op.query.OpDrugSignHerbElementsInfoQuery;
...
/**
 * 门诊签署 处方草药明细成分 处理逻辑 BS302
 * @author F
 *
 * @date 2019年8月27日下午3:51:25
 *
 * @classpath iih.ci.event.ord.bps.sign.op.logicbp.OpDrugSignHerbElementsLogicDealWithBP
 */
public class OpDrugSignHerbElementsLogicDealWithBP {
	...
	public Hashtable<String,FArrayList2> exec(String id_preses) throws BizException{
		...
		// 获得草药处方明细信息
		OpDrugSignHerbElementsInfoQuery qry = new OpDrugSignHerbElementsInfoQuery(id_preses);
