 ...
 * @author F
 *
 * @date 2020年1月15日下午2:55:59
 *
 * @classpath iih.ci.event.ord.bps.sign.op.sql.OpPathSignSql
 */
public class OpPathSignSql {
	 ...
	 * @return
	 */
	public String getOpPathSignEntInfoSql(String id_pathors) {
	 ...
	 * @return
	 */
	public String getOpPathSignContacterInfoSql(String idOrs) {
		StringBuilder stringBuilder = new StringBuilder();
	 ...
	 * @return
	 */
	public String getOpPathSignApplyInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
	 ...
	 * @return
	 */
	public String getOpPathSignDiagInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	 ...
	 * @return
	 */
	public String getOpPathSignSrvInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select "); 
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	 ...
	 * @return
	 */
	public String getOpPathSignOrdInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select ");
		stringBuilder.append(" a.id_or as id_or, ");
		stringBuilder.append(" a.id_en as id_en, ");
	 ...
	 * @return
	 */
	public String getOpPathSignSampleInfoSql(String id_ors) {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(" select"); 
		stringBuilder.append(" a.id_or as id_or, ");
