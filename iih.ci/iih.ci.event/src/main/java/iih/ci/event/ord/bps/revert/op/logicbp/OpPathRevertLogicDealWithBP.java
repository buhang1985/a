...
import iih.ci.event.ord.bps.revert.op.query.OpPathRevertApplyInfoQuery;
import iih.ci.event.ord.bps.revert.op.query.OpPathRevertContacterInfoQuery;
import iih.ci.event.ord.bps.revert.op.query.OpPathRevertDiagInfoQuery;
import iih.ci.event.ord.bps.revert.op.query.OpPathRevertEntInfoQuery;
import iih.ci.event.ord.bps.revert.op.query.OpPathRevertOrdInfoQuery;
import iih.ci.event.ord.bps.revert.op.query.OpPathRevertSampleInfoQuery;
import iih.ci.event.ord.bps.revert.op.query.OpPathRevertSrvInfoQuery;
 ...
 * @author F
 *
 * @date 2020年1月19日下午6:34:10
 *
 * @classpath iih.ci.event.ord.bps.revert.op.logicbp.OpPathRevertLogicDealWithBP
 */
public class OpPathRevertLogicDealWithBP extends CommonParamBP{
	...
	private IEOpPathEntDTO[] getIEOpPathEntDTOs(String id_ors)throws BizException{
		...
		OpPathRevertEntInfoQuery query = new OpPathRevertEntInfoQuery(id_ors);
	...
	private IEOpPathContactDTO[] getIEOpPathContactDTOs(String id_ors)throws BizException{
		...
		OpPathRevertContacterInfoQuery query = new OpPathRevertContacterInfoQuery(id_ors);
	...
	private IEOpPathApplyDTO[] getIEOpPathApplyDTOs(String id_ors)throws BizException{
		...
		OpPathRevertApplyInfoQuery query = new OpPathRevertApplyInfoQuery(id_ors);
	...
	private IEOpPathSrvDTO[] getIEOpPathSrvDTOs(String id_ors)throws BizException{
		...
		OpPathRevertSrvInfoQuery query = new OpPathRevertSrvInfoQuery(id_ors);
	...
	private IEOpPathOrdDTO[] getIEOpPathOrdDTOs(String id_ors)throws BizException{
		...
		OpPathRevertOrdInfoQuery query = new OpPathRevertOrdInfoQuery(id_ors);
	...
	private IEOpPathSampleDTO[] getIEOpPathSampleDTOs(String id_ors)throws BizException{
		...
		OpPathRevertSampleInfoQuery query = new OpPathRevertSampleInfoQuery(id_ors);
	...
	private IEOpPathDiagDTO[] getIEOpPathDiagDTOs(String id_ors)throws BizException{
		...
		OpPathRevertDiagInfoQuery query = new OpPathRevertDiagInfoQuery(id_ors);
