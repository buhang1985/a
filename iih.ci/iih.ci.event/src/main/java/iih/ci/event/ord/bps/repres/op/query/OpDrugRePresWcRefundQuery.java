 ...
 * @author F
 *
 * @date 2019年9月11日上午11:09:07
 *
 * @classpath iih.ci.event.ord.bps.repres.op.query.OpDrugRePresWcRefundQuery
 */
public class OpDrugRePresWcRefundQuery implements ITransQry{

	private String _id_preses;
	private String _id_orsrvs;
	
	public OpDrugRePresWcRefundQuery(String id_preses,String id_orsrvs){
	 ...
	 */
	 private String getSql(){//【IEOpPharmWcOrDTO】
		 String formatsql=new OpDrugRePresSql().getOpDrugReDivisionWcRefundInfoSql();
		 ...
		 OrdEventLogger.info(null, "门诊 重新分方 西药Refund信息sql："+String.format(formatsql, " A1.Id_Pres"+id_pres4sql+" and A1.id_orsrv " + id_orsrvs4sql));
