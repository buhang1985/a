 ...
 * @author F
 *
 * @date 2019年11月19日下午4:32:03
 *
 * @classpath iih.ci.event.ord.bps.revert.op.sql.OpConRevertSql
 */
public class OpConRevertSql {

	/**
	 * BS318
	 * 门诊撤回 会诊 就诊信息【IEOpOpConsulationDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getOpConRevertEntInfoSql(String id_or4sql){
	...
	/**
	 * BS318
	 * 门诊撤回会诊 部门信息【IEOpOpConsultationDeptDTO】
	 * @param id_or4sql
	 * @return
	 */
	public String getOpConDeptInfoSql(String id_or4sql){
		StringBuilder stringBuilder = new StringBuilder();
