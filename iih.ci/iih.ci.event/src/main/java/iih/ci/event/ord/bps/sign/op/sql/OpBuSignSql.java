 ...
 * @author F
 *
 * @date 2019年8月23日上午11:55:34
 *
 * @classpath iih.ci.event.ord.bps.sign.op.sql.OpBuSignSql
 */
public class OpBuSignSql {

	/**
	 * BS309
	 * 门诊 签署 用血sql查询【IEOpBtUseOrDTO】(该dto包含了就诊和医嘱信息)
	 * @param id_or4sql
	 * @return
	 */
	public String getOpBuSignEntAndOrdInfoSql(String id_or4sql){
