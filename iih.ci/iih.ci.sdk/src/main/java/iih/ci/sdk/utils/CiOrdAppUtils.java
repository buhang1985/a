...
public class CiOrdAppUtils {
	...
	public static ICidiagQryService  getICidiagQryService(){
	  ...
	  * @return
	  */
	public static IDeptbRService GetIDeptbRService(){
		return ServiceFinder.find(IDeptbRService.class);
	}
	/**
	 * 医保对外查询服务
	 * @return
	 */
	public static IBlHpOutQryService GetIBlHpOutQryService(){
		return ServiceFinder.find(IBlHpOutQryService.class);
	}
	/**
	 * 就诊域对外接口
	 * @return
	 */
	public static IEn4CiCmdService GetEn4CiCmdService(){
		return ServiceFinder.find(IEn4CiCmdService.class);
	}
}
