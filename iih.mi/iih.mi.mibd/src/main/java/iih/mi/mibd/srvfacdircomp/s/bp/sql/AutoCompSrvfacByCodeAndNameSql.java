 ...
 *@author hexx
 */
public class AutoCompSrvfacByCodeAndNameSql implements ITransQry {

	private String _misId;

	public AutoCompSrvfacByCodeAndNameSql(String misId) {
		this._misId = misId;
	}
	...
	public String getQrySQLStr() {
		...
		baseSQL.append(" AND MISRVFAC.NAME = BDSRV.NAME 	       		     ");
