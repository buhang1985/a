 ...
 *@author hexx
 */
public class AutoCompSrvfacByNameSql implements ITransQry {

	private String _misId;

	public AutoCompSrvfacByNameSql(String misId) {
		this._misId = misId;
	}
	...
	public String getQrySQLStr() {
		...
		baseSQL.append("   (SELECT MIN(MI_BD_SRVFAC.CODE) AS CODE,	       ");
		baseSQL.append("     MI_BD_SRVFAC.NAME		       ");
		...
		baseSQL.append("   GROUP BY MI_BD_SRVFAC.NAME	       ");
		baseSQL.append("   ) MISRVFAC			       ");
		baseSQL.append(" ON MISRVFAC.NAME = BDSRV.NAME 	       ");
