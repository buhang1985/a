 ...
 *
 */
public class FindSrvDirCompByHisSevIdsSql implements ITransQry {

	private String _hpId;
	private String _srvWherePart;

	public FindSrvDirCompByHisSevIdsSql(String hpId, String srvWherePart) {
		this._hpId = hpId;
	...
	private String getBaseSql() {
		...
		sqlBuilder.append(" BD_SRV.NAME AS HISNAME,				      ");
		sqlBuilder.append(" BD_SRV.CODE AS HISCODE			      ");
		sqlBuilder.append(" FROM BD_HP_SRVORCA				      ");
		sqlBuilder.append(" INNER JOIN BD_SRV				      ");
		sqlBuilder.append(" ON BD_HP_SRVORCA.ID_SRV = BD_SRV.ID_SRV  ;	      ");
