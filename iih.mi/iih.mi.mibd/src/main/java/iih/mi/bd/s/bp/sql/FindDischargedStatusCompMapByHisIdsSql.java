...
/**
 * @author dj.zhang
 * @data 2018年6月21日下午9:23:26
 * 
 */
public class FindDischargedStatusCompMapByHisIdsSql implements ITransQry {

	private String _hpId;
	private String[] _dischargedStatusIds;

	public FindDischargedStatusCompMapByHisIdsSql(String hpId, String[] dischargedStatusIds) {
		this._hpId = hpId;
		this._dischargedStatusIds = dischargedStatusIds;
	}
	...
	private String getWherePart() {
		...
		if (this._dischargedStatusIds != null && this._dischargedStatusIds.length > 0) {
			wherePart = SqlUtils.getInSqlByIds("COMP.ID_LEVELDISE", this._dischargedStatusIds);
			wherePartBuilder.append(" and ");
			wherePartBuilder.append(wherePart);
		}
