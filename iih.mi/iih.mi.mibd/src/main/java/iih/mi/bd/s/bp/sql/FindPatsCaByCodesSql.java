 ...
 *
 */
public class FindPatsCaByCodesSql implements ITransQry {

	private String _misId;
	private String _wheredPart;

	public FindPatsCaByCodesSql(String misId, String wherePart) {
		this._misId = misId;
	...
	private String getWherePart() {
		...
		String wherePart = BdEnvContextUtil.processEnvContext(new PatcaDo(), "MI_BD_PATCA");
	...
	private String getBaseSql() {
		...
		sqlBuilder.append("SELECT id_patca,  ");
		sqlBuilder.append("  ID_GRP,	   ");
		sqlBuilder.append("  ID_ORG,	   ");
		sqlBuilder.append("  CODE,	   ");
		sqlBuilder.append("  NAME,	   ");
		sqlBuilder.append("  ID_MIS,	   ");
		sqlBuilder.append("  FG_ALLINHP	AS FG_ALLININSUR  ");
		sqlBuilder.append(" FROM MI_BD_PATCA  ");
