...
/**
 * 根据医疗付款方式编码集合查询医疗付款方式基础信息集合sql语句
 * 
 * @author hexx
 *
 */
public class FindMedPayTpsByCodesSql implements ITransQry {
	
	private String _wherePart;
	
	public FindMedPayTpsByCodesSql(String misId,String wherePart){
