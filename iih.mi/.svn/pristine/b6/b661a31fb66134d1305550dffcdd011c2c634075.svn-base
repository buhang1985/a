...
/**
 * @author dj.zhang
 * @data 2018年6月21日下午7:05:02
 * 
 */
public class FindDischargedStatusCompByHisCodesSql implements ITransQry {

	private String _hpId;
	private String _wherePart;

	public FindDischargedStatusCompByHisCodesSql(String hpId, String wherePart) {
		this._hpId = hpId;
