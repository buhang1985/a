...
public class CheckIsPatDiBP {
	...
	public FMap exec(String hpId,String patId,String[] diDefIds) throws BizException{
		...
		sql2.append("from mi_mc_pat_spec pat                     ");
		sql2.append("inner join mi_mc_pat_spec_di specdi         ");
		sql2.append("on pat.id_mimcpatspec = specdi.id_mimcpatspec   ");
		sql2.append("inner join pi_pat_hp pihp                   ");
		sql2.append(" on (substr(pat.no_hp,1,9)=substr(pihp.no_hp,1,9) and pat.id_hp = pihp.id_hp) ");
