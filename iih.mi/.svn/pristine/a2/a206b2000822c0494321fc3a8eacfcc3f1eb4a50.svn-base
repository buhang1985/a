 ...
 *
 */
public class AutoCompTreatSql implements ITransQry {

	private String _hpId;

	public AutoCompTreatSql(String hpId) {
		this._hpId = hpId;
	}
	...
	public String getQrySQLStr() {
		...
		sqlBuilder.append("ON (SRV.DEF8 = TREAT_ORGINAL.CODE AND　TREAT_ORGINAL.ID_HP = ? AND TREAT_ORGINAL.ID_GRP = ? AND TREAT_ORGINAL.ID_ORG = ?)	   ");
		sqlBuilder.append(
