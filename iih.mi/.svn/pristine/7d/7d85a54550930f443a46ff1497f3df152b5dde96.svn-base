...
/**
 * @author dj.zhang
 * @data 2018年6月21日下午7:54:41
 * 
 */
public class FindDischargedStatusCompByHisIdsSql implements ITransQry {

	private String _hpId;
	private String _wherePart;

	public FindDischargedStatusCompByHisIdsSql(String hpId, String wherePart) {
		this._hpId = hpId;
