...
/**
 * 根据HIS频次主键集合查询频次基础信息集合sql语句
 * 
 * @author hexx
 *
 */
public class FindFreqsByHisFreqIdsSql implements ITransQry {

	private String _wherePart;

	public FindFreqsByHisFreqIdsSql(String misId, String wherePart) {
