...
public class FindDiCompedDataListSql implements ITransQry {

	private String _idHp;
	private String _idRef;
	private String _wherePart;
	
	public FindDiCompedDataListSql(String wherePart, String idHp, String idRef) {
		this._idHp = idHp;
		this._idRef = idRef;
	...
	private String GetWherePart() {
		...
		if (this._wherePart != null) {
			...
			wherePartBuilder.append(" AND DI_VS_HIS.EU_STATUS=? ");
		}
