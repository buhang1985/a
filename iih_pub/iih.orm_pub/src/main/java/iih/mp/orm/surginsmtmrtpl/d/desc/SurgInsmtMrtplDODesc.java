 ...
 * 手术器械模板 DO 元数据信息
 */
public class SurgInsmtMrtplDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.orm.surginsmtmrtpl.d.SurgInsmtMrtplDO";
	public static final String CLASS_DISPALYNAME = "手术器械模板";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MP_ORM_MM_TMPL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_momt";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_momtADesc(tblDesc));
		...
		this.add(getId_deptsADesc(tblDesc));
		this.add(getId_srvsADesc(tblDesc));
		this.add(getFg_atvADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_momtCDesc(tblDesc));
		...
		tblDesc.add(getId_deptsCDesc(tblDesc));
		tblDesc.add(getId_srvsCDesc(tblDesc));
		tblDesc.add(getFg_atvCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_deptsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_depts",  getId_deptsCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("适用科室列表");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_atvADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_atv",  getFg_atvCDesc(tblDesc), this);
	...
	private IAttrDesc getDep_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b4","id_depts=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDep_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b4","id_depts=id_dep","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSrv_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b5","id_srvs=id_srv","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSrv_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b5","id_srvs=id_srv","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_deptsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_depts");
		column.setLength(1000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("适用科室列表"); 
		return column;
	}
	/**
	 * 获取适用手术表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_atvCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_atv");
		column.setLength(1);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_momt");
