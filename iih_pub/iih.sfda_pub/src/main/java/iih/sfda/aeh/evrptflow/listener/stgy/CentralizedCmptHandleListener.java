...
public class CentralizedCmptHandleListener implements IExecutionListener {
	...
	public void notify(WfEventExecution nodeInstance) throws Exception {
		...
		aerEvDo.setCurr_node(FlowProdefConst.NODEINS_STATUS_END);
		aerEvDo.setEv_status(FlowProdefConst.PROINS_STATUS_END);
