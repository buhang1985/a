 ...
 * 事件处理流程配置 DO 元数据信息
 */
public class AdbdConfigDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.adbd.abdbconfig.d.AdbdConfigDO";
	public static final String CLASS_DISPALYNAME = "事件处理流程配置";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_ADBD_CONFIG";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_adbd_config";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_adbd_configADesc(tblDesc));
		...
		this.add(getFullclassADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_adbd_configCDesc(tblDesc));
		tblDesc.add(getId_adbd_configCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getNameCDesc(tblDesc));
		tblDesc.add(getCodeCDesc(tblDesc));
		tblDesc.add(getFullclassCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFullclassADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fullclass",  getFullclassCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("配置全类名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getFullclassCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fullclass");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("配置全类名"); 
		return column;
	}
	/**
	 * 获取扩展字段1表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_adbd_config");
