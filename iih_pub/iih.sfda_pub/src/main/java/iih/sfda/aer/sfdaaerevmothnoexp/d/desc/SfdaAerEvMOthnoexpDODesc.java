...
package iih.sfda.aer.sfdaaerevmothnoexp.d.desc;
 ...
 * 其他非预期事件 DO 元数据信息
 */
public class SfdaAerEvMOthnoexpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.aer.sfdaaerevmothnoexp.d.SfdaAerEvMOthnoexpDO";
	public static final String CLASS_DISPALYNAME = "其他非预期事件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_AER_EV_MOTHNOEXP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_aer_ev_mothnoexp";
	 ...
	 * 无参构造函数
	 */
	public SfdaAerEvMOthnoexpDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_aer_ev_mothnoexpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_aer_ev_mothnoexpADesc(tblDesc));
		this.add(getId_aer_evADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getNo_exp_nameADesc(tblDesc));
		this.add(getNo_exp_stateADesc(tblDesc));
		this.add(getNo_exp_ocur_reasADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_aer_ev_mothnoexpCDesc(tblDesc));
		tblDesc.add(getId_aer_ev_mothnoexpCDesc(tblDesc));
		tblDesc.add(getId_aer_evCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getNo_exp_nameCDesc(tblDesc));
		tblDesc.add(getNo_exp_stateCDesc(tblDesc));
		tblDesc.add(getNo_exp_ocur_reasCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_aer_ev_mothnoexpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_aer_ev_mothnoexp",  getId_aer_ev_mothnoexpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("其他非预期事件主键");
	 ...
	 * @return
	 */
	private IAttrDesc getNo_exp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("No_exp_name",  getNo_exp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("非预期事件名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getNo_exp_stateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("No_exp_state",  getNo_exp_stateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("非预期事件说明");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getNo_exp_ocur_reasADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("No_exp_ocur_reas",  getNo_exp_ocur_reasCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("非预期事件发生原因分析");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_aer_ev_mothnoexpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_aer_ev_mothnoexp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("其他非预期事件主键"); 
		return column;
	}
	/**
	 * 获取护理安全事件外键表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getNo_exp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"No_exp_name");
		column.setLength(100);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("非预期事件名称"); 
		return column;
	}
	/**
	 * 获取非预期事件说明表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getNo_exp_stateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"No_exp_state");
		column.setLength(2000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("非预期事件说明"); 
		return column;
	}
	/**
	 * 获取非预期事件发生原因分析表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getNo_exp_ocur_reasCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"No_exp_ocur_reas");
		column.setLength(2000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("非预期事件发生原因分析"); 
		return column;
	}
	/**
	 * 获取非预期事件处理措施表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_aer_ev_mothnoexp");
