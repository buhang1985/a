package iih.sfda.aer.aerevwarn.d;
...
import iih.sfda.aer.aerevwarn.d.desc.AerEvWarnDODesc;
 ...
 * 
 */
public class AerEvWarnDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//事件提醒标识
	public static final String ID_AER_EV_WARN= "Id_aer_ev_warn";
	//事件标识
	 ...
	 * @return String
	 */
	public String getId_aer_ev_warn() {
		return ((String) getAttrVal("Id_aer_ev_warn"));
	}	
	/**
	 * 事件提醒标识
	 * @param Id_aer_ev_warn
	 */
	public void setId_aer_ev_warn(String Id_aer_ev_warn) {
		setAttrVal("Id_aer_ev_warn", Id_aer_ev_warn);
	}
	/**
	 * 事件标识
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_aer_ev_warn";
	}
	
	@Override
	public String getTableName() {	  
		return "SFDA_AER_EV_WARN";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(AerEvWarnDODesc.class);
	}
