...
package iih.sfda.aer.sfdaaerevmmedicoth.d.desc;
 ...
 * 医疗其他事件 DO 元数据信息
 */
public class SfdaAerEvMmedicothDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.aer.sfdaaerevmmedicoth.d.SfdaAerEvMmedicothDO";
	public static final String CLASS_DISPALYNAME = "医疗其他事件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_AER_EV_MMEDICOTH";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_aer_ev_medicoth";
	 ...
	 * 无参构造函数
	 */
	public SfdaAerEvMmedicothDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_aer_ev_medicothADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_aer_ev_medicothADesc(tblDesc));
		this.add(getId_aer_evADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getEvent_sum_desADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_aer_ev_medicothCDesc(tblDesc));
		tblDesc.add(getId_aer_ev_medicothCDesc(tblDesc));
		tblDesc.add(getId_aer_evCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getEvent_sum_desCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_aer_ev_medicothADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_aer_ev_medicoth",  getId_aer_ev_medicothCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗其他事件主键");
	 ...
	 * @return
	 */
	private IAttrDesc getEvent_sum_desADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Event_sum_des",  getEvent_sum_desCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getId_aer_ev_medicothCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_aer_ev_medicoth");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医疗其他事件主键"); 
		return column;
	}
	/**
	 * 获取护理安全事件外键表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getEvent_sum_desCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Event_sum_des");
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_aer_ev_medicoth");
