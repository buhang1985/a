...
package iih.sfda.aer.sfdaaerevmdelverr.d.desc;
 ...
 * 医疗信息传递错误事件 DO 元数据信息
 */
public class SfdaAerEvMdelverrDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.aer.sfdaaerevmdelverr.d.SfdaAerEvMdelverrDO";
	public static final String CLASS_DISPALYNAME = "医疗信息传递错误事件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_AER_EV_MDELVERR";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_aer_ev_mdelverr";
	 ...
	 * 无参构造函数
	 */
	public SfdaAerEvMdelverrDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_aer_ev_mdelverrADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_aer_ev_mdelverrADesc(tblDesc));
		this.add(getId_aer_evADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_delverrtpADesc(tblDesc));
		this.add(getSd_delverrtpADesc(tblDesc));
		this.add(getOth_delverrtpADesc(tblDesc));
		...
		this.add(getName_delverrtpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_aer_ev_mdelverrCDesc(tblDesc));
		tblDesc.add(getId_aer_ev_mdelverrCDesc(tblDesc));
		tblDesc.add(getId_aer_evCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_delverrtpCDesc(tblDesc));
		tblDesc.add(getSd_delverrtpCDesc(tblDesc));
		tblDesc.add(getOth_delverrtpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_aer_ev_mdelverrADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_aer_ev_mdelverr",  getId_aer_ev_mdelverrCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗信息传递错误事件主键");
	 ...
	 * @return
	 */
	private IAttrDesc getId_delverrtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_delverrtp",  getId_delverrtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗信息传递错误类型id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_delverrtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_delverrtp",  getSd_delverrtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗信息传递错误类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getOth_delverrtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Oth_delverrtp",  getOth_delverrtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗信息传递错误其他类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_delverrtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_delverrtp",  getName_delverrtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_delverrtp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_pat_rsltADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_pat_rslt=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_aer_ev_mdelverrCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_aer_ev_mdelverr");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医疗信息传递错误事件主键"); 
		return column;
	}
	/**
	 * 获取护理安全事件外键表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_delverrtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_delverrtp");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医疗信息传递错误类型id"); 
		return column;
	}
	/**
	 * 获取医疗信息传递错误类型编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_delverrtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_delverrtp");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医疗信息传递错误类型编码"); 
		return column;
	}
	/**
	 * 获取医疗信息传递错误其他类型表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getOth_delverrtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Oth_delverrtp");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医疗信息传递错误其他类型"); 
		return column;
	}
	/**
	 * 获取给病人带来的后果id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_delverrtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_delverrtp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_aer_ev_mdelverr");
