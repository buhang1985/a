...
package iih.mp.dg.mpdgprttmpl.d.desc;
 ...
 * 药单打印模板管理 DO 元数据信息
 */
public class MpdgPrtTmplDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.dg.mpdgprttmpl.d.MpdgPrtTmplDO";
	public static final String CLASS_DISPALYNAME = "药单打印模板管理";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MP_DG_PRTTMPL_DRUGDOC";
	...
	private void init(){		
		...
		this.add(getRptpathADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getRptpathCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getRptpathADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Rptpath",  getRptpathCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getDrug_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"mp_dg_shetp a0b4","id_drugdocs_apply=id_dgshetp","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDrug_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"mp_dg_shetp a0b4","id_drugdocs_apply=id_dgshetp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getRptpathCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Rptpath");
