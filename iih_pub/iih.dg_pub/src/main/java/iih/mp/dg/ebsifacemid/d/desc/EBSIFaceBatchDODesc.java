 ...
 * 日志表 DO 元数据信息
 */
public class EBSIFaceBatchDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.dg.ebsifacemid1.d.EBSIFaceBatchDO";
	public static final String CLASS_DISPALYNAME = "日志表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CUX_GL_EBS_BATCH_IFACE";
