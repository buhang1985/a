 ...
 * 
 */
public class EntWsDrugsDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getEmsdrugspresdto() {
		return ((FArrayList) getAttrVal("Emsdrugspresdto"));
	}	
	/**
	 * 处方信息
	 * @param Emsdrugspresdto
	 */
	public void setEmsdrugspresdto(FArrayList Emsdrugspresdto) {
		setAttrVal("Emsdrugspresdto", Emsdrugspresdto);
	}
}