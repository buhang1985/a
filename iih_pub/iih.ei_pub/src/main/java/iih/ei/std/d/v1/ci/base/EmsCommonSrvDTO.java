 ...
 * 
 */
public class EmsCommonSrvDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getSortno_srv() {
		return ((String) getAttrVal("Sortno_srv"));
	}
	/**
	 * 序号
	 * @param Sortno_srv
	 */
	public void setSortno_srv(String Sortno_srv) {
	 ...
	 * @return String
	 */
	public String getFg_or() {
		return ((String) getAttrVal("Fg_or"));
	}
	/**
	 * 药品/费用标识
	 * @param Fg_or
	 */
	public void setFg_or(String Fg_or) {
	...
	public String getFg_base() {
		return ((String) getAttrVal("Fg_base"));
	}
	/**
	 * 基数药标识
	 * @param Fg_base
	 ...
	 * @return String
	 */
	public String getSd_propc() {
		return ((String) getAttrVal("Sd_propc"));
	}
	/**
	 * 是否预防用药
	 * @param Sd_propc
	 */
	public void setSd_propc(String Sd_propc) {
		setAttrVal("Sd_propc", Sd_propc);
	}
	/**
	 * 不计费类型
	 * @return String
	 ...
	 * @return String
	 */
	public String getPri_std() {
		return ((String) getAttrVal("Pri_std"));
	}
	/**
	 * 标准价
	 * @param Pri_std
	 */
	public void setPri_std(String Pri_std) {
	 ...
	 * @return String
	 */
	public String getPri_ratio() {
		return ((String) getAttrVal("Pri_ratio"));
	}
	/**
	 * 价格系数
	 * @param Pri_ratio
	 */
	public void setPri_ratio(String Pri_ratio) {
	 ...
	 * @return String
	 */
	public String getCode_org_mp_srv() {
		return ((String) getAttrVal("Code_org_mp_srv"));
	}
	/**
	 * 项目执行机构
	 * @param Code_org_mp_srv
	 */
	public void setCode_org_mp_srv(String Code_org_mp_srv) {
		setAttrVal("Code_org_mp_srv", Code_org_mp_srv);
	}
	/**
	 * 项目执行科室
	 * @return String
	 */
	public String getCode_dep_mp_srv() {
		return ((String) getAttrVal("Code_dep_mp_srv"));
	}
	/**
	 * 项目执行科室
	 * @param Code_dep_mp_srv
	 */
	public void setCode_dep_mp_srv(String Code_dep_mp_srv) {
		setAttrVal("Code_dep_mp_srv", Code_dep_mp_srv);
	}
	/**
	 * 关联的服务项目
	 * @return String
	 */
	public BaseDO getOrdSrvDO() {
		return ((BaseDO) getAttrVal("OrdSrvDO"));
	}
	/**
	 * 关联的服务项目
	 * @param OrdSrvDO
	 */
	public void setOrdSrvDO(BaseDO OrdSrvDO) {
	 ...
	 * @return String
	 */
	public String getQuan_medu_srv() {
		return ((String) getAttrVal("Quan_medu_srv"));
	}
	/**
	 * 费用项目单次数量
	 * @param Code_org_or
	 */
	public void setQuan_medu_srv(String Quan_medu_srv) {
		setAttrVal("Quan_medu_srv", Quan_medu_srv);
	}
}