 ...
 * 
 */
public class EmsApbtEntDTO extends BaseDTO {
	...
	public String getOrdlist() {
		return ((String) getAttrVal("Ordlist"));
	}	
	/**
	 * 医嘱信息list
	 * @param Ordlist
	 ...
	 * @return String
	 */
	public FArrayList getEmslisprintdto() {
		return ((FArrayList) getAttrVal("Emslisprintdto"));
	}	
	/**
	 * 检验打印单信息
	 * @param Emslisprintdto
	 */
	public void setEmslisprintdto(FArrayList Emslisprintdto) {
		setAttrVal("Emslisprintdto", Emslisprintdto);
	}
}