package iih.ei.std.d.v1.ci.diag.d;
 ...
 * 
 */
public class EmsWsDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getEmsdiagdto() {
		return ((FArrayList) getAttrVal("Emsdiagdto"));
	}	
	/**
	 * 诊断信息
	 * @param Emsdiagdto
	 */
	public void setEmsdiagdto(FArrayList Emsdiagdto) {
		setAttrVal("Emsdiagdto", Emsdiagdto);
	}
}