 ...
 * 
 */
public class LabPatinfoDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getApplyform() {
		return ((FArrayList) getAttrVal("Applyform"));
	}	
	/**
	 * 申请单信息集合
	 * @param Applyform
	 */
	public void setApplyform(FArrayList Applyform) {
