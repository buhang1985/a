package iih.ei.std.d.v1.en.opaptlistbyagentpatcode.d;
 ...
 * 
 */
public class OpAptListByAgentPatCodeDTO extends BaseDTO {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getEnt_time() {
		return ((FDateTime) getAttrVal("Ent_time"));
	}	
	/**
	 * 挂号时间
	 * @param Ent_time
	 */
	public void setEnt_time(FDateTime Ent_time) {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getOpr_time() {
		return ((FDateTime) getAttrVal("Opr_time"));
	}	
	/**
	 * 操作时间
	 * @param Opr_time
	 */
	public void setOpr_time(FDateTime Opr_time) {
	 ...
	 * @return String
	 */
	public String getCode_ticke() {
		return ((String) getAttrVal("Code_ticke"));
	}	
	/**
	 * 挂号顺序号
	 * @param Code_ticke
	 */
	public void setCode_ticke(String Code_ticke) {
		setAttrVal("Code_ticke", Code_ticke);
	}
	/**
	 * 支付订单号
	 * @return String
	...
	public String getApt_no() {
		return ((String) getAttrVal("Apt_no"));
	}	
	/**
	 * 预约号
	 * @param Apt_no
	 ...
	 * @return String
	 */
	public String getCode_status_op() {
		return ((String) getAttrVal("Code_status_op"));
	}	
	/**
	 * 号源状态
	 * @param Code_status_op
	 */
	public void setCode_status_op(String Code_status_op) {
		setAttrVal("Code_status_op", Code_status_op);
	}
	/**
	 * 患者支付金额
	 * @return FDouble
