 ...
 * 
 */
public class EmsApbuEntDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getEmsapbuorddto() {
		return ((FArrayList) getAttrVal("Emsapbuorddto"));
	}	
	/**
	 * 用血医嘱信息
	 * @param Emsapbuorddto
	 */
	public void setEmsapbuorddto(FArrayList Emsapbuorddto) {
		setAttrVal("Emsapbuorddto", Emsapbuorddto);
	}
}