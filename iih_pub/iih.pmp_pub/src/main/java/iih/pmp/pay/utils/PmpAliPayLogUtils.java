package iih.pmp.pay.utils;

import iih.pmp.pay.log.IPmpAliPayLogService;
 ...
 *
 */
public class PmpAliPayLogUtils {

	private static IPmpAliPayLogService _logService = ServiceFinder.find(IPmpAliPayLogService.class);
