...
import iih.pmp.pay.log.IPmpPayLogService;
 ...
 *
 */
public class PmpPayLogUtils {

	private static IPmpPayLogService _logService = ServiceFinder.find(IPmpPayLogService.class);
