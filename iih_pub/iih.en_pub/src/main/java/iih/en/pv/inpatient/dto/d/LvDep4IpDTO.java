 ...
 * 
 */
public class LvDep4IpDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getDt_lv() {
		return ((String) getAttrVal("Dt_lv"));
	}
	/**
	 * 出院日期
	 * @param Dt_lv
	 */
	public void setDt_lv(String Dt_lv) {
	 ...
	 * @return String
	 */
	public String getDt_ci_lv() {
		return ((String) getAttrVal("Dt_ci_lv"));
	}
	/**
	 * 医嘱中的出院时间
	 * @param Dt_ci_lv
	 */
	public void setDt_ci_lv(String Dt_ci_lv) {
	 ...
	 * @return String
	 */
	public String getTime_inhos() {
		return ((String) getAttrVal("Time_inhos"));
	}
	/**
	 * 住院时长
	 * @param Time_inhos
	 */
	public void setTime_inhos(String Time_inhos) {
		setAttrVal("Time_inhos", Time_inhos);
	}
	/**
	 * 时长单位
	 * @return String
	...
	public String getCreate_time() {
		return ((String) getAttrVal("Create_time"));
	}
	/**
	 * 消息创建时间
	 * @param Create_time
