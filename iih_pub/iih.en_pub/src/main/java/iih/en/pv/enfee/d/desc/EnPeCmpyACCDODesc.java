 ...
 * 团检账户 DO 元数据信息
 */
public class EnPeCmpyACCDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.en.pv.enfee.d.EnPeCmpyACCDO";
	public static final String CLASS_DISPALYNAME = "团检账户";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "en_pe_cmpy_acc";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pecmpyacc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pecmpyaccADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pecmpyaccADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pecmpyaccCDesc(tblDesc));
		tblDesc.add(getId_pecmpyaccCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pecmpyaccADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pecmpyacc",  getId_pecmpyaccCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("团检账户ID");
	 ...
	 * @return
	 */
	private IColumnDesc getId_pecmpyaccCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pecmpyacc");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("团检账户ID"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
