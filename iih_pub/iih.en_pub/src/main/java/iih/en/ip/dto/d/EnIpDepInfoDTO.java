 ...
 * 
 */
public class EnIpDepInfoDTO extends BaseDTO {
	 ...
	 * @return Integer
	 */
	public Integer getSex_pat() {
		return ((Integer) getAttrVal("Sex_pat"));
	}
	/**
	 * 患者性别
	 * @param Sex_pat
	 */
	public void setSex_pat(Integer Sex_pat) {
	...
	public String getZz_name() {
		return ((String) getAttrVal("Zz_name"));
	}
	/**
	 * 主治医师
	 * @param Zz_name
	...
	public String getZy_name() {
		return ((String) getAttrVal("Zy_name"));
	}
	/**
	 * 住院医师
	 * @param Zy_name
	...
	public String getZr_name() {
		return ((String) getAttrVal("Zr_name"));
	}
	/**
	 * 主任医师
	 * @param Zr_name
	 */
	public void setZr_name(String Zr_name) {
		setAttrVal("Zr_name", Zr_name);
	}
	/**
	 * 医疗组
	 * @return String
	 ...
	 * @return FBoolean
	 */
	public FBoolean getFg_pri() {
		return ((FBoolean) getAttrVal("Fg_pri"));
	}
	/**
	 * 专用医疗组
	 * @param Fg_pri
	 */
	public void setFg_pri(FBoolean Fg_pri) {
		setAttrVal("Fg_pri", Fg_pri);
	}
	/**
	 * 科室sd
	 * @return String
