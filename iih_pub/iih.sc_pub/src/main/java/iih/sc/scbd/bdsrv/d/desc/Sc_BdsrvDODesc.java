 ...
 * 排班计划_医疗服务 DO 元数据信息
 */
public class Sc_BdsrvDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sc.scbd.bdsrv.d.Sc_BdsrvDO";
	public static final String CLASS_DISPALYNAME = "排班计划_医疗服务";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "sc_bd_srv";
