...
package iih.sc.sch.sctickb.d.desc;
 ...
 * 计划排班_号位B DO 元数据信息
 */
public class ScSchTickBDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sc.sch.sctickb.d.ScSchTickBDO";
	public static final String CLASS_DISPALYNAME = "计划排班_号位B";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "sc_tickb";
