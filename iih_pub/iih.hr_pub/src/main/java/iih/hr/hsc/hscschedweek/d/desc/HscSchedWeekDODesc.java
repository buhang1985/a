 ...
 * 排班周信息 DO 元数据信息
 */
public class HscSchedWeekDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hr.hsc.hscschedweek.d.HscSchedWeekDO";
	public static final String CLASS_DISPALYNAME = "排班周信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HR_HSC_SCHED_WEEK";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hsc_sched_week";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hsc_sched_weekADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hsc_sched_weekCDesc(tblDesc));
	...
	private IAttrDesc getName_reg_psnADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b4","id_reg_psn=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
