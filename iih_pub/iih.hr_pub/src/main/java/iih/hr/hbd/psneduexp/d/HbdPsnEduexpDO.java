package iih.hr.hbd.psneduexp.d;
...
import iih.hr.hbd.psneduexp.d.desc.HbdPsnEduexpDODesc;
 ...
 * 
 */
public class HbdPsnEduexpDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_HBD_PSN_EDUEXP= "Id_hbd_psn_eduexp";
	...
	public String getId_hbd_psn_eduexp() {
		return ((String) getAttrVal("Id_hbd_psn_eduexp"));
	}	
	public void setId_hbd_psn_eduexp(String Id_hbd_psn_eduexp) {
		setAttrVal("Id_hbd_psn_eduexp", Id_hbd_psn_eduexp);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_hbd_psn_eduexp";
	}
	
	@Override
	public String getTableName() {	  
		return "HR_HBD_PSN_EDUEXP";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HbdPsnEduexpDODesc.class);
	}
