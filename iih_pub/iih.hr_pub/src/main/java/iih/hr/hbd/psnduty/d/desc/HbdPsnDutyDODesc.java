...
package iih.hr.hbd.psnduty.d.desc;
 ...
 * 人员职务 DO 元数据信息
 */
public class HbdPsnDutyDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hr.hbd.psnduty.d.HbdPsnDutyDO";
	public static final String CLASS_DISPALYNAME = "人员职务";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HR_HBD_PSN_DUTY";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hbd_psn_duty";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hbd_psn_dutyADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_hbd_psn_dutyADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hbd_psn_dutyCDesc(tblDesc));
		tblDesc.add(getId_hbd_psn_dutyCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hbd_psn_dutyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hbd_psn_duty",  getId_hbd_psn_dutyCDesc(tblDesc), this);
	...
	private IAttrDesc getName_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b2","id_psndoc=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_reg_psnADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b8","id_reg_psn=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_hbd_psn_dutyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hbd_psn_duty");
		column.setLength(20);
