...
package iih.hr.hbd.psnwkexp.d.desc;
 ...
 * 人员工作经历 DO 元数据信息
 */
public class HbdPsnWkexpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hr.hbd.psnwkexp.d.HbdPsnWkexpDO";
	public static final String CLASS_DISPALYNAME = "人员工作经历";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HR_HBD_PSN_WKEXP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hbd_psn_wkexp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hbd_psn_wkexpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_hbd_psn_wkexpADesc(tblDesc));
		this.add(getId_psndocADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getDt_beginADesc(tblDesc));
		this.add(getDt_endADesc(tblDesc));
		this.add(getName_work_partADesc(tblDesc));
		...
		this.add(getName_cert_psnADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hbd_psn_wkexpCDesc(tblDesc));
		tblDesc.add(getId_hbd_psn_wkexpCDesc(tblDesc));
		tblDesc.add(getId_psndocCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getDt_beginCDesc(tblDesc));
		tblDesc.add(getDt_endCDesc(tblDesc));
		tblDesc.add(getName_work_partCDesc(tblDesc));
		...
		tblDesc.add(getName_cert_psnCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hbd_psn_wkexpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hbd_psn_wkexp",  getId_hbd_psn_wkexpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("工作经历主键");
	 ...
	 * @return
	 */
	private IAttrDesc getName_work_partADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_work_part",  getName_work_partCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_cert_psnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_cert_psn",  getName_cert_psnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("证明人");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_dutyADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_duty=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_hbd_psn_wkexpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hbd_psn_wkexp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("工作经历主键"); 
		return column;
	}
	/**
	 * 获取人员外键表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_work_partCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_work_part");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_cert_psnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_cert_psn");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("证明人"); 
