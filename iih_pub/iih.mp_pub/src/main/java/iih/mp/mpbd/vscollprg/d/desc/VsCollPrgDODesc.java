...
package iih.mp.mpbd.vscollprg.d.desc;
 ...
 * 体征模板采集方案 DO 元数据信息
 */
public class VsCollPrgDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.mpbd.vscollprg.d.VsCollPrgDO";
	public static final String CLASS_DISPALYNAME = "体征模板采集方案";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_vs_coll_prg";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_vs_coll_prg";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_vs_coll_prgADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_vs_coll_prgADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_vs_coll_prgCDesc(tblDesc));
		tblDesc.add(getId_vs_coll_prgCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_vs_coll_prgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_vs_coll_prg",  getId_vs_coll_prgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("模板采集方案ID");
	 ...
	 * @return
	 */
	private IColumnDesc getId_vs_coll_prgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_vs_coll_prg");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("模板采集方案ID"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
