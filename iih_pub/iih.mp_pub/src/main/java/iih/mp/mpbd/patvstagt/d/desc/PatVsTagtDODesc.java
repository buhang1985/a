 ...
 * 患者体征指标 DO 元数据信息
 */
public class PatVsTagtDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.mpbd.patvstagt.d.PatVsTagtDO";
	public static final String CLASS_DISPALYNAME = "患者体征指标";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_vs_tagt";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_vs_tagt";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_vs_tagtADesc(tblDesc));
		...
		this.add(getId_trgtADesc(tblDesc));
		...
		this.add(getCode_trgtADesc(tblDesc));
		this.add(getName_trgtADesc(tblDesc));
		this.add(getCode_owntpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_vs_tagtCDesc(tblDesc));
		...
		tblDesc.add(getId_trgtCDesc(tblDesc));
		tblDesc.add(getSd_trgtCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_trgtADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_trgt",  getId_trgtCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_trgtADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_trgt",  getCode_trgtCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("指标类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_trgt=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_trgtADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("指标类型名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_trgt=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_owntpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_owntp",  getCode_owntpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_owntp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_trgtCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_trgt");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_trgtCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_trgt");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("指标类型编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_owntpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_owntp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
