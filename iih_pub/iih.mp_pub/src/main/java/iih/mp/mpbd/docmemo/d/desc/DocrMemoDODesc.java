 ...
 * 医生备忘录 DO 元数据信息
 */
public class DocrMemoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.mpbd.docmemo.d.DocrMemoDO";
	public static final String CLASS_DISPALYNAME = "医生备忘录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_mb_dcmo";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_memo";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_memoADesc(tblDesc));
		...
		this.add(getDoctorADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_memoCDesc(tblDesc));
		...
		tblDesc.add(getDoctorCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getDoctorADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Doctor",  getDoctorCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getNameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sys_user a0b5","doctor=id_user","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCodeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sys_user a0b5","doctor=id_user","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getDoctorCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Doctor");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医生"); 
