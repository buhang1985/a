...
package iih.mp.mpbd.syntest.d.desc;
 ...
 * 护理任务执行时刻 DO 元数据信息
 */
public class MpSdkTimesDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.mpbd.syntest.d.MpSdkTimesDO";
	public static final String CLASS_DISPALYNAME = "护理任务执行时刻";
