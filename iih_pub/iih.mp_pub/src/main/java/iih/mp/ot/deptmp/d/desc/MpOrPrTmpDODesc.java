 ...
 * 通用医技科室模板 DO 元数据信息
 */
public class MpOrPrTmpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.ot.deptmp.d.MpOrPrTmpDO";
	public static final String CLASS_DISPALYNAME = "通用医技科室模板";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MP_OR_PR_TMP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_orprtmp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_orprtmpADesc(tblDesc));
		...
		this.add(getEu_scopADesc(tblDesc));
		this.add(getFg_activeADesc(tblDesc));
		this.add(getCreatedbyADesc(tblDesc));
		this.add(getCreatedtimeADesc(tblDesc));
		this.add(getModifiedbyADesc(tblDesc));
		this.add(getModifiedtimeADesc(tblDesc));
		this.add(getDnameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_orprtmpCDesc(tblDesc));
		...
		tblDesc.add(getEu_scopCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getEu_scopADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Eu_scop",  getEu_scopCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("适用范围标志");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDnameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dname",  getDnameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getEu_scopCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Eu_scop");
		column.setLength(20);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("适用范围标志"); 
		return column;
	}
	/**
	 * 获取启用标志表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDnameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dname");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_orprtmp");
		iBDDataInfoFldMap.put("id_org","Id_org");
		iBDDataInfoFldMap.put("code","Code_srv");
		iBDDataInfoFldMap.put("name","Name_srv");
