 ...
 * 
 */
public class LabAppInfoRsDTO extends BaseDTO {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getDt_fee() {
		return ((FDateTime) getAttrVal("Dt_fee"));
	}
	/**
	 * 收费时间
	 * @param Dt_fee
	 */
	public void setDt_fee(FDateTime Dt_fee) {
		setAttrVal("Dt_fee", Dt_fee);
	}
	/**
	 * 单价
	 * @return FDouble
	 ...
	 * @return String
	 */
	public String getName_emp_fee() {
		return ((String) getAttrVal("Name_emp_fee"));
	}
	/**
	 * 收费人姓名
	 * @param Name_emp_fee
	 */
	public void setName_emp_fee(String Name_emp_fee) {
		setAttrVal("Name_emp_fee", Name_emp_fee);
	}
	/**
	 * 收费人编码
	 * @return String
	 */
	public String getCode_emp_fee() {
		return ((String) getAttrVal("Code_emp_fee"));
	}
	/**
	 * 收费人编码
	 * @param Code_emp_fee
	 */
	public void setCode_emp_fee(String Code_emp_fee) {
		setAttrVal("Code_emp_fee", Code_emp_fee);
	}
	/**
	 * 项目名称
	 * @return String
	 ...
	 * @return String
	 */
	public String getTotal_code_srv() {
		return ((String) getAttrVal("Total_code_srv"));
	}
	/**
	 * 医嘱级别项目编码
	 * @param Total_code_srv
	 */
	public void setTotal_code_srv(String Total_code_srv) {
		setAttrVal("Total_code_srv", Total_code_srv);
	}
	/**
	 * 医嘱级别项目总价
	 * @return FDouble
	 */
	public FDouble getTotal_price() {
		return ((FDouble) getAttrVal("Total_price"));
	}
	/**
	 * 医嘱级别项目总价
	 * @param Total_price
	 */
	public void setTotal_price(FDouble Total_price) {
