...
package iih.mp.nr.tmpchartprnt.d.desc;
 ...
 * 体温单打印记录 DO 元数据信息
 */
public class TmpChartPrntDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.nr.tmpchartprnt.d.TmpChartPrntDO";
	public static final String CLASS_DISPALYNAME = "体温单打印记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_tmpchart_prnt";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_tempchart_prnt";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_tempchart_prntADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_tempchart_prntADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_tempchart_prntCDesc(tblDesc));
		tblDesc.add(getId_tempchart_prntCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_tempchart_prntADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_tempchart_prnt",  getId_tempchart_prntCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体温单打印记录");
	 ...
	 * @return
	 */
	private IColumnDesc getId_tempchart_prntCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_tempchart_prnt");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("体温单打印记录"); 
		return column;
	}
	/**
	 * 获取就诊ID表列元数据
