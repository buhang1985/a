package iih.mp.nr.mpnelabsamp.d;
...
import iih.mp.nr.mpnelabsamp.d.desc.LabSampDODesc;
 ...
 * 
 */
public class LabSampDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "MP_NE_LAB_SAMP";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(LabSampDODesc.class);
	}
