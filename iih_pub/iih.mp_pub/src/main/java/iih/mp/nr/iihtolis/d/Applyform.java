 ...
 * 
 */
public class Applyform extends BaseDTO {
	 ...
	 * @return FArrayList
	 */
	public FArrayList getLabitemdtos() {
		return ((FArrayList) getAttrVal("Labitemdtos"));
	}
	/**
	 * 申请项目明细
	 * @param Labitemdtos
	 */
	public void setLabitemdtos(FArrayList Labitemdtos) {
		setAttrVal("Labitemdtos", Labitemdtos);
	}
	/**
	 * 执行科室编码
	 * @return String
