...
public class DCMedicalRecord
{
    ...
    @JsonProperty(value = "SubMedicalRecord")
    private ArrayOfDCMedicalRecord SubMedicalRecord;
    ...
    public void setSubMedicalRecord(ArrayOfDCMedicalRecord SubMedicalRecord)
    {
        this.SubMedicalRecord = SubMedicalRecord;
    }
    public ArrayOfDCMedicalRecord getSubMedicalRecord()
    {
        return this.SubMedicalRecord;
    }
}
