...
public class DCPacsInfo
{
    ...
    @JsonProperty(value = "PatientBirth")
    ...
    private ArrayOfDCPacsSeries Series;
    ...
    public void setSeries(ArrayOfDCPacsSeries Series)
    {
        this.Series = Series;
    }
    public ArrayOfDCPacsSeries getSeries()
    {
        return this.Series;
    }
}
