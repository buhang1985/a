...
public class DCNursingTour
{
    ...
    @JsonProperty(value = "TourWorks")
    private ArrayOfDCTourType TourWorks;
    ...
    public void setTourWorks(ArrayOfDCTourType TourWorks)
    {
        this.TourWorks = TourWorks;
    }
    public ArrayOfDCTourType getTourWorks()
    {
        return this.TourWorks;
    }
}
