...
public class StPriceAdjCompListener implements IExecutionListener {
	...
	public void notify(WfEventExecution arg0) throws Exception {
		...
		if(billDo.getParentDO().getSd_su_stpri().equals(IMmDictCodeConst.SD_SU_STPRI_CONFIRM_REFUSE)) {
			setupStatus(billDo, IMmDictCodeConst.SD_SU_STPRI_SUBMIT);
		} else {
			setupStatus(billDo, IMmDictCodeConst.SD_SU_STPRI_CONFIRM_ING);
		}
