 ...
 * 出库单明细 DO 元数据信息
 */
public class StockOutItemDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.st.stockout.d.StockOutItemDO";
	public static final String CLASS_DISPALYNAME = "出库单明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MM_OUT_ITM";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_outitm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_outitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_outADesc(tblDesc));
		this.add(getId_outitmADesc(tblDesc));
		...
		this.add(getPri_sa_batchADesc(tblDesc));
		...
		this.add(getMmfg_batchADesc(tblDesc));
		this.add(getMmfg_priceADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_outitmCDesc(tblDesc));
		tblDesc.add(getId_outitmCDesc(tblDesc));
		...
		tblDesc.add(getPri_sa_batchCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_outitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_outitm",  getId_outitmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("出库单明细主键");
	 ...
	 * @return
	 */
	private IAttrDesc getPri_sa_batchADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Pri_sa_batch",  getPri_sa_batchCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("批次售价_实际单位	");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getMmfg_batchADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mmfg_batch",  getMmfg_batchCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
	 ...
	 * @return
	 */
	private IAttrDesc getMmfg_priceADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mmfg_price",  getMmfg_priceCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM a1b3","id_mm=id_mm","fg_price"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getLoc_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_location a1b10","id_loc=id_loc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getLoc_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_location a1b10","id_loc=id_loc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getLoc_pycodeADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("货位拼音码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_location a1b10","id_loc=id_loc","pycode"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSup_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_SUP a1b8","id_sup=id_sup","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_outitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_outitm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("出库单明细主键"); 
		return column;
	}
	/**
	 * 获取出库单据主键表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getPri_sa_batchCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Pri_sa_batch");
		column.setLength(38);
        column.setPrecision(8);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("批次售价_实际单位	"); 
		return column;
	}
	/**
	 * 获取入库价_实际单位表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getMmfg_batchCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mmfg_batch");
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getMmfg_priceCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mmfg_price");
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_free",new xap.mw.coreitf.d.FBoolean("N"));
	}
