...
package iih.mm.qy.stockbackinfo.d.desc;
 ...
 * 单到回冲明细查询 DO 元数据信息
 */
public class StockBackQueryViewDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.qy.stockbackinfo.d.StockBackQueryView";
	public static final String CLASS_DISPALYNAME = "单到回冲明细查询";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "V_MM_STBACK_QUERY";
