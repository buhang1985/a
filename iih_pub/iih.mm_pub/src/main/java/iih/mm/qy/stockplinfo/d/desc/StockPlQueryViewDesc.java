...
package iih.mm.qy.stockplinfo.d.desc;
 ...
 * 采购计划查询 DO 元数据信息
 */
public class StockPlQueryViewDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.qy.stockplinfo.d.StockPlQueryView";
	public static final String CLASS_DISPALYNAME = "采购计划查询";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "V_MM_STPL_QUERY";
	...
	private void init(){		
		...
		this.add(getPl_codeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getPl_codeCDesc(tblDesc));
		tblDesc.add(getPl_nameCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getPl_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Pl_code",  getPl_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("计划单号");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getFactory_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_SUP a0b5","id_factory=id_sup","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getMmpkgunameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM_PKGU a0b7","id_mmpkgu_actual=id_mmpkgu","mmpkguname"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSupl_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b9","id_su_pl=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getPl_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Pl_code");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("计划单号"); 
		return column;
	}
	/**
	 * 获取计划名称表列元数据
