...
package iih.mm.qy.stockdepoaccinfo.d.desc;
 ...
 * 入出存流水账信息查询 DO 元数据信息
 */
public class StockDepoAccViewDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.qy.stockdepoaccinfo.d.StockDepoAccView";
	public static final String CLASS_DISPALYNAME = "入出存流水账信息查询";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "V_MM_STDEAC_QUERY";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Busi_code";
	...
	private void init(){		
		...
		this.setKeyDesc(getBusi_codeADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_inout_itmADesc(tblDesc));
		this.add(getBusi_codeADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_mmADesc(tblDesc));
		this.add(getDate_busiADesc(tblDesc));
		...
		this.add(getQuan_actADesc(tblDesc));
		...
		this.add(getFg_inADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getBusi_codeCDesc(tblDesc));
		tblDesc.add(getId_inout_itmCDesc(tblDesc));
		tblDesc.add(getBusi_codeCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_mmCDesc(tblDesc));
		tblDesc.add(getDate_busiCDesc(tblDesc));
		...
		tblDesc.add(getQuan_actCDesc(tblDesc));
		...
		tblDesc.add(getFg_inCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_inout_itmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_inout_itm",  getId_inout_itmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("出入库明细");
	 ...
	 * @return
	 */
	private IAttrDesc getBusi_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Busi_code",  getBusi_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getDate_busiADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Date_busi",  getDate_busiCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDate);
		attrDesc.setLabel("业务日期");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getQuan_actADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Quan_act",  getQuan_actCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_inADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_in",  getFg_inCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("出入库区分");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getMmca_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MMCA a0b8","id_mmca=id_mmca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_inout_itmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_inout_itm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("出入库明细"); 
		return column;
	}
	/**
	 * 获取单据号表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getBusi_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Busi_code");
		column.setLength(50);
	 ...
	 * @return
	 */
	private IColumnDesc getDate_busiCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Date_busi");
		column.setLength(10);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("业务日期"); 
		return column;
	}
	/**
	 * 获取制单日期表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getQuan_actCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Quan_act");
		column.setLength(20);
        column.setPrecision(8);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_inCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_in");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("出入库区分"); 
		return column;
	}
	/**
	 * 获取物品编码表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Busi_code");
