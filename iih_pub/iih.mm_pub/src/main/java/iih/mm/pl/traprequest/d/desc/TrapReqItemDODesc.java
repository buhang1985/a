 ...
 * 调拨申请明细 DO 元数据信息
 */
public class TrapReqItemDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.pl.traprequest.d.TrapReqItemDO";
	public static final String CLASS_DISPALYNAME = "调拨申请明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MM_TRAP_ITM";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_trapitm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_trapitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_trapADesc(tblDesc));
		this.add(getId_trapitmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_trapitmCDesc(tblDesc));
		tblDesc.add(getId_trapitmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_trapitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_trapitm",  getId_trapitmCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_trapitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_trapitm");
		column.setLength(20);
