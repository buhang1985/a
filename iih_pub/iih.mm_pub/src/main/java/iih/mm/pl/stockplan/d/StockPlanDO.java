 ...
 * 
 */
public class StockPlanDO extends BaseDO {
	 ...
	 * @return FDouble
	 */
	public FDouble getPlamt() {
		return ((FDouble) getAttrVal("Plamt"));
	}	
	/**
	 * 总金额
	 * @param Plamt
	 */
	public void setPlamt(FDouble Plamt) {
		setAttrVal("Plamt", Plamt);
	}
	/**
	 * 名称
	 * @return String
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(StockPlanDODesc.class);
	}
