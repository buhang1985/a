...
package iih.mm.bl.stockbl.d.desc;
 ...
 * 结存 DO 元数据信息
 */
public class StockBlDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.bl.stockbl.d.StockBlDO";
	public static final String CLASS_DISPALYNAME = "结存";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MM_BL";
	...
	private void init(){		
		...
		this.add(getDt_lastupdateADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getDt_lastupdateCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getDt_lastupdateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_lastupdate",  getDt_lastupdateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDateTime);
		attrDesc.setLabel("最后使用时间");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getDt_lastupdateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_lastupdate");
		column.setLength(19);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("最后使用时间"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_stop",new xap.mw.coreitf.d.FBoolean("N"));
