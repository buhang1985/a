...
package iih.cssd.dpbd.pkgca.d.desc;
 ...
 * 包定义分类 DO 元数据信息
 */
public class CssdPkgCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.cssd.dpbd.pkgca.d.CssdPkgCaDO";
	public static final String CLASS_DISPALYNAME = "包定义分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "cssd_pkg_ca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pkg_ca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pkg_caADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pkg_caCDesc(tblDesc));
	...
	private IAttrDesc getName_pkg_caADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"cssd_pkg_ca a0b6","id_parent=id_pkg_ca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pkg_ca");
