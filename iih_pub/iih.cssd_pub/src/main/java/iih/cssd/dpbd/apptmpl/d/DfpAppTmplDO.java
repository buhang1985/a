...
import iih.cssd.dpbd.apptmpl.d.desc.DfpAppTmplDODesc;
 ...
 * 
 */
public class DfpAppTmplDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "cssd_app_tmpl";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(DfpAppTmplDODesc.class);
	}
