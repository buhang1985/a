 ...
 * 科室请领模板 DO 元数据信息
 */
public class DfpAppTmplDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.cssd.dpbd.apptmpl.d.DfpAppTmplDO";
	public static final String CLASS_DISPALYNAME = "科室请领模板";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "cssd_app_tmpl";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_app_tmpl";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_app_tmplADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_app_tmplCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_app_tmpl");
