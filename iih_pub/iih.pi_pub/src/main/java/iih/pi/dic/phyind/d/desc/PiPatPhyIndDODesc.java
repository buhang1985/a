 ...
 * 患者生理指标 DO 元数据信息
 */
public class PiPatPhyIndDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pi.dic.phyind.d.PiPatPhyIndDO";
	public static final String CLASS_DISPALYNAME = "患者生理指标";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pi_pat_phyind";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_patphyind";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_patphyindADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_patphyindCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_patphyind");
