...
public class CategoryRefModel extends RefGridModel{
	@Override
	...
	public String[] getHiddenFieldCode(){
		return new String[]{PiPatCaDO.ID_PATCA, PiPatCaDO.ID_PATCRETTP, PiPatCaDO.ID_PATPRITP, PiPatCaDO.PATCRETTP_NAME, PiPatCaDO.PATPRITP_NAME,
							"id_hp","hp_code","hp_name","fg_reqhpcode"};
	}
	@Override
...
//		String dateStr = (String)this.getExtendAttributeValue("date");
//		
//		refSql += " Where sch.d_sch = '" + dateStr + "'";
