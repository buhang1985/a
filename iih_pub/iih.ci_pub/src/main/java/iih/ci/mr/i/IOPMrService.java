...
public interface IOPMrService {
	 ...
	 * @throws BizException
	 */
	public abstract FArrayList2 SaveMr(MrDocRefValueDO[] mrDocRefValueDOs,CiMrDO ciMrDO,CiMrFsDO ciMrFsDO) throws BizException,IOException; 
	/**
	 * 获取处置模板信息
	 * @param id_dept
	 * @return
	 ...
	 * @throws BizException
	 */
	public abstract FArrayList2 GetData(CiMrDO ciMrDO) throws BizException,IOException;
	/**
	 * 根据就诊号和数据集获取病历文书
	 * @param id_ent
	 * @param code_sets
	 ...
	 * @throws BizException
	 */
	public abstract CiMrDO[] getCurrentEntAllCiMrList(String id_ent,String id_mrcactm) throws BizException;
	/**
	 * 门诊病历删除方法
	 * @param ciMrDos
	 * @return
	 * @throws BizException
	 */
	public abstract boolean deleteMr(CiMrDO[] ciMrDos) throws BizException;
	/**
	 * 门诊病历逻辑删除方法
	 * @param ciMrDos
	 * @return
	 * @throws BizException
	 */
	public abstract boolean logicDeleteMr(CiMrDO[] ciMrDos) throws BizException;
}
