...
package iih.ci.mr.middle.nmr.d.desc;
 ...
 * 病历中间表护理文书 DO 元数据信息
 */
public class CiMrMiddleNmrDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.middle.nmr.d.CiMrMiddleNmrDO";
	public static final String CLASS_DISPALYNAME = "病历中间表护理文书";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_mr_middle_nmr";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ci_mr_middle_nmr";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ci_mr_middle_nmrADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_ci_mr_middle_nmrADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ci_mr_middle_nmrCDesc(tblDesc));
		tblDesc.add(getId_ci_mr_middle_nmrCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_ci_mr_middle_nmrADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_ci_mr_middle_nmr",  getId_ci_mr_middle_nmrCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_ci_mr_middle_nmrCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_ci_mr_middle_nmr");
		column.setLength(20);
