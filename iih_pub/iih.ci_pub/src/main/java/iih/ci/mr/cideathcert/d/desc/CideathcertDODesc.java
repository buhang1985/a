...
public class CideathcertDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getBirth_place_codeADesc(tblDesc));
		this.add(getBirth_place_nameADesc(tblDesc));
		this.add(getBirth_place_fullnameADesc(tblDesc));
		this.add(getBirth_place_streetADesc(tblDesc));
		this.add(getAddress_usualADesc(tblDesc));
		this.add(getAddress_usual_codeADesc(tblDesc));
		this.add(getAddress_usual_nameADesc(tblDesc));
		this.add(getAddress_usual_fullnameADesc(tblDesc));
		this.add(getAddress_usual_streetADesc(tblDesc));
		...
		this.add(getSerialnumberADesc(tblDesc));
		this.add(getPrefixcodeADesc(tblDesc));
		this.add(getHealthnumberADesc(tblDesc));
		this.add(getReject_reasonADesc(tblDesc));
		this.add(getDeath_reason_tfADesc(tblDesc));
		...
		this.add(getCode_card_typeADesc(tblDesc));
		this.add(getName_card_typeADesc(tblDesc));
		...
		this.add(getCode_whcdADesc(tblDesc));
		this.add(getName_whcdADesc(tblDesc));
		this.add(getCode_grsfADesc(tblDesc));
		this.add(getName_grsfADesc(tblDesc));
		this.add(getCode_addressADesc(tblDesc));
		this.add(getName_addressADesc(tblDesc));
		this.add(getFullname_addressADesc(tblDesc));
		this.add(getCode_deathsiteADesc(tblDesc));
		this.add(getName_deathsiteADesc(tblDesc));
		this.add(getName_birth_placeADesc(tblDesc));
		this.add(getCode_birth_placeADesc(tblDesc));
		this.add(getName_address_usualADesc(tblDesc));
		this.add(getCode_address_usualADesc(tblDesc));
		...
		this.add(getCode_cert_statusADesc(tblDesc));
		this.add(getName_cert_statusADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getBirth_place_codeCDesc(tblDesc));
		tblDesc.add(getBirth_place_nameCDesc(tblDesc));
		tblDesc.add(getBirth_place_fullnameCDesc(tblDesc));
		tblDesc.add(getBirth_place_streetCDesc(tblDesc));
		tblDesc.add(getAddress_usualCDesc(tblDesc));
		tblDesc.add(getAddress_usual_codeCDesc(tblDesc));
		tblDesc.add(getAddress_usual_nameCDesc(tblDesc));
		tblDesc.add(getAddress_usual_fullnameCDesc(tblDesc));
		tblDesc.add(getAddress_usual_streetCDesc(tblDesc));
		...
		tblDesc.add(getSerialnumberCDesc(tblDesc));
		tblDesc.add(getPrefixcodeCDesc(tblDesc));
		tblDesc.add(getHealthnumberCDesc(tblDesc));
		tblDesc.add(getReject_reasonCDesc(tblDesc));
		tblDesc.add(getDeath_reason_tfCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getBirth_place_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Birth_place_code",  getBirth_place_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getBirth_place_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Birth_place_name",  getBirth_place_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getBirth_place_fullnameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Birth_place_fullname",  getBirth_place_fullnameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("户籍地址全称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getBirth_place_streetADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Birth_place_street",  getBirth_place_streetCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("户籍地址街道");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAddress_usual_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Address_usual_code",  getAddress_usual_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("常住地址编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAddress_usual_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Address_usual_name",  getAddress_usual_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("常住地址名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAddress_usual_fullnameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Address_usual_fullname",  getAddress_usual_fullnameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("常住地址全称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAddress_usual_streetADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Address_usual_street",  getAddress_usual_streetCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("常住地址街道");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSerialnumberADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Serialnumber",  getSerialnumberCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getPrefixcodeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Prefixcode",  getPrefixcodeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("序号前缀");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getHealthnumberADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Healthnumber",  getHealthnumberCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getDeath_reason_tfADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Death_reason_tf",  getDeath_reason_tfCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("二至四联死亡原因");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getCode_grpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_grp a0b20","id_grp=id_grp","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_grpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_grp a0b20","id_grp=id_grp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_card_typeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_card_type",  getCode_card_typeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b3","id_cardtype=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_card_typeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_card_type",  getName_card_typeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b3","id_cardtype=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_countryADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_country a0b4","id_country=id_countryzone","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_countryADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_country a0b4","id_country=id_countryzone","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCodeth_countryADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_country a0b4","id_country=id_countryzone","codeth"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getFullname_countryADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_country a0b4","id_country=id_countryzone","fullname"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_nationADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_nation=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_nationADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_nation=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_marryADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_marry=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_marryADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_marry=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_whcdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_whcd",  getCode_whcdCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_degree=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_whcdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_whcd",  getName_whcdCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_degree=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_grsfADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_grsf",  getCode_grsfCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_job=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_grsfADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_grsf",  getName_grsfCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_job=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_addressADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b9","address_pat=id_adminarea","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_addressADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b9","address_pat=id_adminarea","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getFullname_addressADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fullname_address",  getFullname_addressCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b9","address_pat=id_adminarea","fullname"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_deathsiteADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b10","death_site=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_deathsiteADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b10","death_site=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_birth_placeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_birth_place",  getName_birth_placeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a0b16","birth_place=id_mr_area","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_birth_placeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_birth_place",  getCode_birth_placeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a0b16","birth_place=id_mr_area","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_address_usualADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_address_usual",  getName_address_usualCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a0b17","address_usual=id_mr_area","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_address_usualADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_address_usual",  getCode_address_usualCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a0b17","address_usual=id_mr_area","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_diagbasisADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b11","diag_basis=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_diagbasisADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b11","diag_basis=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode123ADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b12","diag_hospital=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName123ADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b12","diag_hospital=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_cert_statusADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_cert_status",  getCode_cert_statusCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b18","cert_status=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_cert_statusADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_cert_status",  getName_cert_statusCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b18","cert_status=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getBirth_place_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Birth_place_code");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getBirth_place_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Birth_place_name");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getBirth_place_fullnameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Birth_place_fullname");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("户籍地址全称"); 
		return column;
	}
	/**
	 * 获取户籍地址街道表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getBirth_place_streetCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Birth_place_street");
		column.setLength(200);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("户籍地址街道"); 
		return column;
	}
	/**
	 * 获取常住地址表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAddress_usual_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Address_usual_code");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("常住地址编码"); 
		return column;
	}
	/**
	 * 获取常住地址名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAddress_usual_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Address_usual_name");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("常住地址名称"); 
		return column;
	}
	/**
	 * 获取常住地址全称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAddress_usual_fullnameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Address_usual_fullname");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("常住地址全称"); 
		return column;
	}
	/**
	 * 获取常住地址街道表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAddress_usual_streetCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Address_usual_street");
		column.setLength(200);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("常住地址街道"); 
		return column;
	}
	/**
	 * 获取联系人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSerialnumberCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Serialnumber");
		column.setLength(4);
	 ...
	 * @return
	 */
	private IColumnDesc getPrefixcodeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Prefixcode");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("序号前缀"); 
		return column;
	}
	/**
	 * 获取卫生部编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getHealthnumberCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Healthnumber");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getDeath_reason_tfCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Death_reason_tf");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("二至四联死亡原因"); 
		return column;
	}
	/**
	 * 获取就诊id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getCode_card_typeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_card_type");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_card_typeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_card_type");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_whcdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_whcd");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_whcdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_whcd");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_grsfCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_grsf");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_grsfCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_grsf");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getFullname_addressCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fullname_address");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_birth_placeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_birth_place");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_birth_placeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_birth_place");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_address_usualCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_address_usual");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_address_usualCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_address_usual");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_cert_statusCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_cert_status");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_cert_statusCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_cert_status");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
