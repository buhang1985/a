...
public class AMrDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_bd_mrm_otADesc(tblDesc));
		this.add(getCode_amr_timesADesc(tblDesc));
		this.add(getId_psn_sendmrmADesc(tblDesc));
		this.add(getFg_supplementADesc(tblDesc));
		this.add(getId_qa_tempADesc(tblDesc));
		this.add(getSd_qa_tempADesc(tblDesc));
		this.add(getScore_qa_tyADesc(tblDesc));
		this.add(getName_divide_levelADesc(tblDesc));
		...
		this.add(getMrm_ot_nameADesc(tblDesc));
		this.add(getName_psn_sendmrmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_bd_mrm_otCDesc(tblDesc));
		tblDesc.add(getCode_amr_timesCDesc(tblDesc));
		tblDesc.add(getId_psn_sendmrmCDesc(tblDesc));
		tblDesc.add(getFg_supplementCDesc(tblDesc));
		tblDesc.add(getId_qa_tempCDesc(tblDesc));
		tblDesc.add(getSd_qa_tempCDesc(tblDesc));
		tblDesc.add(getScore_qa_tyCDesc(tblDesc));
		tblDesc.add(getName_divide_levelCDesc(tblDesc));
...
/**
	 ...
	 * @return
	 */
	private IAttrDesc getId_bd_mrm_otADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_bd_mrm_ot",  getId_bd_mrm_otCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("病案操作");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_amr_timesADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_amr_times",  getCode_amr_timesCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("病案条码号");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_psn_sendmrmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_psn_sendmrm",  getId_psn_sendmrmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("送案人");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_supplementADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_supplement",  getFg_supplementCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("有否补充");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_qa_tempADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_qa_temp",  getId_qa_tempCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("暂存病案状态id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_qa_tempADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_qa_temp",  getSd_qa_tempCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("暂存病案状态编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getScore_qa_tyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Score_qa_ty",  getScore_qa_tyCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("最后一次病历质量分值");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_divide_levelADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_divide_level",  getName_divide_levelCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("最后一次病历质量等级");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
...
/**
	 ...
	 * @return
	 */
	private IAttrDesc getMrm_ot_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mrm_ot_name",  getMrm_ot_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mrm_ot a0b40","id_bd_mrm_ot=id_bd_mrm_ot","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_psn_sendmrmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_psn_sendmrm",  getName_psn_sendmrmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b41","id_psn_sendmrm=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
...
/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_bd_mrm_otCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_bd_mrm_ot");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("病案操作"); 
		return column;
	}
	/**
	 * 获取病案条码号表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getCode_amr_timesCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_amr_times");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("病案条码号"); 
		return column;
	}
	/**
	 * 获取送案人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_psn_sendmrmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_psn_sendmrm");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("送案人"); 
	 ...
	 * @return
	 */
	private IColumnDesc getFg_supplementCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_supplement");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("有否补充"); 
		return column;
	}
	/**
	 * 获取暂存病案状态id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_qa_tempCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_qa_temp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("暂存病案状态id"); 
		return column;
	}
	/**
	 * 获取暂存病案状态编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_qa_tempCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_qa_temp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("暂存病案状态编码"); 
		return column;
	}
	/**
	 * 获取最后一次病历质量分值表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getScore_qa_tyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Score_qa_ty");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("最后一次病历质量分值"); 
		return column;
	}
	/**
	 * 获取最后一次病历质量等级表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_divide_levelCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_divide_level");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("最后一次病历质量等级"); 
		return column;
	}
	/**
	 * 获取组织编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getMrm_ot_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mrm_ot_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_psn_sendmrmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_psn_sendmrm");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("姓名"); 
		return column;
