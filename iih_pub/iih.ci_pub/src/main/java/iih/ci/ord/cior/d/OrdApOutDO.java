...
public class OrdApOutDO extends BaseDO {
	...
	public static final String NAME_EXT1= "Name_ext1";
	...
	public String getName_ext1() {
		return ((String) getAttrVal("Name_ext1"));
	}	
	public void setName_ext1(String Name_ext1) {
		setAttrVal("Name_ext1", Name_ext1);
	}
