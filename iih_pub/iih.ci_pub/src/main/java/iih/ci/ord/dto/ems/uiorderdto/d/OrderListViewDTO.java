...
import iih.ci.ord.dto.ems.uiorderdto.b.BaseOrderListViewDTO;
 ...
 * 
 */
public class OrderListViewDTO extends BaseOrderListViewDTO {
	 ...
	 * @return String
	 */
	public String getQuan_firday_mp() {
		return ((String) getAttrVal("Quan_firday_mp"));
	}
	/**
	 * 首日执行次数
	 * @param Quan_firday_mp
	 */
	public void setQuan_firday_mp(String Quan_firday_mp) {
