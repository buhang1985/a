...
public class OrdApOpDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getName_desADesc(tblDesc));
		this.add(getFg_daysugADesc(tblDesc));
		this.add(getId_datelimittypeADesc(tblDesc));
		this.add(getSd_datelimittypeADesc(tblDesc));
		this.add(getId_surgical_siteADesc(tblDesc));
		this.add(getSd_surgical_siteADesc(tblDesc));
		this.add(getId_specialreqADesc(tblDesc));
		this.add(getSd_specialreqADesc(tblDesc));
		this.add(getId_specialinstrumentADesc(tblDesc));
		this.add(getSd_specialinstrumentADesc(tblDesc));
		this.add(getSug_requireADesc(tblDesc));
		this.add(getFg_infection_sugADesc(tblDesc));
		this.add(getSd_infectionca_sugADesc(tblDesc));
		this.add(getName_infectionca_sugADesc(tblDesc));
		this.add(getDes_allergyADesc(tblDesc));
		this.add(getId_asaADesc(tblDesc));
		this.add(getSd_asaADesc(tblDesc));
		this.add(getName_asaADesc(tblDesc));
		...
		this.add(getName_datelimittpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getName_desCDesc(tblDesc));
		tblDesc.add(getFg_daysugCDesc(tblDesc));
		tblDesc.add(getId_datelimittypeCDesc(tblDesc));
		tblDesc.add(getSd_datelimittypeCDesc(tblDesc));
		...
		tblDesc.add(getSd_specialreqCDesc(tblDesc));
		tblDesc.add(getId_specialinstrumentCDesc(tblDesc));
		tblDesc.add(getSd_specialinstrumentCDesc(tblDesc));
		tblDesc.add(getSug_requireCDesc(tblDesc));
		tblDesc.add(getFg_infection_sugCDesc(tblDesc));
		tblDesc.add(getSd_infectionca_sugCDesc(tblDesc));
		tblDesc.add(getName_infectionca_sugCDesc(tblDesc));
		tblDesc.add(getDes_allergyCDesc(tblDesc));
		tblDesc.add(getId_asaCDesc(tblDesc));
		tblDesc.add(getSd_asaCDesc(tblDesc));
		tblDesc.add(getName_asaCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_desADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_des",  getName_desCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手术名称描述信息");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_datelimittypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_datelimittype",  getId_datelimittypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手术期限");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_datelimittypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_datelimittype",  getSd_datelimittypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手术期限编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_specialreqADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_specialreq",  getSd_specialreqCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("特殊用物编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_specialinstrumentADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_specialinstrument",  getSd_specialinstrumentCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("特殊仪器编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_infection_sugADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_infection_sug",  getFg_infection_sugCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("感染手术标志");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_infectionca_sugADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_infectionca_sug",  getSd_infectionca_sugCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("感染手术分类");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_infectionca_sugADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_infectionca_sug",  getName_infectionca_sugCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("感染手术分类名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDes_allergyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Des_allergy",  getDes_allergyCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("药物过敏记录");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_asaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_asa",  getName_asaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("麻醉风险评分");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_datelimittpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_datelimittp",  getName_datelimittpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b13","id_datelimittype=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_surgical_siteADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b14","id_surgical_site=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_desCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_des");
		column.setLength(4000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("手术名称描述信息"); 
		return column;
	}
	/**
	 * 获取日间手术标识表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_datelimittypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_datelimittype");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("手术期限"); 
		return column;
	}
	/**
	 * 获取手术期限编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_datelimittypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_datelimittype");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("手术期限编码"); 
		return column;
	}
	/**
	 * 获取手术部位id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_specialreqCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_specialreq");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("特殊用物编码"); 
		return column;
	}
	/**
	 * 获取特殊仪器Id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_specialinstrumentCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_specialinstrument");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("特殊仪器编码"); 
		return column;
	}
	/**
	 * 获取手术要求表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_infection_sugCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_infection_sug");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("感染手术标志"); 
		return column;
	}
	/**
	 * 获取感染手术分类表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_infectionca_sugCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_infectionca_sug");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("感染手术分类"); 
		return column;
	}
	/**
	 * 获取感染手术分类名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_infectionca_sugCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_infectionca_sug");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("感染手术分类名称"); 
		return column;
	}
	/**
	 * 获取药物过敏记录表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDes_allergyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Des_allergy");
		column.setLength(4000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("药物过敏记录"); 
		return column;
	}
	/**
	 * 获取麻醉风险评分id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_asaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_asa");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("麻醉风险评分"); 
		return column;
	}
	/**
	 * 获取诊断表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_datelimittpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_datelimittp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Id_didef_relstd","~");
		defaultValueMap.put("Fg_daysug",new xap.mw.coreitf.d.FBoolean("N"));
	}
