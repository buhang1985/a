...
public class IEOthOrDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getVisit_time_type_code() {
		return ((String) getAttrVal("Visit_time_type_code"));
	}	
	/**
	 * 就诊时间类型编码
	 * @param Visit_time_type_code
	 */
	public void setVisit_time_type_code(String Visit_time_type_code) {
		setAttrVal("Visit_time_type_code", Visit_time_type_code);
	}
	/**
	 * 就诊时间类型名称
	 * @return String
	 */
	public String getVisit_time_type_name() {
		return ((String) getAttrVal("Visit_time_type_name"));
	}	
	/**
	 * 就诊时间类型名称
	 * @param Visit_time_type_name
	 */
	public void setVisit_time_type_name(String Visit_time_type_name) {
		setAttrVal("Visit_time_type_name", Visit_time_type_name);
	}
	/**
	 * 医嘱序号
	 * @return String
	 */
	public String getOrder_sort_no() {
		return ((String) getAttrVal("Order_sort_no"));
	}	
	/**
	 * 医嘱序号
	 * @param Order_sort_no
	 */
	public void setOrder_sort_no(String Order_sort_no) {
		setAttrVal("Order_sort_no", Order_sort_no);
	}
	/**
	 * 申请科室编码
	 * @return String
