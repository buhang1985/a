...
public class IEOpPharmOrMmDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getPiecesdecoctionmethod() {
		return ((String) getAttrVal("Piecesdecoctionmethod"));
	}	
	/**
	 * 中药饮片煎煮法
	 * @param Piecesdecoctionmethod
	 */
	public void setPiecesdecoctionmethod(String Piecesdecoctionmethod) {
		setAttrVal("Piecesdecoctionmethod", Piecesdecoctionmethod);
	}
}