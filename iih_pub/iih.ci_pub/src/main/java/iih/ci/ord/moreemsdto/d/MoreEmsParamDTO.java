...
public class MoreEmsParamDTO extends BaseDTO {
	...
	public void addErrorEms(CiEmsDTO ciEmsDTO){
		if(ciEmsDTO == null){
			return;
		}
		FMap2 fMap2 = this.getErrormap2();
		if(fMap2==null){
			fMap2 = new FMap2();
			this.setErrormap2(fMap2);
		}
		fMap2.put(ciEmsDTO.getName(), ciEmsDTO);
	}
	public void addErrorEms(String key,CiEmsDTO ciEmsDTO){
		if(ciEmsDTO == null){
			return;
		}
		FMap2 fMap2 = this.getErrormap2();
