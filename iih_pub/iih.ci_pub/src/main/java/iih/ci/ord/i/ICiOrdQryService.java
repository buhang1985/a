...
public interface ICiOrdQryService {
	...
	public abstract EmsOrSrvSc[] getMedSrvSc(String srvca, String srvName, String Healthca, String code_ent)
			throws BizException;
	public abstract EmsOrSrvSc[] getMedSrvSc_TL(String srvca, String srvName, String Healthca, String code_ent,String id_pripat)
			throws BizException;
	/**
	 * 获取服务（含医保计划）
	 * @param srvca
	 * @param srvName
	 * @param Healthca
	 * @param conetxtDTO 就诊上下文信息
	 * @return
	 */
	public abstract EmsOrSrvSc[] getMedSrvScByContext(String srvca,String sd_inputmethod, String srvName, String Healthca,CiEnContextDTO conetxtDTO) throws BizException;
	/**
	 * 医嘱模板获得医疗服务
	 * 
	 * @param dto 查询参数对象
	...
	public abstract OrdConsDTO[] GetInviteList(String id_dep, String su_cons) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract EmsBuItemDO getOrderUBDto(String id_or) throws BizException;
	 ...
	 * 
	 */
	public abstract EmsBuItemDO[] getOrderUBDtoList(String id_ent) throws BizException;
	...
	public abstract CiEmsDTO getCiEmsDTO_TL(String id_or) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract MoreEmsParamDTO getMoreEmsParamDTO(CiEnContextDTO envinfo, OrTplNItmDO[] ortplItemDO, String clinicalzztz)
			throws BizException;
	...
	public LabDTO[] getLabItms8DateBP(String idpat, FDateTime end, FDateTime start, String[] srvlist)
			throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract DiagTreatViewRntDataDTO getDiagTreatKeyPointData(OrSrvSplitParamDTO orparams)
			throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract NewOrderTemplateDTO[] getNewOrderTemplateDTO(String id_ortmpl, CiEnContextDTO ctx) throws BizException;
	...
	public abstract FMap2 getOrderMrDtoFlushList_TL(String id_ent, String code_entp, CiOrderDO[] orders,String id_psndoc,String refreshMode) throws BizException;
	...
	public abstract FMap getNewOrderTemplateDTO2(String[] id_ortmpl,CiEnContextDTO ctx)
			throws BizException;
	public abstract FMap getNewOrderTemplateDTO2_TL(String[] id_ortmpl, String Id_pripat, String id_hp, String code_entp)
			throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract FMap2 getCiMrCourseOfLastDisease(String idEnt,FBoolean firstMr) throws BizException, DocumentException, IOException ;
	/**
	 * 获得长期频次为always、已经停止核对的医嘱
	 * @param queryNode
	 * @return
	 */
	public abstract CiOrdModifyEndTimeDTO[] findOrdIsAlwaysCanEndByQCond(QryRootNodeDTO queryNode) throws BizException;
	/**
	 * 获得长期频次为always、已经停止核对的医嘱  分页查询
	 * @param queryNode
	 * @return
	 */
	public abstract PagingRtnData<CiOrdModifyEndTimeDTO> findOrdIsAlwaysCanEndPageInfo(QryRootNodeDTO queryNode,PaginationInfo  p) throws BizException;
	/**
	 * 医嘱计价接口，铜陵版本，住院使用
	 * @param queryOrderDTO
	 * @return
	 * @throws BizException
	 */
	public abstract OrderByPriceDTO[] getCiOrderDOByCondition(String[] id_ents,QryRootNodeDTO qryRootNodeDTO)throws BizException;
	/**
	 * 判断是否有自费诊断
	 * @param id_didef
	 * @return
  ...
  /**
	 ...
	 * @throws BizException
	 */
	public abstract OrderPassRstDTO getOrderPassRstInfo(String id_ent,String id_pat,String idors) throws BizException;
	/**
	 * 护嘱查询接口
	 * @param nursOrderQueryDTO
	 * @return
	 * @throws BizException
	 */
	public abstract CiOrderDO[] getActiveOrders(NursOrderQueryDTO nursOrderQueryDTO) throws BizException;
    /**
     *  查询医疗服务  （id_mm 商品名开立）
     * @param id_srv
     * @param id_mm
     ...
     * @throws BizException
     */
	public abstract MedSrvDO   getMedsrvDO(String id_srv,String id_mm)throws BizException;
	/**
	 * 查询医疗服务  （id_mm 商品名开立）
	 * @param ciEnContextDto
	 * @param id_srv
	 ...
	 * @throws BizException
	 */
	public abstract MedSrvDO   getMedsrvDO_Pri(CiEnContextDTO ciEnContextDto, String id_srv, String id_mm) throws BizException;
	/**
    * 医嘱列表
    * @param whereStr
    * @param id_ent
    ...
    * @throws BizException
    */
    public  abstract CiOrderDO[] getOrderList(String whereStr ,String orderbyStr)throws BizException;
	/**
	 * 获取患者本次就诊下的所有二次手术申请单
	 * @param id_ent
	 * @return
	 * @throws BizException
	 */
	public abstract OrdApOpAgainDO[] getApSugAgainDos(String id_ent) throws BizException;
	/**
	 * 获得需要审批的二次手术申请单
	 * @return
	 * @throws BizException
	 */
	public abstract OrdApOpAgainDO[] loadCheckAgainData() throws BizException;
	/**
	 * 查询需要审批的二次手术申请单
	 * @return
	 * @throws BizException
	 */
	public abstract OrdApOpAgainDO[] queryCheckAgainData(OpAgainQueryDTO agindo) throws BizException;
	/**
	 * 获得自定义服务可参照的计量单位
	 * @param paramCode
	 * @return
	 */
	public abstract FMap getFreqForFtmSrv(String paramCode) throws BizException ;
	/**
	 * 计算首日执行次数
	 * @param id_freq
	 * @param dateTime
	 ...
	 * @throws BizException
	 */
	Integer calQuanFirdayMp(String id_freq, FDateTime dateTime,FDateTime dt_end,String sd_srvtp) throws BizException;
	/**
	 ...
	 * @throws BizException
	 */
	QuanFirstDayMpRstDTO calQuanFirdayMpRst(String id_freq, FDateTime dateTime,FDateTime dt_end,String sd_srvtp,FBoolean fg_pres_outp) throws BizException;
	/**
	 * 查询患者的主诉、现病史、体格检查
	 * @param id_en
	 * @return
	 * @throws BizException
	 */
	public abstract String getDiseaseDescription(String id_en) throws BizException;
	
	public abstract FArrayList2 getKeyTimes(OrSrvSplitParamDTO orparams)throws BizException;
	
	public abstract DiagTreatViewRntDataDTO getStartAndEndTime(OrSrvSplitParamDTO orparams)throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract FBoolean entHasTag(String id_ent, String sd_tagtp) throws BizException;
	/**
	 * 通用查询
	 * @param sql
	 * @return
	 * @throws BizException
	 */
	public abstract FArrayList2  executeQuery(String sql) throws BizException;
   /**
                * 医嘱编码生成添加部门信息，拼接部门编码 
    * @return
    * @throws BizException
    */
	public abstract String getCodeOr()throws BizException;
	/**
	 * 退药
	 * @param id_en
	 * @param strs
	 ...
	 * @throws BizException
	 */
    public abstract DgRtnOrderDTO[] getReturnBackdrugList(String id_en, String[] strs)throws BizException;
    /**
     * 剩余退药量
     * @param gRtnOrderDTO
     * @return
     * @throws BizException
     */
    public abstract FDouble getReturnBackdrugQuan(DgRtnOrderDTO gRtnOrderDTO)throws BizException;
    /**
     * 获取编码规则的申请单号
     * @param sd_srvtp
     * @return
     * @throws BizException
     */
    public abstract String getNoapply(String sd_srvtp)throws BizException; 

   /**
    * 获取医嘱数量
    * 
    * @param idOrArr 医嘱id集合
    * @return
    * @throws BizException
    */
    public abstract int getCount(String[] idOrArr) throws BizException;
     ...
     * @throws BizException
     */
    public abstract CiOrdQryItemDTO[] GetOrdItem4Bl(CiOrderFilterDTO filterdto) throws BizException;
     ...
     * @throws BizException
     */
    public abstract CiBlIpCgDTO[] GetBlCgItem(CiOrdQryItemDTO cond) throws BizException;
    /**
     * 通过服务类型生成申请单号
     * @param sd_srvtp
     * @return
     */
    public abstract String getNoApplyFormBySrvtp(String sd_srvtp) throws BizException ;
    /**
     * 通过医疗单的类型生成申请单号
     * @param EmsType
     * @return
    ...
    public abstract FMap getOrderSrvMMInfo(String[] idors) throws BizException ;
    ...
    public abstract String getClinicalzztz(String id_en) throws BizException;
     ...
     * @throws BizException
     */
    public abstract FBoolean isTimeUnit(String id_unit_med) throws BizException;
    /**
     * 计量单位的量纲类型是否为时间
     * @param id_unit_med
     * @return
     * @throws BizException
     */
    public abstract FBoolean unitOppdimenIsTime(String id_unit_med) throws BizException;
    /**
     * 检验报告节点获取id_srv
     * @param id_ent
     * @param type
     ...
     * @throws BizException
     */
    public abstract SrvCateDO[] GetId_srv(String id_ent,String type)throws BizException;
