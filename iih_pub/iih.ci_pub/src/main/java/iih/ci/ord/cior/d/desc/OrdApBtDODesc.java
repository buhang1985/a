...
public class OrdApBtDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_bloodtype_apADesc(tblDesc));
		this.add(getSd_bloodtype_apADesc(tblDesc));
		this.add(getId_rhd_apADesc(tblDesc));
		this.add(getSd_rhd_apADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_bloodtype_apCDesc(tblDesc));
		tblDesc.add(getSd_bloodtype_apCDesc(tblDesc));
		tblDesc.add(getId_rhd_apCDesc(tblDesc));
		tblDesc.add(getSd_rhd_apCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_bloodtype_apADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_bloodtype_ap",  getId_bloodtype_apCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("申请血型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_bloodtype_apADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_bloodtype_ap",  getSd_bloodtype_apCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getId_rhd_apADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_rhd_ap",  getId_rhd_apCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("申请Rh(D)");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_rhd_apADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_rhd_ap",  getSd_rhd_apCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getName_bloodtpADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("申请血型名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b10","id_bloodtype_ap=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_rhdADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("申请RH（D）名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b11","id_rhd_ap=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_bloodtype_apCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_bloodtype_ap");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("申请血型"); 
		return column;
	}
	/**
	 * 获取申请血型编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_bloodtype_apCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_bloodtype_ap");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_rhd_apCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_rhd_ap");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("申请Rh(D)"); 
		return column;
	}
	/**
	 * 获取申请Rh(D)编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_rhd_apCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_rhd_ap");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
