 ...
 * 检验报告单历史 DO 元数据信息
 */
public class CiRptLabHISDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.ord.cirptlabhis.d.CiRptLabHISDO";
	public static final String CLASS_DISPALYNAME = "检验报告单历史";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_RPT_LAB_HIS";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_rptlab_his";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_rptlab_hisADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_rptlab_hisCDesc(tblDesc));
	...
	private IAttrDesc getApplyformnoADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"LAB_ORDERNO_VIEW a0b4","no_applyform=id_orlab","no_applyform"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_rpttpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_su_lab=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getRpt_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b10","id_emp=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
