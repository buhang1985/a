...
* 检查打印申请单数据维护服务
*/
public interface ICiapprissheetMDORService {
	/**
	*  根据id值查找检查打印申请单数据
	*/	
	...
	*  根据condition条件查找检查打印申请单数据集合
	*/
	public abstract CiAppRisSheetDO[] find2(String whereStr,SqlParamDTO sqlParamDTO,String orderStr,FBoolean isLazy) throws BizException;
	...
	*/
	...
	public abstract PagingRtnData<CiAppRisSheetDO> findByPageInfo2(PaginationInfo pg, String whereStr, SqlParamDTO sqlParamDTO, String orderStr) throws BizException;
