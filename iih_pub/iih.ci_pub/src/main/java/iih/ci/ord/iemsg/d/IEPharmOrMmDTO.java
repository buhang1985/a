...
public class IEPharmOrMmDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getCy_ord_seq_no() {
		return ((String) getAttrVal("Cy_ord_seq_no"));
	}	
	/**
	 * 医嘱序号
	 * @param Cy_ord_seq_no
	 */
	public void setCy_ord_seq_no(String Cy_ord_seq_no) {
		setAttrVal("Cy_ord_seq_no", Cy_ord_seq_no);
	}
	/**
	 * 药品名称
	 * @return String
	 */
	public String getCy_yp_name() {
		return ((String) getAttrVal("Cy_yp_name"));
	}	
	/**
	 * 药品名称
	 * @param Cy_yp_name
	 */
	public void setCy_yp_name(String Cy_yp_name) {
		setAttrVal("Cy_yp_name", Cy_yp_name);
	}
}