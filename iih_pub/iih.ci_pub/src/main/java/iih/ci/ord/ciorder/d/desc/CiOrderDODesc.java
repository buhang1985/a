...
public class CiOrderDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_excep_level_pharmADesc(tblDesc));
		this.add(getSd_excep_level_pharmADesc(tblDesc));
		this.add(getDes_verify_sysADesc(tblDesc));
		this.add(getId_excep_level_sysADesc(tblDesc));
		...
		this.add(getCode_researchprojectADesc(tblDesc));
		this.add(getFg_hospital_herbpresADesc(tblDesc));
		this.add(getFg_deliveryroom_useADesc(tblDesc));
		this.add(getError_levelADesc(tblDesc));
		this.add(getError_desADesc(tblDesc));
		this.add(getEu_refusechecktpADesc(tblDesc));
		this.add(getFg_refusecheckADesc(tblDesc));
		this.add(getId_emp_refusecheckADesc(tblDesc));
		this.add(getDt_refusecheckADesc(tblDesc));
		this.add(getFg_pay_unitADesc(tblDesc));
		this.add(getId_dep_nur_orADesc(tblDesc));
		this.add(getFg_recheckADesc(tblDesc));
		this.add(getId_emp_recheckADesc(tblDesc));
		this.add(getDt_recheckADesc(tblDesc));
		this.add(getFg_spec_anti_approveADesc(tblDesc));
		this.add(getSd_spec_anti_approveADesc(tblDesc));
		this.add(getId_emp_second_chkADesc(tblDesc));
		this.add(getFg_prnADesc(tblDesc));
		this.add(getId_orsrcfunADesc(tblDesc));
		this.add(getSd_orsrcfunADesc(tblDesc));
		this.add(getFg_infect_dep_consADesc(tblDesc));
		this.add(getId_didefADesc(tblDesc));
		this.add(getName_didefADesc(tblDesc));
		this.add(getMore_money_reasonADesc(tblDesc));
		this.add(getId_messageADesc(tblDesc));
		this.add(getId_dripspeedADesc(tblDesc));
		this.add(getName_dripspeedADesc(tblDesc));
		...
		this.add(getId_or_srcADesc(tblDesc));
		...
		this.add(getName_researchprojectADesc(tblDesc));
		this.add(getPasswordADesc(tblDesc));
		this.add(getName_emp_second_chkADesc(tblDesc));
		this.add(getCode_didefADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_excep_level_pharmCDesc(tblDesc));
		tblDesc.add(getSd_excep_level_pharmCDesc(tblDesc));
		tblDesc.add(getDes_verify_sysCDesc(tblDesc));
		tblDesc.add(getId_excep_level_sysCDesc(tblDesc));
		...
		tblDesc.add(getCode_researchprojectCDesc(tblDesc));
		tblDesc.add(getFg_hospital_herbpresCDesc(tblDesc));
		tblDesc.add(getFg_deliveryroom_useCDesc(tblDesc));
		tblDesc.add(getError_levelCDesc(tblDesc));
		tblDesc.add(getError_desCDesc(tblDesc));
		tblDesc.add(getEu_refusechecktpCDesc(tblDesc));
		tblDesc.add(getFg_refusecheckCDesc(tblDesc));
		tblDesc.add(getId_emp_refusecheckCDesc(tblDesc));
		tblDesc.add(getDt_refusecheckCDesc(tblDesc));
		tblDesc.add(getFg_pay_unitCDesc(tblDesc));
		tblDesc.add(getId_dep_nur_orCDesc(tblDesc));
		tblDesc.add(getFg_recheckCDesc(tblDesc));
		tblDesc.add(getId_emp_recheckCDesc(tblDesc));
		tblDesc.add(getDt_recheckCDesc(tblDesc));
		tblDesc.add(getFg_spec_anti_approveCDesc(tblDesc));
		tblDesc.add(getSd_spec_anti_approveCDesc(tblDesc));
		tblDesc.add(getId_emp_second_chkCDesc(tblDesc));
		tblDesc.add(getFg_prnCDesc(tblDesc));
		tblDesc.add(getId_orsrcfunCDesc(tblDesc));
		tblDesc.add(getSd_orsrcfunCDesc(tblDesc));
		tblDesc.add(getFg_infect_dep_consCDesc(tblDesc));
		tblDesc.add(getId_didefCDesc(tblDesc));
		tblDesc.add(getName_didefCDesc(tblDesc));
		tblDesc.add(getMore_money_reasonCDesc(tblDesc));
		tblDesc.add(getId_messageCDesc(tblDesc));
		tblDesc.add(getId_dripspeedCDesc(tblDesc));
		tblDesc.add(getName_dripspeedCDesc(tblDesc));
		...
		tblDesc.add(getId_or_srcCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_excep_level_pharmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_excep_level_pharm",  getId_excep_level_pharmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getId_excep_level_sysADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_excep_level_sys",  getId_excep_level_sysCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_researchprojectADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_researchproject",  getCode_researchprojectCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("科研项目编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_hospital_herbpresADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_hospital_herbpres",  getFg_hospital_herbpresCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("草药院内制剂");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_deliveryroom_useADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_deliveryroom_use",  getFg_deliveryroom_useCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("产房使用");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getError_levelADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Error_level",  getError_levelCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("错误级别");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getError_desADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Error_des",  getError_desCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("错误信息描述");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getEu_refusechecktpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Eu_refusechecktp",  getEu_refusechecktpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("护士核对拒绝确认类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_refusecheckADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_refusecheck",  getFg_refusecheckCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("拒绝确认标志");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_emp_refusecheckADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_emp_refusecheck",  getId_emp_refusecheckCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("拒绝确认人");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDt_refusecheckADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_refusecheck",  getDt_refusecheckCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDateTime);
		attrDesc.setLabel("拒绝确认时间");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_dep_nur_orADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_dep_nur_or",  getId_dep_nur_orCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("开单病区");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_spec_anti_approveADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_spec_anti_approve",  getFg_spec_anti_approveCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否需要特殊级抗菌药审批");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_spec_anti_approveADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_spec_anti_approve",  getSd_spec_anti_approveCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("特殊级抗菌药审批结果");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_emp_second_chkADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_emp_second_chk",  getId_emp_second_chkCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("第二和对人主键");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_orsrcfunADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_orsrcfun",  getId_orsrcfunCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医嘱来源功能id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_orsrcfunADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_orsrcfun",  getSd_orsrcfunCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医嘱来源功能sd");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_infect_dep_consADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_infect_dep_cons",  getFg_infect_dep_consCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否感染科会诊");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_didefADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("诊断名称（考虑存在自定义诊断的情况，所以 ）");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getMore_money_reasonADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("More_money_reason",  getMore_money_reasonCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("超额原因");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_dripspeedADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_dripspeed",  getId_dripspeedCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_dripspeedADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_dripspeed",  getName_dripspeedCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("滴速名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_or_srcADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_or_src",  getId_or_srcCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("关联原发药医嘱ID");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getCode_dispADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_freq a0b10","id_freq=id_freq","code_disp"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_researchprojectADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_researchproject",  getName_researchprojectCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("科研项目名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_rsc_project a0b50","id_researchproject=id_researchproject","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getPasswordADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("科研项目密码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_rsc_project a0b50","id_researchproject=id_researchproject","password"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_emp_second_chkADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_emp_second_chk",  getName_emp_second_chkCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("姓名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b54","id_emp_second_chk=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_didefADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_didef",  getCode_didefCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_di_def a0b56","id_didef=id_didef","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_excep_level_pharmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_excep_level_pharm");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_excep_level_sysCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_excep_level_sys");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_researchprojectCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_researchproject");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("科研项目编码"); 
		return column;
	}
	/**
	 * 获取草药院内制剂表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_hospital_herbpresCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_hospital_herbpres");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("草药院内制剂"); 
		return column;
	}
	/**
	 * 获取产房使用表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_deliveryroom_useCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_deliveryroom_use");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("产房使用"); 
		return column;
	}
	/**
	 * 获取错误级别表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getError_levelCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Error_level");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("错误级别"); 
		return column;
	}
	/**
	 * 获取错误信息描述表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getError_desCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Error_des");
		column.setLength(2000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("错误信息描述"); 
		return column;
	}
	/**
	 * 获取护士核对拒绝确认类型表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getEu_refusechecktpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Eu_refusechecktp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("护士核对拒绝确认类型"); 
		return column;
	}
	/**
	 * 获取拒绝确认标志表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_refusecheckCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_refusecheck");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("拒绝确认标志"); 
		return column;
	}
	/**
	 * 获取拒绝确认人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_emp_refusecheckCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_emp_refusecheck");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("拒绝确认人"); 
		return column;
	}
	/**
	 * 获取拒绝确认时间表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDt_refusecheckCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_refusecheck");
		column.setLength(19);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("拒绝确认时间"); 
		return column;
	}
	/**
	 * 获取单位支付标志表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_dep_nur_orCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_dep_nur_or");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("开单病区"); 
		return column;
	}
	/**
	 * 获取复核标识表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_spec_anti_approveCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_spec_anti_approve");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否需要特殊级抗菌药审批"); 
		return column;
	}
	/**
	 * 获取特殊级抗菌药审批结果表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_spec_anti_approveCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_spec_anti_approve");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("特殊级抗菌药审批结果"); 
		return column;
	}
	/**
	 * 获取第二和对人主键表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_emp_second_chkCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_emp_second_chk");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("第二和对人主键"); 
		return column;
	}
	/**
	 * 获取打印到医嘱单表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_orsrcfunCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_orsrcfun");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医嘱来源功能id"); 
		return column;
	}
	/**
	 * 获取医嘱来源功能sd表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_orsrcfunCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_orsrcfun");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医嘱来源功能sd"); 
		return column;
	}
	/**
	 * 获取是否感染科会诊表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_infect_dep_consCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_infect_dep_cons");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否感染科会诊"); 
		return column;
	}
	/**
	 * 获取诊断定义中的主键表列元数据
	...
	private IColumnDesc getId_didefCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("诊断定义中的主键"); 
		return column;
	}
	/**
	 * 获取诊断名称（考虑存在自定义诊断的情况，所以 ）表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getName_didefCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("诊断名称（考虑存在自定义诊断的情况，所以 ）"); 
		return column;
	}
	/**
	 * 获取超额原因表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getMore_money_reasonCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"More_money_reason");
		column.setLength(1000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("超额原因"); 
		return column;
	}
	/**
	 * 获取提醒护士确认消息id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_dripspeedCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_dripspeed");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("滴速"); 
	 ...
	 * @return
	 */
	private IColumnDesc getName_dripspeedCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_dripspeed");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("滴速名称"); 
		return column;
	}
	/**
	 * 获取领药方式ID表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_or_srcCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_or_src");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("关联原发药医嘱ID"); 
		return column;
	}
	/**
	 * 获取患者姓名表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_researchprojectCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_researchproject");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("科研项目名称"); 
		return column;
	}
	/**
	 * 获取科研项目密码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_emp_second_chkCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_emp_second_chk");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("姓名"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_didefCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_didef");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_or_form",new xap.mw.coreitf.d.FBoolean("Y"));
		defaultValueMap.put("Fg_pres_outp",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_uncancelable",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Eu_hpindicjudge",0);
		defaultValueMap.put("Eu_uncporjudge",0);
		defaultValueMap.put("Fg_feertnable",new xap.mw.coreitf.d.FBoolean("Y"));
		defaultValueMap.put("Fg_quickwflow",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_vip",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_prepay",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_orhp",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Sd_totalopenmode","0");
		defaultValueMap.put("Ismulexec",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Ismuldose",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_research",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_hospital_herbpres",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_deliveryroom_use",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Error_level","A");
		defaultValueMap.put("Fg_refusecheck",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_pay_unit",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_spec_anti_approve",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_prn",new xap.mw.coreitf.d.FBoolean("Y"));
		defaultValueMap.put("Fg_wholepack",new xap.mw.coreitf.d.FBoolean("N"));
	}
