...
package iih.ci.ord.cirptobshis.d.desc;
 ...
 * 历史检查报告 DO 元数据信息
 */
public class CiRptObsHisDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.ord.cirptobshis.d.CiRptObsHisDO";
	public static final String CLASS_DISPALYNAME = "历史检查报告";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_RPT_OBS_HIS";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_rptobs_his";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_rptobs_hisADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_rptobs_hisADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_rptobs_hisCDesc(tblDesc));
		tblDesc.add(getId_rptobs_hisCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_rptobs_hisADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_rptobs_his",  getId_rptobs_hisCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("历史检查报告主键");
	...
	private IAttrDesc getApplyformnoADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"OBS_ORDERNO_VIEW a0b4","no_applyform=id_orobs","no_applyform"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_orADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"ci_order a0b7","id_or=id_or","name_or"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSu_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_su=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_rptobs_hisCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_rptobs_his");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("历史检查报告主键"); 
		return column;
	}
	/**
	 * 获取检验报告ID表列元数据
