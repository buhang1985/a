 ...
 * 
 */
public class CiConsActInviteDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//会诊实际应答人ID
	public static final String ID_CONSACRINVITE= "Id_consacrinvite";
	//会诊医嘱
	 ...
	 * @return String
	 */
	public String getId_consacrinvite() {
		return ((String) getAttrVal("Id_consacrinvite"));
	}	
	/**
	 * 会诊实际应答人ID
	 * @param Id_consacrinvite
	 */
	public void setId_consacrinvite(String Id_consacrinvite) {
		setAttrVal("Id_consacrinvite", Id_consacrinvite);
	}
	/**
	 * 会诊医嘱
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_consacrinvite";
	}
	
	@Override
	public String getTableName() {	  
		return "CI_CONS_ACT_INVITE";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiConsActInviteDODesc.class);
	}
