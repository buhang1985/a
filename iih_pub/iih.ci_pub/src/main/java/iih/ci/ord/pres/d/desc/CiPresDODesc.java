...
public class CiPresDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_weight_unitADesc(tblDesc));
		...
		this.add(getName_weight_unitADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_weight_unitCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_weight_unitADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_weight_unit",  getId_weight_unitCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("患者体重单位");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_weight_unitADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_weight_unit",  getName_weight_unitCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_measdoc a0b24","id_weight_unit=id_measdoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_weight_unitCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_weight_unit");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("患者体重单位"); 
		return column;
	}
	/**
	 * 获取院内制剂表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_weight_unitCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_weight_unit");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_blsettled",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Hecominsurinfo","N");
