...
public class OrConfirm extends BaseDTO {
	...
	public String getId_dep_wh() {
		return ((String) getAttrVal("getId_dep_wh"));
	}
	public void setId_dep_wh(String getId_dep_wh) {
		setAttrVal("getId_dep_wh", getId_dep_wh);
	}
	/**
	 * 执行科室名称
	 * @return String
	 ...
	 * @return Integer
	 */
	public Integer getOpst() {
		return ((Integer) getAttrVal("Opst"));
	}
	/**
	 * 操作状态
	 * @param Opst
	 */
	public void setOpst(Integer Opst) {
		setAttrVal("Opst", Opst);
	}
}