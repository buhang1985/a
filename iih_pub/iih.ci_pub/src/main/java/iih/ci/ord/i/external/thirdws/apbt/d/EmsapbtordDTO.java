 ...
 * 
 */
public class EmsapbtordDTO extends EmsCommonOrdDTO {
	...
	/**
	 * 检验信息
	 * @return List<EmsapbtviewitemDTO>
	 */
	public List<EmsapbtviewitemDTO> getCheckList() {
		return ((List<EmsapbtviewitemDTO>) getAttrVal("CheckList"));
	}
	/**
	 * 检验信息
	 * @param CheckList
	 */
	public void setCheckList(List<EmsapbtviewitemDTO> CheckList) {
		setAttrVal("CheckList", CheckList);
	}
	/**
	 * 费用信息
	 * @return List<EmsapbtsrvDTO>
	 */
	public List<EmsCommonSrvDTO> getSrvList() {
		return ((List<EmsCommonSrvDTO>) getAttrVal("SrvList"));
	}
	/**
	 * 费用信息
	 * @param SrvList
	 */
	public void setSrvList(List<EmsCommonSrvDTO> SrvList) {
		setAttrVal("SrvList", SrvList);
	}
	
	/**
	 * 血液成分
	 * @return List<EmsapbtBloodItemDTO>
	 */
	public List<EmsapbtBloodItemDTO> getBloodItemList() {
		return ((List<EmsapbtBloodItemDTO>) getAttrVal("BloodItemList"));
	}
	/**
	 * 血液成分
	 * @param BloodItemList
	 */
	public void setBloodItemList(List<EmsapbtBloodItemDTO> BloodItemList) {
		setAttrVal("BloodItemList", BloodItemList);
	}
}