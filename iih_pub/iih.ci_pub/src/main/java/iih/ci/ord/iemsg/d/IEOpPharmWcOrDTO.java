...
public class IEOpPharmWcOrDTO extends BaseDTO {
	...
	public Integer getOrderseqnum() {
		return ((Integer) getAttrVal("Orderseqnum"));
	}	
	/**
	 * 医嘱序号
	 * @param Orderseqnum
	...
	public void setOrderseqnum(Integer Orderseqnum) {
		setAttrVal("Orderseqnum", Orderseqnum);
	}
	/**
	 * 医嘱时间类型名称
	 * @return String
	...
	public String getYpname() {
		return ((String) getAttrVal("Ypname"));
	}	
	/**
	 * 药品名称
	 * @param Ypname
	 ...
	 * @return String
	 */
	public String getDurggid() {
		return ((String) getAttrVal("Durggid"));
	}	
	/**
	 * 药品组号
	 * @param Durggid
	 */
	public void setDurggid(String Durggid) {
		setAttrVal("Durggid", Durggid);
	}
}