...
public class CiAppRisSheetDODesc extends DODesc {
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_urgent",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_prn",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_hp",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_bb",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Fg_mp_bed",new xap.mw.coreitf.d.FBoolean("N"));
		...
		defaultValueMap.put("Fg_hpbirth",new xap.mw.coreitf.d.FBoolean("N"));
