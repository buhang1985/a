...
public class IENsOrDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getOrder_time_type() {
		return ((String) getAttrVal("Order_time_type"));
	}	
	/**
	 * 医嘱时间类型编码
	 * @param Order_time_type
	 */
	public void setOrder_time_type(String Order_time_type) {
		setAttrVal("Order_time_type", Order_time_type);
	}
	/**
	 * 医嘱时间类型名称
	 * @return String
	 */
	public String getOrder_time_type_name() {
		return ((String) getAttrVal("Order_time_type_name"));
	}	
	/**
	 * 医嘱时间类型名称
	 * @param Order_time_type_name
	 */
	public void setOrder_time_type_name(String Order_time_type_name) {
		setAttrVal("Order_time_type_name", Order_time_type_name);
	}
	/**
	 * 医嘱序号
	 * @return Integer
	 */
	public Integer getOrder_sort_no() {
		return ((Integer) getAttrVal("Order_sort_no"));
	}	
	/**
	 * 医嘱序号
	 * @param Order_sort_no
	 */
	public void setOrder_sort_no(Integer Order_sort_no) {
