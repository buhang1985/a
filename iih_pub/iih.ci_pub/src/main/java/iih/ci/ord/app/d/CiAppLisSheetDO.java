...
public class CiAppLisSheetDO extends BaseDO {
	...
	public CiAppLisSheetDO () {
		super();
		setFg_urgent(new xap.mw.coreitf.d.FBoolean("N"));
		setFg_prn(new xap.mw.coreitf.d.FBoolean("N"));
		setFg_hp_pres(new xap.mw.coreitf.d.FBoolean("N"));
		setFg_bb(new xap.mw.coreitf.d.FBoolean("N"));
		setHecominsurinfo("N");
		setFg_prepay(new xap.mw.coreitf.d.FBoolean("N"));
		setFg_vip(new xap.mw.coreitf.d.FBoolean("N"));
		setFg_lishp(new xap.mw.coreitf.d.FBoolean("N"));
		setFg_hpbirth(new xap.mw.coreitf.d.FBoolean("N"));
		setFg_blsettled(new xap.mw.coreitf.d.FBoolean("N"));
	}
