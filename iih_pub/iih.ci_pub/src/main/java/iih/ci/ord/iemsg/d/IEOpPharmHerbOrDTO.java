...
public class IEOpPharmHerbOrDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getTemporaryflagcode() {
		return ((String) getAttrVal("Temporaryflagcode"));
	}	
	/**
	 * 医嘱时间类型编码
	 * @param Temporaryflagcode
	 */
	public void setTemporaryflagcode(String Temporaryflagcode) {
		setAttrVal("Temporaryflagcode", Temporaryflagcode);
	}
	/**
	 * 医嘱时间类型名称
	 * @return String
	 */
	public String getTemporaryflagname() {
		return ((String) getAttrVal("Temporaryflagname"));
	}	
	/**
	 * 医嘱时间类型名称
	 * @param Temporaryflagname
	 */
	public void setTemporaryflagname(String Temporaryflagname) {
		setAttrVal("Temporaryflagname", Temporaryflagname);
	}
	/**
	 * 收费状态标识
	 * @return String
	 ...
	 * @return String
	 */
	public String getDruggid() {
		return ((String) getAttrVal("Druggid"));
	}	
	/**
	 * 药品组号
	 * @param Druggid
	 */
	public void setDruggid(String Druggid) {
		setAttrVal("Druggid", Druggid);
	}
	/**
	 * 用药方法编码
	 * @return String
	 */
	public String getMedicationmethodcode() {
		return ((String) getAttrVal("Medicationmethodcode"));
	}	
	/**
	 * 用药方法编码
	 * @param Medicationmethodcode
	 */
	public void setMedicationmethodcode(String Medicationmethodcode) {
		setAttrVal("Medicationmethodcode", Medicationmethodcode);
	}
	/**
	 * 用药方法名称
	 * @return String
	...
	public String getMedicationmethod() {
		return ((String) getAttrVal("Medicationmethod"));
	}	
	/**
	 * 用药方法名称
	 * @param Medicationmethod
	 */
	public void setMedicationmethod(String Medicationmethod) {
		setAttrVal("Medicationmethod", Medicationmethod);
	}
	/**
	 * 药物剂型编码
	 * @return String
	...
	public String getDrugformcode() {
		return ((String) getAttrVal("Drugformcode"));
	}	
	/**
	 * 药物剂型编码
	 * @param Drugformcode
	...
	public void setDrugformcode(String Drugformcode) {
		setAttrVal("Drugformcode", Drugformcode);
	}
	/**
	 * 药物剂型名称
	 * @return String
	...
	public String getDrugform() {
		return ((String) getAttrVal("Drugform"));
	}	
	/**
	 * 药物剂型名称
	 * @param Drugform
