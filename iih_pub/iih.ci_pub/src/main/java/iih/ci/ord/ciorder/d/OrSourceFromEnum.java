...
public interface OrSourceFromEnum {
    ...
    @DmEnumDesc(name="采集费",description="通过采集费关联")
    public static final String IIHORRELSAMPPRI="0D"; //采集费
    @DmEnumDesc(name="容器费",description="通过容器费关联")
    public static final String IIHORRELCONTP="0E"; //容器费
    @DmEnumDesc(name="预住院申请生成",description="通过预住院申请生成")
    public static final String IIHPREIPAPP="0F"; //预住院申请生成
}	
