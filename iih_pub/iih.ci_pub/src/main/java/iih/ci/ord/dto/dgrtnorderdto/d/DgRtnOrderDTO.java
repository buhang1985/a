package iih.ci.ord.dto.dgrtnorderdto.d;
 ...
 * 
 */
public class DgRtnOrderDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getRtn_des() {
		return ((String) getAttrVal("Rtn_des"));
	}
	/**
	 * 退药原因
	 * @param Rtn_des
	 */
	public void setRtn_des(String Rtn_des) {
		setAttrVal("Rtn_des", Rtn_des);
	}
}