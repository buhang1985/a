...
public class CiRuleEntityDesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getFg_use_er3ADesc(tblDesc));
		...
		this.add(getProps_defADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getFg_use_er3CDesc(tblDesc));
		...
		tblDesc.add(getProps_defCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_use_er3ADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_use_er3",  getFg_use_er3CDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
	 ...
	 * @return
	 */
	private IAttrDesc getProps_defADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Props_def",  getProps_defCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("属性定义");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_use_er3CDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_use_er3");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getProps_defCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Props_def");
		column.setLength(0);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("属性定义"); 
		return column;
	}
	/**
	 * 获取集团编码表列元数据
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_sys",new xap.mw.coreitf.d.FBoolean("N"));
	}
