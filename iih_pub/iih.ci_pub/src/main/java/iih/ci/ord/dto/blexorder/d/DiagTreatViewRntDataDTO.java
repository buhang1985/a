...
public class DiagTreatViewRntDataDTO extends BaseDTO {
	 ...
	 * @return FArrayList2
	 */
	public FArrayList2 getClinicalevents() {
		return ((FArrayList2) getAttrVal("Clinicalevents"));
	}
	/**
	 * 临床事件数据
	 * @param Clinicalevents
	 */
	public void setClinicalevents(FArrayList2 Clinicalevents) {
		setAttrVal("Clinicalevents", Clinicalevents);
	}
	/**
	 * 护理文书数据
	 * @return FArrayList2
	 */
	public FArrayList2 getNmrdata() {
		return ((FArrayList2) getAttrVal("Nmrdata"));
	}
	/**
	 * 护理文书数据
	 * @param Nmrdata
	 */
	public void setNmrdata(FArrayList2 Nmrdata) {
		setAttrVal("Nmrdata", Nmrdata);
	}
	/**
	 * 待书写病历
	 * @return FArrayList2
	 */
	public FArrayList2 getMrtasks() {
		return ((FArrayList2) getAttrVal("Mrtasks"));
	}
	/**
	 * 待书写病历
	 * @param Mrtasks
	 */
	public void setMrtasks(FArrayList2 Mrtasks) {
		setAttrVal("Mrtasks", Mrtasks);
	}
}