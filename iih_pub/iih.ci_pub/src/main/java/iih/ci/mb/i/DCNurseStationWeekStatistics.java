...
public class DCNurseStationWeekStatistics
{
    @JsonProperty(value = "WeekDateString")
    private ArrayOfString WeekDateString;
    @JsonProperty(value = "PatientInHos")
    private ArrayOfInt PatientInHos;
    @JsonProperty(value = "PatientEnterHos")
    private ArrayOfInt PatientEnterHos;
    @JsonProperty(value = "PatientExitHos")
    private ArrayOfInt PatientExitHos;
    @JsonProperty(value = "PatientTransfer")
    private ArrayOfInt PatientTransfer;
    @JsonProperty(value = "DoctorOrderSend")
    private ArrayOfInt DoctorOrderSend;
    ...
    public void setWeekDateString(ArrayOfString WeekDateString)
    {
        this.WeekDateString = WeekDateString;
    }
    public ArrayOfString getWeekDateString()
    {
        return this.WeekDateString;
    }
    public void setPatientInHos(ArrayOfInt PatientInHos)
    {
        this.PatientInHos = PatientInHos;
    }
    public ArrayOfInt getPatientInHos()
    {
        return this.PatientInHos;
    }
    public void setPatientEnterHos(ArrayOfInt PatientEnterHos)
    {
        this.PatientEnterHos = PatientEnterHos;
    }
    public ArrayOfInt getPatientEnterHos()
    {
        return this.PatientEnterHos;
    }
    public void setPatientExitHos(ArrayOfInt PatientExitHos)
    {
        this.PatientExitHos = PatientExitHos;
    }
    public ArrayOfInt getPatientExitHos()
    {
        return this.PatientExitHos;
    }
    public void setPatientTransfer(ArrayOfInt PatientTransfer)
    {
        this.PatientTransfer = PatientTransfer;
    }
    public ArrayOfInt getPatientTransfer()
    {
        return this.PatientTransfer;
    }
    public void setDoctorOrderSend(ArrayOfInt DoctorOrderSend)
    {
        this.DoctorOrderSend = DoctorOrderSend;
    }
    public ArrayOfInt getDoctorOrderSend()
    {
        return this.DoctorOrderSend;
    }
