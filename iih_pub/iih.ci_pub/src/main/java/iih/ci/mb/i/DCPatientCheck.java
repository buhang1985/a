...
public class DCPatientCheck
{
    ...
    @JsonProperty(value = "PacsInfo")
    private DCPacsInfo PacsInfo;
    ...
    @JsonProperty(value = "AccessNowUrl")
    private String AccessNowUrl;
    ...
    public void setPacsInfo(DCPacsInfo PacsInfo)
    {
        this.PacsInfo = PacsInfo;
    }
    public DCPacsInfo getPacsInfo()
    {
    ...
    public void setAccessNowUrl(String AccessNowUrl)
    {
        this.AccessNowUrl = AccessNowUrl;
    }
    public String getAccessNowUrl()
    {
        return this.AccessNowUrl;
    }
