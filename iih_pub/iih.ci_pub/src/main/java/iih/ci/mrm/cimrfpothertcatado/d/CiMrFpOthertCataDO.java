package iih.ci.mrm.cimrfpothertcatado.d;
 ...
 * 
 */
public class CiMrFpOthertCataDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "CI_MR_FP_OTHERT_CATA";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiMrFpOthertCataDODesc.class);
	}
