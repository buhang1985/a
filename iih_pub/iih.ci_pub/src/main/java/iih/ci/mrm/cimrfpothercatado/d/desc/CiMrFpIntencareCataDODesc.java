 ...
 * 病案编目重症监护 DO 元数据信息
 */
public class CiMrFpIntencareCataDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mrm.cimrfpothercatado.d.CiMrFpIntencareCataDO";
	public static final String CLASS_DISPALYNAME = "病案编目重症监护";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_MR_FP_INTENCARE_CATA";
	 ...
	 * 无参构造函数
	 */
	public CiMrFpIntencareCataDODesc(){
		init();
	}
