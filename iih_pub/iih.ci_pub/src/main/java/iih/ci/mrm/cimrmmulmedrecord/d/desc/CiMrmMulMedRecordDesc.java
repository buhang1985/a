...
package iih.ci.mrm.cimrmmulmedrecord.d.desc;
 ...
 * 多媒体文件记录分类 DO 元数据信息
 */
public class CiMrmMulMedRecordDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mrm.cimrmmulmedrecord.d.CiMrmMulMedRecord";
	public static final String CLASS_DISPALYNAME = "多媒体文件记录分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "Ci_Mr_mmRecord";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mmrecord";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mmrecordADesc(tblDesc));
		...
		this.add(getId_editstatusADesc(tblDesc));
		this.add(getName_editstatusADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mmrecordCDesc(tblDesc));
		...
		tblDesc.add(getId_editstatusCDesc(tblDesc));
		tblDesc.add(getName_editstatusCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_editstatusADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_editstatus",  getId_editstatusCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编辑状态");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_editstatusADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_editstatus",  getName_editstatusCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编辑状态name");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getGroup_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_grp a0b4","id_group=id_grp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getGroup_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_grp a0b4","id_group=id_grp","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_editstatusCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_editstatus");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编辑状态"); 
		return column;
	}
	/**
	 * 获取编辑状态name表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_editstatusCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_editstatus");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编辑状态name"); 
		return column;
	}
	/**
	 * 获取五笔表列元数据
