package iih.ci.mrm.cimrfpblcatado.d;
 ...
 * 
 */
public class CiMrFpBlCataDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "CI_MR_FP_BL_CATA";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiMrFpBlCataDODesc.class);
	}
