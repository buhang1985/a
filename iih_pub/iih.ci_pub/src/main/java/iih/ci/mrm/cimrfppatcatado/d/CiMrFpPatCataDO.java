...
public class CiMrFpPatCataDO extends BaseDO {
	...
	//行政区划编码
	public static final String ADDR_BORN_CODE= "Addr_born_code";
	//行政区划名称
	public static final String ADDR_BORN_NAME= "Addr_born_name";
	//行政区划编码
	 ...
	 * @return String
	 */
	public String getAddr_born_code() {
		return ((String) getAttrVal("Addr_born_code"));
	}	
	/**
	 * 行政区划编码
	 * @param Addr_born_code
	 */
	public void setAddr_born_code(String Addr_born_code) {
		setAttrVal("Addr_born_code", Addr_born_code);
	}
	/**
	 * 行政区划名称
	 * @return String
	 */
	public String getAddr_born_name() {
		return ((String) getAttrVal("Addr_born_name"));
	}	
	/**
	 * 行政区划名称
	 * @param Addr_born_name
	 */
	public void setAddr_born_name(String Addr_born_name) {
		setAttrVal("Addr_born_name", Addr_born_name);
	}
	/**
	 * 行政区划编码
	 * @return String
