...
public interface IOther2mrfpCudService {
	...
	*/
	 ...
	 *  根据主DO对病案首页其他信息数据真删除
	 */
	public abstract void deleteByParentDO(CiMrFpOtherDO[] mainDos) throws BizException;
	
	/**
	 *  根据主DO对病案首页其他信息数据逻辑删除
	 */
	public abstract void logicDeleteByParentDO(CiMrFpOtherDO[] mainDos) throws BizException;
}
