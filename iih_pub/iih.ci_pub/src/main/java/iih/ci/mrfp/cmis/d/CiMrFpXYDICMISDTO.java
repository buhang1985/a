 ...
 * 
 */
public class CiMrFpXYDICMISDTO extends BaseDTO {
	 ...
	 * @return Boolean
	 */
	public Boolean getFg_maindi() {
		return ((Boolean) getAttrVal("Fg_maindi"));
	}
	/**
	 * 主诊断
	 * @param Fg_maindi
	 */
	public void setFg_maindi(Boolean Fg_maindi) {
