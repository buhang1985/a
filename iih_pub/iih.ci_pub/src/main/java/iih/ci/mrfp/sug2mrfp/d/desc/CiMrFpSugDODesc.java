...
public class CiMrFpSugDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_exec_anes_clfADesc(tblDesc));
		this.add(getSd_exec_anes_clfADesc(tblDesc));
		this.add(getName_exec_anes_clfADesc(tblDesc));
		this.add(getMain_sug_timesADesc(tblDesc));
		this.add(getOther_sug_timesADesc(tblDesc));
		this.add(getFg_main_sugADesc(tblDesc));
		...
		this.add(getExec_anes_clf_codeADesc(tblDesc));
		this.add(getExec_anes_clf_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_exec_anes_clfCDesc(tblDesc));
		tblDesc.add(getSd_exec_anes_clfCDesc(tblDesc));
		tblDesc.add(getName_exec_anes_clfCDesc(tblDesc));
		tblDesc.add(getMain_sug_timesCDesc(tblDesc));
		tblDesc.add(getOther_sug_timesCDesc(tblDesc));
		tblDesc.add(getFg_main_sugCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_exec_anes_clfADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_exec_anes_clf",  getId_exec_anes_clfCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("麻醉分级id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_exec_anes_clfADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_exec_anes_clf",  getSd_exec_anes_clfCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("麻醉分级code");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_exec_anes_clfADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_exec_anes_clf",  getName_exec_anes_clfCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("麻醉分级name");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getMain_sug_timesADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Main_sug_times",  getMain_sug_timesCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("主要手术持续时间");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getOther_sug_timesADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Other_sug_times",  getOther_sug_timesCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("其他手术持续时间");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_main_sugADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_main_sug",  getFg_main_sugCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("主要手术标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getExec_anes_clf_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Exec_anes_clf_code",  getExec_anes_clf_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b34","id_exec_anes_clf=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getExec_anes_clf_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Exec_anes_clf_name",  getExec_anes_clf_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b34","id_exec_anes_clf=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_exec_anes_clfCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_exec_anes_clf");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("麻醉分级id"); 
		return column;
	}
	/**
	 * 获取麻醉分级code表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_exec_anes_clfCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_exec_anes_clf");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("麻醉分级code"); 
		return column;
	}
	/**
	 * 获取麻醉分级name表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_exec_anes_clfCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_exec_anes_clf");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("麻醉分级name"); 
		return column;
	}
	/**
	 * 获取主要手术持续时间表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getMain_sug_timesCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Main_sug_times");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("主要手术持续时间"); 
		return column;
	}
	/**
	 * 获取其他手术持续时间表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getOther_sug_timesCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Other_sug_times");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("其他手术持续时间"); 
		return column;
	}
	/**
	 * 获取主要手术标识表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_main_sugCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_main_sug");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("主要手术标识"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getExec_anes_clf_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Exec_anes_clf_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getExec_anes_clf_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Exec_anes_clf_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
