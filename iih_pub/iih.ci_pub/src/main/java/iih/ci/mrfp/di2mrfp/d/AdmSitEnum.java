...
public interface AdmSitEnum {
    ...
    public static final String YOU="1"; //有
    @DmEnumDesc(name="临床未确定",description="临床未确定")
    public static final String LINCHUANGWEIQUEDING="2"; //临床未确定
    @DmEnumDesc(name="情况不明",description="情况不明")
    public static final String QINGKUANGBUMING="3"; //情况不明
    @DmEnumDesc(name="无",description="无")
    public static final String WU="4"; //无
}	
