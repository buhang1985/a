...
public interface IDi2mrfpCudService {
	...
	*/
	...
	/**
	 *  根据主DO对住院病案首页_诊断数据真删除
	 */
	public abstract void deleteByParentDO(CiMrfpDiDO[] mainDos) throws BizException;
	
	/**
	 *  根据主DO对住院病案首页_诊断数据逻辑删除
	 */
	public abstract void logicDeleteByParentDO(CiMrfpDiDO[] mainDos) throws BizException;
}
