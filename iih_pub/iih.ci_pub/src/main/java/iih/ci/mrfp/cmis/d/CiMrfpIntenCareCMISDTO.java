 ...
 * 
 */
public class CiMrfpIntenCareCMISDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getTime_in_intencare() {
		return ((String) getAttrVal("Time_in_intencare"));
	}
	/**
	 * 进重症监护室时间（年月日时分）
	 * @param Time_in_intencare
	 */
	public void setTime_in_intencare(String Time_in_intencare) {
	 ...
	 * @return String
	 */
	public String getTime_out_intencare() {
		return ((String) getAttrVal("Time_out_intencare"));
	}
	/**
	 * 出重症监护室时间（年月日时分）
	 * @param Time_out_intencare
	 */
	public void setTime_out_intencare(String Time_out_intencare) {
