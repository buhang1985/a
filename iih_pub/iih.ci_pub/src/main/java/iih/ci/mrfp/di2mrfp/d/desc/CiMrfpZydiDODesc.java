...
public class CiMrfpZydiDODesc extends DODesc {
	...
	private IAttrDesc getName_hpdiADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_HP_DI_ORGINAL a2b6","id_hpdi=id_hpdiorginal","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_hpdiADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_HP_DI_ORGINAL a2b6","id_hpdi=id_hpdiorginal","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
