...
public class CiMrFpPatDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_doct_opADesc(tblDesc));
		this.add(getName_doct_opADesc(tblDesc));
		this.add(getId_cm_symptomADesc(tblDesc));
		this.add(getCode_cm_symptomADesc(tblDesc));
		this.add(getName_cm_symptomADesc(tblDesc));
		...
		this.add(getAddr_cencus_codeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_doct_opCDesc(tblDesc));
		tblDesc.add(getName_doct_opCDesc(tblDesc));
		tblDesc.add(getId_cm_symptomCDesc(tblDesc));
		tblDesc.add(getCode_cm_symptomCDesc(tblDesc));
		tblDesc.add(getName_cm_symptomCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_doct_opADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_doct_op",  getId_doct_opCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("门急诊医师ID");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_doct_opADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_doct_op",  getName_doct_opCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("门急诊医师");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_cm_symptomADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_cm_symptom",  getId_cm_symptomCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("门（急）诊诊断-中医证候id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	/**
	 * 门（急）诊诊断-中医证候code属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getCode_cm_symptomADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_cm_symptom",  getCode_cm_symptomCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("门（急）诊诊断-中医证候code");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	/**
	 * 门（急）诊诊断-中医证候name属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getName_cm_symptomADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_cm_symptom",  getName_cm_symptomCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("门（急）诊诊断-中医证候name");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getAddr_origin_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b23","id_addr_origin=id_adminarea","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAddr_origin_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b23","id_addr_origin=id_adminarea","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAddr_now_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b24","id_addr_now=id_adminarea","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAddr_now_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b24","id_addr_now=id_adminarea","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getAddr_cencus_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Addr_cencus_code",  getAddr_cencus_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("行政区划编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b25","id_addr_cencus=id_adminarea","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAddr_cencus_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b25","id_addr_cencus=id_adminarea","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getWorkunit_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b26","id_workunit=id_adminarea","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getWorkunit_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b26","id_workunit=id_adminarea","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAddr_work_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b27","id_addr_work=id_adminarea","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAddr_work_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b27","id_addr_work=id_adminarea","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAddr_cont_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b28","id_addr_cont=id_adminarea","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAddr_cont_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_adminarea a0b28","id_addr_cont=id_adminarea","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCurecategory_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b15","id_curecategory=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCurecategory_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b15","id_curecategory=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getOutp_cm_di_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_di_def a0b16","id_outp_cm_di=id_didef","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getOutp_cm_di_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_di_def a0b16","id_outp_cm_di=id_didef","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getOrg_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_org a0b18","id_org=id_org","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getOrg_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_org a0b18","id_org=id_org","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_doct_opCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_doct_op");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("门急诊医师ID"); 
		return column;
	}
	/**
	 * 获取门急诊医师表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_doct_opCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_doct_op");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("门急诊医师"); 
		return column;
	}
	/**
	 * 获取门（急）诊诊断-中医证候id表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_cm_symptomCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_cm_symptom");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("门（急）诊诊断-中医证候id"); 
		return column;
	}
	/**
	 * 获取门（急）诊诊断-中医证候code表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getCode_cm_symptomCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_cm_symptom");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("门（急）诊诊断-中医证候code"); 
		return column;
	}
	/**
	 * 获取门（急）诊诊断-中医证候name表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getName_cm_symptomCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_cm_symptom");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("门（急）诊诊断-中医证候name"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAddr_cencus_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Addr_cencus_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("行政区划编码"); 
		return column;
