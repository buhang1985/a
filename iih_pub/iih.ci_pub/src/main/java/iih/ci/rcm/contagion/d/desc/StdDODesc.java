...
public class StdDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_monitor_stdADesc(tblDesc));
		this.add(getSd_monitor_stdADesc(tblDesc));
		this.add(getName_monitor_stdADesc(tblDesc));
		...
		this.add(getCode_monADesc(tblDesc));
		this.add(getName_monADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_monitor_stdCDesc(tblDesc));
		tblDesc.add(getSd_monitor_stdCDesc(tblDesc));
		tblDesc.add(getName_monitor_stdCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_monitor_stdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_monitor_std",  getId_monitor_stdCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("监测性病");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_monitor_stdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_monitor_std",  getSd_monitor_stdCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("监测性病编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_monitor_stdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_monitor_std",  getName_monitor_stdCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("监测性病名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_monADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_mon",  getCode_monCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a1b10","id_monitor_std=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_monADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_mon",  getName_monCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a1b10","id_monitor_std=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_monitor_stdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_monitor_std");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("监测性病"); 
		return column;
	}
	/**
	 * 获取监测性病编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_monitor_stdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_monitor_std");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("监测性病编码"); 
		return column;
	}
	/**
	 * 获取监测性病名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_monitor_stdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_monitor_std");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("监测性病名称"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getCode_monCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_mon");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_monCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_mon");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
