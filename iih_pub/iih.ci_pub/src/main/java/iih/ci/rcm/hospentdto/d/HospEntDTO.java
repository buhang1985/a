...
public class HospEntDTO extends BaseDTO {
	...
	public String getStages_code() {
		return ((String) getAttrVal("Stages_code"));
	}
	/**
	 * 状态编码
	 * @param Stages_code
	...
	public void setStages_code(String Stages_code) {
		setAttrVal("Stages_code", Stages_code);
	}
	/**
	 * 删除原因
	 * @return String
	 ...
	 * @return String
	 */
	public String getFirstgeneration_time() {
		return ((String) getAttrVal("Firstgeneration_time"));
	}
	/**
	 * 首次生成时间
	 * @param Firstgeneration_time
	 */
	public void setFirstgeneration_time(String Firstgeneration_time) {
		setAttrVal("Firstgeneration_time", Firstgeneration_time);
	}
}