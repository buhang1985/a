...
public class AidsDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getSd_domicile_placeADesc(tblDesc));
		this.add(getName_domicile_placeADesc(tblDesc));
		this.add(getDt_aids_confirmdateADesc(tblDesc));
		this.add(getReport_unitADesc(tblDesc));
		this.add(getUnit_phonenumberADesc(tblDesc));
		...
		this.add(getDomicile_place_codeADesc(tblDesc));
		this.add(getDomicile_place_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getSd_domicile_placeCDesc(tblDesc));
		tblDesc.add(getName_domicile_placeCDesc(tblDesc));
		tblDesc.add(getDt_aids_confirmdateCDesc(tblDesc));
		tblDesc.add(getReport_unitCDesc(tblDesc));
		tblDesc.add(getUnit_phonenumberCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getSd_domicile_placeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_domicile_place",  getSd_domicile_placeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("户籍所在地编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_domicile_placeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_domicile_place",  getName_domicile_placeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("户籍所在地名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDt_aids_confirmdateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_aids_confirmdate",  getDt_aids_confirmdateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDate);
		attrDesc.setLabel("艾滋病确诊日期");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getUnit_phonenumberADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Unit_phonenumber",  getUnit_phonenumberCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getAreacodeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a5b8","hjdz=id_mr_area","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAreafullnameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a5b8","hjdz=id_mr_area","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getDomicile_place_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Domicile_place_code",  getDomicile_place_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a5b13","domicile_place=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getDomicile_place_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Domicile_place_name",  getDomicile_place_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a5b13","domicile_place=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getSd_domicile_placeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_domicile_place");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("户籍所在地编码"); 
		return column;
	}
	/**
	 * 获取户籍所在地名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_domicile_placeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_domicile_place");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("户籍所在地名称"); 
		return column;
	}
	/**
	 * 获取艾滋病确诊日期表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDt_aids_confirmdateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_aids_confirmdate");
		column.setLength(10);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("艾滋病确诊日期"); 
		return column;
	}
	/**
	 * 获取报告单位表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getUnit_phonenumberCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Unit_phonenumber");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getDomicile_place_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Domicile_place_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getDomicile_place_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Domicile_place_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
