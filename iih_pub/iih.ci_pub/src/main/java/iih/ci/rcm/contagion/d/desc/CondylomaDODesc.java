...
public class CondylomaDODesc extends DODesc {
	...
	private IAttrDesc getAreacodeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a6b11","id_hjdz=id_mr_area","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAreanameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a6b11","id_hjdz=id_mr_area","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
