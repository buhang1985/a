...
public class RevisionNoticeDO extends BaseDO {
	...
	public static final String DES_FEEDBACK= "Des_feedback";
	public static final String ID_QA_RECORD= "Id_qa_record";
	...
	public String getDes_feedback() {
		return ((String) getAttrVal("Des_feedback"));
	}	
	public void setDes_feedback(String Des_feedback) {
		setAttrVal("Des_feedback", Des_feedback);
	}
