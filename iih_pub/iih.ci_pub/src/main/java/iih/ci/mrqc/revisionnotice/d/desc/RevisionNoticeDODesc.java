...
public class RevisionNoticeDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getDes_feedbackADesc(tblDesc));
		this.add(getId_qa_recordADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getDes_feedbackCDesc(tblDesc));
		tblDesc.add(getId_qa_recordCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getDes_feedbackADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Des_feedback",  getDes_feedbackCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("反馈备注");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_qa_recordADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_qa_record",  getId_qa_recordCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("质控记录主键");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getDes_feedbackCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Des_feedback");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("反馈备注"); 
		return column;
	}
	/**
	 * 获取质控记录主键表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_qa_recordCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_qa_record");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("质控记录主键"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
