...
public interface ICiMrRecallResultService {
	 ...
	 PagingRtnData<CiMrRecallResultDTO> getIpMrRecallResultsApprove(QryRootNodeDTO qryRootNodeDTO, PaginationInfo paginationInfo) throws BizException;

	 PagingRtnData<CiMrRecallResultDTO> getIpMrRecallResults4MySelf(QryRootNodeDTO qryRootNodeDTO, PaginationInfo paginationInfo) throws BizException;
}
