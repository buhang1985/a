...
public class QaPatListDTO extends BaseDTO {
	 ...
	 * @return FDouble
	 */
	public FDouble getScore_dept() {
		return ((FDouble) getAttrVal("Score_dept"));
	}
	/**
	 * 科室评分
	 * @param Score_dept
	 */
	public void setScore_dept(FDouble Score_dept) {
		setAttrVal("Score_dept", Score_dept);
	}
	/**
	 * 终末评分
	 * @return FDouble
	 */
	public FDouble getScore_terminal() {
		return ((FDouble) getAttrVal("Score_terminal"));
	}
	/**
	 * 终末评分
	 * @param Score_terminal
	 */
	public void setScore_terminal(FDouble Score_terminal) {
	 ...
	 * @return String
	 */
	public String getId_emp_zydoc() {
		return ((String) getAttrVal("Id_emp_zydoc"));
	}
	/**
	 * 住院医生
	 * @param Id_emp_zydoc
	 */
	public void setId_emp_zydoc(String Id_emp_zydoc) {
		setAttrVal("Id_emp_zydoc", Id_emp_zydoc);
	}
	/**
	 * 主治医师
	 * @return String
	 */
	public String getId_emp_zzdoc() {
		return ((String) getAttrVal("Id_emp_zzdoc"));
	}
	/**
	 * 主治医师
	 * @param Id_emp_zzdoc
	 */
	public void setId_emp_zzdoc(String Id_emp_zzdoc) {
		setAttrVal("Id_emp_zzdoc", Id_emp_zzdoc);
	}
	/**
	 * 副主任/主任医师
	 * @return String
	 */
	public String getId_emp_zrdoc() {
		return ((String) getAttrVal("Id_emp_zrdoc"));
	}
	/**
	 * 副主任/主任医师
	 * @param Id_emp_zrdoc
	 */
	public void setId_emp_zrdoc(String Id_emp_zrdoc) {
		setAttrVal("Id_emp_zrdoc", Id_emp_zrdoc);
	}
	/**
	 * 内涵质控标记
	 * @return FBoolean
	 */
	public FBoolean getFg_connonation() {
		return ((FBoolean) getAttrVal("Fg_connonation"));
	}
	/**
	 * 内涵质控标记
	 * @param Fg_connonation
	 */
	public void setFg_connonation(FBoolean Fg_connonation) {
		setAttrVal("Fg_connonation", Fg_connonation);
	}
	/**
	 * 入院病区id
	 * @return String
	 ...
	 * @return String
	 */
	public String getId_diag_outhos() {
		return ((String) getAttrVal("Id_diag_outhos"));
	}
	/**
	 * 出院诊断id
	 * @param Id_diag_outhos
	 */
	public void setId_diag_outhos(String Id_diag_outhos) {
		setAttrVal("Id_diag_outhos", Id_diag_outhos);
	}
	/**
	 * 出院诊断编码
	 * @return String
	 */
	public String getSd_diag_outhos() {
		return ((String) getAttrVal("Sd_diag_outhos"));
	}
	/**
	 * 出院诊断编码
	 * @param Sd_diag_outhos
	 */
	public void setSd_diag_outhos(String Sd_diag_outhos) {
		setAttrVal("Sd_diag_outhos", Sd_diag_outhos);
	}
	/**
	 * 出院诊断
	 * @return String
	 */
	public String getName_diag_outhos() {
		return ((String) getAttrVal("Name_diag_outhos"));
	}
	/**
	 * 出院诊断
	 * @param Name_diag_outhos
	 */
	public void setName_diag_outhos(String Name_diag_outhos) {
		setAttrVal("Name_diag_outhos", Name_diag_outhos);
	}
	/**
	 * 出院未归档天数
	 * @return Integer
	 */
	public Integer getDays_outhos_pig() {
		return ((Integer) getAttrVal("Days_outhos_pig"));
	}
	/**
	 * 出院未归档天数
	 * @param Days_outhos_pig
	 */
	public void setDays_outhos_pig(Integer Days_outhos_pig) {
		setAttrVal("Days_outhos_pig", Days_outhos_pig);
	}
	/**
	 * 环节评分
	 * @return FDouble
	 */
	public FDouble getScore_process() {
		return ((FDouble) getAttrVal("Score_process"));
	}
	/**
	 * 环节评分
	 * @param Score_process
	 */
	public void setScore_process(FDouble Score_process) {
		setAttrVal("Score_process", Score_process);
	}
	/**
	 * 患者编码
	 * @return String
	 ...
	 * @return String
	 */
	public String getReason_amr_callback() {
		return ((String) getAttrVal("Reason_amr_callback"));
	}
	/**
	 * 病案驳回原因
	 * @param Reason_amr_callback
	 */
	public void setReason_amr_callback(String Reason_amr_callback) {
		setAttrVal("Reason_amr_callback", Reason_amr_callback);
	}
	/**
	 * 病历质量等级
	 * @return String
	...
	public String getLevelnew() {
		return ((String) getAttrVal("Levelnew"));
	}
	/**
	 * 病历质量等级
	 * @param Levelnew
	...
	public void setLevelnew(String Levelnew) {
		setAttrVal("Levelnew", Levelnew);
	}
	/**
	 * 可质控病历份数
	 * @return Integer
	 */
	public Integer getQc_copies() {
		return ((Integer) getAttrVal("Qc_copies"));
	}
	/**
	 * 可质控病历份数
	 * @param Qc_copies
	 */
	public void setQc_copies(Integer Qc_copies) {
		setAttrVal("Qc_copies", Qc_copies);
	}
}