...
public interface IQcServiceExt {
	...
	*  获取门诊质控缺陷DTO 
	*/
    public abstract  QaFltDTO[] getOutQcfltDtos( String id_ent, String cqf_submit_user ) throws BizException;
//    /**
//	*  获取质控缺陷DTO
//	*/
//    public abstract  QaFltDTO[] getTraceQcfltDtos( String id_revision ) throws BizException;
   ...
   */
	...
	*/
    public abstract  QaFltDTO[] getMrQcfltDto(String id_revision,String id_flt_sta) throws BizException;
    
    /**
   	*  获取诊断DTO
   	*/
    public abstract  Cidiagdto[] getCidiagdto( String id_ent, String[] sd_disys ) throws BizException;
       /**
	   	*  根据患者id_ent查询所有待整改通知
	   	*/
	...
	*  再整改根据通知获取待整改的缺陷DTO
	*/
    public abstract  QaFltDTO[] getNeedToDoQcfltDtoAgainByRevision( String id_revision) throws BizException;
    ...
    public abstract  QaFltDTO[] getQcfltAndAutoFltDtos( String id_ent,String sd_qctype) throws BizException;
}
