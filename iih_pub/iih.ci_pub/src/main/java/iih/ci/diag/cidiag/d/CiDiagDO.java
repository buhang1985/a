...
public class CiDiagDO extends BaseDO {
	...
	public static final String ID_EMP_CANCEL= "Id_emp_cancel";
	...
	public String getId_emp_cancel() {
		return ((String) getAttrVal("Id_emp_cancel"));
	}	
	public void setId_emp_cancel(String Id_emp_cancel) {
		setAttrVal("Id_emp_cancel", Id_emp_cancel);
	}
