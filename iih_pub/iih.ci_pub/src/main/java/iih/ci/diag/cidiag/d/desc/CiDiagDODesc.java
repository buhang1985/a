...
public class CiDiagDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_emp_cancelADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_emp_cancelCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_emp_cancelADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_emp_cancel",  getId_emp_cancelCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getId_emp_cancelCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_emp_cancel");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
