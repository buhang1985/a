...
public class EMSSupplierRefModel extends RefGridModel{
	...
	private String BuildWherePart() {
		...
		stringBuilder.append(" and (fg_ems = 'Y') and ds = 0 and fg_active = 'Y' ");
		...
		String fg_highval = (String) this.getExtendAttributeValue("fg_ems");
		if (!StringUtils.isBlank(fg_highval)) {
			stringBuilder.append(String.format(" and fg_ems = '%s' ", fg_highval));
		}
