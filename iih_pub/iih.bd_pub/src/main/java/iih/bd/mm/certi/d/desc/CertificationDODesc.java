...
package iih.bd.mm.certi.d.desc;
...
/**
 * 医疗物品_资质证书字典 DO 元数据信息
 */
public class CertificationDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mm.certi.d.CertificationDO";
	public static final String CLASS_DISPALYNAME = "医疗物品_资质证书字典";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_MM_CF";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mmcf";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mmcfADesc(tblDesc));
		...
		this.add(getFg_vitemsADesc(tblDesc));
		this.add(getFg_itemsADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mmcfCDesc(tblDesc));
		...
		tblDesc.add(getFg_vitemsCDesc(tblDesc));
		tblDesc.add(getFg_itemsCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_vitemsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_vitems",  getFg_vitemsCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("高值卫材适用标志");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_itemsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_items",  getFg_itemsCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("普通卫材适用标志");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_vitemsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_vitems");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("高值卫材适用标志"); 
		return column;
	}
	/**
	 * 获取普通卫材适用标志表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_itemsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_items");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("普通卫材适用标志"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mmcf");
