...
package iih.bd.mm.medicinedirectory.d.desc;
 ...
 * 包药机药品目录维护 DO 元数据信息
 */
public class MedicineDirectoryDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mm.medicinedirectory.d.MedicineDirectoryDO";
	public static final String CLASS_DISPALYNAME = "包药机药品目录维护";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mm_oralmech_rel";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_oralmech_rel";
	 ...
	 * 无参构造函数
	 */
	public MedicineDirectoryDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_oralmech_relADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_oralmech_relADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_oralmech_relCDesc(tblDesc));
		tblDesc.add(getId_oralmech_relCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_oralmech_relADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_oralmech_rel",  getId_oralmech_relCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("包药机药品目录维护主键");
	...
	private IAttrDesc getMm_sup_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM a0b4","id_mm=id_mm","sup_name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_oralmech_relCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_oralmech_rel");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("包药机药品目录维护主键"); 
		return column;
	}
	/**
	 * 获取所属组织表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_oralmech_rel");
