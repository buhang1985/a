...
import iih.bd.log.IBdSrvPriceTableUpdateLogService;
 ...
 *
 */
public class BdSrvPriceTableUpdateLogUtils {

	private static IBdSrvPriceTableUpdateLogService _logService = ServiceFinder
			.find(IBdSrvPriceTableUpdateLogService.class);
