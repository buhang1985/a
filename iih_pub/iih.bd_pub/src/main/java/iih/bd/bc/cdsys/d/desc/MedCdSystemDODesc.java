...
package iih.bd.bc.cdsys.d.desc;
...
/**
 * 基础编码_医疗编码标准 DO 元数据信息
 */
public class MedCdSystemDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.bc.cdsys.d.MedCdSystemDO";
	public static final String CLASS_DISPALYNAME = "基础编码_医疗编码标准";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_cdsys";
	...
	private void init(){		
		...
		this.add(getId_gradetpADesc(tblDesc));
		this.add(getSd_gradetpADesc(tblDesc));
		...
		this.add(getGradetp_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_gradetpCDesc(tblDesc));
		tblDesc.add(getSd_gradetpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_gradetpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_gradetp",  getId_gradetpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标准类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_gradetpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_gradetp",  getSd_gradetpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标准类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getCdsys_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b3","id_cdsystp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCdsys_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b3","id_cdsystp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getGradetp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Gradetp_name",  getGradetp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_gradetp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_gradetpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_gradetp");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标准类型"); 
		return column;
	}
	/**
	 * 获取标准类型编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_gradetpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_gradetp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标准类型编码"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getGradetp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Gradetp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
