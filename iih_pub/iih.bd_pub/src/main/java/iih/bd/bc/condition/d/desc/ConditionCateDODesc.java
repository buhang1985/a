 ...
 * 条件指标分类 DO 元数据信息
 */
public class ConditionCateDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.bc.condition.d.ConditionCateDO";
	public static final String CLASS_DISPALYNAME = "条件指标分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_contica";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_contica";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_conticaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_conticaCDesc(tblDesc));
	...
	private IAttrDesc getParent_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_contica a0b3","id_parent=id_contica","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_contica");
