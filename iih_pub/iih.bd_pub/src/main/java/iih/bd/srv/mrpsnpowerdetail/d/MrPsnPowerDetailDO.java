package iih.bd.srv.mrpsnpowerdetail.d;
 ...
 * 
 */
public class MrPsnPowerDetailDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//主键
	public static final String IDMRPSNPOWERDETAIL= "Idmrpsnpowerdetail";
	//集团
	...
	//人员权限外键
	public static final String IDMRPSNPOWER= "Idmrpsnpower";
	//医疗记录自定义分类
	public static final String ID_MRCA_CTM= "Id_mrca_ctm";
	//医疗记录自定义分类编码
	public static final String CODE_MRCA= "Code_mrca";
	//医疗记录自定义分类名称
	public static final String NAME_MRCA= "Name_mrca";
	//医疗记录类型
	...
	//编码
	public static final String MRCA_CODE= "Mrca_code";
	//名称
	public static final String MRCA_NAME= "Mrca_name";
	//医疗记录类型编码
	 ...
	 * @return String
	 */
	public String getIdmrpsnpowerdetail() {
		return ((String) getAttrVal("Idmrpsnpowerdetail"));
	}	
	/**
	 * 主键
	 * @param Idmrpsnpowerdetail
	 */
	public void setIdmrpsnpowerdetail(String Idmrpsnpowerdetail) {
		setAttrVal("Idmrpsnpowerdetail", Idmrpsnpowerdetail);
	}
	/**
	 * 集团
	 * @return String
	 ...
	 * @return String
	 */
	public String getIdmrpsnpower() {
		return ((String) getAttrVal("Idmrpsnpower"));
	}	
	/**
	 * 人员权限外键
	 * @param Idmrpsnpower
	 */
	public void setIdmrpsnpower(String Idmrpsnpower) {
		setAttrVal("Idmrpsnpower", Idmrpsnpower);
	}
	/**
	 * 医疗记录自定义分类
	 * @return String
	 */
	public String getId_mrca_ctm() {
		return ((String) getAttrVal("Id_mrca_ctm"));
	}	
	/**
	 * 医疗记录自定义分类
	 * @param Id_mrca_ctm
	 */
	public void setId_mrca_ctm(String Id_mrca_ctm) {
		setAttrVal("Id_mrca_ctm", Id_mrca_ctm);
	}
	/**
	 * 医疗记录自定义分类编码
	 * @return String
	 */
	public String getCode_mrca() {
		return ((String) getAttrVal("Code_mrca"));
	}	
	/**
	 * 医疗记录自定义分类编码
	 * @param Code_mrca
	 */
	public void setCode_mrca(String Code_mrca) {
		setAttrVal("Code_mrca", Code_mrca);
	}
	/**
	 * 医疗记录自定义分类名称
	 * @return String
	 */
	public String getName_mrca() {
		return ((String) getAttrVal("Name_mrca"));
	}	
	/**
	 * 医疗记录自定义分类名称
	 * @param Name_mrca
	 */
	public void setName_mrca(String Name_mrca) {
		setAttrVal("Name_mrca", Name_mrca);
	}
	/**
	 * 医疗记录类型
	 * @return String
	 ...
	 * @return String
	 */
	public String getMrca_code() {
		return ((String) getAttrVal("Mrca_code"));
	}	
	/**
	 * 编码
	 * @param Mrca_code
	 */
	public void setMrca_code(String Mrca_code) {
		setAttrVal("Mrca_code", Mrca_code);
	}
	/**
	 * 名称
	 * @return String
	 */
	public String getMrca_name() {
		return ((String) getAttrVal("Mrca_name"));
	}	
	/**
	 * 名称
	 * @param Mrca_name
	 */
	public void setMrca_name(String Mrca_name) {
		setAttrVal("Mrca_name", Mrca_name);
	}
	/**
	 * 医疗记录类型编码
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Idmrpsnpowerdetail";
	}
	
	@Override
	public String getTableName() {	  
		return "mr_pan_power_detail";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MrPsnPowerDetailDODesc.class);
	}
