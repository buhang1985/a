...
package iih.bd.srv.mropgrouplevel.d.desc;
 ...
 * 操作层级 DO 元数据信息
 */
public class MrOpGroupLevelDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.mropgrouplevel.d.MrOpGroupLevelDO";
	public static final String CLASS_DISPALYNAME = "操作层级";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_op_group_level";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Idmropgrouplevel";
	...
	private void init(){		
		...
		this.setKeyDesc(getIdmropgrouplevelADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getIdmropgrouplevelADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getIdmropgrouplevelCDesc(tblDesc));
		tblDesc.add(getIdmropgrouplevelCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orpCDesc(tblDesc));
		tblDesc.add(getIdmropgroupCDesc(tblDesc));
		tblDesc.add(getSortnoCDesc(tblDesc));
		tblDesc.add(getName_levelCDesc(tblDesc));
		tblDesc.add(getCode_levelCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_orpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_orp",  getId_orpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getCode_orgADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_org a0b3","id_orp=id_org","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_orgADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_org a0b3","id_orp=id_org","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getNameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"mr_op_group a0b4","idmropgroup=idmropgroup","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCodeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"mr_op_group a0b4","idmropgroup=idmropgroup","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_orpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_orp");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
