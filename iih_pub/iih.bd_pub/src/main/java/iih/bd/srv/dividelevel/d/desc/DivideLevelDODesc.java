...
package iih.bd.srv.dividelevel.d.desc;
 ...
 * 评分等级 DO 元数据信息
 */
public class DivideLevelDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.dividelevel.d.DivideLevelDO";
	public static final String CLASS_DISPALYNAME = "评分等级";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_qa_divide_level";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_qa_divide_level";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_qa_divide_levelADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_qa_divide_levelADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getMin_scrADesc(tblDesc));
		this.add(getMax_scrADesc(tblDesc));
		this.add(getLvlADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_qa_divide_levelCDesc(tblDesc));
		tblDesc.add(getId_qa_divide_levelCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getMin_scrCDesc(tblDesc));
		tblDesc.add(getMax_scrCDesc(tblDesc));
		tblDesc.add(getLvlCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_qa_divide_levelADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_qa_divide_level",  getId_qa_divide_levelCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getMin_scrADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Min_scr",  getMin_scrCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getMax_scrADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Max_scr",  getMax_scrCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
	 ...
	 * @return
	 */
	private IAttrDesc getLvlADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Lvl",  getLvlCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getId_qa_divide_levelCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_qa_divide_level");
		column.setLength(20);
	 ...
	 * @return
	 */
	private IColumnDesc getMin_scrCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Min_scr");
		column.setLength(5);
	 ...
	 * @return
	 */
	private IColumnDesc getMax_scrCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Max_scr");
		column.setLength(5);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("最大值"); 
	 ...
	 * @return
	 */
	private IColumnDesc getLvlCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Lvl");
		column.setLength(32);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("级别"); 
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_qa_divide_level");
		iBDDataInfoFldMap.put("id_org","Id_org");
		iBDDataInfoFldMap.put("name","Lvl");
