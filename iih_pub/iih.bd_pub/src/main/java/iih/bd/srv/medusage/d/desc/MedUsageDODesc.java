 ...
 * 用法 DO 元数据信息
 */
public class MedUsageDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.medusage.d.MedUsageDO";
	public static final String CLASS_DISPALYNAME = "用法";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_route";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_route";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_routeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_routeCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_usg");
