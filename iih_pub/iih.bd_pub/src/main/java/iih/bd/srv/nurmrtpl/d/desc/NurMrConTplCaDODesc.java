 ...
 * 护理记录内容模板分类 DO 元数据信息
 */
public class NurMrConTplCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.nurmrtpl.d.NurMrConTplCaDO";
	public static final String CLASS_DISPALYNAME = "护理记录内容模板分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mr_nur_con_tpl_ca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mrnurcontplca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mrnurcontplcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mrnurcontplcaCDesc(tblDesc));
	...
	private IAttrDesc getId_mrnurcontplcaADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("护理记录内容模板分类主键标识");
	...
	private IAttrDesc getParent_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_nur_con_tpl_ca a0b4","id_parent=id_mrnurcontplca","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getParent_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_nur_con_tpl_ca a0b4","id_parent=id_mrnurcontplca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IColumnDesc getId_mrnurcontplcaCDesc(ITableDesc tblDesc){
		...
		column.setLabel("护理记录内容模板分类主键标识"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mrnurcontplca");
