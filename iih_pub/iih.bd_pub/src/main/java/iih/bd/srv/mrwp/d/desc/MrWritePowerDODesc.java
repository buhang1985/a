 ...
 * 病历书写权限 DO 元数据信息
 */
public class MrWritePowerDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.mrwp.d.MrWritePowerDO";
	public static final String CLASS_DISPALYNAME = "病历书写权限";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mr_wp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mr_wp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mr_wpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_mr_wpADesc(tblDesc));
		...
		this.add(getId_ptADesc(tblDesc));
		this.add(getSd_ptADesc(tblDesc));
		...
		this.add(getName_ptADesc(tblDesc));
		this.add(getCode_ptADesc(tblDesc));
		this.add(getName_cjrADesc(tblDesc));
		this.add(getCode_cjrADesc(tblDesc));
		this.add(getName_zhxgrADesc(tblDesc));
		this.add(getCode_zhxgrADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mr_wpCDesc(tblDesc));
		tblDesc.add(getId_mr_wpCDesc(tblDesc));
		...
		tblDesc.add(getId_ptCDesc(tblDesc));
		tblDesc.add(getSd_ptCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_mr_wpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mr_wp",  getId_mr_wpCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getId_ptADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pt",  getId_ptCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("权限实体类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_ptADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_pt",  getSd_ptCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("权限实体类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getCode_grpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_grp a0b8","id_grp=id_grp","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_pmADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_pm=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_pmADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_pm=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_ptADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_pt",  getName_ptCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_pt=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_ptADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_pt",  getCode_ptCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_pt=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_cjrADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_cjr",  getName_cjrCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_cjrADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_cjr",  getCode_cjrCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_zhxgrADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_zhxgr",  getName_zhxgrCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("用户名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_zhxgrADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_zhxgr",  getCode_zhxgrCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("用户编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_mr_wpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mr_wp");
		column.setLength(20);
	 ...
	 * @return
	 */
	private IColumnDesc getId_ptCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pt");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("权限实体类型"); 
		return column;
	}
	/**
	 * 获取权限实体类型编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_ptCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_pt");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("权限实体类型编码"); 
		return column;
	}
	/**
	 * 获取序号表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_ptCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_pt");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_ptCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_pt");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_cjrCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_cjr");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_cjrCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_cjr");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_zhxgrCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_zhxgr");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("用户名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_zhxgrCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_zhxgr");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("用户编码"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mr_wp");
