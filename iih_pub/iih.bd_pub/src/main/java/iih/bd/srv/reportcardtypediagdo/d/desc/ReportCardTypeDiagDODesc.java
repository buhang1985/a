...
package iih.bd.srv.reportcardtypediagdo.d.desc;
 ...
 * 报卡类型关联诊断 DO 元数据信息
 */
public class ReportCardTypeDiagDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.reportcardtypediagdo.d.ReportCardTypeDiagDO";
	public static final String CLASS_DISPALYNAME = "报卡类型关联诊断";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_rcm_tp_diag";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Idbdrcmtpdiag";
	 ...
	 * 无参构造函数
	 */
	public ReportCardTypeDiagDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getIdbdrcmtpdiagADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getIdbdrcmtpdiagADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getIdbdrcmtpdiagCDesc(tblDesc));
		tblDesc.add(getIdbdrcmtpdiagCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getIdbdrcmtpdiagADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Idbdrcmtpdiag",  getIdbdrcmtpdiagCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getIdbdrcmtpdiagCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Idbdrcmtpdiag");
		column.setLength(50);
