...
package iih.bd.srv.preformat.d.desc;
 ...
 * 处方格式 DO 元数据信息
 */
public class MrPreFormatDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.preformat.d.MrPreFormatDO";
	public static final String CLASS_DISPALYNAME = "处方格式";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mr_pre_format";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mr_pre_format";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mr_pre_formatADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_mr_pre_formatADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_medsrvtypeADesc(tblDesc));
		this.add(getId_entpADesc(tblDesc));
		this.add(getId_deptADesc(tblDesc));
		this.add(getId_mrtplsecADesc(tblDesc));
		this.add(getNu_sortADesc(tblDesc));
		...
		this.add(getCode_medsrvtypeADesc(tblDesc));
		this.add(getName_medsrvtypeADesc(tblDesc));
		this.add(getCode_entpADesc(tblDesc));
		this.add(getName_entpADesc(tblDesc));
		this.add(getCode_deptADesc(tblDesc));
		this.add(getName_deptADesc(tblDesc));
		this.add(getCode_mrtplsecADesc(tblDesc));
		this.add(getName_mrtplsecADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mr_pre_formatCDesc(tblDesc));
		tblDesc.add(getId_mr_pre_formatCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_medsrvtypeCDesc(tblDesc));
		tblDesc.add(getId_entpCDesc(tblDesc));
		tblDesc.add(getId_deptCDesc(tblDesc));
		tblDesc.add(getId_mrtplsecCDesc(tblDesc));
		tblDesc.add(getNu_sortCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_mr_pre_formatADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mr_pre_format",  getId_mr_pre_formatCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("处方格式主键");
	 ...
	 * @return
	 */
	private IAttrDesc getId_medsrvtypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_medsrvtype",  getId_medsrvtypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getNu_sortADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Nu_sort",  getNu_sortCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_medsrvtypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_medsrvtype",  getCode_medsrvtypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_medsrvtype=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_medsrvtypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_medsrvtype",  getName_medsrvtypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_medsrvtype=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_entpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_entp a0b9","id_entp=id_entp","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_mrtplsecADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_mrtplsec",  getCode_mrtplsecCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mrtpl_sec a0b3","id_mrtplsec=id_mrtplsec","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_mrtplsecADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_mrtplsec",  getName_mrtplsecCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mrtpl_sec a0b3","id_mrtplsec=id_mrtplsec","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_mr_pre_formatCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mr_pre_format");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("处方格式主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_medsrvtypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_medsrvtype");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getNu_sortCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Nu_sort");
		column.setLength(10);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_medsrvtypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_medsrvtype");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_medsrvtypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_medsrvtype");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_mrtplsecCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_mrtplsec");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_mrtplsecCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_mrtplsec");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mr_pre_format");
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_loop",new xap.mw.coreitf.d.FBoolean("Y"));
	}
