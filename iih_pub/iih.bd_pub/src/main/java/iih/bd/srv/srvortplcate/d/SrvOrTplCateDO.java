package iih.bd.srv.srvortplcate.d;
 ...
 * 
 */
public class SrvOrTplCateDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_srvortplca";
	}
	
	@Override
	public String getTableName() {	  
		return "bd_srv_tpl_ca";
	}
	
	@Override
	public IDODesc getDODesc() {		
		return DescManager.getInstance().getDODesc(SrvOrTplCateDODesc.class);
	}
