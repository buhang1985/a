...
* 医疗服务数据维护服务
*/
public interface IMedSrvRelMmDORService {
	/**
	*  根据id值查找医疗服务数据
	*/	
	...
	*/
	 ...
	 * @throws BizException
	 */
	public abstract MedSrvRelMmDO[] findByAttrValString(String attr, String value) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract MedSrvRelMmDO[] findByAttrValStrings(String attr, String[] values) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract MedSrvRelMmDO[] findByAttrValList(String attr, FArrayList values) throws BizException;
	 ...
	 * @throws BizException
	 */
	public PagingRtnData<MedSrvRelMmDO> findByQCondAndPageInfo(QryRootNodeDTO qryRootNodeDTO,String orderStr,PaginationInfo pg) throws BizException;
}