 ...
 * 科室服务黑白名单项目 DO 元数据信息
 */
public class DeptSrvLimitItemDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.deptsrvlimit.d.DeptSrvLimitItemDO";
	public static final String CLASS_DISPALYNAME = "科室服务黑白名单项目";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_deplimt_itm";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvdeplimtitm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvdeplimtitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_srvdeplimtADesc(tblDesc));
		this.add(getId_srvdeplimtitmADesc(tblDesc));
		this.add(getId_srvdeplimtADesc(tblDesc));
		this.add(getId_depADesc(tblDesc));
		this.add(getEu_limtitmreltpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvdeplimtitmCDesc(tblDesc));
		tblDesc.add(getId_srvdeplimtitmCDesc(tblDesc));
		tblDesc.add(getId_srvdeplimtCDesc(tblDesc));
		tblDesc.add(getId_depCDesc(tblDesc));
		tblDesc.add(getEu_limtitmreltpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvdeplimtitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvdeplimtitm",  getId_srvdeplimtitmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("科室服务黑白名单项目");
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvdeplimtADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvdeplimt",  getId_srvdeplimtCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("科室服务黑白名单");
	 ...
	 * @return
	 */
	private IAttrDesc getEu_limtitmreltpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Eu_limtitmreltp",  getEu_limtitmreltpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("关联项目类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getCode_srvtpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a1b3","id_srvtp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_srvcaADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srvca a1b5","id_srvca=id_srvca","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getInnercodeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srvca a1b5","id_srvca=id_srvca","innercode"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvdeplimtitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvdeplimtitm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("科室服务黑白名单项目"); 
		return column;
	}
	/**
	 * 获取科室服务黑白名单表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvdeplimtCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvdeplimt");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("科室服务黑白名单"); 
		return column;
	}
	/**
	 * 获取科室表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getEu_limtitmreltpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Eu_limtitmreltp");
		column.setLength(50);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("关联项目类型"); 
		return column;
	}
	/**
	 * 获取服务类型表列元数据
