 ...
 * 疾病诊断分类 DO 元数据信息
 */
public class DiagCateDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.diagcate.d.DiagCateDO";
	public static final String CLASS_DISPALYNAME = "疾病诊断分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_dica";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_dica";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_dicaADesc(tblDesc));
		...
		this.add(getCode_distandADesc(tblDesc));
		...
		this.add(getName_infectiontpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_dicaCDesc(tblDesc));
		...
		tblDesc.add(getCode_distandCDesc(tblDesc));
	...
	private IAttrDesc getId_dicaADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("疾病诊断基本分类主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getCode_distandADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_distand",  getCode_distandCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("对应外部疾病编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_infectiontpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_infectiontp",  getName_infectiontpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("传染病种类名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_infectiontp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getCode_distandCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_distand");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("对应外部疾病编码"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_infectiontpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_infectiontp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("传染病种类名称"); 
		return column;
	}
	/**
	 * 设置IBDataInfo接口映射数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_dica");
