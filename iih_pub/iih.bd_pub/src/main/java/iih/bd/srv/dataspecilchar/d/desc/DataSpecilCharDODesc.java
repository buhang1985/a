 ...
 * 特殊字符 DO 元数据信息
 */
public class DataSpecilCharDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.dataspecilchar.d.DataSpecilCharDO";
	public static final String CLASS_DISPALYNAME = "特殊字符";
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_sc");
