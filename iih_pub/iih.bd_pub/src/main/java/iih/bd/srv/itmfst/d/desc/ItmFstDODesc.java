...
package iih.bd.srv.itmfst.d.desc;
 ...
 * 质控项目一级分类 DO 元数据信息
 */
public class ItmFstDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.itmfst.d.ItmFstDO";
	public static final String CLASS_DISPALYNAME = "质控项目一级分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_qa_itm_fst";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_fst";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_fstADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_fstCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_fst");
