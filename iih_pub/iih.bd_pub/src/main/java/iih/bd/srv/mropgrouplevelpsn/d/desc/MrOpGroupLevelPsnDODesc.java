...
package iih.bd.srv.mropgrouplevelpsn.d.desc;
 ...
 * 操作人员 DO 元数据信息
 */
public class MrOpGroupLevelPsnDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.mropgrouplevelpsn.d.MrOpGroupLevelPsnDO";
	public static final String CLASS_DISPALYNAME = "操作人员";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_op_group_level_psn";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Idmropgrouplevelpsn";
	 ...
	 * 无参构造函数
	 */
	public MrOpGroupLevelPsnDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getIdmropgrouplevelpsnADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getIdmropgrouplevelpsnADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getIdmropgrouplevelpsnCDesc(tblDesc));
		tblDesc.add(getIdmropgrouplevelpsnCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getIdmropgrouplevelCDesc(tblDesc));
		tblDesc.add(getId_psnCDesc(tblDesc));
		tblDesc.add(getCode_psnCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getIdmropgrouplevelpsnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Idmropgrouplevelpsn",  getIdmropgrouplevelpsnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("病历操作人员主键");
	 ...
	 * @return
	 */
	private IColumnDesc getIdmropgrouplevelpsnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Idmropgrouplevelpsn");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("病历操作人员主键"); 
		return column;
	}
	/**
	 * 获取集团外键表列元数据
