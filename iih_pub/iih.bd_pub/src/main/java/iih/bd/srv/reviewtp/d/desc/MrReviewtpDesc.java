...
package iih.bd.srv.reviewtp.d.desc;
 ...
 * 医疗记录审签类型 DO 元数据信息
 */
public class MrReviewtpDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.reviewtp.d.MrReviewtp";
	public static final String CLASS_DISPALYNAME = "医疗记录审签类型";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_reviewtp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_reviewtp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_reviewtpADesc(tblDesc));
		...
		this.add(getMr_finish_codeADesc(tblDesc));
		this.add(getMr_finish_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_reviewtpCDesc(tblDesc));
		...
		tblDesc.add(getId_mr_finish_statusCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getMr_finish_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mr_finish_code",  getMr_finish_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("完成状态编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_mr_finish_status=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getMr_finish_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mr_finish_name",  getMr_finish_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("完成状态名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_mr_finish_status=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getFlowtype_typecodeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"wf_flwtype a0b3","id_flowtype=id_flowtype","typecode"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getFlowtype_typenameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"wf_flwtype a0b3","id_flowtype=id_flowtype","typename"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getMr_finish_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mr_finish_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("完成状态编码"); 
		return column;
	}
	/**
	 * 获取完成状态名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getMr_finish_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mr_finish_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("完成状态名称"); 
		return column;
	}
	/**
	 * 获取类型编码表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_reviewtp");
