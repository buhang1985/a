 ...
 * 病历辅助录入组件 DO 元数据信息
 */
public class EmrTermCompDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.emrterm.d.EmrTermCompDO";
	public static final String CLASS_DISPALYNAME = "病历辅助录入组件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mra_comp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mracomp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mracompADesc(tblDesc));
		...
		this.add(getQryschemeADesc(tblDesc));
		...
		this.add(getFuncclassADesc(tblDesc));
		this.add(getComplayoutADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mracompCDesc(tblDesc));
		...
		tblDesc.add(getQryschemeCDesc(tblDesc));
		...
		tblDesc.add(getFuncclassCDesc(tblDesc));
		tblDesc.add(getComplayoutCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getQryschemeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Qryscheme",  getQryschemeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getFuncclassADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Funcclass",  getFuncclassCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("功能对应类");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getComplayoutADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Complayout",  getComplayoutCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("组件布局");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getQryschemeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Qryscheme");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getFuncclassCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Funcclass");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("功能对应类"); 
		return column;
	}
	/**
	 * 获取组件布局表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getComplayoutCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Complayout");
		column.setLength(2000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("组件布局"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mracomp");
