 ...
 * 病历辅助录入病历事件 DO 元数据信息
 */
public class EmrEvent4TermDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.emrterm.d.EmrEvent4TermDO";
	public static final String CLASS_DISPALYNAME = "病历辅助录入病历事件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mra_et";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mraet";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mraetADesc(tblDesc));
		...
		this.add(getId_mraettpADesc(tblDesc));
		this.add(getSd_mraettpADesc(tblDesc));
		...
		this.add(getMr_mraettp_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mraetCDesc(tblDesc));
		...
		tblDesc.add(getId_mraettpCDesc(tblDesc));
		tblDesc.add(getSd_mraettpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_mraettpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mraettp",  getId_mraettpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_mraettpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_mraettp",  getSd_mraettpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getMr_mraettp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mr_mraettp_name",  getMr_mraettp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_mraettp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_mraettpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mraettp");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getSd_mraettpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_mraettp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getMr_mraettp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mr_mraettp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mraet");
