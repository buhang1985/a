 ...
 * 诊断别名 DO 元数据信息
 */
public class DiagAliasDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.diagdef.d.DiagAliasDO";
	public static final String CLASS_DISPALYNAME = "诊断别名";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_di_als";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_dials";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_dialsADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_didefADesc(tblDesc));
		this.add(getId_dialsADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_dialsCDesc(tblDesc));
		tblDesc.add(getId_dialsCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_dialsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_dials",  getId_dialsCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("诊断别名集诊断主键标识");
	 ...
	 * @return
	 */
	private IColumnDesc getId_dialsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_dials");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("诊断别名集诊断主键标识"); 
		return column;
	}
	/**
	 * 获取诊断表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_dials");
