 ...
 * 队列规则 DO 元数据信息
 */
public class QueRuleDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.fc.querule.d.QueRuleDO";
	public static final String CLASS_DISPALYNAME = "队列规则";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_que_rule";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_querule";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_queruleADesc(tblDesc));
		...
		this.add(getSd_queruletypeADesc(tblDesc));
		this.add(getCodeADesc(tblDesc));
		this.add(getNameADesc(tblDesc));
		this.add(getQuan_waitADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_queruleCDesc(tblDesc));
		tblDesc.add(getId_queruleCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getSd_queruletypeCDesc(tblDesc));
		tblDesc.add(getCodeCDesc(tblDesc));
		tblDesc.add(getNameCDesc(tblDesc));
		tblDesc.add(getQuan_waitCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getSd_queruletypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_queruletype",  getSd_queruletypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("分诊规则类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getQuan_waitADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Quan_wait",  getQuan_waitCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("候诊数");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getSd_queruletypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_queruletype");
		column.setLength(50);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("分诊规则类型"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getQuan_waitCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Quan_wait");
		column.setLength(10);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("候诊数"); 
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_querule");
