 ...
 * 流程配置_就诊类型 DO 元数据信息
 */
public class EnTypeDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.fc.entp.d.EnTypeDO";
	public static final String CLASS_DISPALYNAME = "流程配置_就诊类型";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_entp";
	...
	private void init(){		
		...
		this.add(getIssysADesc(tblDesc));
		...
		this.add(getName_createbyADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getIssysCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getIssysADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Issys",  getIssysCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否系统预置");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_createbyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_createby",  getName_createbyCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("创建人");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
	 ...
	 * @return
	 */
	private IColumnDesc getIssysCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Issys");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否系统预置"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_createbyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_createby");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("创建人"); 
		return column;
