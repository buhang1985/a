...
package iih.bd.fc.mdwfsrvtp.d.desc;
 ...
 * 通用医嘱流向模式 DO 元数据信息
 */
public class MdWfSrvTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.fc.mdwfsrvtp.d.MdWfSrvTpDO";
	public static final String CLASS_DISPALYNAME = "通用医嘱流向模式";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "md_wf_srvtp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Pk_wfsrvtp";
	...
	private void init(){		
		...
		this.setKeyDesc(getPk_wfsrvtpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getPk_wfsrvtpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getPk_wfsrvtpCDesc(tblDesc));
		tblDesc.add(getPk_wfsrvtpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getPk_wfsrvtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Pk_wfsrvtp",  getPk_wfsrvtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("服务类型流向主键");
	...
	private IAttrDesc getEntp_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_entp a0b3","id_entp=id_entp","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getEntp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_entp a0b3","id_entp=id_entp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDept_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_deptp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDept_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_deptp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getPk_wfsrvtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Pk_wfsrvtp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("服务类型流向主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
