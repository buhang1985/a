package iih.bd.fc.orwfovalchk.d;
 ...
 * 
 */
public class OrWfOvalChkSrvDTO extends BaseDTO {
	 ...
	 * @return FBoolean
	 */
	public FBoolean getFg_outdeptadmt() {
		return ((FBoolean) getAttrVal("Fg_outdeptadmt"));
	}
	/**
	 * 目标科室外执行
	 * @param Fg_outdeptadmt
	 */
	public void setFg_outdeptadmt(FBoolean Fg_outdeptadmt) {
		setAttrVal("Fg_outdeptadmt", Fg_outdeptadmt);
	}
}