 ...
 * 医嘱流向 DO 元数据信息
 */
public class WfDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.fc.wf.d.WfDO";
	public static final String CLASS_DISPALYNAME = "医嘱流向";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_WF";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_wf";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_wfADesc(tblDesc));
		...
		this.add(getWf_codeADesc(tblDesc));
		this.add(getWf_nameADesc(tblDesc));
		this.add(getCode_srvtpADesc(tblDesc));
		this.add(getName_srvtpADesc(tblDesc));
		this.add(getName_ctreateADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_wfCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getWf_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Wf_code",  getWf_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("就诊类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
	 ...
	 * @return
	 */
	private IAttrDesc getWf_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Wf_name",  getWf_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_ctreateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_ctreate",  getName_ctreateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getWf_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Wf_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("就诊类型编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getWf_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Wf_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_ctreateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_ctreate");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_wf");
