 ...
 * 医嘱流向分类 DO 元数据信息
 */
public class MdWfCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.fc.mdwfconfig.d.MdWfCaDO";
	public static final String CLASS_DISPALYNAME = "医嘱流向分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "md_wfca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_wfca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_wfcaADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_wfcaADesc(tblDesc));
		...
		this.add(getModi_nameADesc(tblDesc));
		this.add(getModi_codeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_wfcaCDesc(tblDesc));
		tblDesc.add(getId_wfcaCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_wfcaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_wfca",  getId_wfcaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医嘱流向分类主键");
	...
	private IAttrDesc getParent_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"md_wfca a0b3","id_parent=id_wfca","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getParent_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"md_wfca a0b3","id_parent=id_wfca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getModi_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Modi_name",  getModi_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("修改人名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getModi_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Modi_code",  getModi_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("修改人编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_wfcaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_wfca");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医嘱流向分类主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getModi_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Modi_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("修改人名称"); 
		return column;
	}
	/**
	 * 获取修改人编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getModi_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Modi_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("修改人编码"); 
		return column;
	}
	/**
	 * 设置IBDataInfo接口映射数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_wfca");
