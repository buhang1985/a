...
package iih.bd.mhi.hpinsurpres.d.desc;
 ...
 * 医保计划医保处方权 DO 元数据信息
 */
public class HpInsurPresDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpinsurpres.d.HpInsurPresDO";
	public static final String CLASS_DISPALYNAME = "医保计划医保处方权";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_RP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hprp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hprpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hprpCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hprp");
