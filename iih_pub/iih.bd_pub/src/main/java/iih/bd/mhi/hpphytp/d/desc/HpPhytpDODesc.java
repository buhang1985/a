...
package iih.bd.mhi.hpphytp.d.desc;
 ...
 * 医保计划医师类别 DO 元数据信息
 */
public class HpPhytpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpphytp.d.HpPhytpDO";
	public static final String CLASS_DISPALYNAME = "医保计划医师类别";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_PHY_TP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpphytp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpphytpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpphytpCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpphytp");
