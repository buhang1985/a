...
package iih.bd.mhi.hpmedpaytp.d.desc;
...
/**
 * 医保产品_医疗付款方式 DO 元数据信息
 */
public class HpMedPayTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpmedpaytp.d.HpMedPayTpDO";
	public static final String CLASS_DISPALYNAME = "医保产品_医疗付款方式";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_MEDPAYTP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_medpaytp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_medpaytpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_medpaytpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_medpaytpCDesc(tblDesc));
		tblDesc.add(getId_medpaytpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_medpaytpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_medpaytp",  getId_medpaytpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗付款方式主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_medpaytpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_medpaytp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医疗付款方式主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_medpaytp");
