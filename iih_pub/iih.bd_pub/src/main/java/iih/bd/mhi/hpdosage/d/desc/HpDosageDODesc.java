...
package iih.bd.mhi.hpdosage.d.desc;
 ...
 * 医保剂型目录 DO 元数据信息
 */
public class HpDosageDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpdosage.d.HpDosageDO";
	public static final String CLASS_DISPALYNAME = "医保剂型目录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_MHI_DOSAGE";
