...
package iih.bd.mhi.hpdoc.d.desc;
 ...
 * 医保档案 DO 元数据信息
 */
public class HpDocDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpdoc.d.HpDocDO";
	public static final String CLASS_DISPALYNAME = "医保档案";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mhi_doc";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpdoc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpdocADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_hpdocADesc(tblDesc));
		this.add(getId_groupADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_hpADesc(tblDesc));
		this.add(getId_doctypeADesc(tblDesc));
		this.add(getSd_doctypeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpdocCDesc(tblDesc));
		tblDesc.add(getId_hpdocCDesc(tblDesc));
		tblDesc.add(getId_groupCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_hpCDesc(tblDesc));
		tblDesc.add(getId_doctypeCDesc(tblDesc));
		tblDesc.add(getSd_doctypeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hpdocADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hpdoc",  getId_hpdocCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医保档案主键");
	 ...
	 * @return
	 */
	private IAttrDesc getId_doctypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_doctype",  getId_doctypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_doctypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_doctype",  getSd_doctypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getId_hpdocCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hpdoc");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医保档案主键"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_doctypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_doctype");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getSd_doctypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_doctype");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpdoc");
