...
package iih.bd.mhi.hpreferraltp.d.desc;
 ...
 * 转诊类型 DO 元数据信息
 */
public class HpReferralTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpreferraltp.d.HpReferralTpDO";
	public static final String CLASS_DISPALYNAME = "转诊类型";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_MHI_REFERRALTP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_referraltp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_referraltpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_referraltpCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_referraltp");
