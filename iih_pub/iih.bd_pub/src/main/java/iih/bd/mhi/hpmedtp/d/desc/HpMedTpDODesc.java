...
package iih.bd.mhi.hpmedtp.d.desc;
 ...
 * 医保产品_医疗类型 DO 元数据信息
 */
public class HpMedTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpmedtp.d.HpMedTpDO";
	public static final String CLASS_DISPALYNAME = "医保产品_医疗类型";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_MEDTP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_medtp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_medtpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_medtpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_medtpCDesc(tblDesc));
		tblDesc.add(getId_medtpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_medtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_medtp",  getId_medtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗类型主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_medtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_medtp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医疗类型主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_medtp");
