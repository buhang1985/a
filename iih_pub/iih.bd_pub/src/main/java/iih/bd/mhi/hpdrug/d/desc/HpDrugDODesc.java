...
package iih.bd.mhi.hpdrug.d.desc;
 ...
 * 医保产品_药品 DO 元数据信息
 */
public class HpDrugDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpdrug.d.HpDrugDO";
	public static final String CLASS_DISPALYNAME = "医保产品_药品";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_DRUG";
	...
	private IAttrDesc getHp_nameADesc(ITableDesc tblDesc) {
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[] { "BD_MHI_HP a0b2", "id_hp=id_hp", "name" });
		attrDesc.setRefType(false);
		return attrDesc;
	}
