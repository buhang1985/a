...
package iih.bd.mhi.hpstafftp.d.desc;
 ...
 * 医保计划医院人员类别 DO 元数据信息
 */
public class HpStaffTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpstafftp.d.HpStaffTpDO";
	public static final String CLASS_DISPALYNAME = "医保计划医院人员类别";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_STAFF_TP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpstafftp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpstafftpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpstafftpCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpstafftp");
