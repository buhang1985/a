package iih.bd.mhi.hpphytitle.d.desc;
 ...
 * 医保计划医师职称 DO 元数据信息
 */
public class HpPhyTitleDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpphytitle.d.HpPhyTitleDO";
	public static final String CLASS_DISPALYNAME = "医保计划医师职称";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_PHY_TITLE";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpphytitle";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpphytitleADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpphytitleCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpphytitle");
