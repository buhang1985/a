package iih.bd.mhi.hpdepdircomp.d;
 ...
 * 
 */
public class HpDepDirCompDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_COMP_DEP= "Id_comp_dep";
	public static final String ID_GRP= "Id_grp";
	public static final String ID_ORG= "Id_org";
	public static final String ID_HP= "Id_hp";
	public static final String ID_DEP= "Id_dep";
	public static final String ID_HPDEP= "Id_hpdep";
	...
	public String getId_comp_dep() {
		return ((String) getAttrVal("Id_comp_dep"));
	}	
	public void setId_comp_dep(String Id_comp_dep) {
		setAttrVal("Id_comp_dep", Id_comp_dep);
	}
	...
	public String getId_hpdep() {
		return ((String) getAttrVal("Id_hpdep"));
	}	
	public void setId_hpdep(String Id_hpdep) {
		setAttrVal("Id_hpdep", Id_hpdep);
	}
...
//	}
	...
	public String getTableName() {	  
		return "BD_HP_COMP_DEP";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpDepDirCompDODesc.class);
	}
