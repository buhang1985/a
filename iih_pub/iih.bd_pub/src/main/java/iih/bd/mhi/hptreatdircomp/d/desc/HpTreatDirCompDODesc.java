...
package iih.bd.mhi.hptreatdircomp.d.desc;
 ...
 * 医保产品_诊疗对照 DO 元数据信息
 */
public class HpTreatDirCompDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hptreatdircomp.d.HpTreatDirCompDO";
	public static final String CLASS_DISPALYNAME = "医保产品_诊疗对照";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_COMP_TREAT";
	...
	private IAttrDesc getTreat_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("HIS诊疗服务名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b5","id_treat=id_srv","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
