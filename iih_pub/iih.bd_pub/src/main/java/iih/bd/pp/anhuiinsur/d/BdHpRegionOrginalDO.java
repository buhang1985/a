 ...
 * 
 */
public class BdHpRegionOrginalDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_HPREGION= "Id_hpregion";
	...
	public String getId_hpregion() {
		return ((String) getAttrVal("Id_hpregion"));
	}	
	public void setId_hpregion(String Id_hpregion) {
		setAttrVal("Id_hpregion", Id_hpregion);
	}
...
//	}
	...
	public String getTableName() {	  
		return "BD_HP_REGION_AH";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(BdHpRegionOrginalDODesc.class);
	}
