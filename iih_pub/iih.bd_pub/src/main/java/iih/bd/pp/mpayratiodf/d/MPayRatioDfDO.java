package iih.bd.pp.mpayratiodf.d;
 ...
 * 
 */
public class MPayRatioDfDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_hpmpayratiodf";
	}
	
	@Override
	public String getTableName() {	  
		return "BD_HP_MPAYRATIODF";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MPayRatioDfDODesc.class);
	}
