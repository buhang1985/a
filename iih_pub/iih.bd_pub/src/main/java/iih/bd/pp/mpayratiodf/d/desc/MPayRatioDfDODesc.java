...
package iih.bd.pp.mpayratiodf.d.desc;
...
/**
 * 医保计划_多支付比例字典 DO 元数据信息
 */
public class MPayRatioDfDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.mpayratiodf.d.MPayRatioDfDO";
	public static final String CLASS_DISPALYNAME = "医保计划_多支付比例字典";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_MPAYRATIODF";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpmpayratiodf";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpmpayratiodfADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpmpayratiodfCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpmpayratiodf");
