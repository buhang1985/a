 ...
 * 
 */
public class BdHpOrgDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_HPORG= "Id_hporg";
	...
	public String getId_hporg() {
		return ((String) getAttrVal("Id_hporg"));
	}	
	public void setId_hporg(String Id_hporg) {
		setAttrVal("Id_hporg", Id_hporg);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(BdHpOrgDODesc.class);
	}
