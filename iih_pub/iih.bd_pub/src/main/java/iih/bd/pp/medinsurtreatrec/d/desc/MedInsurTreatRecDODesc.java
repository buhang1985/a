...
package iih.bd.pp.medinsurtreatrec.d.desc;
 ...
 * 医保诊疗记录 DO 元数据信息
 */
public class MedInsurTreatRecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.medinsurtreatrec.d.MedInsurTreatRecDO";
	public static final String CLASS_DISPALYNAME = "医保诊疗记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_ANMEDI_TREAT_REC";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_treatrec";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_treatrecADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_treatrecADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_treatrecCDesc(tblDesc));
		tblDesc.add(getId_treatrecCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_treatrecADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_treatrec",  getId_treatrecCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("诊疗记录主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_treatrecCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_treatrec");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("诊疗记录主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_treatrec");
