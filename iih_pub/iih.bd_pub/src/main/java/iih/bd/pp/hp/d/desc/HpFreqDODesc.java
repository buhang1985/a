 ...
 * 医保计划下频次 DO 元数据信息
 */
public class HpFreqDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.hp.d.HpFreqDO";
	public static final String CLASS_DISPALYNAME = "医保计划下频次";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_hp_freq";
	public static final String TABLE_ALIAS_NAME = "a6";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpfreq";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpfreqADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_hpADesc(tblDesc));
		this.add(getId_hpfreqADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpfreqCDesc(tblDesc));
		tblDesc.add(getId_hpfreqCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hpfreqADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hpfreq",  getId_hpfreqCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医保计划下频次主键");
	...
	private IAttrDesc getName_freqADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("his频次名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_freq a6b3","id_freq=id_freq","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_hpfreqCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hpfreq");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医保计划下频次主键"); 
		return column;
	}
	/**
	 * 获取医保计划表列元数据
