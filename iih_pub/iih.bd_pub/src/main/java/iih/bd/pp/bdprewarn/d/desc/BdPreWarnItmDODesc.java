 ...
 * 受控名单 DO 元数据信息
 */
public class BdPreWarnItmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.bdprewarn.d.BdPreWarnItmDO";
	public static final String CLASS_DISPALYNAME = "受控名单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_prewarn_itm";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_prewarnitm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_prewarnitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_prewarnADesc(tblDesc));
		this.add(getId_prewarnitmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_prewarnitmCDesc(tblDesc));
		tblDesc.add(getId_prewarnitmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_prewarnitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_prewarnitm",  getId_prewarnitmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("受控名单主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_prewarnitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_prewarnitm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("受控名单主键"); 
		return column;
	}
	/**
	 * 获取预交金警告策略主键表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_prewarnitm");
		iBDDataInfoFldMap.put("pid","Id_prewarn");
	}
