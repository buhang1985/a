package iih.bd.pp.prisrvsetfix.d;
 ...
 * 
 */
public class PriSrvSetFixDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_PRISRVSETFIX= "Id_prisrvsetfix";
...
//	}
	...
	public String getPKFieldName() {
		return "Id_prisrvsetfix";
	}
	
	@Override
	public String getTableName() {	  
		return "bd_pri_srv_setfix";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PriSrvSetFixDODesc.class);
	}
