...
package iih.bd.pp.bdhpsrvctrdef.d.desc;
...
public class BdHpSrvCtrDsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.bdhpsrvctrdef.d.BdHpSrvCtrDefDO";
	public static final String CLASS_DISPALYNAME = "医保目录对照病种限制";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_hp_srvctr_def";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvctr_def";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvctr_defADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_srvctr_defADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvctr_defCDesc(tblDesc));
		tblDesc.add(getId_srvctr_defCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvctr_defADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvctr_def",  getId_srvctr_defCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvctr_defCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvctr_def");
		column.setLength(20);
