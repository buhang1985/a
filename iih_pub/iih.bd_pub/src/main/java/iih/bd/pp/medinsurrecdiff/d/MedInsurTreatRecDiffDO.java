 ...
 * 
 */
public class MedInsurTreatRecDiffDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_TREATDIFF= "Id_treatdiff";
	...
	public MedInsurTreatRecDiffDO () {
		super();
	}
	
	public String getId_treatdiff() {
		return ((String) getAttrVal("Id_treatdiff"));
	}	
	public void setId_treatdiff(String Id_treatdiff) {
		setAttrVal("Id_treatdiff", Id_treatdiff);
	}
...
//	}
	...
	public String getTableName() {	  
		return "BD_AHMEDIDIFF_TREAT";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MedInsurTreatRecDiffDODesc.class);
	}
