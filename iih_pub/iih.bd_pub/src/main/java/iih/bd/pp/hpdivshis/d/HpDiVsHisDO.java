 ...
 * 
 */
public class HpDiVsHisDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_HPDIVSHIS= "Id_hpdivshis";
	...
	public static final String ID_HPDIDICT= "Id_hpdidict";
	public static final String DIDEF_CODE= "Didef_code";
	public static final String DIDEF_NAME= "Didef_name";
	public static final String HPDIDICT_CODE= "Hpdidict_code";
	public static final String HPDIDICT_NAME= "Hpdidict_name";
...
//	}
	...
	public String getTableName() {	  
		return "bd_hp_di_vs_his";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpDiVsHisDODesc.class);
	}
