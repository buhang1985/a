package iih.bd.pp.bdhpsrvctrds.d;
...
public class BdHpSrvCtrDsDO extends BaseDO {
	...
	//主键
	public static final String ID_SRVCTR_DS= "Id_srvctr_ds";
	//所属集团
	 ...
	 * @return String
	 */
	public String getId_srvctr_ds() {
		return ((String) getAttrVal("Id_srvctr_ds"));
	}	
	/**
	 * 主键
	 * @param Id_srvctr_ds
	 */
	public void setId_srvctr_ds(String Id_srvctr_ds) {
		setAttrVal("Id_srvctr_ds", Id_srvctr_ds);
	}
	/**
	 * 所属集团
	 * @return String
