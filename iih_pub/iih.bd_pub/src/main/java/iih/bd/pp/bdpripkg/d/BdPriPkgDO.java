 ...
 * 
 */
public class BdPriPkgDO extends BaseDO {
	...
	public FDouble getRate_default() {
		return ((FDouble) getAttrVal("Rate_default"));
	}	
	public void setRate_default(FDouble Rate_default) {
		setAttrVal("Rate_default", Rate_default);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(BdPriPkgDODesc.class);
	}
