...
package iih.bd.pp.hpdidictneusoftah.d.desc;
 ...
 */
public class HpDiDictNeusoftAhDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.hpdidictneusoftah.d.HpDiDictNeusoftAhDO";
	public static final String CLASS_DISPALYNAME = "医保诊断扩展_东软安徽";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_hp_di_dict_neusoft_ah";
	 ...
	 * 无参构造函数
	 */
	public HpDiDictNeusoftAhDODesc(){
		init();
	}
