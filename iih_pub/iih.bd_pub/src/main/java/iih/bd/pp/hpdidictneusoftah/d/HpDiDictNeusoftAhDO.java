package iih.bd.pp.hpdidictneusoftah.d;
 ...
 * 
 */
public class HpDiDictNeusoftAhDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "bd_hp_di_dict_neusoft_ah";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpDiDictNeusoftAhDODesc.class);
	}
