...
package iih.bd.pp.prisrvcomp.d.desc;
 ...
 * 付款策略_组合定价 DO 元数据信息
 */
public class PriSrvCompDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.prisrvcomp.d.PriSrvCompDO";
	public static final String CLASS_DISPALYNAME = "付款策略_组合定价";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_pri_srv_comp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_prisrvcomp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_prisrvcompADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_prisrvcompADesc(tblDesc));
		...
		this.add(getFg_adjustableADesc(tblDesc));
		...
		this.add(getSrv_bl_fg_mmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_prisrvcompCDesc(tblDesc));
		tblDesc.add(getId_prisrvcompCDesc(tblDesc));
		...
		tblDesc.add(getFg_adjustableCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_prisrvcompADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_prisrvcomp",  getId_prisrvcompCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("组合定价主键");
	 ...
	 * @return
	 */
	private IAttrDesc getFg_adjustableADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_adjustable",  getFg_adjustableCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("数量可调整标志");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getCode_srvADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b3","id_srv_bl=id_srv","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_srvADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b3","id_srv_bl=id_srv","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getId_primdADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b3","id_srv_bl=id_srv","id_primd"});
		attrDesc.setRefType(true);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getSrv_bl_fg_mmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Srv_bl_fg_mm",  getSrv_bl_fg_mmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b3","id_srv_bl=id_srv","fg_mm"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_prisrvcompCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_prisrvcomp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("组合定价主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_adjustableCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_adjustable");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("数量可调整标志"); 
		return column;
	}
	/**
	 * 获取价格系数表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSrv_bl_fg_mmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Srv_bl_fg_mm");
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_prisrvcomp");
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Ratio",new xap.mw.coreitf.d.FDouble(1));
	}
