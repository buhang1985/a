...
package iih.bd.pp.medinsursrvfacrec.d.desc;
 ...
 * 医保服务设施记录 DO 元数据信息
 */
public class MedInsurSrvFacRecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.medinsursrvfacrec.d.MedInsurSrvFacRecDO";
	public static final String CLASS_DISPALYNAME = "医保服务设施记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_ANMEDI_SRVFAC_REC";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvfacrec";
	 ...
	 * 无参构造函数
	 */
	public MedInsurSrvFacRecDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvfacrecADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_srvfacrecADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvfacrecCDesc(tblDesc));
		tblDesc.add(getId_srvfacrecCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvfacrecADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvfacrec",  getId_srvfacrecCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("服务设施记录主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvfacrecCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvfacrec");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("服务设施记录主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_srvfacrec");
		iBDDataInfoFldMap.put("id_org","Id_org");
		iBDDataInfoFldMap.put("code","Code");
		iBDDataInfoFldMap.put("name","Name");
		iBDDataInfoFldMap.put("id_group","Id_grp");
		iBDDataInfoFldMap.put("pycode","Py_code");
		iBDDataInfoFldMap.put("wbcode","Wb_code");
		iBDDataInfoFldMap.put("mnecode","Zdy_code");
	}
