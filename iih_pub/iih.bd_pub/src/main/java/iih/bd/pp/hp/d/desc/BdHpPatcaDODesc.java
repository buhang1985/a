 ...
 * 医保计划_医保身份 DO 元数据信息
 */
public class BdHpPatcaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.hp.d.BdHpPatcaDO";
	public static final String CLASS_DISPALYNAME = "医保计划_医保身份";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_PATCA";
	public static final String TABLE_ALIAS_NAME = "a10";
	public static final String PRIMARYKEY_FIELDNAME="Id_hppatca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hppatcaADesc(tblDesc));
		...
		this.add(getFg_allinhpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hppatcaCDesc(tblDesc));
		...
		tblDesc.add(getName_hppatcaCDesc(tblDesc));
		tblDesc.add(getFg_allinhpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_allinhpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_allinhp",  getFg_allinhpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("全保内标志");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_allinhpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_allinhp");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("全保内标志"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hppatca");
		iBDDataInfoFldMap.put("id_org","Id_org");
		iBDDataInfoFldMap.put("code","Code_hppatca");
		iBDDataInfoFldMap.put("name","Name_hppatca");
