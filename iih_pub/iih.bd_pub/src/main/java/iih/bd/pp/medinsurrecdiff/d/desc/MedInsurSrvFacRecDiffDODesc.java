 ...
 * 医保服务设施记录差异 DO 元数据信息
 */
public class MedInsurSrvFacRecDiffDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.medinsurrecdiff.d.MedInsurSrvFacRecDiffDO";
	public static final String CLASS_DISPALYNAME = "医保服务设施记录差异";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_AHMEDIDIFF_SRVFAC";
	public static final String TABLE_ALIAS_NAME = "a3";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvfacdiff";
	 ...
	 * 无参构造函数
	 */
	public MedInsurSrvFacRecDiffDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvfacdiffADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_diffADesc(tblDesc));
		this.add(getId_srvfacdiffADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_diffADesc(tblDesc));
		this.add(getEu_difftypeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvfacdiffCDesc(tblDesc));
		tblDesc.add(getId_srvfacdiffCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_diffCDesc(tblDesc));
		tblDesc.add(getEu_difftypeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvfacdiffADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvfacdiff",  getId_srvfacdiffCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("服务设施差异主键");
	 ...
	 * @return
	 */
	private IAttrDesc getEu_difftypeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Eu_difftype",  getEu_difftypeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("差异类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvfacdiffCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvfacdiff");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("服务设施差异主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getEu_difftypeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Eu_difftype");
		column.setLength(50);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("差异类型"); 
		return column;
	}
	/**
	 * 获取下载主键表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_srvfacdiff");
