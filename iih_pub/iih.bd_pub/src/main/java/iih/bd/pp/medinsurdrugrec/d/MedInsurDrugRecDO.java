package iih.bd.pp.medinsurdrugrec.d;
 ...
 * 
 */
public class MedInsurDrugRecDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_DRUGREC= "Id_drugrec";
	...
	public MedInsurDrugRecDO () {
		super();
	}
	
	public String getId_drugrec() {
		return ((String) getAttrVal("Id_drugrec"));
	}	
	public void setId_drugrec(String Id_drugrec) {
		setAttrVal("Id_drugrec", Id_drugrec);
	}
	...
	public Integer getStr_oct() {
		return ((Integer) getAttrVal("Str_oct"));
	}	
	public void setStr_oct(Integer Str_oct) {
	...
	public Integer getStr_prep_self() {
		return ((Integer) getAttrVal("Str_prep_self"));
	}	
	public void setStr_prep_self(Integer Str_prep_self) {
	...
	public Integer getCode_ca() {
		return ((Integer) getAttrVal("Code_ca"));
	}	
	public void setCode_ca(Integer Code_ca) {
...
//	}
	...
	public String getTableName() {	  
		return "BD_ANMEDI_DRUG_REC";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MedInsurDrugRecDODesc.class);
	}
