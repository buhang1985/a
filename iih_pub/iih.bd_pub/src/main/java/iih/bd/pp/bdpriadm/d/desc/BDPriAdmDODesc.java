...
package iih.bd.pp.bdpriadm.d.desc;
...
/**
 * 入院登记收费项目配置表 DO 元数据信息
 */
public class BDPriAdmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.bdpriadm.d.BDPriAdmDO";
	public static final String CLASS_DISPALYNAME = "入院登记收费项目配置表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_PRI_ADM";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_priadm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_priadmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_priadmADesc(tblDesc));
		...
		this.add(getFg_pay_firstadmADesc(tblDesc));
		this.add(getCreatedbyADesc(tblDesc));
		this.add(getCreatedtimeADesc(tblDesc));
		this.add(getModifiedbyADesc(tblDesc));
		this.add(getModifiedtimeADesc(tblDesc));
		this.add(getName_owtpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_priadmCDesc(tblDesc));
		tblDesc.add(getId_priadmCDesc(tblDesc));
		...
		tblDesc.add(getFg_pay_firstadmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_priadmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_priadm",  getId_priadmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本采集费用主键");
	 ...
	 * @return
	 */
	private IAttrDesc getFg_pay_firstadmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_pay_firstadm",  getFg_pay_firstadmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否只有首次入院收取费用");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_owtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_owtp",  getName_owtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b10","id_owtp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getFg_mmADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b7","id_srv=id_srv","fg_mm"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_priadmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_priadm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("标本采集费用主键"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_pay_firstadmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_pay_firstadm");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否只有首次入院收取费用"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_owtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_owtp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_priadm");
