 ...
 * 医保计划_医疗机构 DO 元数据信息
 */
public class BdHpOrgDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.hp.d.BdHpOrgDO";
	public static final String CLASS_DISPALYNAME = "医保计划_医疗机构";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_hp_org";
	public static final String TABLE_ALIAS_NAME = "a12";
	public static final String PRIMARYKEY_FIELDNAME="Id_hporg";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hporgADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_hpADesc(tblDesc));
		this.add(getId_hporgADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hporgCDesc(tblDesc));
		tblDesc.add(getId_hporgCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hporgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hporg",  getId_hporgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医保计划机构主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_hporgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hporg");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医保计划机构主键"); 
		return column;
	}
	/**
	 * 获取医保计划表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hporg");
