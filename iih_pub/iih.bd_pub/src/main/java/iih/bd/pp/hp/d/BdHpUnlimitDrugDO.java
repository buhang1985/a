...
/**
 * 付款策略_医保计划_不限量药品 DO数据 
 * 
 */
public class BdHpUnlimitDrugDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_HPUNLIMITDRUG= "Id_hpunlimitdrug";
	...
	public String getId_hpunlimitdrug() {
		return ((String) getAttrVal("Id_hpunlimitdrug"));
	}	
	public void setId_hpunlimitdrug(String Id_hpunlimitdrug) {
		setAttrVal("Id_hpunlimitdrug", Id_hpunlimitdrug);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_hpunlimitdrug";
	}
	
	@Override
	public String getTableName() {	  
		return "bd_hp_unlimit_drug";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(BdHpUnlimitDrugDODesc.class);
	}
