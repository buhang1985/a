 ...
 * 禁止单方服务表 DO 元数据信息
 */
public class BdHpLimitPsdDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.hp.d.BdHpLimitPsdDO";
	public static final String CLASS_DISPALYNAME = "禁止单方服务表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_LIMIT_PSD";
	public static final String TABLE_ALIAS_NAME = "a11";
	public static final String PRIMARYKEY_FIELDNAME="Id_hplimitpsd";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hplimitpsdADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_hpADesc(tblDesc));
		this.add(getId_hplimitpsdADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hplimitpsdCDesc(tblDesc));
		tblDesc.add(getId_hplimitpsdCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hplimitpsdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hplimitpsd",  getId_hplimitpsdCDesc(tblDesc), this);
	...
	private IAttrDesc getName_srvADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a11b3","id_srv=id_srv","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_hplimitpsdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hplimitpsd");
		column.setLength(20);
