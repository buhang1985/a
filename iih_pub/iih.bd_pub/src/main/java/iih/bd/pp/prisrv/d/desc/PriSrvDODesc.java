...
package iih.bd.pp.prisrv.d.desc;
...
public class PriSrvDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.prisrv.d.PriSrvDO";
	public static final String CLASS_DISPALYNAME = "服务价表(本服务定价)";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_PRI_SRV";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_prisrv";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_prisrvADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_prisrvADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_prisrvCDesc(tblDesc));
		tblDesc.add(getId_prisrvCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_prisrvADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_prisrv",  getId_prisrvCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("服务定价主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_prisrvCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_prisrv");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("服务定价主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_prisrv");
