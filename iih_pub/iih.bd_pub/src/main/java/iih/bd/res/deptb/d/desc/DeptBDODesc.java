...
package iih.bd.res.deptb.d.desc;
 ...
 * 部门 DO 元数据信息
 */
public class DeptBDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.res.deptb.d.DeptBDO";
	public static final String CLASS_DISPALYNAME = "部门";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_dep";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_dep";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_depADesc(tblDesc));
		...
		this.add(getSd_deptlevelADesc(tblDesc));
		this.add(getCreatedateADesc(tblDesc));
		this.add(getShortnameADesc(tblDesc));
		this.add(getPycodeADesc(tblDesc));
		this.add(getWbcodeADesc(tblDesc));
		this.add(getMnecodeADesc(tblDesc));
		this.add(getDeptcanceldateADesc(tblDesc));
		this.add(getCreatedbyADesc(tblDesc));
		this.add(getCreatedtimeADesc(tblDesc));
		this.add(getModifiedbyADesc(tblDesc));
		this.add(getModifiedtimeADesc(tblDesc));
		this.add(getActivestateADesc(tblDesc));
		this.add(getDisplayorderADesc(tblDesc));
		this.add(getPrincipalADesc(tblDesc));
		this.add(getTelADesc(tblDesc));
		this.add(getId_plcADesc(tblDesc));
		this.add(getDesADesc(tblDesc));
		this.add(getIslastversionADesc(tblDesc));
		this.add(getDeptdutyADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_depCDesc(tblDesc));
		...
		tblDesc.add(getSd_depttpCDesc(tblDesc));
		tblDesc.add(getSd_deptlevelCDesc(tblDesc));
		tblDesc.add(getCreatedateCDesc(tblDesc));
		tblDesc.add(getShortnameCDesc(tblDesc));
		tblDesc.add(getPycodeCDesc(tblDesc));
		tblDesc.add(getWbcodeCDesc(tblDesc));
		tblDesc.add(getMnecodeCDesc(tblDesc));
		tblDesc.add(getDeptcanceldateCDesc(tblDesc));
		tblDesc.add(getCreatedbyCDesc(tblDesc));
		tblDesc.add(getCreatedtimeCDesc(tblDesc));
		tblDesc.add(getModifiedbyCDesc(tblDesc));
		tblDesc.add(getModifiedtimeCDesc(tblDesc));
		tblDesc.add(getActivestateCDesc(tblDesc));
		tblDesc.add(getDisplayorderCDesc(tblDesc));
		tblDesc.add(getPrincipalCDesc(tblDesc));
		tblDesc.add(getTelCDesc(tblDesc));
		tblDesc.add(getId_plcCDesc(tblDesc));
		tblDesc.add(getDesCDesc(tblDesc));
		tblDesc.add(getIslastversionCDesc(tblDesc));
		tblDesc.add(getDeptdutyCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getSd_deptlevelADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_deptlevel",  getSd_deptlevelCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("部门级别");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getCreatedateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Createdate",  getCreatedateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDate);
		attrDesc.setLabel("部门成立时间");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDeptcanceldateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Deptcanceldate",  getDeptcanceldateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDateTime);
		attrDesc.setLabel("部门撤销日期");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDisplayorderADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Displayorder",  getDisplayorderCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
	 ...
	 * @return
	 */
	private IAttrDesc getPrincipalADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Principal",  getPrincipalCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getIslastversionADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Islastversion",  getIslastversionCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否最新版本");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDeptdutyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Deptduty",  getDeptdutyCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("部门职责");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getDept_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("上级部门编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep b1","id_parent=id_dep","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDept_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("上级部门名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep b1","id_parent=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getGrp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_grp b2","id_grp=id_grp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getGrp_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_grp b2","id_grp=id_grp","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getOrg_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_org b3","id_org=id_org","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getOrg_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_org b3","id_org=id_org","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getSd_deptlevelCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_deptlevel");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("部门级别"); 
		return column;
	}
	/**
	 * 获取部门成立时间表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getCreatedateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Createdate");
		column.setLength(10);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("部门成立时间"); 
		return column;
	}
	/**
	 * 获取简称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDeptcanceldateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Deptcanceldate");
		column.setLength(19);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("部门撤销日期"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDisplayorderCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Displayorder");
		column.setLength(22);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getPrincipalCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Principal");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("负责人"); 
	 ...
	 * @return
	 */
	private IColumnDesc getIslastversionCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Islastversion");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否最新版本"); 
		return column;
	}
	/**
	 * 获取部门职责表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDeptdutyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Deptduty");
		column.setLength(1024);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("部门职责"); 
		return column;
	}
	/**
	 * 获取客开字段1表列元数据
	...
	private IColumnDesc getDef1CDesc(ITableDesc tblDesc){
		...
		column.setLength(101);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("客开字段1"); 
		return column;
	}
	/**
	 * 获取客开字段2表列元数据
