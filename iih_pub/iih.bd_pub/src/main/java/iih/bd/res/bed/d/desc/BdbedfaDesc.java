 ...
 * 床位固定资产对应 DO 元数据信息
 */
public class BdbedfaDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.res.bed.d.Bdbedfa";
	public static final String CLASS_DISPALYNAME = "床位固定资产对应";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_BED_FA";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_bedfa";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_bedfaADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_bedADesc(tblDesc));
		this.add(getId_bedfaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_bedfaCDesc(tblDesc));
		tblDesc.add(getId_bedfaCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_bedfaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_bedfa",  getId_bedfaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("床位固定资产ID");
	 ...
	 * @return
	 */
	private IColumnDesc getId_bedfaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_bedfa");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("床位固定资产ID"); 
		return column;
	}
	/**
	 * 获取床位表列元数据
