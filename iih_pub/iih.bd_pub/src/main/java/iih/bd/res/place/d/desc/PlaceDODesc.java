...
package iih.bd.res.place.d.desc;
 ...
 * 地点 DO 元数据信息
 */
public class PlaceDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.res.place.d.PlaceDO";
	public static final String CLASS_DISPALYNAME = "地点";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_plc";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_plc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_plcADesc(tblDesc));
		...
		this.add(getName_pathADesc(tblDesc));
		...
		this.add(getParent_name_pathADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_plcCDesc(tblDesc));
		tblDesc.add(getId_plcCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getCodeCDesc(tblDesc));
		tblDesc.add(getNameCDesc(tblDesc));
		tblDesc.add(getName_pathCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_pathADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_path",  getName_pathCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getParent_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_plc a0b3","id_parent=id_plc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getParent_name_pathADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Parent_name_path",  getParent_name_pathCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("地点全局名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_plc a0b3","id_parent=id_plc","name_path"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_pathCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_path");
		column.setLength(100);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getParent_name_pathCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Parent_name_path");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("地点全局名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_plc");
