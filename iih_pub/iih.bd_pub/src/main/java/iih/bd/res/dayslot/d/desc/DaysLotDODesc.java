 ...
 * 日期分组 DO 元数据信息
 */
public class DaysLotDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.res.dayslot.d.DaysLotDO";
	public static final String CLASS_DISPALYNAME = "日期分组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_dayslot";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_dayslot";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_dayslotADesc(tblDesc));
		...
		this.add(getName_dayslotcaADesc(tblDesc));
		this.add(getCode_dayslotcaADesc(tblDesc));
		this.add(getDayslottp_codeADesc(tblDesc));
		this.add(getDayslottp_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_dayslotCDesc(tblDesc));
		...
		tblDesc.add(getId_dayslottpCDesc(tblDesc));
		tblDesc.add(getSd_dayslottpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_dayslotcaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_dayslotca",  getName_dayslotcaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dayslotca a0b4","id_dayslotca=id_dayslotca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_dayslotcaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_dayslotca",  getCode_dayslotcaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dayslotca a0b4","id_dayslotca=id_dayslotca","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getDayslottp_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dayslottp_code",  getDayslottp_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_dayslottp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getDayslottp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dayslottp_name",  getDayslottp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_dayslottp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_dayslotcaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_dayslotca");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_dayslotcaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_dayslotca");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getDayslottp_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dayslottp_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getDayslottp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dayslottp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_dayslot");
