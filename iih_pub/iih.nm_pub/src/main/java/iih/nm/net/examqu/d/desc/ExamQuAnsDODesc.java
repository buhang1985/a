 ...
 * 答案 DO 元数据信息
 */
public class ExamQuAnsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.net.examqu.d.ExamQuAnsDO";
	public static final String CLASS_DISPALYNAME = "答案";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_EXAM_QU_ANS";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_qu_ans";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_qu_ansADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_quADesc(tblDesc));
		...
		this.add(getFg_rightADesc(tblDesc));
		this.add(getAns_contentADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_qu_ansCDesc(tblDesc));
		...
		tblDesc.add(getFg_rightCDesc(tblDesc));
		tblDesc.add(getAns_contentCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_rightADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_right",  getFg_rightCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否正确答案");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAns_contentADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Ans_content",  getAns_contentCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("内容(选项)");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_rightCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_right");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否正确答案"); 
		return column;
	}
	/**
	 * 获取内容(选项)表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAns_contentCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Ans_content");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("内容(选项)"); 
		return column;
	}
	/**
	 * 获取备注表列元数据
