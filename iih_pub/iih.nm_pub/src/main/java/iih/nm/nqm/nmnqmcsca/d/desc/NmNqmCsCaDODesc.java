...
package iih.nm.nqm.nmnqmcsca.d.desc;
 ...
 * 检查标准分类 DO 元数据信息
 */
public class NmNqmCsCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nmnqmcsca.d.NmNqmCsCaDO";
	public static final String CLASS_DISPALYNAME = "检查标准分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_CSCA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_csca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_cscaADesc(tblDesc));
		...
		this.add(getMecodeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_cscaCDesc(tblDesc));
		...
		tblDesc.add(getMecodeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getMecodeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mecode",  getMecodeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getMecodeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mecode");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("助记码"); 
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("mnecode","Mecode");
	}
