 ...
 * 护理管理_检查科室 DO 元数据信息
 */
public class NmNqmTaskDepDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nmnqmtask.d.NmNqmTaskDepDO";
	public static final String CLASS_DISPALYNAME = "护理管理_检查科室";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_TASK_DEP";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_task_dep";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_task_depADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_task_depCDesc(tblDesc));
