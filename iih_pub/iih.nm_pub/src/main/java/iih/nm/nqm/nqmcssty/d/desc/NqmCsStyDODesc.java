 ...
 * 质量检查表样式 DO 元数据信息
 */
public class NqmCsStyDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nqmcssty.d.NqmCsStyDO";
	public static final String CLASS_DISPALYNAME = "质量检查表样式";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_CS_STY";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_cs_sty";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_cs_styADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_cs_styCDesc(tblDesc));
