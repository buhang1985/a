 ...
 * 任务参与人员 DO 元数据信息
 */
public class NmNqmTaskActorDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nmnqmtask.d.NmNqmTaskActorDO";
	public static final String CLASS_DISPALYNAME = "任务参与人员";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_TASK_ACTOR";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_task_actor";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_task_actorADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_nqm_taskADesc(tblDesc));
		this.add(getId_nqm_task_actorADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_task_actorCDesc(tblDesc));
		tblDesc.add(getId_nqm_task_actorCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nqm_task_actorADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nqm_task_actor",  getId_nqm_task_actorCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("任务参与人员主键");
	...
	private IAttrDesc getName_qc_grpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NQM_QCGRP a1b6","id_qc_grp=id_nqm_qcgrp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_dutyADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a1b7","id_duty=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nqm_task_actorCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nqm_task_actor");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("任务参与人员主键"); 
		return column;
	}
	/**
	 * 获取检查任务外键表列元数据
