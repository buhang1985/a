...
package iih.nm.nqm.qctplcamaintenance.d.desc;
 ...
 * 质量控制模板分类 DO 元数据信息
 */
public class NmQctplCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.qctplcamaintenance.d.NmQctplCaDO";
	public static final String CLASS_DISPALYNAME = "质量控制模板分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_QCTPL_CA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_qctpl_ca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_qctpl_caADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_qctpl_caCDesc(tblDesc));
	...
	private IAttrDesc getName_parADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_QCTPL_CA a0b6","id_par=id_qctpl_ca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_qctpl_ca");
