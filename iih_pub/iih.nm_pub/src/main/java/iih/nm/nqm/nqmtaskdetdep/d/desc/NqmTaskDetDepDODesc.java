...
/**
 * 质控任务明细受检护理单元 DO 元数据信息
 */
public class NqmTaskDetDepDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nqmtaskdetdep.d.NqmTaskDetDepDO";
	public static final String CLASS_DISPALYNAME = "质控任务明细受检护理单元";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_TASK_DET_DEP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_task_det_dep";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_task_det_depADesc(tblDesc));
		...
		this.add(getName_ndb_depADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_task_det_depCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_ndb_depADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_ndb_dep",  getName_ndb_depCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NBD_DEP a0b2","id_nbd_dep=id_nbd_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_ndb_depCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_ndb_dep");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
