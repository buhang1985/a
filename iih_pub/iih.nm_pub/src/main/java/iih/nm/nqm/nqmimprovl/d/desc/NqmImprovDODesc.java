 ...
 * 持续改进 DO 元数据信息
 */
public class NqmImprovDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nqmimprovl.d.NqmImprovDO";
	public static final String CLASS_DISPALYNAME = "持续改进";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_IMPROV";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_improv";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_improvADesc(tblDesc));
		...
		this.add(getId_nqm_lvlADesc(tblDesc));
		...
		this.add(getName_nqm_lvlADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_improvCDesc(tblDesc));
		...
		tblDesc.add(getId_nqm_lvlCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nqm_lvlADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nqm_lvl",  getId_nqm_lvlCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getCode_depADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b10","id_dep=id_dep","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_nqm_lvlADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_nqm_lvl",  getName_nqm_lvlCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("质控级别");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_nqm_lvl=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_reg_psnADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b5","id_reg_psn=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nqm_lvlCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nqm_lvl");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_nqm_lvlCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_nqm_lvl");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("质控级别"); 
		return column;
