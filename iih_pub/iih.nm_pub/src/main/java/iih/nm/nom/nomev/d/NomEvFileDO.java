 ...
 * 
 */
public class NomEvFileDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_NOM_EV_FILE= "Id_nom_ev_file";
	public static final String NAME= "Name";
	public static final String DT_UPLOAD= "Dt_upload";
	public static final String ID_UPLOAD_PSN= "Id_upload_psn";
	...
	public String getId_nom_ev_file() {
		return ((String) getAttrVal("Id_nom_ev_file"));
	}	
	public void setId_nom_ev_file(String Id_nom_ev_file) {
		setAttrVal("Id_nom_ev_file", Id_nom_ev_file);
	}
	...
	public String getId_upload_psn() {
		return ((String) getAttrVal("Id_upload_psn"));
	}	
	public void setId_upload_psn(String Id_upload_psn) {
		setAttrVal("Id_upload_psn", Id_upload_psn);
	}
	public String getFile_path() {
		return ((String) getAttrVal("File_path"));
	}	
	public void setFile_path(String File_path) {
		setAttrVal("File_path", File_path);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_nom_ev_file";
	}
	
	@Override
	public String getTableName() {	  
		return "NM_NOM_EV_FILE";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(NomEvFileDODesc.class);
	}
