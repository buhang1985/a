 ...
 * 护理部大事记 DO 元数据信息
 */
public class NomEvDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nom.nomev.d.NomEvDO";
	public static final String CLASS_DISPALYNAME = "护理部大事记";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NOM_EV";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nom_ev";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nom_evADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nom_evCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_om_ev");
