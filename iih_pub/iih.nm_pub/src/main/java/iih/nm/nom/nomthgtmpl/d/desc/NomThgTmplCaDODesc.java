 ...
 * 病区事物记录模板分类 DO 元数据信息
 */
public class NomThgTmplCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nom.nomthgtmpl.d.NomThgTmplCaDO";
	public static final String CLASS_DISPALYNAME = "病区事物记录模板分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NOM_THGTMPL_CA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nom_thgtmpl_ca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nom_thgtmpl_caADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nom_thgtmpl_caADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nom_thgtmpl_caCDesc(tblDesc));
		tblDesc.add(getId_nom_thgtmpl_caCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nom_thgtmpl_caADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nom_thgtmpl_ca",  getId_nom_thgtmpl_caCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_nom_thgtmpl_caCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nom_thgtmpl_ca");
		column.setLength(20);
