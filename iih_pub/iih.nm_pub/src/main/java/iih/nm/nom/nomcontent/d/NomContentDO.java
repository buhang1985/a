package iih.nm.nom.nomcontent.d;
...
import iih.nm.nom.nomcontent.d.desc.NomContentDODesc;
 ...
 * 
 */
public class NomContentDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_NOM_CONTENT= "Id_nom_content";
	public static final String ID_ORG= "Id_org";
	public static final String ID_GRP= "Id_grp";
	public static final String DT_WRITE= "Dt_write";
	...
	public String getId_nom_content() {
		return ((String) getAttrVal("Id_nom_content"));
	}	
	public void setId_nom_content(String Id_nom_content) {
		setAttrVal("Id_nom_content", Id_nom_content);
	}
	...
	public FDate getDt_write() {
		return ((FDate) getAttrVal("Dt_write"));
	}	
	public void setDt_write(FDate Dt_write) {
		setAttrVal("Dt_write", Dt_write);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_nom_content";
	}
	
	@Override
	public String getTableName() {	  
		return "NM_NOM_CONTENT";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(NomContentDODesc.class);
	}
