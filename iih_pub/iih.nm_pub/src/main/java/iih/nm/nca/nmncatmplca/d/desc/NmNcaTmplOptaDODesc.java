 ...
 * 满意度问卷模板选项 DO 元数据信息
 */
public class NmNcaTmplOptaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nca.nmncatmplca.d.NmNcaTmplOptaDO";
	public static final String CLASS_DISPALYNAME = "满意度问卷模板选项";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NCA_TMPL_OPTA";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_nca_tmpl_opta";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nca_tmpl_optaADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_nca_tmplcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nca_tmpl_optaCDesc(tblDesc));
		...
		tblDesc.add(getResCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getResADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Res",  getResCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getResCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Res");
