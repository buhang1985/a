...
/**
 * 护理管理_实习小组计划_人员 DO 元数据信息
 */
public class NmNitGrpPlPsnDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nit.nmnitgrpplpsn.d.NmNitGrpPlPsnDO";
	public static final String CLASS_DISPALYNAME = "护理管理_实习小组计划_人员";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NIT_GRPPL_PSN";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nit_grppl_psn";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nit_grppl_psnADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nit_grppl_psnCDesc(tblDesc));
	...
	private IAttrDesc getName_psninfoADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NIT_PSNINFO a0b6","id_nit_psninfo=id_nit_psninfo","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
