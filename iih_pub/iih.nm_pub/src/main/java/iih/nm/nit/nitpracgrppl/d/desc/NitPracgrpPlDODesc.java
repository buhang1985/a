...
/**
 * 护理管理_小组实习计划 DO 元数据信息
 */
public class NitPracgrpPlDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nit.nitpracgrppl.d.NitPracgrpPlDO";
	public static final String CLASS_DISPALYNAME = "护理管理_小组实习计划";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NIT_PRACGRP_PL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pracgrp_pl";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pracgrp_plADesc(tblDesc));
		...
		this.add(getPracgrp_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pracgrp_plCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getPracgrp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Pracgrp_name",  getPracgrp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NIT_PRACGRP a0b4","id_pracgrp=id_pracgrp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getPracgrp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Pracgrp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pracgrp_pl");
		iBDDataInfoFldMap.put("pid","Id_pracgrp_pl");
