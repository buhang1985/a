...
package iih.nm.nit.nitpracpl.d.desc;
 ...
 * 个人实习计划 DO 元数据信息
 */
public class NitPracPlDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nit.nitpracpl.d.NitPracPlDO";
	public static final String CLASS_DISPALYNAME = "个人实习计划";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NIT_PRAC_PL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_prac_pl";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_prac_plADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_prac_plADesc(tblDesc));
		this.add(getId_gropADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_nit_psninofADesc(tblDesc));
		...
		this.add(getName_nit_psninofADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_prac_plCDesc(tblDesc));
		tblDesc.add(getId_prac_plCDesc(tblDesc));
		tblDesc.add(getId_gropCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_nit_psninofCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_gropADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_grop",  getId_gropCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getId_nit_psninofADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nit_psninof",  getId_nit_psninofCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("实习进修生主键");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_nit_psninofADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_nit_psninof",  getName_nit_psninofCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NIT_PSNINFO a0b4","id_nit_psninof=id_nit_psninfo","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_regADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b5","id_reg=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_gropCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_grop");
		column.setLength(20);
	 ...
	 * @return
	 */
	private IColumnDesc getId_nit_psninofCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nit_psninof");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("实习进修生主键"); 
		return column;
	}
	/**
	 * 获取开始日期表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_nit_psninofCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_nit_psninof");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("实习生"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id_group","Id_grop");
	}
