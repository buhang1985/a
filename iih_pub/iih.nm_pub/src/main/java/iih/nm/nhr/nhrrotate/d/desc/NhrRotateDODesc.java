...
package iih.nm.nhr.nhrrotate.d.desc;
 ...
 * 护理人员轮转记录 DO 元数据信息
 */
public class NhrRotateDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nhrrotate.d.NhrRotateDO";
	public static final String CLASS_DISPALYNAME = "护理人员轮转记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NHR_ROTATE";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nhr_rotate";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nhr_rotateADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nhr_rotateADesc(tblDesc));
		...
		this.add(getDt_rotateADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nhr_rotateCDesc(tblDesc));
		tblDesc.add(getId_nhr_rotateCDesc(tblDesc));
		...
		tblDesc.add(getDt_rotateCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nhr_rotateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nhr_rotate",  getId_nhr_rotateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("护理人员轮转记录主键");
	 ...
	 * @return
	 */
	private IAttrDesc getDt_rotateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_rotate",  getDt_rotateCDesc(tblDesc), this);
	...
	private IAttrDesc getName_dep_nur_outADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NBD_DEP a0b5","id_dep_nur_out=id_nbd_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_dep_nur_inADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NBD_DEP a0b6","id_dep_nur_in=id_nbd_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_reg_psnADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b7","id_reg_psn=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nhr_rotateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nhr_rotate");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("护理人员轮转记录主键"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDt_rotateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_rotate");
		column.setLength(10);
