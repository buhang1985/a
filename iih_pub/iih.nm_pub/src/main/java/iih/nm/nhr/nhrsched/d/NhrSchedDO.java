...
import iih.nm.nhr.nhrsched.d.desc.NhrSchedDODesc;
...
public class NhrSchedDO extends BaseDO {
	...
	public static final String NAME_NHRSI= "Name_nhrsi";
	...
	public String getName_nhrsi() {
		return ((String) getAttrVal("Name_nhrsi"));
	}	
	public void setName_nhrsi(String Name_nhrsi) {
		setAttrVal("Name_nhrsi", Name_nhrsi);
	}
