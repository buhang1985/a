...
package iih.nm.nhr.nmnuracadexp.d.desc;
...
/**
 * 护理人员_学术团体任职 DO 元数据信息
 */
public class NmNurAcadExpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmnuracadexp.d.NmNurAcadExpDO";
	public static final String CLASS_DISPALYNAME = "护理人员_学术团体任职";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NUR_ACADEXP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nur_acadexp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nur_acadexpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nur_acadexpADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_nurADesc(tblDesc));
		this.add(getDt_beginADesc(tblDesc));
		this.add(getDt_endADesc(tblDesc));
		this.add(getName_acad_badyADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nur_acadexpCDesc(tblDesc));
		tblDesc.add(getId_nur_acadexpCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_nurCDesc(tblDesc));
		tblDesc.add(getDt_beginCDesc(tblDesc));
		tblDesc.add(getDt_endCDesc(tblDesc));
		tblDesc.add(getName_acad_badyCDesc(tblDesc));
		tblDesc.add(getName_dutyCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nur_acadexpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nur_acadexp",  getId_nur_acadexpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("学术团体任职主键");
	 ...
	 * @return
	 */
	private IAttrDesc getName_acad_badyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_acad_bady",  getName_acad_badyCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("学术团体");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_nur_acadexpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nur_acadexp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("学术团体任职主键"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_acad_badyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_acad_bady");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("学术团体"); 
		return column;
	}
	/**
	 * 获取职务表列元数据
