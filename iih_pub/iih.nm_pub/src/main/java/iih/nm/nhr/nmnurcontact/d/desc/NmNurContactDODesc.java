...
package iih.nm.nhr.nmnurcontact.d.desc;
 ...
 * 护理管理_联系人 DO 元数据信息
 */
public class NmNurContactDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmnurcontact.d.NmNurContactDO";
	public static final String CLASS_DISPALYNAME = "护理管理_联系人";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NUR_CONTACT";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nur_contact";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nur_contactADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nur_contactADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nur_contactCDesc(tblDesc));
		tblDesc.add(getId_nur_contactCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nur_contactADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nur_contact",  getId_nur_contactCDesc(tblDesc), this);
	...
	private IAttrDesc getName_contact_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b9","id_conttp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nur_contactCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nur_contact");
		column.setLength(20);
