 ...
 * @version 创建时间：2017年1月5日 上午11:39:09
 * 类说明：
 * Company: Copyright 2016 by PKU healthcare IT Co.Ltd.
 */
public class NmNurTransRejectListener implements IExecutionListener{
	...
	public void notify(WfEventExecution arg0) throws Exception {
		...
		setupStatus(transFormDO, INmNurDictCodeConst.SD_APPLY_STATUS_REJECT);
	...
	private void setupStatus(NmNurTransFormDO transFormDO, String status) throws BizException {
		...
		transFormDO.setId_applystatus(INmNurDictCodeConst.ID_APPLY_STATUS_REJECT);
