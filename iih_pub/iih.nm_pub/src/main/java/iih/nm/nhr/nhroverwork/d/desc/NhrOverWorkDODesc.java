...
package iih.nm.nhr.nhroverwork.d.desc;
 ...
 * 加班申请 DO 元数据信息
 */
public class NhrOverWorkDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nhroverwork.d.NhrOverWorkDO";
	public static final String CLASS_DISPALYNAME = "加班申请";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NHR_OVERWORK";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nhr_overwork";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nhr_overworkADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nhr_overworkADesc(tblDesc));
		...
		this.add(getDt_workADesc(tblDesc));
		this.add(getDur_hourADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nhr_overworkCDesc(tblDesc));
		tblDesc.add(getId_nhr_overworkCDesc(tblDesc));
		...
		tblDesc.add(getDt_workCDesc(tblDesc));
		tblDesc.add(getDur_hourCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nhr_overworkADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nhr_overwork",  getId_nhr_overworkCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("加班申请主键");
	 ...
	 * @return
	 */
	private IAttrDesc getDt_workADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_work",  getDt_workCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDate);
		attrDesc.setLabel("加班日期");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDur_hourADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dur_hour",  getDur_hourCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_nhr_overworkCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nhr_overwork");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("加班申请主键"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDt_workCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_work");
		column.setLength(10);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("加班日期"); 
		return column;
	}
	/**
	 * 获取加班时长表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDur_hourCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dur_hour");
		column.setLength(16);
