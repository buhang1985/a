...
package iih.nm.nhr.nmnurfurstu.d.desc;
 ...
 * 人员进修 DO 元数据信息
 */
public class NmNurFurstuDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmnurfurstu.d.NmNurFurstuDO";
	public static final String CLASS_DISPALYNAME = "人员进修";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NHR_NUR_FURSTU";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nur_furstu";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nur_furstuADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nur_furstuADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_nurADesc(tblDesc));
		this.add(getDt_beginADesc(tblDesc));
		this.add(getDt_endADesc(tblDesc));
		this.add(getName_hos_stuADesc(tblDesc));
		this.add(getName_major_stuADesc(tblDesc));
		this.add(getContent_stuADesc(tblDesc));
		this.add(getAddr_stuADesc(tblDesc));
		...
		this.add(getResult_stuADesc(tblDesc));
		...
		this.add(getName_lvlADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nur_furstuCDesc(tblDesc));
		tblDesc.add(getId_nur_furstuCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_nurCDesc(tblDesc));
		tblDesc.add(getDt_beginCDesc(tblDesc));
		tblDesc.add(getDt_endCDesc(tblDesc));
		tblDesc.add(getName_hos_stuCDesc(tblDesc));
		tblDesc.add(getName_major_stuCDesc(tblDesc));
		tblDesc.add(getContent_stuCDesc(tblDesc));
		tblDesc.add(getAddr_stuCDesc(tblDesc));
		...
		tblDesc.add(getResult_stuCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nur_furstuADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nur_furstu",  getId_nur_furstuCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("联系人主键");
	 ...
	 * @return
	 */
	private IAttrDesc getName_hos_stuADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_hos_stu",  getName_hos_stuCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("进修医院");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_major_stuADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_major_stu",  getName_major_stuCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("进修专业");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getContent_stuADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Content_stu",  getContent_stuCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("进修内容");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAddr_stuADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Addr_stu",  getAddr_stuCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("进修地点");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getResult_stuADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Result_stu",  getResult_stuCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("进修成果");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_lvlADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_lvl",  getName_lvlCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_nur_lvl=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nur_furstuCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nur_furstu");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("联系人主键"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_hos_stuCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_hos_stu");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("进修医院"); 
		return column;
	}
	/**
	 * 获取进修专业表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_major_stuCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_major_stu");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("进修专业"); 
		return column;
	}
	/**
	 * 获取进修内容表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getContent_stuCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Content_stu");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("进修内容"); 
		return column;
	}
	/**
	 * 获取进修地点表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAddr_stuCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Addr_stu");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("进修地点"); 
		return column;
	}
	/**
	 * 获取职称id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getResult_stuCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Result_stu");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("进修成果"); 
		return column;
	}
	/**
	 * 获取备注表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_lvlCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_lvl");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
