...
package iih.nm.nhr.nmnhrnurdefbed.d.desc;
 ...
 * 护理人员床位维护 DO 元数据信息
 */
public class NmNhrNurDefbedDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmnhrnurdefbed.d.NmNhrNurDefbedDO";
	public static final String CLASS_DISPALYNAME = "护理人员床位维护";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NHR_NUR_DEFBED";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nhr_nur_defbed";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nhr_nur_defbedADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nhr_nur_defbedADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nhr_nur_defbedCDesc(tblDesc));
		tblDesc.add(getId_nhr_nur_defbedCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nhr_nur_defbedADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nhr_nur_defbed",  getId_nhr_nur_defbedCDesc(tblDesc), this);
	...
	private IAttrDesc getCode_bedADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_bed a0b5","id_bed=id_bed","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nhr_nur_defbedCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nhr_nur_defbed");
		column.setLength(20);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_nhr_nur_defbed");
		iBDDataInfoFldMap.put("id_org","Id_org");
		iBDDataInfoFldMap.put("code","Code_bed");
		iBDDataInfoFldMap.put("name","Name_bed");
