 ...
 * 实习计划 DO 元数据信息
 */
public class NmOptPlDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmoptpl.d.NmOptPlDO";
	public static final String CLASS_DISPALYNAME = "实习计划";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_OPT_PL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_opt_pl";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_opt_plADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_opt_plCDesc(tblDesc));
	...
	private IAttrDesc getGrp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"nm_grp a0b4","id_nm_grp=id_nm_grp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
