 ...
 * 调整时 DO 元数据信息
 */
public class NmNurLaborDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmnurlabor.d.NmNurLaborDO";
	public static final String CLASS_DISPALYNAME = "调整时";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NUR_LABOR";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nur_labor";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nur_laborADesc(tblDesc));
		...
		this.add(getDt_monthADesc(tblDesc));
		this.add(getId_dep_nurADesc(tblDesc));
		this.add(getId_nurADesc(tblDesc));
		this.add(getMon_hoursADesc(tblDesc));
		this.add(getNmnurlaborsadjsADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nur_laborCDesc(tblDesc));
		tblDesc.add(getId_nur_laborCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getDt_monthCDesc(tblDesc));
		tblDesc.add(getId_dep_nurCDesc(tblDesc));
		tblDesc.add(getId_nurCDesc(tblDesc));
		tblDesc.add(getMon_hoursCDesc(tblDesc));
		tblDesc.add(getNmnurlaborsadjsCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getDt_monthADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_month",  getDt_monthCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getMon_hoursADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mon_hours",  getMon_hoursCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("工时");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getNmnurlaborsadjsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Nmnurlaborsadjs",  getNmnurlaborsadjsCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("工时调整记录");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b3","id_nur=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getJob_noADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b3","id_nur=id_nur","job_no"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getDt_monthCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_month");
		column.setLength(10);
	 ...
	 * @return
	 */
	private IColumnDesc getMon_hoursCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mon_hours");
		column.setLength(16);
	 ...
	 * @return
	 */
	private IColumnDesc getNmnurlaborsadjsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Nmnurlaborsadjs");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("工时调整记录"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
