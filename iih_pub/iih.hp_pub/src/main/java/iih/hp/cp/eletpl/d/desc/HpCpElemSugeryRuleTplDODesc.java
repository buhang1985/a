...
/**
 * 诊疗计划元素_手术规则_模板 DO 元数据信息
 */
public class HpCpElemSugeryRuleTplDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hp.cp.eletpl.d.HpCpElemSugeryRuleTplDO";
	public static final String CLASS_DISPALYNAME = "诊疗计划元素_手术规则_模板";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HP_CP_ELE_SUGERYRULE_TPL";
	public static final String TABLE_ALIAS_NAME = "${EntityMeta.entityClassMeta.aliasName}";
	public static final String PRIMARYKEY_FIELDNAME="Id_ele_sugeryrule_tpl";
	 ...
	 * 无参构造函数
	 */
	public HpCpElemSugeryRuleTplDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ele_sugeryrule_tplADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_ele_sugeryrule_tplADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ele_sugeryrule_tplCDesc(tblDesc));
		tblDesc.add(getId_ele_sugeryrule_tplCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_ele_sugeryrule_tplADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_ele_sugeryrule_tpl",  getId_ele_sugeryrule_tplCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手术规则ID");
	 ...
	 * @return
	 */
	private IColumnDesc getId_ele_sugeryrule_tplCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_ele_sugeryrule_tpl");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("手术规则ID"); 
		return column;
	}
	/**
	 * 获取元素ID表列元数据
