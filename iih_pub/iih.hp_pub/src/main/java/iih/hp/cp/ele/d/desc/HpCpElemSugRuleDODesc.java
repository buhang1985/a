...
/**
 * 诊疗计划元素_手术规则 DO 元数据信息
 */
public class HpCpElemSugRuleDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hp.cp.ele.d.HpCpElemSugRuleDO";
	public static final String CLASS_DISPALYNAME = "诊疗计划元素_手术规则";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HP_CP_ELE_SUGERYRULE";
	public static final String TABLE_ALIAS_NAME = "a7";
	public static final String PRIMARYKEY_FIELDNAME="Id_ele_sugeryrule";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ele_sugeryruleADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_eleADesc(tblDesc));
		this.add(getId_ele_sugeryruleADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ele_sugeryruleCDesc(tblDesc));
		tblDesc.add(getId_ele_sugeryruleCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_ele_sugeryruleADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_ele_sugeryrule",  getId_ele_sugeryruleCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_ele_sugeryruleCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_ele_sugeryrule");
		column.setLength(20);
