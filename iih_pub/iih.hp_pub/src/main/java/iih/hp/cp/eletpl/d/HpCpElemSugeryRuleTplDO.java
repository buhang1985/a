...
import iih.hp.cp.eletpl.d.desc.HpCpElemSugeryRuleTplDODesc;
 ...
 * 
 */
public class HpCpElemSugeryRuleTplDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_ELE_SUGERYRULE_TPL= "Id_ele_sugeryrule_tpl";
	...
	public String getId_ele_sugeryrule_tpl() {
		return ((String) getAttrVal("Id_ele_sugeryrule_tpl"));
	}	
	public void setId_ele_sugeryrule_tpl(String Id_ele_sugeryrule_tpl) {
		setAttrVal("Id_ele_sugeryrule_tpl", Id_ele_sugeryrule_tpl);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_ele_sugeryrule_tpl";
	}
	
	@Override
	public String getTableName() {	  
		return "HP_CP_ELE_SUGERYRULE_TPL";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpCpElemSugeryRuleTplDODesc.class);
	}
