 ...
 * 
 */
public class HpCpElemSugRuleDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//手术规则ID
	public static final String ID_ELE_SUGERYRULE= "Id_ele_sugeryrule";
	//元素ID
	 ...
	 * @return String
	 */
	public String getId_ele_sugeryrule() {
		return ((String) getAttrVal("Id_ele_sugeryrule"));
	}	
	/**
	 * 手术规则ID
	 * @param Id_ele_sugeryrule
	 */
	public void setId_ele_sugeryrule(String Id_ele_sugeryrule) {
		setAttrVal("Id_ele_sugeryrule", Id_ele_sugeryrule);
	}
	/**
	 * 元素ID
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_ele_sugeryrule";
	}
	
	@Override
	public String getTableName() {	  
		return "HP_CP_ELE_SUGERYRULE";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpCpElemSugRuleDODesc.class);
	}
