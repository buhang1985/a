 ...
 *
 */
public class HpCpAppOrderDTO extends HpCpAppEleDTO{
	...
	public String getDistinguish() {
		return ((String) getAttrVal("Distinguish"));
	}
	/**
	 * 功能区分
	 * @param Distinguish
	...
	public void setDistinguish(String Distinguish) {
		setAttrVal("Distinguish", Distinguish);
	}
	/**
	 * 径内医嘱区分
	 * @return Integer
	 ...
	 * @return FArrayList
	 */
	public FArrayList getHpCpAppOrdSrvs() {
		return ((FArrayList) getAttrVal("HpCpAppOrdSrvs"));
	}
	/**
	 * 医疗服务明细
	 * @param HpcpOrdSrvs
	 */
	public void setHpCpAppOrdSrvs(FArrayList HpCpAppOrdSrvs) {
		setAttrVal("HpCpAppOrdSrvs", HpCpAppOrdSrvs);
	}
	/**
	 * 医嘱生效时间
	 * @return FDateTime
	...
	/**
	 * 是否成组医嘱<br/>
	 * 药品医嘱服务项目中，大于1个药品的为成组医嘱
	 * @return FBoolean
	 */
	public FBoolean getFg_group() {

		FArrayList hpcpOrdSrvList = this.getHpCpAppOrdSrvs();
		// 非药品医嘱返回不是成组医嘱
		if (!this.getSd_srvtp().startsWith(IBdSrvTpDictCodeConst.SD_SRVTP_DRUG) || hpcpOrdSrvList == null
				|| hpcpOrdSrvList.size() == 0) {
			return FBoolean.FALSE;
		}
		int i = 0;
		for(Object obj : hpcpOrdSrvList){
			HpCpAppOrdSrvDTO ordSrv = (HpCpAppOrdSrvDTO)obj;
