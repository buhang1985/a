...
package iih.pe.pqry.pelogcatlog.d.desc;
 ...
 * 体检项目变更日志 DO 元数据信息
 */
public class PeLogCatlogDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqry.pelogcatlog.d.PeLogCatlogDO";
	public static final String CLASS_DISPALYNAME = "体检项目变更日志";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_log_pecatlog";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pelogcatlog";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pelogcatlogADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pelogcatlogADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pelogcatlogCDesc(tblDesc));
		tblDesc.add(getId_pelogcatlogCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pelogcatlogADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pelogcatlog",  getId_pelogcatlogCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检项目变更主键标识");
	...
	private IAttrDesc getCode_srvitmADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_pesrvbcatlog a0b5","id_pesrvcatlog=id_pesrvbcatlog","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_srvitmADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_pesrvbcatlog a0b5","id_pesrvcatlog=id_pesrvbcatlog","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_pelogcatlogCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pelogcatlog");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("体检项目变更主键标识"); 
		return column;
	}
	/**
	 * 获取体检个人预约项目ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pelogcatlog");
	}
