 ...
 * 体检问卷问题分组 DO 元数据信息
 */
public class PeQaCatDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.peqacatlog.d.PeQaCatDO";
	public static final String CLASS_DISPALYNAME = "体检问卷问题分组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_peqacat";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_peqacatlog";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_peqacatlogADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_peqacatlogADesc(tblDesc));
		this.add(getId_peqacatlog_parADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_peqacatlogCDesc(tblDesc));
		tblDesc.add(getId_peqacatlogCDesc(tblDesc));
		tblDesc.add(getId_peqacatlog_parCDesc(tblDesc));
	...
	private IAttrDesc getId_peqacatlogADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("体检问卷问题分组主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getId_peqacatlog_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_peqacatlog_par",  getId_peqacatlog_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检问卷问题分组父ID");
	...
	private IAttrDesc getCode_parADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_qn_peqacat a0b6","id_peqacatlog_par=id_peqacatlog","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_parADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_qn_peqacat a0b6","id_peqacatlog_par=id_peqacatlog","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_peqacatlog_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_peqacatlog_par");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("体检问卷问题分组父ID"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_peqacatlog");
		iBDDataInfoFldMap.put("pid","Id_peqacatlog_par");
