...
/**
 * 健康评估模型_缺血性冠心病_总分 DO 元数据信息
 */
public class PeIcdvModelTotalDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.peicdvmodel.d.PeIcdvModelTotalDO";
	public static final String CLASS_DISPALYNAME = "健康评估模型_缺血性冠心病_总分";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_peicdvmodeltotal";
	public static final String TABLE_ALIAS_NAME = "a8";
	public static final String PRIMARYKEY_FIELDNAME="Id_peicdvmodeltotal";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_peicdvmodeltotalADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_peicdvmodelADesc(tblDesc));
		this.add(getId_peicdvmodeltotalADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_peicdvmodeltotalCDesc(tblDesc));
		tblDesc.add(getId_peicdvmodeltotalCDesc(tblDesc));
	...
	/**
	 * 缺血性冠心病评估模型总分主键标识属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getId_peicdvmodeltotalADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_peicdvmodeltotal",  getId_peicdvmodeltotalCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("缺血性冠心病评估模型总分主键标识");
	...
	/**
	 * 获取缺血性冠心病评估模型总分主键标识表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_peicdvmodeltotalCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_peicdvmodeltotal");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("缺血性冠心病评估模型总分主键标识"); 
		return column;
	}
	/**
	 * 获取缺血性冠心病ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_peicdvmodeltotal");
	}
