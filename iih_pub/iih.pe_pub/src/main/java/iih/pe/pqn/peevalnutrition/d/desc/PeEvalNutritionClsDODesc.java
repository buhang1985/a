...
/**
 * 健康管理-营养评估定义-营养分类 DO 元数据信息
 */
public class PeEvalNutritionClsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.peevalnutrition.d.PeEvalNutritionClsDO";
	public static final String CLASS_DISPALYNAME = "健康管理-营养评估定义-营养分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_peevalnutritioncls";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_peevalnutritioncls";
	 ...
	 * 无参构造函数
	 */
	public PeEvalNutritionClsDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_peevalnutritionclsADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_peevalnutritionADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_peevalnutritionclsCDesc(tblDesc));
	...
	private IAttrDesc getId_peevalnutritionclsADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("健康营养评估定义营养分类主键标识");
	...
	private IAttrDesc getCode_riskADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_hm_riskdef a1b2","id_riskdef=id_riskdef","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_riskADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_hm_riskdef a1b2","id_riskdef=id_riskdef","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getValue_ref_riskADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_hm_riskdef a1b2","id_riskdef=id_riskdef","value_ref"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getValue_idea_riskADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_hm_riskdef a1b2","id_riskdef=id_riskdef","value_idea"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 * 获取健康营养评估定义营养分类主键标识表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_peevalnutritionclsCDesc(ITableDesc tblDesc){
		...
		column.setLabel("健康营养评估定义营养分类主键标识"); 
		return column;
	}
	/**
	 * 获取健康营养评估定义ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_peevalnutritioncls");
	}
