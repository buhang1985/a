...
/**
 * 健康评估模型_糖尿病_收缩压 DO 元数据信息
 */
public class PeDiabModelSbpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.pediabmodel.d.PeDiabModelSbpDO";
	public static final String CLASS_DISPALYNAME = "健康评估模型_糖尿病_收缩压";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_pediabmodelsbp";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_pediabmodelsbp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pediabmodelsbpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_pediabmodelADesc(tblDesc));
		this.add(getId_pediabmodelsbpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pediabmodelsbpCDesc(tblDesc));
		tblDesc.add(getId_pediabmodelsbpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pediabmodelsbpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pediabmodelsbp",  getId_pediabmodelsbpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("糖尿病模型收缩压主键标识");
	 ...
	 * @return
	 */
	private IColumnDesc getId_pediabmodelsbpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pediabmodelsbp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("糖尿病模型收缩压主键标识"); 
		return column;
	}
	/**
	 * 获取糖尿病模型ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pediabmodelsbp");
	}
