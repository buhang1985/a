...
/**
 * 健康评估模型_缺血性冠心病_体重指数 DO 元数据信息
 */
public class PeIcdvModelBmiDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.peicdvmodel.d.PeIcdvModelBmiDO";
	public static final String CLASS_DISPALYNAME = "健康评估模型_缺血性冠心病_体重指数";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_peicdvmodelbmi";
	public static final String TABLE_ALIAS_NAME = "a3";
	public static final String PRIMARYKEY_FIELDNAME="Id_peicdvmodelbmi";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_peicdvmodelbmiADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_peicdvmodelADesc(tblDesc));
		this.add(getId_peicdvmodelbmiADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_peicdvmodelbmiCDesc(tblDesc));
		tblDesc.add(getId_peicdvmodelbmiCDesc(tblDesc));
	...
	/**
	 * 缺血性冠心病评估模型体重指数主键标识属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getId_peicdvmodelbmiADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_peicdvmodelbmi",  getId_peicdvmodelbmiCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("缺血性冠心病评估模型体重指数主键标识");
	...
	/**
	 * 获取缺血性冠心病评估模型体重指数主键标识表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_peicdvmodelbmiCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_peicdvmodelbmi");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("缺血性冠心病评估模型体重指数主键标识"); 
		return column;
	}
	/**
	 * 获取缺血性冠心病ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_peicdvmodelbmi");
	}
