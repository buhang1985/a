 ...
 * 体检问卷问题库 DO 元数据信息
 */
public class PeQacontentDefDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.peqacontentdef.d.PeQacontentDefDO";
	public static final String CLASS_DISPALYNAME = "体检问卷问题库";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_peqacontentdef";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_peqacontentdef";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_peqacontentdefADesc(tblDesc));
		...
		this.add(getFg_impADesc(tblDesc));
		...
		this.add(getFg_summaryADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_peqacontentdefCDesc(tblDesc));
		...
		tblDesc.add(getFg_impCDesc(tblDesc));
		...
		tblDesc.add(getFg_summaryCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_impADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_imp",  getFg_impCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("重要标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_summaryADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_summary",  getFg_summaryCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("汇总摘要标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_impCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_imp");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("重要标识"); 
		return column;
	}
	/**
	 * 获取复制标识表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_summaryCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_summary");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("汇总摘要标识"); 
		return column;
	}
	/**
	 * 设置IBDataInfo接口映射数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_peqacontentdef");
