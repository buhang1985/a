 ...
 * 体检结果范围定义 DO 元数据信息
 */
public class PeSrvItemRangeDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pitm.pesrvitemrange.d.PeSrvItemRangeDO";
	public static final String CLASS_DISPALYNAME = "体检结果范围定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_itm_pesrvitemrange";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pesrvttemrange";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pesrvttemrangeADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pesrvttemrangeADesc(tblDesc));
		this.add(getId_pesrvttemrange_parADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pesrvttemrangeCDesc(tblDesc));
		tblDesc.add(getId_pesrvttemrangeCDesc(tblDesc));
		tblDesc.add(getId_pesrvttemrange_parCDesc(tblDesc));
	...
	private IAttrDesc getId_pesrvttemrangeADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("体检结果范围定义主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getId_pesrvttemrange_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pesrvttemrange_par",  getId_pesrvttemrange_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检结果范围定义父ID");
	...
	private IAttrDesc getCode_diADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_perstdidef a0b5","id_perstdidef=id_perstdidef","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_diADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_perstdidef a0b5","id_perstdidef=id_perstdidef","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_pesrvttemrange_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pesrvttemrange_par");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("体检结果范围定义父ID"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pesrvttemrange");
		iBDDataInfoFldMap.put("pid","Id_pesrvttemrange_par");
