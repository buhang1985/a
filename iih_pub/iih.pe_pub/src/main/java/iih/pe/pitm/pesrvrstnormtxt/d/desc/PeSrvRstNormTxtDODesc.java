...
/**
 * 体检结果正常时报告内容 DO 元数据信息
 */
public class PeSrvRstNormTxtDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pitm.pesrvrstnormtxt.d.PeSrvRstNormTxtDO";
	public static final String CLASS_DISPALYNAME = "体检结果正常时报告内容";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_itm_pesrvrstnormtxt";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pesrvrstnormtxt";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pesrvrstnormtxtADesc(tblDesc));
		...
		this.add(getNormal_txtADesc(tblDesc));
		this.add(getFg_peitmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pesrvrstnormtxtCDesc(tblDesc));
		...
		tblDesc.add(getNormal_txtCDesc(tblDesc));
		tblDesc.add(getFg_peitmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getNormal_txtADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Normal_txt",  getNormal_txtCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("结果正常显示内容");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_peitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_peitm",  getFg_peitmCDesc(tblDesc), this);
	...
	private IAttrDesc getCode_catlogADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_pesrvbcatlog a0b7","id_pesrvbcatlog=id_pesrvbcatlog","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_catlogADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_pesrvbcatlog a0b7","id_pesrvbcatlog=id_pesrvbcatlog","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getNormal_txtCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Normal_txt");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("结果正常显示内容"); 
		return column;
	}
	/**
	 * 获取体检结果标识表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_peitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_peitm");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pesrvrstnormtxt");
	}
