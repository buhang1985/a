 ...
 * 体检客户会员卡 DO 元数据信息
 */
public class PePsnCardDDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.por.pepsncard.d.PePsnCardDDO";
	public static final String CLASS_DISPALYNAME = "体检客户会员卡";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_or_pepsncard";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pepsncard";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pepsncardADesc(tblDesc));
		...
		this.add(getFg_masterADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pepsncardCDesc(tblDesc));
		...
		tblDesc.add(getFg_masterCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_masterADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_master",  getFg_masterCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("主卡标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getIdcodeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_or_pepsnbinfo a0b6","id_pepsnbinfo=id_pepsnbinfo","idcode"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getFg_masterCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_master");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("主卡标识"); 
		return column;
	}
	/**
	 * 获取卡状态表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pepsncard");
