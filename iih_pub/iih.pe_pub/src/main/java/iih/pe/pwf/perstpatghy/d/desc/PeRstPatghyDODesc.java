...
package iih.pe.pwf.perstpatghy.d.desc;
 ...
 * 体检病理结果 DO 元数据信息
 */
public class PeRstPatghyDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pwf.perstpatghy.d.PeRstPatghyDO";
	public static final String CLASS_DISPALYNAME = "体检病理结果";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_wf_perstpatghy";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_perstpathgy";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_perstpathgyADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_perstpathgyADesc(tblDesc));
		...
		this.add(getExam_paraADesc(tblDesc));
		this.add(getDescriptionADesc(tblDesc));
		this.add(getImpressionADesc(tblDesc));
		this.add(getId_technicianADesc(tblDesc));
		this.add(getCode_technicianADesc(tblDesc));
		this.add(getName_technicianADesc(tblDesc));
		this.add(getId_reporterADesc(tblDesc));
		this.add(getCode_reporterADesc(tblDesc));
		this.add(getName_reporterADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_perstpathgyCDesc(tblDesc));
		tblDesc.add(getId_perstpathgyCDesc(tblDesc));
		...
		tblDesc.add(getExam_paraCDesc(tblDesc));
		tblDesc.add(getDescriptionCDesc(tblDesc));
		tblDesc.add(getImpressionCDesc(tblDesc));
		tblDesc.add(getId_technicianCDesc(tblDesc));
		tblDesc.add(getCode_technicianCDesc(tblDesc));
		tblDesc.add(getName_technicianCDesc(tblDesc));
		tblDesc.add(getId_reporterCDesc(tblDesc));
		tblDesc.add(getCode_reporterCDesc(tblDesc));
		tblDesc.add(getName_reporterCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_perstpathgyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_perstpathgy",  getId_perstpathgyCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检病理结果ID");
	 ...
	 * @return
	 */
	private IAttrDesc getExam_paraADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Exam_para",  getExam_paraCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("肉眼所见");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getImpressionADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Impression",  getImpressionCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("诊断意见");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_technicianADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_technician",  getId_technicianCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("诊断医师id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_technicianADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_technician",  getCode_technicianCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("诊断医师编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_technicianADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_technician",  getName_technicianCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("诊断医师名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_reporterADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_reporter",  getId_reporterCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("审核医师id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_reporterADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_reporter",  getCode_reporterCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("审核医师编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_reporterADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_reporter",  getName_reporterCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("审核医师名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getSu_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_su_rpt=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getRpt_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b7","id_emp_rpt=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDep_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b8","id_dep_rpt=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_perstpathgyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_perstpathgy");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("体检病理结果ID"); 
		return column;
	}
	/**
	 * 获取体检预约单id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getExam_paraCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Exam_para");
		column.setLength(1000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("肉眼所见"); 
		return column;
	}
	/**
	 * 获取镜下所见表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getImpressionCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Impression");
		column.setLength(2000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("诊断意见"); 
		return column;
	}
	/**
	 * 获取诊断医师id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_technicianCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_technician");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("诊断医师id"); 
		return column;
	}
	/**
	 * 获取诊断医师编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getCode_technicianCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_technician");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("诊断医师编码"); 
		return column;
	}
	/**
	 * 获取诊断医师名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_technicianCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_technician");
		column.setLength(200);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("诊断医师名称"); 
		return column;
	}
	/**
	 * 获取审核医师id表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_reporterCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_reporter");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("审核医师id"); 
		return column;
	}
	/**
	 * 获取审核医师编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getCode_reporterCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_reporter");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("审核医师编码"); 
		return column;
	}
	/**
	 * 获取审核医师名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_reporterCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_reporter");
		column.setLength(200);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("审核医师名称"); 
		return column;
	}
	/**
	 * 获取就诊编码表列元数据
