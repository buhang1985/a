 ...
 * 体检检查路线次序 DO 元数据信息
 */
public class PeChkRouteDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pbd.pewfroute.d.PeChkRouteDO";
	public static final String CLASS_DISPALYNAME = "体检检查路线次序";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_bd_chkroute";
	public static final String TABLE_ALIAS_NAME = "a0b4";
	public static final String PRIMARYKEY_FIELDNAME="Id_pechkroute";
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pechkrouteCDesc(tblDesc));
		tblDesc.add(getId_pechkrouteCDesc(tblDesc));
		tblDesc.add(getId_pewfroutedefCDesc(tblDesc));
		tblDesc.add(getId_pedeptsetCDesc(tblDesc));
		tblDesc.add(getChk_orderCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pechkrouteADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pechkroute",  getId_pechkrouteCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检检查路线次序主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getChk_orderADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Chk_order",  getChk_orderCDesc(tblDesc), this);
	...
	private IAttrDesc getName_deptADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_bd_deptset a0b4b3","id_pedeptset=id_pedeptset","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_deptADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_bd_deptset a0b4b3","id_pedeptset=id_pedeptset","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getChkdurationADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_bd_deptset a0b4b3","id_pedeptset=id_pedeptset","chkduration"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_pechkrouteCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pechkroute");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("体检检查路线次序主键标识"); 
		return column;
	}
	/**
	 * 获取体检检查路线定义表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getChk_orderCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Chk_order");
		column.setLength(10);
