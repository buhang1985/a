 ...
 * 体检诊断决策定义 DO 元数据信息
 */
public class PeDsDiagDefDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pds.pedsdiag.d.PeDsDiagDefDO";
	public static final String CLASS_DISPALYNAME = "体检诊断决策定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_ds_pedsdiagdef";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pedsdiagdef";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pedsdiagdefADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pedsdiagdefADesc(tblDesc));
		this.add(getId_pedsdiagdef_parADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pedsdiagdefCDesc(tblDesc));
		tblDesc.add(getId_pedsdiagdefCDesc(tblDesc));
		tblDesc.add(getId_pedsdiagdef_parCDesc(tblDesc));
	...
	private IAttrDesc getId_pedsdiagdefADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("体检诊断决策定义主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getId_pedsdiagdef_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pedsdiagdef_par",  getId_pedsdiagdef_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检诊断决策定义父ID");
	...
	private IAttrDesc getCode_diADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_perstdidef a0b2","id_perstdidef=id_perstdidef","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_diADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_perstdidef a0b2","id_perstdidef=id_perstdidef","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_pedsdiagdef_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pedsdiagdef_par");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("体检诊断决策定义父ID"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pedsdiagdef");
		iBDDataInfoFldMap.put("pid","Id_pedsdiagdef_par");
