 ...
 * 健康评估结果-单因素 DO 元数据信息
 */
public class PeRstHraDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.phm.persthra.d.PeRstHraDO";
	public static final String CLASS_DISPALYNAME = "健康评估结果-单因素";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_hm_persthra";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_persthra";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_persthraADesc(tblDesc));
		...
		this.add(getRelativeriskADesc(tblDesc));
		this.add(getAbsoluteriskADesc(tblDesc));
		this.add(getReduceriskADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_persthraCDesc(tblDesc));
		...
		tblDesc.add(getRelativeriskCDesc(tblDesc));
		tblDesc.add(getAbsoluteriskCDesc(tblDesc));
		tblDesc.add(getReduceriskCDesc(tblDesc));
	...
	private IAttrDesc getId_persthraADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("健康评估结果单因素主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getRelativeriskADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Relativerisk",  getRelativeriskCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("相对风险");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAbsoluteriskADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Absoluterisk",  getAbsoluteriskCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("绝对风险");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getReduceriskADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Reducerisk",  getReduceriskCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("降低风险");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getRelativeriskCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Relativerisk");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("相对风险"); 
		return column;
	}
	/**
	 * 获取绝对风险表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAbsoluteriskCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Absoluterisk");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("绝对风险"); 
		return column;
	}
	/**
	 * 获取降低风险表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getReduceriskCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Reducerisk");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("降低风险"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_persthra");
