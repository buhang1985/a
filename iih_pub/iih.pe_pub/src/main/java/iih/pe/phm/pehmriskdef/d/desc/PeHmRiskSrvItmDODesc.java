...
/**
 * 健康危险因素-体检结果关系定义 DO 元数据信息
 */
public class PeHmRiskSrvItmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.phm.pehmriskdef.d.PeHmRiskSrvItmDO";
	public static final String CLASS_DISPALYNAME = "健康危险因素-体检结果关系定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_hm_pehmrisksrvitm";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_pehmrisksrvitm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pehmrisksrvitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_riskdefADesc(tblDesc));
		this.add(getId_pehmrisksrvitmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pehmrisksrvitmCDesc(tblDesc));
		tblDesc.add(getId_pehmrisksrvitmCDesc(tblDesc));
	...
	/**
	 * 健康危险因素体检结果关系定义主键标识属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getId_pehmrisksrvitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pehmrisksrvitm",  getId_pehmrisksrvitmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("健康危险因素体检结果关系定义主键标识");
	...
	/**
	 * 获取健康危险因素体检结果关系定义主键标识表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_pehmrisksrvitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pehmrisksrvitm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("健康危险因素体检结果关系定义主键标识"); 
		return column;
	}
	/**
	 * 获取体检结果ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pehmrisksrvitm");
	}
