...
import iih.pe.phm.perstin.d.desc.PeRstinDODesc;
 ...
 * 
 */
public class PeRstinDO extends BaseDO {
	...
	//体检记录类型
	public static final String RECTP= "Rectp";
	//健康预约单ID
	 ...
	 * @return Integer
	 */
	public Integer getRectp() {
		return ((Integer) getAttrVal("Rectp"));
	}	
	/**
	 * 体检记录类型
	 * @param Rectp
	 */
	public void setRectp(Integer Rectp) {
		setAttrVal("Rectp", Rectp);
	}
	/**
	 * 健康预约单ID
	 * @return String
...
//	}
	...
	public String getTableName() {	  
		return "pe_hm_perstin";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PeRstinDODesc.class);
	}
