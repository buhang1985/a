 ...
 * 健康评估自测问卷记录 DO 元数据信息
 */
public class PeCmaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.phm.pecmaresult.d.PeCmaDO";
	public static final String CLASS_DISPALYNAME = "健康评估自测问卷记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_hm_cma";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pecma";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pecmaADesc(tblDesc));
		...
		this.add(getDt_surveyADesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getDt_surveyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_survey",  getDt_surveyCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDate);
		attrDesc.setLabel("问卷日期");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getHealth_respADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_or_pepsnbinfo a0b6","id_pepsnbinfo=id_pepsnbinfo","health_resp"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getDt_surveyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_survey");
		column.setLength(10);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("问卷日期"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pecma");
