...
/**
 * 健康管理_脑卒中评估结果危险因素 DO 元数据信息
 */
public class PeRstStrokeRiskDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.phm.perststroke.d.PeRstStrokeRiskDO";
	public static final String CLASS_DISPALYNAME = "健康管理_脑卒中评估结果危险因素";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_hm_perststrokerisk";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_perststrokerisk";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_perststrokeriskADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_perststrokeADesc(tblDesc));
		this.add(getId_perststrokeriskADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_perststrokeriskCDesc(tblDesc));
		tblDesc.add(getId_perststrokeriskCDesc(tblDesc));
	...
	/**
	 * 健康评估脑卒中评估结果危险因素主键标识属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getId_perststrokeriskADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_perststrokerisk",  getId_perststrokeriskCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("健康评估脑卒中评估结果危险因素主键标识");
	...
	private IAttrDesc getId_perststrokeADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("健康评估脑卒中评估结果ID");
	...
	/**
	 * 获取健康评估脑卒中评估结果危险因素主键标识表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_perststrokeriskCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_perststrokerisk");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("健康评估脑卒中评估结果危险因素主键标识"); 
		return column;
	}
	/**
	 * 获取健康评估脑卒中评估结果ID表列元数据
	 * @param tblDesc
	 * @return
	 */
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_perststrokerisk");
	}
