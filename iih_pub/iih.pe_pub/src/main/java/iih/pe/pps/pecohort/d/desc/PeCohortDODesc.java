 ...
 * 体检人群队列管理 DO 元数据信息
 */
public class PeCohortDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pps.pecohort.d.PeCohortDO";
	public static final String CLASS_DISPALYNAME = "体检人群队列管理";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_pecohort";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pecohort";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pecohortADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pecohortADesc(tblDesc));
		this.add(getId_pecohort_parADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pecohortCDesc(tblDesc));
		tblDesc.add(getId_pecohortCDesc(tblDesc));
		tblDesc.add(getId_pecohort_parCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pecohort_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pecohort_par",  getId_pecohort_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检人群父ID");
	...
	private IAttrDesc getCode_ruleADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_perules a0b4","id_peruledef=id_peruledef","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_ruleADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_perules a0b4","id_peruledef=id_peruledef","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_pecohort_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pecohort_par");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("体检人群父ID"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pecohort");
		iBDDataInfoFldMap.put("pid","Id_pecohort_par");
