package iih.pe.pps.dto.pepositracklistdto.d;
 ...
 * 
 */
public class PePosiTrackListDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getDt_assign() {
		return ((String) getAttrVal("Dt_assign"));
	}
	/**
	 * 分配日期
	 * @param Dt_assign
	 */
	public void setDt_assign(String Dt_assign) {
