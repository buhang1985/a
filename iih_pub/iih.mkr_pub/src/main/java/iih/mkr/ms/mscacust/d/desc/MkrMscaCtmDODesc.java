 ...
 * 组套自定义分类 DO 元数据信息
 */
public class MkrMscaCtmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mkr.ms.mscacust.d.MkrMscaCtmDO";
	public static final String CLASS_DISPALYNAME = "组套自定义分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MKR_MSCACTM";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_cactm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_cactmADesc(tblDesc));
		...
		this.add(getId_ow_deptADesc(tblDesc));
		...
		this.add(getOwdep_nameADesc(tblDesc));
		this.add(getOwemp_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_cactmCDesc(tblDesc));
		...
		tblDesc.add(getId_ow_deptCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_ow_deptADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_ow_dept",  getId_ow_deptCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getPar_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"MKR_MSCACTM a0b6","id_par=id_cactm","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getOwdep_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Owdep_name",  getOwdep_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b7","id_ow_dept=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getOwemp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Owemp_name",  getOwemp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b8","id_ow_emp=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_ow_deptCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_ow_dept");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getOwdep_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Owdep_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getOwemp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Owemp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("姓名"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_cactm");
