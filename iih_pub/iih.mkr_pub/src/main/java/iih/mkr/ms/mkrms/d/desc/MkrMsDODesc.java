 ...
 * 组套定义 DO 元数据信息
 */
public class MkrMsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mkr.ms.mkrms.d.MkrMsDO";
	public static final String CLASS_DISPALYNAME = "组套定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MKR_MS";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ms";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_msADesc(tblDesc));
		...
		this.add(getId_enbl_depADesc(tblDesc));
		...
		this.add(getEnblemp_nameADesc(tblDesc));
		this.add(getEnbldep_nameADesc(tblDesc));
		this.add(getStatus_nameADesc(tblDesc));
		this.add(getName_cactmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_msCDesc(tblDesc));
		...
		tblDesc.add(getId_enbl_depCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_enbl_depADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_enbl_dep",  getId_enbl_depCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getOwdep_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b5","id_ow_dep=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getOwemp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b6","id_ow_emp=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getEnblemp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Enblemp_name",  getEnblemp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("姓名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b7","id_enbl_emp=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getEnbldep_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Enbldep_name",  getEnbldep_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b12","id_enbl_dep=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_cactmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_cactm",  getName_cactmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"MKR_MSCACTM a0b11","id_cactm=id_cactm","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_enbl_depCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_enbl_dep");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getEnblemp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Enblemp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("姓名"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getEnbldep_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Enbldep_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_cactmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_cactm");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_ms");
