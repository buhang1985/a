...
package iih.mkr.std.desetca.d.desc;
 ...
 * 数据集分类 DO 元数据信息
 */
public class DeSetCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mkr.std.desetca.d.DeSetCaDO";
	public static final String CLASS_DISPALYNAME = "数据集分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_set_tp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_setca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_setcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_setcaCDesc(tblDesc));
	...
	private IAttrDesc getParent_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_set_tp a0b6","id_parent=id_setca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_setca");
