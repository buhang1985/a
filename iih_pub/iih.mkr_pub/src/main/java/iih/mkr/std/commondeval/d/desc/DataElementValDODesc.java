...
package iih.mkr.std.commondeval.d.desc;
 ...
 * 数据元值 DO 元数据信息
 */
public class DataElementValDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mkr.std.commondeval.d.DataElementValDO";
	public static final String CLASS_DISPALYNAME = "数据元值";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_de_val";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_de_val";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_de_valADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_de_valADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getValdomaincodeADesc(tblDesc));
		this.add(getValdomaincodenameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_de_valCDesc(tblDesc));
		tblDesc.add(getId_de_valCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getValdomaincodeCDesc(tblDesc));
		tblDesc.add(getValdomaincodenameCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_de_valADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_de_val",  getId_de_valCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("数据元值主键");
	 ...
	 * @return
	 */
	private IAttrDesc getValdomaincodenameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Valdomaincodename",  getValdomaincodenameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("类型编码与名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_parADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_de_val a0b6","id_par=id_de_val","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_de_valCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_de_val");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("数据元值主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getValdomaincodenameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Valdomaincodename");
		column.setLength(100);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("类型编码与名称"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_de_val");
