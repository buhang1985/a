...
import iih.mc.pl.deprequestap.d.desc.McDepReqApOrderDODesc;
 ...
 * 
 */
public class McDepReqApOrderDO extends BaseDO {
	...
	//关联结存id标识
	public static final String RELBLTAG= "Relbltag";
	//高值低值分类
	public static final String EU_MMCA= "Eu_mmca";
	//是否已生单
	public static final String FG_CREATEPL= "Fg_createpl";
	//部门名称
	 ...
	 * @return FBoolean
	 */
	public FBoolean getRelbltag() {
		return ((FBoolean) getAttrVal("Relbltag"));
	}	
	/**
	 * 关联结存id标识
	 * @param Relbltag
	 */
	public void setRelbltag(FBoolean Relbltag) {
		setAttrVal("Relbltag", Relbltag);
	}
	/**
	 * 高值低值分类
	 * @return Integer
	 ...
	 * @return FBoolean
	 */
	public FBoolean getFg_createpl() {
		return ((FBoolean) getAttrVal("Fg_createpl"));
	}	
	/**
	 * 是否已生单
	 * @param Fg_createpl
	 */
	public void setFg_createpl(FBoolean Fg_createpl) {
		setAttrVal("Fg_createpl", Fg_createpl);
	}
	/**
	 * 部门名称
	 * @return String
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(McDepReqApOrderDODesc.class);
	}
