 ...
 * 耗材库存计划 DO 元数据信息
 */
public class McStockPlanDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.pl.mcstockplan.d.McStockPlanDO";
	public static final String CLASS_DISPALYNAME = "耗材库存计划";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_PL";
	...
	private void init(){		
		...
		this.add(getId_dasADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_dasCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_dasADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_das",  getId_dasCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("领用计划id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getPltp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_pltp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSupl_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_su_pl=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCheck_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b9","id_emp_check=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_dasCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_das");
		column.setLength(500);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("领用计划id"); 
		return column;
	}
	/**
	 * 获取名称表列元数据
