 ...
 * 
 */
public class McTrReqApImplItemDO extends BaseDO {
	...
	//调拨的那明细汇总主键
	public static final String ID_TRITMSUM= "Id_tritmsum";
	//结存主键
	 ...
	 * @return String
	 */
	public String getId_tritmsum() {
		return ((String) getAttrVal("Id_tritmsum"));
	}	
	/**
	 * 调拨的那明细汇总主键
	 * @param Id_tritmsum
	 */
	public void setId_tritmsum(String Id_tritmsum) {
		setAttrVal("Id_tritmsum", Id_tritmsum);
	}
	/**
	 * 结存主键
	 * @return String
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(McTrReqApImplItemDODesc.class);
	}
