 ...
 * 高值验收单细目 DO 元数据信息
 */
public class McInspectionItemDoDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.st.inspection.d.McInspectionItemDo";
	public static final String CLASS_DISPALYNAME = "高值验收单细目";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mc_insp_itm";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_inspitem";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_inspitemADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_inspitemCDesc(tblDesc));
