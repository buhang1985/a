 ...
 * 出库单明细 DO 元数据信息
 */
public class McStockOutItemDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.st.stockout.d.McStockOutItemDO";
	public static final String CLASS_DISPALYNAME = "出库单明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mc_out_itm";
	...
	private void init(){		
		...
		this.add(getId_outitm_oriADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_outitm_oriCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_outitm_oriADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_outitm_ori",  getId_outitm_oriCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("历史出库明细id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getMmpkgunameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM_PKGU a1b6","id_mmpkgu_actual=id_mmpkgu","mmpkguname"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_outitm_oriCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_outitm_ori");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("历史出库明细id"); 
		return column;
	}
	/**
	 * 获取物品编码表列元数据
