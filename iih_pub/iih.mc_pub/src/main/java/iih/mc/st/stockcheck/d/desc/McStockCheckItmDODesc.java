 ...
 * 库存盘点明细 DO 元数据信息
 */
public class McStockCheckItmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.st.stockcheck.d.McStockCheckItmDO";
	public static final String CLASS_DISPALYNAME = "库存盘点明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_ST_TK_ITM";
	...
	private IAttrDesc getEmpsttk_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a1b6","id_emp_sttk=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
