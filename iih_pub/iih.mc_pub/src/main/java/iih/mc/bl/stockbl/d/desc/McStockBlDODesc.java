...
package iih.mc.bl.stockbl.d.desc;
 ...
 * 耗材结存 DO 元数据信息
 */
public class McStockBlDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.bl.stockbl.d.McStockBlDO";
	public static final String CLASS_DISPALYNAME = "耗材结存";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mc_bl";
	...
	private IAttrDesc getFactory_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM a0b5","id_mm=id_mm","sup_name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_changed",new xap.mw.coreitf.d.FBoolean("N"));
	}
