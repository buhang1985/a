 ...
 * 采购发票结算 DO 元数据信息
 */
public class McSettlementDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.po.settlement.d.McSettlementDO";
	public static final String CLASS_DISPALYNAME = "采购发票结算";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_BANL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_banl";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_banlADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_banlCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_banl");
