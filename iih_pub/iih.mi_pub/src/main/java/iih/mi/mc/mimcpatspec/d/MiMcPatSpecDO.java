 ...
 * 
 */
public class MiMcPatSpecDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//医保特殊病患者主键
	public static final String ID_MIMCPATSPEC= "Id_mimcpatspec";
	//所属集团
...
//	}
	...
	public String getPKFieldName() {
		return "Id_mimcpatspec";
	}
	
	@Override
	public String getTableName() {	  
		return "mi_mc_pat_spec";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MiMcPatSpecDODesc.class);
	}
