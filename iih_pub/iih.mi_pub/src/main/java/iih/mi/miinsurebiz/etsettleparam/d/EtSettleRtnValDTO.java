 ...
 * 
 */
public class EtSettleRtnValDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getOrigin_tarnsdate() {
		return ((String) getAttrVal("Origin_tarnsdate"));
	}
	/**
	 * 原交易日期
	 * @param Origin_tarnsdate
	 */
	public void setOrigin_tarnsdate(String Origin_tarnsdate) {
		setAttrVal("Origin_tarnsdate", Origin_tarnsdate);
	}
	/**
	 * 银行交易成功标志
	 * @return String
	 ...
	 * @return String
	 */
	public String getName_pat_hp() {
		return ((String) getAttrVal("Name_pat_hp"));
	}
	/**
	 * 医保人员姓名
	 * @param Name_pat_hp
	 */
	public void setName_pat_hp(String Name_pat_hp) {
		setAttrVal("Name_pat_hp", Name_pat_hp);
	}
	/**
	 * 照顾人员补助
	 * @return FDouble
	 ...
	 * @return String
	 */
	public String getHporg_code() {
		return ((String) getAttrVal("Hporg_code"));
	}
	/**
	 * 社保机构编码
	 * @param Hporg_code
	 */
	public void setHporg_code(String Hporg_code) {
		setAttrVal("Hporg_code", Hporg_code);
	}
	/**
	 * 起付标准现金支付金额
	 * @return FDouble
	 */
	public FDouble getAmt_std_cash() {
		return ((FDouble) getAttrVal("Amt_std_cash"));
	}
	/**
	 * 起付标准现金支付金额
	 * @param Amt_std_cash
	 */
	public void setAmt_std_cash(FDouble Amt_std_cash) {
		setAttrVal("Amt_std_cash", Amt_std_cash);
	}
	/**
	 * 分段自理
	 * @return FDouble
	 */
	public FDouble getAmt_segzl() {
		return ((FDouble) getAttrVal("Amt_segzl"));
	}
	/**
	 * 分段自理
	 * @param Amt_segzl
	 */
	public void setAmt_segzl(FDouble Amt_segzl) {
		setAttrVal("Amt_segzl", Amt_segzl);
	}
	/**
	 * 起付以上帐户支付金额
	 * @return FDouble
	 */
	public FDouble getAmt_over_psn() {
		return ((FDouble) getAttrVal("Amt_over_psn"));
	}
	/**
	 * 起付以上帐户支付金额
	 * @param Amt_over_psn
	 */
	public void setAmt_over_psn(FDouble Amt_over_psn) {
		setAttrVal("Amt_over_psn", Amt_over_psn);
	}
	/**
	 * 起付以上现金支付金额
	 * @return FDouble
	 */
	public FDouble getAmt_over_cash() {
		return ((FDouble) getAttrVal("Amt_over_cash"));
	}
	/**
	 * 起付以上现金支付金额
	 * @param Amt_over_cash
	 */
	public void setAmt_over_cash(FDouble Amt_over_cash) {
		setAttrVal("Amt_over_cash", Amt_over_cash);
	}
	/**
	 * 分段1自付
	 * @return FDouble
	 */
	public FDouble getAmt_seg1self() {
		return ((FDouble) getAttrVal("Amt_seg1self"));
	}
	/**
	 * 分段1自付
	 * @param Amt_seg1self
	 */
	public void setAmt_seg1self(FDouble Amt_seg1self) {
		setAttrVal("Amt_seg1self", Amt_seg1self);
	}
	/**
	 * 分段2自付
	 * @return FDouble
	 */
	public FDouble getAmt_seg2self() {
		return ((FDouble) getAttrVal("Amt_seg2self"));
	}
	/**
	 * 分段2自付
	 * @param Amt_seg2self
	 */
	public void setAmt_seg2self(FDouble Amt_seg2self) {
		setAttrVal("Amt_seg2self", Amt_seg2self);
	}
	/**
	 * 分段3自付
	 * @return FDouble
	 */
	public FDouble getAmt_seg3self() {
		return ((FDouble) getAttrVal("Amt_seg3self"));
	}
	/**
	 * 分段3自付
	 * @param Amt_seg3self
	 */
	public void setAmt_seg3self(FDouble Amt_seg3self) {
		setAttrVal("Amt_seg3self", Amt_seg3self);
	}
	/**
	 * 分段4自付
	 * @return FDouble
	 */
	public FDouble getAmt_seg4self() {
		return ((FDouble) getAttrVal("Amt_seg4self"));
	}
	/**
	 * 分段4自付
	 * @param Amt_seg4self
	 */
	public void setAmt_seg4self(FDouble Amt_seg4self) {
		setAttrVal("Amt_seg4self", Amt_seg4self);
	}
	/**
	 * 分段5自付
	 * @return FDouble
	 */
	public FDouble getAmt_seg5self() {
		return ((FDouble) getAttrVal("Amt_seg5self"));
	}
	/**
	 * 分段5自付
	 * @param Amt_seg5self
	 */
	public void setAmt_seg5self(FDouble Amt_seg5self) {
		setAttrVal("Amt_seg5self", Amt_seg5self);
	}
	/**
	 * 本年帐户支出金额
	 * @return FDouble
	 */
	public FDouble getAmt_accountyear() {
		return ((FDouble) getAttrVal("Amt_accountyear"));
	}
	/**
	 * 本年帐户支出金额
	 * @param Amt_accountyear
	 */
	public void setAmt_accountyear(FDouble Amt_accountyear) {
		setAttrVal("Amt_accountyear", Amt_accountyear);
	}
	/**
	 * 一般参保职工补助(
	 * @return FDouble
	 */
	public FDouble getAmt_ybzg() {
		return ((FDouble) getAttrVal("Amt_ybzg"));
	}
	/**
	 * 一般参保职工补助(
	 * @param Amt_ybzg
	 */
	public void setAmt_ybzg(FDouble Amt_ybzg) {
		setAttrVal("Amt_ybzg", Amt_ybzg);
	}
	/**
	 * 床位费用个人自理
	 * @return FDouble
	 */
	public FDouble getAmt_bedself() {
		return ((FDouble) getAttrVal("Amt_bedself"));
	}
	/**
	 * 床位费用个人自理
	 * @param Amt_bedself
	 */
	public void setAmt_bedself(FDouble Amt_bedself) {
		setAttrVal("Amt_bedself", Amt_bedself);
	}
	/**
	 * 审核扣款
	 * @return FDouble
	 */
	public FDouble getAmt_shkk() {
		return ((FDouble) getAttrVal("Amt_shkk"));
	}
	/**
	 * 审核扣款
	 * @param Amt_shkk
	 */
	public void setAmt_shkk(FDouble Amt_shkk) {
		setAttrVal("Amt_shkk", Amt_shkk);
	}
	/**
	 * 门诊慢性病起付线支付
	 * @return FDouble
	 */
	public FDouble getAmt_chronic_base() {
		return ((FDouble) getAttrVal("Amt_chronic_base"));
	}
	/**
	 * 门诊慢性病起付线支付
	 * @param Amt_chronic_base
	 */
	public void setAmt_chronic_base(FDouble Amt_chronic_base) {
		setAttrVal("Amt_chronic_base", Amt_chronic_base);
	}
	/**
	 * 门诊慢性病费用
	 * @return FDouble
	 */
	public FDouble getAmt_chronic() {
		return ((FDouble) getAttrVal("Amt_chronic"));
	}
	/**
	 * 门诊慢性病费用
	 * @param Amt_chronic
	 */
	public void setAmt_chronic(FDouble Amt_chronic) {
		setAttrVal("Amt_chronic", Amt_chronic);
	}
	/**
	 * 家庭病床支出
	 * @return FDouble
	 */
	public FDouble getAmt_jtbc() {
		return ((FDouble) getAttrVal("Amt_jtbc"));
	}
	/**
	 * 家庭病床支出
	 * @param Amt_jtbc
	 */
	public void setAmt_jtbc(FDouble Amt_jtbc) {
		setAttrVal("Amt_jtbc", Amt_jtbc);
	}
	/**
	 * 门诊现金支出
	 * @return FDouble
	 */
	public FDouble getAmt_mzcash() {
		return ((FDouble) getAttrVal("Amt_mzcash"));
	}
	/**
	 * 门诊现金支出
	 * @param Amt_mzcash
	 */
	public void setAmt_mzcash(FDouble Amt_mzcash) {
		setAttrVal("Amt_mzcash", Amt_mzcash);
	}
	/**
	 * 纳入大病救助额度
	 * @return FDouble
	 */
	public FDouble getAmt_inseriousill() {
		return ((FDouble) getAttrVal("Amt_inseriousill"));
	}
	/**
	 * 纳入大病救助额度
	 * @param Amt_inseriousill
	 */
	public void setAmt_inseriousill(FDouble Amt_inseriousill) {
		setAttrVal("Amt_inseriousill", Amt_inseriousill);
	}
	/**
	 * 本次纳入商保大病合规费用
	 * @return FDouble
	 ...
	 * @return FDouble
	 */
	public FDouble getAmt_inhp_year() {
		return ((FDouble) getAttrVal("Amt_inhp_year"));
	}
	/**
	 * 本年累计纳入统筹额度
	 * @param Amt_inhp_year
	 */
	public void setAmt_inhp_year(FDouble Amt_inhp_year) {
		setAttrVal("Amt_inhp_year", Amt_inhp_year);
	}
	/**
	 * 本年累计纳入大额救助额度
	 * @return FDouble
	 */
	public FDouble getAmt_inseriousill_year() {
		return ((FDouble) getAttrVal("Amt_inseriousill_year"));
	}
	/**
	 * 本年累计纳入大额救助额度
	 * @param Amt_inseriousill_year
	 */
	public void setAmt_inseriousill_year(FDouble Amt_inseriousill_year) {
		setAttrVal("Amt_inseriousill_year", Amt_inseriousill_year);
	}
	/**
	 * 本年累计纳入商保大病合规费用额度
	 * @return FDouble
	 */
	public FDouble getAmt_inbusinessinsure_year() {
		return ((FDouble) getAttrVal("Amt_inbusinessinsure_year"));
	}
	/**
	 * 本年累计纳入商保大病合规费用额度
	 * @param Amt_inbusinessinsure_year
	 */
	public void setAmt_inbusinessinsure_year(FDouble Amt_inbusinessinsure_year) {
		setAttrVal("Amt_inbusinessinsure_year", Amt_inbusinessinsure_year);
	}
	/**
	 * 本年累计纳入门诊统筹额度
	 * @return FDouble
	 */
	public FDouble getAmt_inhpoep_year() {
		return ((FDouble) getAttrVal("Amt_inhpoep_year"));
	}
	/**
	 * 本年累计纳入门诊统筹额度
	 * @param Amt_inhpoep_year
	 */
	public void setAmt_inhpoep_year(FDouble Amt_inhpoep_year) {
		setAttrVal("Amt_inhpoep_year", Amt_inhpoep_year);
	}
	/**
	 * 本年商保大病累计理赔金额
	 * @return FDouble
	 */
	public FDouble getAmt_businessinsure_year() {
		return ((FDouble) getAttrVal("Amt_businessinsure_year"));
	}
	/**
	 * 本年商保大病累计理赔金额
	 * @param Amt_businessinsure_year
	 */
	public void setAmt_businessinsure_year(FDouble Amt_businessinsure_year) {
		setAttrVal("Amt_businessinsure_year", Amt_businessinsure_year);
	}
	/**
	 * 本年公务员补助累计报销金额
	 * @return FDouble
	 */
	public FDouble getAmt_civilservice_year() {
		return ((FDouble) getAttrVal("Amt_civilservice_year"));
	}
	/**
	 * 本年公务员补助累计报销金额
	 * @param Amt_civilservice_year
	 */
	public void setAmt_civilservice_year(FDouble Amt_civilservice_year) {
		setAttrVal("Amt_civilservice_year", Amt_civilservice_year);
	}
	/**
	 * 本年门诊统筹累计报销金额
	 * @return FDouble
	 */
	public FDouble getAmt_hpoep_year() {
		return ((FDouble) getAttrVal("Amt_hpoep_year"));
	}
	/**
	 * 本年门诊统筹累计报销金额
	 * @param Amt_hpoep_year
	 */
	public void setAmt_hpoep_year(FDouble Amt_hpoep_year) {
		setAttrVal("Amt_hpoep_year", Amt_hpoep_year);
	}
	/**
	 * 本年门诊慢性病累计起付线金额
	 * @return FDouble
	 */
	public FDouble getAmt_chronic_base_year() {
		return ((FDouble) getAttrVal("Amt_chronic_base_year"));
	}
	/**
	 * 本年门诊慢性病累计起付线金额
	 * @param Amt_chronic_base_year
	 */
	public void setAmt_chronic_base_year(FDouble Amt_chronic_base_year) {
		setAttrVal("Amt_chronic_base_year", Amt_chronic_base_year);
	}
	/**
	 * 本次纳入扶贫合规费用
	 * @return FDouble
	 ...
	 * @return FDouble
	 */
	public FDouble getAmt_fpthbxje() {
		return ((FDouble) getAttrVal("Amt_fpthbxje"));
	}
	/**
	 * 扶贫特惠保险金额
	 * @param Amt_fpthbxje
	 */
	public void setAmt_fpthbxje(FDouble Amt_fpthbxje) {
		setAttrVal("Amt_fpthbxje", Amt_fpthbxje);
	}
	/**
	 * 低保救助金额
	 * @return FDouble
	 */
	public FDouble getAmt_dbjzje() {
		return ((FDouble) getAttrVal("Amt_dbjzje"));
	}
	/**
	 * 低保救助金额
	 * @param Amt_dbjzje
	 */
	public void setAmt_dbjzje(FDouble Amt_dbjzje) {
		setAttrVal("Amt_dbjzje", Amt_dbjzje);
	}
	/**
	 * 重特大疾病救助金额
	 * @return FDouble
	 */
	public FDouble getAmt_ztdjbjzje() {
		return ((FDouble) getAttrVal("Amt_ztdjbjzje"));
	}
	/**
	 * 重特大疾病救助金额
	 * @param Amt_ztdjbjzje
	 */
	public void setAmt_ztdjbjzje(FDouble Amt_ztdjbjzje) {
		setAttrVal("Amt_ztdjbjzje", Amt_ztdjbjzje);
	}
	/**
	 * 本年度累计民政救助金额
	 * @return FDouble
	 */
	public FDouble getAmt_civilassist_year() {
		return ((FDouble) getAttrVal("Amt_civilassist_year"));
	}
	/**
	 * 本年度累计民政救助金额
	 * @param Amt_civilassist_year
	 */
	public void setAmt_civilassist_year(FDouble Amt_civilassist_year) {
		setAttrVal("Amt_civilassist_year", Amt_civilassist_year);
	}
	/**
	 * 本年度累计特惠保险金额
	 * @return FDouble
	 */
	public FDouble getAmt_fpthbxje_year() {
		return ((FDouble) getAttrVal("Amt_fpthbxje_year"));
	}
	/**
	 * 本年度累计特惠保险金额
	 * @param Amt_fpthbxje_year
	 */
	public void setAmt_fpthbxje_year(FDouble Amt_fpthbxje_year) {
		setAttrVal("Amt_fpthbxje_year", Amt_fpthbxje_year);
	}
	/**
	 * 本年度累计重特大疾病救助金额
	 * @return FDouble
	 */
	public FDouble getAmt_ztdjbjzje_year() {
		return ((FDouble) getAttrVal("Amt_ztdjbjzje_year"));
	}
	/**
	 * 本年度累计重特大疾病救助金额
	 * @param Amt_ztdjbjzje_year
	 */
	public void setAmt_ztdjbjzje_year(FDouble Amt_ztdjbjzje_year) {
		setAttrVal("Amt_ztdjbjzje_year", Amt_ztdjbjzje_year);
	}
	/**
	 * 生育基金支付
	 * @return FDouble
	 */
	public FDouble getAmt_birth() {
		return ((FDouble) getAttrVal("Amt_birth"));
	}
	/**
	 * 生育基金支付
	 * @param Amt_birth
	 */
	public void setAmt_birth(FDouble Amt_birth) {
		setAttrVal("Amt_birth", Amt_birth);
	}
	/**
	 * 统筹结算单
	 * @return String
	 ...
	 * @return FDouble
	 */
	public FDouble getAmt_jbylpsn() {
		return ((FDouble) getAttrVal("Amt_jbylpsn"));
	}
	/**
	 * 基本医疗账户支付
	 * @param Amt_jbylpsn
	 */
	public void setAmt_jbylpsn(FDouble Amt_jbylpsn) {
		setAttrVal("Amt_jbylpsn", Amt_jbylpsn);
	}
	/**
	 * 公费医疗账户支付
	 * @return FDouble
