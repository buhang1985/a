...
package iih.mi.biz.mihporsharelog.d.desc;
 ...
 * 医保共享日志 DO 元数据信息
 */
public class MiHpOrShareLogDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.biz.mihporsharelog.d.MiHpOrShareLogDO";
	public static final String CLASS_DISPALYNAME = "医保共享日志";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_OR_SHARE_LOG";
