 ...
 * 安徽医保交易记录 DO 元数据信息
 */
public class MiHpTransActDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.biz.mihptransact.d.MiHpTransActDO";
	public static final String CLASS_DISPALYNAME = "安徽医保交易记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mi_hptransact";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hptransact";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hptransactADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hptransactCDesc(tblDesc));
