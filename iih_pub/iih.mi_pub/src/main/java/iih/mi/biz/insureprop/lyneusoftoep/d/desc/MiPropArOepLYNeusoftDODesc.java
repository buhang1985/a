...
package iih.mi.biz.insureprop.lyneusoftoep.d.desc;
...
/**
 * 临沂市医保门诊分摊数据 DO 元数据信息
 */
public class MiPropArOepLYNeusoftDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.biz.insureprop.lyneusoftoep.d.MiPropArOepLYNeusoftDO";
	public static final String CLASS_DISPALYNAME = "临沂市医保门诊分摊数据";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mi_prop_aroep_lyneusoft";
	 ...
	 * 无参构造函数
	 */
	public MiPropArOepLYNeusoftDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.add(getName_pat_hpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getName_pat_hpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_pat_hpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_pat_hp",  getName_pat_hpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医保人员姓名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getName_pat_hpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_pat_hp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医保人员姓名"); 
		return column;
	}
	/**
	 * 获取定点医疗机构编号表列元数据
