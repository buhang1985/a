...
package iih.mi.biz.mireferralinfo.d.desc;
 ...
 * 转诊单申请表 DO 元数据信息
 */
public class MiReferralDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.biz.mireferralinfo.d.MiReferralDO";
	public static final String CLASS_DISPALYNAME = "转诊单申请表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mi_referral";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_referral";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_referralADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_referralADesc(tblDesc));
		...
		this.add(getSexcodeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_referralCDesc(tblDesc));
		tblDesc.add(getId_referralCDesc(tblDesc));
		...
		tblDesc.add(getSexcodeCDesc(tblDesc));
		tblDesc.add(getSexnameCDesc(tblDesc));
		...
		tblDesc.add(getReferraltp_codeCDesc(tblDesc));
		tblDesc.add(getReferraltp_nameCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_referralADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_referral",  getId_referralCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getSexcodeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sexcode",  getSexcodeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("性别代码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_referralCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_referral");
		column.setLength(20);
	 ...
	 * @return
	 */
	private IColumnDesc getSexcodeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sexcode");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("性别代码"); 
		return column;
	}
	/**
	 * 获取性别名称表列元数据
