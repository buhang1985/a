...
package iih.mi.biz.insureprop.ruraltmp.d.desc;
...
/**
 * 前置流程新农合医保分摊 DO 元数据信息
 */
public class MiHpPropRuralIpTmpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.biz.insureprop.ruraltmp.d.MiHpPropRuralIpTmpDO";
	public static final String CLASS_DISPALYNAME = "前置流程新农合医保分摊";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mi_prop_arip_ruraltmp";
	 ...
	 * 无参构造函数
	 */
	public MiHpPropRuralIpTmpDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.add(getId_refADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_refCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_refADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_ref",  getId_refCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("关联his业务主键");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_refCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_ref");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("关联his业务主键"); 
		return column;
	}
	/**
	 * 获取方向表列元数据
