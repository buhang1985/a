 ...
 * 医保交易记录 DO 元数据信息
 */
public class MiTransRecordDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.biz.mitransrecord.d.MiTransRecord";
