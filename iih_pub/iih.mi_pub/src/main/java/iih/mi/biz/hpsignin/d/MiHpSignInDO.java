 ...
 * 
 */
public class MiHpSignInDO extends BaseDO {
	...
	public static final String EU_BIZTYPE= "Eu_biztype";
	...
	public Integer getEu_biztype() {
		return ((Integer) getAttrVal("Eu_biztype"));
	}	
	public void setEu_biztype(Integer Eu_biztype) {
		setAttrVal("Eu_biztype", Eu_biztype);
	}
...
//	}
	...
	public String getTableName() {	  
		return "mi_hp_sign_in";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MiHpSignInDODesc.class);
	}
