...
package iih.mi.biz.mirefundrecord.d.desc;
 ...
 * 医保退费记录 DO 元数据信息
 */
public class MiRefundRecordDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.biz.mirefundrecord.d.MiRefundRecordDO";
	public static final String CLASS_DISPALYNAME = "医保退费记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mi_refund_record";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_refundrecord";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_refundrecordADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_refundrecordADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_refundrecordCDesc(tblDesc));
		tblDesc.add(getId_refundrecordCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_refundrecordADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_refundrecord",  getId_refundrecordCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("退费id");
	 ...
	 * @return
	 */
	private IColumnDesc getId_refundrecordCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_refundrecord");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("退费id"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
