...
package iih.mi.mibd.referraltp.d.desc;
 ...
 * 转诊类型 DO 元数据信息
 */
public class ReferralTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.referraltp.d.ReferralTpDO";
	public static final String CLASS_DISPALYNAME = "转诊类型";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_REFERRALTP";
