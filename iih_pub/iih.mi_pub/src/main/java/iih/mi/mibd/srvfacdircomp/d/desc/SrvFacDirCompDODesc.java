package iih.mi.mibd.srvfacdircomp.d.desc;
...
public class SrvFacDirCompDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.srvfacdircomp.d.SrvFacDirCompDO";
	public static final String CLASS_DISPALYNAME = "服务设施对照";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_COMP_SRVFAC";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_comp_srvfac";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_comp_srvfacADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_comp_srvfacADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_comp_srvfacCDesc(tblDesc));
		tblDesc.add(getId_comp_srvfacCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_comp_srvfacADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_comp_srvfac",  getId_comp_srvfacCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("服务设施对照主键");
	...
	private IAttrDesc getCode_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"MI_BD_SRVFAC a0b6","code=id_srvfac","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_comp_srvfacCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_comp_srvfac");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("服务设施对照主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_comp_srvfac");
