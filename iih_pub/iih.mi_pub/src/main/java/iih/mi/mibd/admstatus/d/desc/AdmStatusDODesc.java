...
package iih.mi.mibd.admstatus.d.desc;
 ...
 * 入院状态 DO 元数据信息
 */
public class AdmStatusDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.admstatus.d.AdmStatusDO";
	public static final String CLASS_DISPALYNAME = "入院状态";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_ADMSTATUS";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_admstatus";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_admstatusADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_admstatusCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_admstatu");
