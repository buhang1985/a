 ...
 * 险种 DO 元数据信息
 */
public class IcDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.ic.d.IcDO";
	public static final String CLASS_DISPALYNAME = "险种";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_INSURKIND";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_kind";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_kindADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_kindCDesc(tblDesc));
