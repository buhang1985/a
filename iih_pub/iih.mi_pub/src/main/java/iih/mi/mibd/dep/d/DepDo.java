 ...
 * 
 */
public class DepDo extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_MIDEP= "Id_midep";
	...
	public String getId_midep() {
		return ((String) getAttrVal("Id_midep"));
	}	
	public void setId_midep(String Id_midep) {
		setAttrVal("Id_midep", Id_midep);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(DepDoDesc.class);
	}
