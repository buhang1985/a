...
package iih.mi.mibd.dep.d.desc;
 ...
 * 科别 DO 元数据信息
 */
public class DepDoDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.dep.d.DepDo";
	public static final String CLASS_DISPALYNAME = "科别";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_DEP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_midep";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_midepADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_midepADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_midepCDesc(tblDesc));
		tblDesc.add(getId_midepCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_midepADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_midep",  getId_midepCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("科别主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_midepCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_midep");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("科别主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_midep");
