 ...
 * 
 */
public class FreqDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_MIFREQ= "Id_mifreq";
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(FreqDODesc.class);
	}
