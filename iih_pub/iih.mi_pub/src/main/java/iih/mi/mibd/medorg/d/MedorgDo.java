 ...
 * 
 */
public class MedorgDo extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_MEDORG= "Id_medorg";
	...
	public String getId_medorg() {
		return ((String) getAttrVal("Id_medorg"));
	}	
	public void setId_medorg(String Id_medorg) {
		setAttrVal("Id_medorg", Id_medorg);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MedorgDoDesc.class);
	}
