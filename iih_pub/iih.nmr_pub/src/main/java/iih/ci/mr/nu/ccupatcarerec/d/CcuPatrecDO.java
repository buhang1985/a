...
import iih.ci.mr.nu.ccupatcarerec.d.desc.CcuPatrecDODesc;
 ...
 * 
 */
public class CcuPatrecDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_CCUPAT= "Id_ccupat";
	...
	public String getId_ccupat() {
		return ((String) getAttrVal("Id_ccupat"));
	}	
	public void setId_ccupat(String Id_ccupat) {
		setAttrVal("Id_ccupat", Id_ccupat);
	}
...
//	}
	...
	public String getTableName() {	  
		return "mr_nu_ccupatrec";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CcuPatrecDODesc.class);
	}
