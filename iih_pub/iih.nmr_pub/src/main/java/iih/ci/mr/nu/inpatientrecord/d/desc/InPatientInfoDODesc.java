 ...
 * 内科住院患者信息 DO 元数据信息
 */
public class InPatientInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.inpatientrecord.d.InPatientInfoDO";
	public static final String CLASS_DISPALYNAME = "内科住院患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_inpatinfo";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_intmed";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_intmedADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_intmedCDesc(tblDesc));
