 ...
 * 就诊患者信息 DO 元数据信息
 */
public class CriticallyCustDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.obstetrics.criticallyill.d.CriticallyCustDO";
