 ...
 * 产科住院患者信息 DO 元数据信息
 */
public class IpobstetricnurinfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.ipobstetricnur.d.IpobstetricnurinfoDO";
	public static final String CLASS_DISPALYNAME = "产科住院患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_ipobstinfo";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_obsinfo";
	 ...
	 * 无参构造函数
	 */
	public IpobstetricnurinfoDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_obsinfoADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_obsinfoCDesc(tblDesc));
