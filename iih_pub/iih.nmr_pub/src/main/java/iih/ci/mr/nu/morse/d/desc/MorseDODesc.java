...
package iih.ci.mr.nu.morse.d.desc;
 ...
 */
public class MorseDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.morse.d.MorseDO";
	public static final String CLASS_DISPALYNAME = "Morse跌倒/坠床风险评估单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_morse";
	...
	private void init(){		
		...
		this.add(getName_treadADesc(tblDesc));
		this.add(getName_know_statusADesc(tblDesc));
		this.add(getName_enum_fallADesc(tblDesc));
		this.add(getName_medi_diagADesc(tblDesc));
		this.add(getName_intr_drip_injeADesc(tblDesc));
		this.add(getName_walk_auxiADesc(tblDesc));
		this.add(getName_drug_reacADesc(tblDesc));
		this.add(getName_envi_factADesc(tblDesc));
	...
	private IAttrDesc getId_morseADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("Morse跌倒/坠床风险评估单id");
	...
	private IAttrDesc getSd_nurs_measADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("Morse跌倒护理措施编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getSd_enum_fallADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("跌倒史（近三个月有发生）编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getId_intr_drip_injeADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("静脉输液中、使用静脉留置针");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getSd_intr_drip_injeADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("静脉输液中、使用静脉留置针编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getId_drug_reacADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("使用降压药、镇静药等特殊药物或麻醉反映");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getSd_drug_reacADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("使用降压药、镇静药等特殊药物或麻醉反映编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_nurs_measADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b16","id_nurs_meas=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_treadADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_tread",  getName_treadCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("步态名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_tread=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_know_statusADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_know_status",  getName_know_statusCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("认知状态名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_know_status=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_enum_fallADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_enum_fall",  getName_enum_fallCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("跌倒史名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b18","id_enum_fall=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_medi_diagADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_medi_diag",  getName_medi_diagCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("超过一个医学诊断名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b19","id_medi_diag=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_intr_drip_injeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_intr_drip_inje",  getName_intr_drip_injeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("静脉输液中名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b20","id_intr_drip_inje=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_walk_auxiADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_walk_auxi",  getName_walk_auxiCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("行走辅助名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b17","id_walk_auxi=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 * 使用降压药、镇静药等特殊药物或麻醉反映名称属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getName_drug_reacADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_drug_reac",  getName_drug_reacCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("使用降压药、镇静药等特殊药物或麻醉反映名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b23","id_drug_reac=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_envi_factADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_envi_fact",  getName_envi_factCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("环境因素名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b22","id_envi_fact=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_sign_nurseADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b15","id_sign_nurse=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 * 获取Morse跌倒/坠床风险评估单id表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_morseCDesc(ITableDesc tblDesc){
		...
		column.setLabel("Morse跌倒/坠床风险评估单id"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
	...
	private IColumnDesc getId_nurs_measCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("Morse跌倒护理措施"); 
		return column;
	}
	/**
	 * 获取Morse跌倒护理措施编码表列元数据
	 * @param tblDesc
	 * @return
	 */
	...
	private IColumnDesc getId_enum_fallCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("跌倒史（近三个月有发生）"); 
		return column;
	}
	/**
	 * 获取跌倒史（近三个月有发生）编码表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getSd_enum_fallCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("跌倒史（近三个月有发生）编码"); 
		return column;
	}
	/**
	 * 获取超过一个医学诊断表列元数据
	...
	private IColumnDesc getId_intr_drip_injeCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("静脉输液中、使用静脉留置针"); 
		return column;
	}
	/**
	 * 获取静脉输液中、使用静脉留置针编码表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getSd_intr_drip_injeCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("静脉输液中、使用静脉留置针编码"); 
		return column;
	}
	/**
	 * 获取行走辅助表列元数据
	...
	private IColumnDesc getId_drug_reacCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("使用降压药、镇静药等特殊药物或麻醉反映"); 
		return column;
	}
	/**
	 * 获取使用降压药、镇静药等特殊药物或麻醉反映编码表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getSd_drug_reacCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("使用降压药、镇静药等特殊药物或麻醉反映编码"); 
		return column;
	}
	/**
	 * 获取环境因素表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_treadCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_tread");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("步态名称"); 
		return column;
	}
	/**
	 * 获取认知状态名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_know_statusCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_know_status");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("认知状态名称"); 
		return column;
	}
	/**
	 * 获取跌倒史名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_enum_fallCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_enum_fall");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("跌倒史名称"); 
		return column;
	}
	/**
	 * 获取超过一个医学诊断名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_medi_diagCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_medi_diag");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("超过一个医学诊断名称"); 
		return column;
	}
	/**
	 * 获取静脉输液中名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_intr_drip_injeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_intr_drip_inje");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("静脉输液中名称"); 
		return column;
	}
	/**
	 * 获取行走辅助名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_walk_auxiCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_walk_auxi");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("行走辅助名称"); 
		return column;
	}
	/**
	 * 获取使用降压药、镇静药等特殊药物或麻醉反映名称表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getName_drug_reacCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_drug_reac");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("使用降压药、镇静药等特殊药物或麻醉反映名称"); 
		return column;
	}
	/**
	 * 获取环境因素名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_envi_factCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_envi_fact");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("环境因素名称"); 
		return column;
	}
	/**
	 * 获取护士签名表列元数据
