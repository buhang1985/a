 ...
 * CCU患者信息 DO 元数据信息
 */
public class CcuPatrecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.ccupatcarerec.d.CcuPatrecDO";
	public static final String CLASS_DISPALYNAME = "CCU患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_ccupatrec";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ccupat";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ccupatADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ccupatCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_ccupat");
