 ...
 * 外科患者基本信息 DO 元数据信息
 */
public class SurgeryPatInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.sugeryip.d.SurgeryPatInfoDO";
	public static final String CLASS_DISPALYNAME = "外科患者基本信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MR_NU_SURGERYPATINFO";
