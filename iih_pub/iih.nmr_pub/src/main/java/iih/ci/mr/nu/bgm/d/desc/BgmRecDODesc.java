 ...
 * 血糖监测记录表 DO 元数据信息
 */
public class BgmRecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.bgm.d.BgmRecDO";
	public static final String CLASS_DISPALYNAME = "血糖监测记录表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MR_NU_BGM_ITM";
	...
	private IAttrDesc getName_signatureADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b6b2","id_signature=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_tpchkADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6b3","id_tp_check=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
