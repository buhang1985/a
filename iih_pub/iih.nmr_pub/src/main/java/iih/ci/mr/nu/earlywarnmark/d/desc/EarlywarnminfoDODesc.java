 ...
 * 早期预警患者基本信息 DO 元数据信息
 */
public class EarlywarnminfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.earlywarnmark.d.EarlywarnminfoDO";
	public static final String CLASS_DISPALYNAME = "早期预警患者基本信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_early_info";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_earlywarinfo";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_earlywarinfoADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_earlywarinfoCDesc(tblDesc));
