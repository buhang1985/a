 ...
 * 手术患者术中患者信息 DO 元数据信息
 */
public class OpermatDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.opermatlist.d.OpermatDO";
	public static final String CLASS_DISPALYNAME = "手术患者术中患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MR_NU_OPERMAT";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_opermatlist";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_opermatlistADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_opermatlistCDesc(tblDesc));
	...
	private IAttrDesc getName_signatureADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b6","id_signature=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
