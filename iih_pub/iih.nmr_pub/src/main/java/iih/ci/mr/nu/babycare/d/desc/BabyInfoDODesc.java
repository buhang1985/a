 ...
 * 新生儿信息 DO 元数据信息
 */
public class BabyInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.babycare.d.BabyInfoDO";
	public static final String CLASS_DISPALYNAME = "新生儿信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MR_NU_BABYINFO";
