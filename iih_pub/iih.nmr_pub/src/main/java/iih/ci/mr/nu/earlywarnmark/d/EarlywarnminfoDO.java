...
import iih.ci.mr.nu.earlywarnmark.d.desc.EarlywarnminfoDODesc;
 ...
 * 
 */
public class EarlywarnminfoDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_earlywarinfo";
	}
	
	@Override
	public String getTableName() {	  
		return "mr_nu_early_info";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(EarlywarnminfoDODesc.class);
	}
