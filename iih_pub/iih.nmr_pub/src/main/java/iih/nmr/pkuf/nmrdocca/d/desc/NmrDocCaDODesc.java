...
package iih.nmr.pkuf.nmrdocca.d.desc;
 ...
 * 文书分类 DO 元数据信息
 */
public class NmrDocCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.nmrdocca.d.NmrDocCaDO";
	public static final String CLASS_DISPALYNAME = "文书分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_DOCCA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nmr_docca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nmr_doccaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nmr_doccaCDesc(tblDesc));
	...
	private IAttrDesc getName_patADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NMR_DOCCA a0b6","id_par=id_nmr_docca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_nmr_docca");
