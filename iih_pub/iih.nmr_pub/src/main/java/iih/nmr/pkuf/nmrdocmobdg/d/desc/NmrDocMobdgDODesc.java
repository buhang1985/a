 ...
 * 移动数据集新版 DO 元数据信息
 */
public class NmrDocMobdgDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.nmrdocmobdg.d.NmrDocMobdgDO";
	public static final String CLASS_DISPALYNAME = "移动数据集新版";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "nmr_doc_mobdg";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nmr_doc_mobdg";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nmr_doc_mobdgADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nmr_doc_mobdgCDesc(tblDesc));
	...
	private IAttrDesc getName_nmr_docADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NMR_DOC a0b4","id_nmr_doc=id_nmr_doc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_nmr_doc_mobdg");
