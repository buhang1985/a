package iih.nmr.pkuf.bprecord.d;
...
import iih.nmr.pkuf.bprecord.d.desc.BprecordDODesc;
 ...
 * 
 */
public class BprecordDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//血压监测主键
	public static final String ID_BPRECORD= "Id_bprecord";
	//组织
	 ...
	 * @return String
	 */
	public String getId_bprecord() {
		return ((String) getAttrVal("Id_bprecord"));
	}	
	/**
	 * 血压监测主键
	 * @param Id_bprecord
	 */
	public void setId_bprecord(String Id_bprecord) {
		setAttrVal("Id_bprecord", Id_bprecord);
	}
	/**
	 * 组织
	 * @return String
...
//	}
	...
	public String getTableName() {	  
		return "NMR_PKUF_BPRECORD";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(BprecordDODesc.class);
	}
