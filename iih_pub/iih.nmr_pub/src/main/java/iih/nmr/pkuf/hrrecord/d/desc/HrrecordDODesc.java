...
package iih.nmr.pkuf.hrrecord.d.desc;
 ...
 * 心率监测记录单 DO 元数据信息
 */
public class HrrecordDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.hrrecord.d.HrrecordDO";
	public static final String CLASS_DISPALYNAME = "心率监测记录单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_PKUF_HRRECORD";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hrrecord";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hrrecordADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_hrrecordADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hrrecordCDesc(tblDesc));
		tblDesc.add(getId_hrrecordCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hrrecordADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hrrecord",  getId_hrrecordCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("心率监测主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_hrrecordCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hrrecord");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("心率监测主键"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
