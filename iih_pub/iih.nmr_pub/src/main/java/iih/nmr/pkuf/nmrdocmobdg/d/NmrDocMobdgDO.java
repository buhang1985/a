...
import iih.nmr.pkuf.nmrdocmobdg.d.desc.NmrDocMobdgDODesc;
 ...
 * 
 */
public class NmrDocMobdgDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_nmr_doc_mobdg";
	}
	
	@Override
	public String getTableName() {	  
		return "nmr_doc_mobdg";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(NmrDocMobdgDODesc.class);
	}
