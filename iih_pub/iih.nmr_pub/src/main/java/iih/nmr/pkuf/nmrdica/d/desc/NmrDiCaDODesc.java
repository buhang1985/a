...
package iih.nmr.pkuf.nmrdica.d.desc;
 ...
 * 护理诊断分类 DO 元数据信息
 */
public class NmrDiCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.nmrdica.d.NmrDiCaDO";
	public static final String CLASS_DISPALYNAME = "护理诊断分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_DICA";
	...
	private IAttrDesc getName_patADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NMR_DICA a0b6","id_par=id_dica","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
