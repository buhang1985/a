 ...
 * 健康教育计划执行单 DO 元数据信息
 */
public class HealtheduDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.healthedu.d.HealtheduDO";
	public static final String CLASS_DISPALYNAME = "健康教育计划执行单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_PKUF_HEALTHEDU";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_healthedu";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_healtheduADesc(tblDesc));
		...
		this.add(getId_religionADesc(tblDesc));
		this.add(getSd_religionADesc(tblDesc));
		this.add(getId_culcutre_dgreeADesc(tblDesc));
		this.add(getSd_culcutre_dgreeADesc(tblDesc));
		...
		this.add(getName_religionADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_healtheduCDesc(tblDesc));
		...
		tblDesc.add(getId_religionCDesc(tblDesc));
		tblDesc.add(getSd_religionCDesc(tblDesc));
		tblDesc.add(getId_culcutre_dgreeCDesc(tblDesc));
		tblDesc.add(getSd_culcutre_dgreeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_religionADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_religion",  getId_religionCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_religionADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_religion",  getSd_religionCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getId_culcutre_dgreeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_culcutre_dgree",  getId_culcutre_dgreeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_culcutre_dgreeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_culcutre_dgree",  getSd_culcutre_dgreeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_religionADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_religion",  getName_religionCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("宗教信仰");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_religion=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_cultureADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_culcutre_dgree=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_religionCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_religion");
	 ...
	 * @return
	 */
	private IColumnDesc getSd_religionCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_religion");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_culcutre_dgreeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_culcutre_dgree");
		column.setLength(200);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getSd_culcutre_dgreeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_culcutre_dgree");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_religionCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_religion");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("宗教信仰"); 
		return column;
