...
package iih.nmr.pkuf.nmrinfo.d.desc;
 ...
 * 护理文书_告知单 DO 元数据信息
 */
public class NmrInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.nmrinfo.d.NmrInfoDO";
	public static final String CLASS_DISPALYNAME = "护理文书_告知单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "nmr_info";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nmr_info";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nmr_infoADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nmr_infoADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nmr_infoCDesc(tblDesc));
		tblDesc.add(getId_nmr_infoCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nmr_infoADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nmr_info",  getId_nmr_infoCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("告知单之间标识");
	 ...
	 * @return
	 */
	private IColumnDesc getId_nmr_infoCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nmr_info");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("告知单之间标识"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
