package iih.nmr.common.medicrecord.d;

import xap.sys.appfw.orm.model.agg.BaseAggDO;
import xap.mw.core.data.BaseDO;
import xap.mw.coreitf.i.IAggDesc;
import xap.mw.coreitf.i.IBaseDO;
import iih.nmr.common.medicrecord.d.desc.MedicrecordAggDODesc;
...
public class MedicrecordAggDO extends BaseAggDO {
	...
	public IAggDesc getAggDesc() {
     ...
     public  BaseDO createChildDO(String clzName) {
	     if (clzName.equals("iih.nmr.common.medicrecord.d.MedicalRecordSetCollDO")) {
