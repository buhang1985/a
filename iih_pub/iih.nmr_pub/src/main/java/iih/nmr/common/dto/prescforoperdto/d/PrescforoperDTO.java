package iih.nmr.common.dto.prescforoperdto.d;
 ...
 * 
 */
public class PrescforoperDTO extends BaseDTO {
	 ...
	 * @return Integer
	 */
	public Integer getSc_value() {
		return ((Integer) getAttrVal("Sc_value"));
	}
	/**
	 * 每项得分
	 * @param Sc_value
	 */
	public void setSc_value(Integer Sc_value) {
		setAttrVal("Sc_value", Sc_value);
	}
	/**
	 * 是否选择
	 * @return FBoolean
