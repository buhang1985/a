...
import iih.nmr.ha.tcho.ipevalsigle.d.desc.TchoEvaluateDODesc;
 ...
 * 
 */
public class TchoEvaluateDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_EVALSGL= "Id_evalsgl";
	public static final String ID_ORG= "Id_org";
	public static final String ID_GRP= "Id_grp";
	public static final String CODE_EVALSGL= "Code_evalsgl";
	...
	public String getCode_evalsgl() {
		return ((String) getAttrVal("Code_evalsgl"));
	}	
	public void setCode_evalsgl(String Code_evalsgl) {
		setAttrVal("Code_evalsgl", Code_evalsgl);
	}
...
//	}
	...
	public String getTableName() {	  
		return "NMR_HA_TCHO_EVLASGL";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(TchoEvaluateDODesc.class);
	}
