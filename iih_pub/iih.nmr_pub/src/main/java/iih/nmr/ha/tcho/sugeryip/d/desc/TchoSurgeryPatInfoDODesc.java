 ...
 * 外科患者基本信息 DO 元数据信息
 */
public class TchoSurgeryPatInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.ha.tcho.sugeryip.d.TchoSurgeryPatInfoDO";
	public static final String CLASS_DISPALYNAME = "外科患者基本信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_HA_TCHO_SURGERYPATINFO";
	 ...
	 * 无参构造函数
	 */
	public TchoSurgeryPatInfoDODesc(){
		init();
	}
