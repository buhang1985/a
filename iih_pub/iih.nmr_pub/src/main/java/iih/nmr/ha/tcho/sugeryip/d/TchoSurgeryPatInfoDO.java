...
import iih.nmr.ha.tcho.sugeryip.d.desc.TchoSurgeryPatInfoDODesc;
 ...
 * 
 */
public class TchoSurgeryPatInfoDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "NMR_HA_TCHO_SURGERYPATINFO";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(TchoSurgeryPatInfoDODesc.class);
	}
