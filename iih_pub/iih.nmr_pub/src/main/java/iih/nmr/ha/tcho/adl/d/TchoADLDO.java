...
import iih.nmr.ha.tcho.adl.d.desc.TchoADLDODesc;
 ...
 * 
 */
public class TchoADLDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "nur_ha_tcho_ADL";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(TchoADLDODesc.class);
	}
