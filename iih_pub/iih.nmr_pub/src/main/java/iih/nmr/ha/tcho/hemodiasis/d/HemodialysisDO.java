...
import iih.nmr.ha.tcho.hemodiasis.d.desc.HemodialysisDODesc;
 ...
 * 
 */
public class HemodialysisDO extends BaseDO {
	...
	public static final String ID_DOC_SIGN= "Id_doc_sign";
	public static final String ID_CCZ_SIGN= "Id_ccz_sign";
	public static final String ID_XJZ_SIGN= "Id_xjz_sign";
	...
	public static final String NAME_DOC_SIGN= "Name_doc_sign";
	public static final String NAME_CCZ_SIGN= "Name_ccz_sign";
	public static final String NAME_XJZ_SIGN= "Name_xjz_sign";
	...
	public Integer getNo_dialymachine() {
		return ((Integer) getAttrVal("No_dialymachine"));
	}	
	public void setNo_dialymachine(Integer No_dialymachine) {
	...
	public String getId_doc_sign() {
		return ((String) getAttrVal("Id_doc_sign"));
	}	
	public void setId_doc_sign(String Id_doc_sign) {
		setAttrVal("Id_doc_sign", Id_doc_sign);
	}
	public String getId_ccz_sign() {
		return ((String) getAttrVal("Id_ccz_sign"));
	}	
	public void setId_ccz_sign(String Id_ccz_sign) {
		setAttrVal("Id_ccz_sign", Id_ccz_sign);
	}
	public String getId_xjz_sign() {
		return ((String) getAttrVal("Id_xjz_sign"));
	}	
	public void setId_xjz_sign(String Id_xjz_sign) {
		setAttrVal("Id_xjz_sign", Id_xjz_sign);
	}
	...
	public String getName_doc_sign() {
		return ((String) getAttrVal("Name_doc_sign"));
	}	
	public void setName_doc_sign(String Name_doc_sign) {
		setAttrVal("Name_doc_sign", Name_doc_sign);
	}
	public String getName_ccz_sign() {
		return ((String) getAttrVal("Name_ccz_sign"));
	}	
	public void setName_ccz_sign(String Name_ccz_sign) {
		setAttrVal("Name_ccz_sign", Name_ccz_sign);
	}
	public String getName_xjz_sign() {
		return ((String) getAttrVal("Name_xjz_sign"));
	}	
	public void setName_xjz_sign(String Name_xjz_sign) {
		setAttrVal("Name_xjz_sign", Name_xjz_sign);
	}
...
//	}
	...
	public String getTableName() {	  
		return "NMR_TCHO_HEMO";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HemodialysisDODesc.class);
	}
