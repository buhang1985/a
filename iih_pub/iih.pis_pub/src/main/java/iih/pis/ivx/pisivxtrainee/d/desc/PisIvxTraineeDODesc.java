...
package iih.pis.ivx.pisivxtrainee.d.desc;
 ...
 * 微信服务-培训生 DO 元数据信息
 */
public class PisIvxTraineeDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pis.ivx.pisivxtrainee.d.PisIvxTraineeDO";
	public static final String CLASS_DISPALYNAME = "微信服务-培训生";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pis_ivx_trainee";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pisivxtrainee";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pisivxtraineeADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pisivxtraineeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pisivxtraineeCDesc(tblDesc));
		tblDesc.add(getId_pisivxtraineeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pisivxtraineeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pisivxtrainee",  getId_pisivxtraineeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("微信培训生主键标识");
	...
	private IAttrDesc getOpenidADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pis_ivx_account a0b6","id_pisivxaccount=id_pisivxaccount","openid"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getId_pisivxtagsADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pis_ivx_account a0b6","id_pisivxaccount=id_pisivxaccount","id_pisivxtags"});
		attrDesc.setRefType(true);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getAcctpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pis_ivx_account a0b6","id_pisivxaccount=id_pisivxaccount","acctp"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_pisivxtraineeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pisivxtrainee");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("微信培训生主键标识"); 
		return column;
	}
	/**
	 * 获取微信账户ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pisivxtrainee");
