...
package iih.pis.mbw.pismbwfocdoc.d.desc;
 ...
 * 关注医生 DO 元数据信息
 */
public class PisMbwFocdocDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pis.mbw.pismbwfocdoc.d.PisMbwFocdocDO";
	public static final String CLASS_DISPALYNAME = "关注医生";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pis_mbw_focdoc";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mbw_focdoc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mbw_focdocADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_mbw_focdocADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mbw_focdocCDesc(tblDesc));
		tblDesc.add(getId_mbw_focdocCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_mbw_focdocADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mbw_focdoc",  getId_mbw_focdocCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("关注医生");
	 ...
	 * @return
	 */
	private IColumnDesc getId_mbw_focdocCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mbw_focdoc");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("关注医生"); 
		return column;
	}
	/**
	 * 获取用户Id表列元数据
