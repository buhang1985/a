package iih.pis.mbw.pismbwfocdoc.d;
...
import iih.pis.mbw.pismbwfocdoc.d.desc.PisMbwFocdocDODesc;
 ...
 * 
 */
public class PisMbwFocdocDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//关注医生
	public static final String ID_MBW_FOCDOC= "Id_mbw_focdoc";
	//用户Id
	...
	public String getId_mbw_focdoc() {
		return ((String) getAttrVal("Id_mbw_focdoc"));
	}	
	/**
	 * 关注医生
	 * @param Id_mbw_focdoc
	...
	public void setId_mbw_focdoc(String Id_mbw_focdoc) {
		setAttrVal("Id_mbw_focdoc", Id_mbw_focdoc);
	}
	/**
	 * 用户Id
	 * @return String
...
//	}
	...
	public String getTableName() {	  
		return "pis_mbw_focdoc";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PisMbwFocdocDODesc.class);
	}
