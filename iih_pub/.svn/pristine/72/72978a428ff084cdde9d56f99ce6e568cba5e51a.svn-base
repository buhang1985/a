package iih.mp.mpbd.mprscard.d;
...
import iih.mp.mpbd.mprscard.d.desc.MpRsCardDODesc;
 ...
 * 
 */
public class MpRsCardDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//护士站滚屏卡ID
	public static final String ID_RS_CARD= "Id_rs_card";
	//护士站滚屏
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MpRsCardDODesc.class);
	}
