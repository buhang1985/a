package iih.bd.srv.reportcardtype.d;
 ...
 * 
 */
public class EmrReportCardTypeDO extends BaseDO {
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(EmrReportCardTypeDODesc.class);
	}
