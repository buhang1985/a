package iih.bd.mhi.hpsex.d.desc;
 ...
 * 医保计划性别 DO 元数据信息
 */
public class HpSexDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpsex.d.HpSexDO";
	public static final String CLASS_DISPALYNAME = "医保计划性别";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_SEX";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpsex";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpsexADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpsexCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpsex");
