...
public interface ICiOrdMaintainService {
	 ...
	 * @throws BizException
	 */
	public abstract CiOrderDO[] SaveCiEmsDTO_TL(CiEmsDTO ciEmsDTO,CiEnContextDTO CiEnContext) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract EmsRstDTO SaveCiEmsDTO_new(CiEmsDTO ciEmsDTO,CiEnContextDTO CiEnContext) throws BizException ;
	/**
	 * 医嘱保存提示信息后保存
	 * 
	 * @param ciEmsDTO
	...
	public abstract EmsRstDTO[] SaveCiEmsDTO_TL_new(CiEmsDTO ciEmsDTO,CiEnContextDTO ctx) throws BizException ;
	/**
	 * 删除医嘱 和相关的信息
	 * 
	 * @param id_orders
	...
	public abstract ValidateRtnInfoDTO ciOrderSign_TL(String[] id_ors, CiEnContextDTO ciEnContextDTO,boolean fgUseEr,OrderOperateDTO arg) throws BizException;
	...
	public abstract CiOrderDO[] CiOrderSCSCheck_TL(String[] id_sign_ors, String[] id_canc_ors, String[] id_stop_ors,String id_emp_second_chk,FDateTime dt_chk_stop) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract OrdApConsDO revokeAggDo(OrdApConsDO aggdos) throws BizException;
	/**
	 * 更新备血申请的可用血余量
	 * 
	 * @param aggDO
	 ...
	 * @return
	 */
    public abstract Integer getTotalTimes(FDateTime dt_effe,String id_freq, int use_day) throws BizException;
    /**
     * 物品类计算总量
     * @param code_entp
     * @param fg_pres_outp
	...
	/**
	 * 修改医嘱的停止时间
	 * @param ciOrdModifyEndTimeDTO
	 * @return
	 * @throws BizException
	 */
	public CiOrdModifyEndTimeDTO updateCiOrdDtEnd(CiOrdModifyEndTimeDTO ciOrdModifyEndTimeDTO) throws BizException;
	/**
	 * 校验人员和密码，一个人员可以有多个用户，校验时只要有一个密码符合即通过
	 * @param id_psndoc
	 * @param password
	 * @return
	 * @throws BizException
	...
	/**
	 * 门诊开始时间取值逻辑处理，0,不处理；1，指定时间；2，取频次第一个执行时刻
	 * @param id_freq
	 * @param dt_effe
	 * @return
	 * @throws BizException
	 ...
	 * 更新医嘱是否打印医嘱单标识
	 * @param id_or 医嘱id
	 * @param fg_prn 是否打印到医嘱单 true 打印， false 不打印
	 * @return
	 * @throws BizException
	 */
	 ...
	 * @return
	 */
	public OrderRstDTO ordRevoke(IdVProperty[] id_ors, FArrayList reactOrds,CiEnContextDTO ciEnContext, FDateTime dt_end, String sd_su_or, OrderOperateDTO arg) throws BizException;
     /**
     * 从IE平台获取输血动态指标结果
     * @param CiEnContext
     * @param btviewitem
     ...
     * @throws BizException
     */
    public abstract FArrayList getBtlabRtnFromIE(CiEnContextDTO CiEnContext,FArrayList btviewitem)throws BizException;
        /**
	 * 住院医生站医嘱,医嘱列表右键进行自费操作
	 * @param id_or
	 * @param ctx
	 * @param fg_selfpay
	 * @throws BizException
	 */
    public abstract FBoolean FgSelfpay(String[] id_ors,CiEnContextDTO ctx,FBoolean fg_selfpay)throws BizException;
    /**
     * 医嘱取消停止
     * @param id_ors
     * @return
     * @throws BizException
     */
    public abstract String revertStop(String[] id_ors) throws BizException;
    /**
     * 护士补录医嘱保存
     * @param ctx
     * @param orders
     ...
     * @throws BizException
     */
    public abstract EmsRstDTO[] saveNursOrders(CiEnContextDTO ctx,CiOrderDO[] orders) throws BizException;
    /**
     * 护嘱删除
     * @param id_ors
     * @return
     ...
     * @throws BizException
     */
    public  abstract void  updateOrderExamine(String[] id_ors,String id_emp_verify_pharm,
    		Integer eu_verify_pharm,String des_verify_pharm) throws BizException;
    /**
     * 强删医嘱
     * @param id_ors
     */
    public abstract void forceDelOrders(String[] id_ors) throws BizException;
    /**
     * 根据服务id_srv和就诊上下文信息，创建药品条目信息
     * @param source
     * @param contextdto
     * @return
     */
    public abstract EmsOrDrug[] creatDrugItems(EmsDrugCreateParamDTO source, CiEnContextDTO contextdto) throws BizException ;
    /**
     * 采集费对应的医嘱是否还存在
     * @param idors
     * @return
     ...
     * @throws BizException
     */
    public abstract ValidateRtnInfoDTO SignOrdersMds(String[] id_ors, CiEnContextDTO ciEnContextDTO,boolean fgUseEr,OrderOperateDTO arg) throws BizException;
    /**
     * 医技医生站作废操作
     * @param operateDTO
     * @return
     * @throws BizException
     */
    public abstract OrderRstDTO CancelOrdersMds(OrderOperateDTO operateDTO) throws BizException;
    /**
     * 医嘱确认校验
     * @param verifyParam
     * @return
     * @throws BizException
     */
    public abstract OrConfirmRstDTO ordConfirmVerify(OrConfirmVerifyParamDTO verifyParam) throws BizException;
}
