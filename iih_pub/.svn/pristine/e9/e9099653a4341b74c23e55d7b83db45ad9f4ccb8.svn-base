package iih.sfda.aer.sfdaaerevmsug.d;
...
import iih.sfda.aer.sfdaaerevmsug.d.desc.SfdaAerEvMsugDODesc;
 ...
 * 
 */
public class SfdaAerEvMsugDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//医疗手术事件主键
	public static final String ID_AER_EV_MSUG= "Id_aer_ev_msug";
	//护理安全事件外键
	 ...
	 * @return String
	 */
	public String getId_aer_ev_msug() {
		return ((String) getAttrVal("Id_aer_ev_msug"));
	}	
	/**
	 * 医疗手术事件主键
	 * @param Id_aer_ev_msug
	 */
	public void setId_aer_ev_msug(String Id_aer_ev_msug) {
		setAttrVal("Id_aer_ev_msug", Id_aer_ev_msug);
	}
	/**
	 * 护理安全事件外键
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_aer_ev_msug";
	}
	
	@Override
	public String getTableName() {	  
		return "SFDA_AER_EV_MSUG";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(SfdaAerEvMsugDODesc.class);
	}
