package iih.mi.mibd.medpaytp.d;
 ...
 * 
 */
public class MedPayTpDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "MI_BD_MEDPAYTP";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MedPayTpDODesc.class);
	}
