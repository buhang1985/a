...
package iih.ems.embd.emgeca.d.desc;
 ...
 * 计量分类 DO 元数据信息
 */
public class EmGeCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ems.embd.emgeca.d.EmGeCaDO";
	public static final String CLASS_DISPALYNAME = "计量分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ems_geca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_geca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_gecaADesc(tblDesc));
		...
		this.add(getPcodeADesc(tblDesc));
		...
		this.add(getPnameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_gecaCDesc(tblDesc));
		tblDesc.add(getId_gecaCDesc(tblDesc));
		tblDesc.add(getId_parentCDesc(tblDesc));
		tblDesc.add(getCodeCDesc(tblDesc));
		tblDesc.add(getPcodeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getPcodeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Pcode",  getPcodeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("父级编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getPnameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Pname",  getPnameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"ems_geca a0b2","id_parent=id_geca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getPcodeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Pcode");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("父级编码"); 
		return column;
	}
	/**
	 * 获取名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getPnameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Pname");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_geca");
