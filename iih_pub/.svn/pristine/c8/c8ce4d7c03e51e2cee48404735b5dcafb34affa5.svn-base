package iih.nmr.ha.tcho.morse.d;
...
import iih.nmr.ha.tcho.morse.d.desc.TchoMorseDODesc;
 ...
 * 
 */
public class TchoMorseDO extends BaseDO {
	...
	public static final String TREADNAME= "Treadname";
	public static final String KNOWNAME= "Knowname";
	public static final String FALLNAME= "Fallname";
	public static final String MEDINAME= "Mediname";
	public static final String DRIPNAME= "Dripname";
	public static final String WALKNAME= "Walkname";
	public static final String DRUGNAME= "Drugname";
	public static final String ENVINAME= "Enviname";
	...
	public String getMeasurename() {
		return ((String) getAttrVal("Measurename"));
	}	
	public void setMeasurename(String Measurename) {
		setAttrVal("Measurename", Measurename);
	}
	public String getTreadname() {
		return ((String) getAttrVal("Treadname"));
	}	
	public void setTreadname(String Treadname) {
		setAttrVal("Treadname", Treadname);
	}
	public String getKnowname() {
		return ((String) getAttrVal("Knowname"));
	}	
	public void setKnowname(String Knowname) {
		setAttrVal("Knowname", Knowname);
	}
	public String getFallname() {
		return ((String) getAttrVal("Fallname"));
	}	
	public void setFallname(String Fallname) {
		setAttrVal("Fallname", Fallname);
	}
	public String getMediname() {
		return ((String) getAttrVal("Mediname"));
	}	
	public void setMediname(String Mediname) {
		setAttrVal("Mediname", Mediname);
	}
	public String getDripname() {
		return ((String) getAttrVal("Dripname"));
	}	
	public void setDripname(String Dripname) {
		setAttrVal("Dripname", Dripname);
	}
	public String getWalkname() {
		return ((String) getAttrVal("Walkname"));
	}	
	public void setWalkname(String Walkname) {
		setAttrVal("Walkname", Walkname);
	}
	...
	public String getEnviname() {
		return ((String) getAttrVal("Enviname"));
	}	
	public void setEnviname(String Enviname) {
		setAttrVal("Enviname", Enviname);
	}
...
//	}
	...
	public String getTableName() {	  
		return "nmr_ha_tcho_morse";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(TchoMorseDODesc.class);
	}
