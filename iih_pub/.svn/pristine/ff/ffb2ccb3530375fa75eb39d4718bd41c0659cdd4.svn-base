 ...
 * 备忘录文件 DO 元数据信息
 */
public class DocMemoFileDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.mpbd.docmemo.d.DocMemoFileDO";
	public static final String CLASS_DISPALYNAME = "备忘录文件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_mb_dcfi";
