...
package iih.nmr.pkuf.sporecord.d.desc;
...
/**
 * 血氧饱和度监测记录单血氧饱和度监测记录单 DO 元数据信息
 */
public class SporecordDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.sporecord.d.SporecordDO";
	public static final String CLASS_DISPALYNAME = "血氧饱和度监测记录单血氧饱和度监测记录单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_PKUF_SPORECORD";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_sporecord";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_sporecordADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_sporecordADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_sporecordCDesc(tblDesc));
		tblDesc.add(getId_sporecordCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_sporecordADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_sporecord",  getId_sporecordCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("血氧饱和度监测主键");
	...
	private IAttrDesc getName_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b4","id_nur=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_signADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b5","id_sign=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_sporecordCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_sporecord");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("血氧饱和度监测主键"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
