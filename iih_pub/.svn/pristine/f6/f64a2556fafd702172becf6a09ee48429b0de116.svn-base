 ...
 * 新生儿皮肤风险评估单 DO 元数据信息
 */
public class NewBabySkinAssDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.newbabyskinriskass.d.NewBabySkinAssDO";
	public static final String CLASS_DISPALYNAME = "新生儿皮肤风险评估单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MR_NU_BYSKINASS";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_babyskinass";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_babyskinassADesc(tblDesc));
		...
		this.add(getName_sigmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_babyskinassCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_sigmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_sigm",  getName_sigmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("评估人签名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getName_sigmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_sigm");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("评估人签名"); 
		return column;
	}
	/**
	 * 设置IBDataInfo接口映射数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_babyskinass");
