package iih.en.pv.enhpreferral.d;
 ...
 * 
 */
public class EnHpReferralDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_ENT_HPREFERRAL= "Id_ent_hpreferral";
	...
	public static final String REFERRAL_CREATETIME= "Referral_createtime";
	public static final String REFERRAL_UPDATETIME= "Referral_updatetime";
	...
	public static final String ID_REFERRALTP= "Id_referraltp";
	public static final String STAGE= "Stage";
	public static final String ACCUMULAMT_HP= "Accumulamt_hp";
	public static final String TIMES_HP= "Times_hp";
	...
	public String getId_ent_hpreferral() {
		return ((String) getAttrVal("Id_ent_hpreferral"));
	}	
	public void setId_ent_hpreferral(String Id_ent_hpreferral) {
		setAttrVal("Id_ent_hpreferral", Id_ent_hpreferral);
	}
	...
	public FDateTime getAuditdate() {
		return ((FDateTime) getAttrVal("Auditdate"));
	}	
	public void setAuditdate(FDateTime Auditdate) {
	...
	public FDateTime getReferral_createtime() {
		return ((FDateTime) getAttrVal("Referral_createtime"));
	}	
	public void setReferral_createtime(FDateTime Referral_createtime) {
		setAttrVal("Referral_createtime", Referral_createtime);
	}
	public FDateTime getReferral_updatetime() {
		return ((FDateTime) getAttrVal("Referral_updatetime"));
	}	
	public void setReferral_updatetime(FDateTime Referral_updatetime) {
		setAttrVal("Referral_updatetime", Referral_updatetime);
	}
	...
	public FDouble getAccumulamt() {
		return ((FDouble) getAttrVal("Accumulamt"));
	}	
	public void setAccumulamt(FDouble Accumulamt) {
	...
	public FDateTime getExportdate() {
		return ((FDateTime) getAttrVal("Exportdate"));
	}	
	public void setExportdate(FDateTime Exportdate) {
		setAttrVal("Exportdate", Exportdate);
	}
	...
	public String getSourcetype() {
		return ((String) getAttrVal("Sourcetype"));
	}	
	public void setSourcetype(String Sourcetype) {
		setAttrVal("Sourcetype", Sourcetype);
	}
	public String getSourcecode() {
		return ((String) getAttrVal("Sourcecode"));
	}	
	public void setSourcecode(String Sourcecode) {
		setAttrVal("Sourcecode", Sourcecode);
	}
	public String getTargetcode() {
		return ((String) getAttrVal("Targetcode"));
	}	
	public void setTargetcode(String Targetcode) {
		setAttrVal("Targetcode", Targetcode);
	}
	public String getId_referraltp() {
		return ((String) getAttrVal("Id_referraltp"));
	}	
	public void setId_referraltp(String Id_referraltp) {
		setAttrVal("Id_referraltp", Id_referraltp);
	}
	public String getStage() {
		return ((String) getAttrVal("Stage"));
	}	
	public void setStage(String Stage) {
		setAttrVal("Stage", Stage);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_ent_hpreferral";
	}
	
	@Override
	public String getTableName() {	  
		return "en_ent_hp_referral";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(EnHpReferralDODesc.class);
	}
