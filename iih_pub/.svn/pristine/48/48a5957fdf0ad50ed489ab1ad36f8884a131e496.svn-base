 ...
 * 调拨申请单 DO 元数据信息
 */
public class McTrReqApOrderDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.pl.trrequestap.d.McTrReqApOrderDO";
	public static final String CLASS_DISPALYNAME = "调拨申请单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_TR_AP";
	...
	private IAttrDesc getWhap_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("转入仓库名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_wh a0b5","id_wh_ap=id_wh","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
