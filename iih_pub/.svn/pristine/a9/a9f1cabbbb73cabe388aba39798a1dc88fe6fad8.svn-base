 ...
 * 
 */
public class ExclusiveDetailDO extends BaseDO {
	...
	public String getDetail_id() {
		return ((String) getAttrVal("Detail_id"));
	}	
	public void setDetail_id(String Detail_id) {
		setAttrVal("Detail_id", Detail_id);
	}
	...
	public Integer getSort() {
		return ((Integer) getAttrVal("Sort"));
	}	
	public void setSort(Integer Sort) {
		setAttrVal("Sort", Sort);
	}
...
//	}
	...
	public String getTableName() {	  
		return "bd_exclusive_detail";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(ExclusiveDetailDODesc.class);
	}
