 ...
 * 住院患者信息 DO 元数据信息
 */
public class EvaluatDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.nm.bch.evaluation.d.EvaluatDO";
	public static final String CLASS_DISPALYNAME = "住院患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NRM_NM_BCH_EVLASGL";
