 ...
 * 
 */
public class EmsApbuOrdDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getDt_bu_plan() {
		return ((String) getAttrVal("Dt_bu_plan"));
	}	
	/**
	 * 计划用血日期
	 * @param Dt_bu_plan
	 */
	public void setDt_bu_plan(String Dt_bu_plan) {
	 ...
	 * @return String
	 */
	public FArrayList getEmsapbusrvdto() {
		return ((FArrayList) getAttrVal("Emsapbusrvdto"));
	}	
	/**
	 * 用血明细
	 * @param Emsapbusrvdto
	 */
	public void setEmsapbusrvdto(FArrayList Emsapbusrvdto) {
		setAttrVal("Emsapbusrvdto", Emsapbusrvdto);
	}
}