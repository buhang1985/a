 ...
 * 新生儿信息 DO 元数据信息
 */
public class Baby24InfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.baby24care.d.Baby24InfoDO";
	public static final String CLASS_DISPALYNAME = "新生儿信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MR_NU_BABY24INFO";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_babycare";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_babycareADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_babycareCDesc(tblDesc));
