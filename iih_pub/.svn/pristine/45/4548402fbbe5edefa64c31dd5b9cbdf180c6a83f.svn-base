 ...
 * 儿科健康教育评价单 DO 元数据信息
 */
public class ChildHealthEduDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.childhealthedu.d.ChildHealthEduDO";
	public static final String CLASS_DISPALYNAME = "儿科健康教育评价单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_mr_ny_childhealthedu";
	public static final String TABLE_ALIAS_NAME = "${EntityMeta.entityClassMeta.aliasName}";
	public static final String PRIMARYKEY_FIELDNAME="Id_childhealthedu";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_childhealtheduADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_childhealtheduCDesc(tblDesc));
	...
	private IAttrDesc getName_dep_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep undefinedb5","id_dep_nur=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
