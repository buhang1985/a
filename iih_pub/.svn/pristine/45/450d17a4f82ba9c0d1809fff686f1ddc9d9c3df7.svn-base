 ...
 * 检查危急值 DO 元数据信息
 */
public class CrisisValObsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.nr.crisisval.d.CrisisValObsDO";
	public static final String CLASS_DISPALYNAME = "检查危急值";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_cris_val_obs";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_cris_val_obs";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_cris_val_obsADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_cris_valADesc(tblDesc));
		this.add(getId_cris_val_obsADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_cris_val_obsCDesc(tblDesc));
		tblDesc.add(getId_cris_val_obsCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_cris_val_obsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_cris_val_obs",  getId_cris_val_obsCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("检查危急值");
	 ...
	 * @return
	 */
	private IColumnDesc getId_cris_val_obsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_cris_val_obs");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("检查危急值"); 
		return column;
	}
	/**
	 * 获取危急值表列元数据
