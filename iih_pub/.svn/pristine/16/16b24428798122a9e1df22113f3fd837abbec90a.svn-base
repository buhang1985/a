 ...
 * 
 */
public class PeEvalKineFreqDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//健康运动评估频率主键标识
	public static final String ID_PEEVALKINEFREQ= "Id_peevalkinefreq";
	//健康运动评估定义ID
	 ...
	 * @return String
	 */
	public String getId_peevalkinefreq() {
		return ((String) getAttrVal("Id_peevalkinefreq"));
	}	
	/**
	 * 健康运动评估频率主键标识
	 * @param Id_peevalkinefreq
	 */
	public void setId_peevalkinefreq(String Id_peevalkinefreq) {
		setAttrVal("Id_peevalkinefreq", Id_peevalkinefreq);
	}
	/**
	 * 健康运动评估定义ID
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_peevalkinefreq";
	}
	
	@Override
	public String getTableName() {	  
		return "pe_qn_peevalkinefreq";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PeEvalKineFreqDODesc.class);
	}
