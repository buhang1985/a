...
//	}
   ...
   /**
	 ...
	 * @return String
	 */
	public String getId_dietusable() {
		return ((String) getAttrVal("Id_dietusable"));
	}
	/**
	 * 膳食可选指标
	 * @param Id_dietusable
	 */
	public void setId_dietusable(String Id_dietusable) {
		setAttrVal("Id_dietusable", Id_dietusable);
	}
	/**
	 * 滴速id
	 * @return String
