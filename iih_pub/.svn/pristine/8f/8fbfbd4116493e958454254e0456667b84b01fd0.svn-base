 ...
 * 
 */
public class OepSettleInParamDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getHpcard_info() {
		return ((String) getAttrVal("Hpcard_info"));
	}
	/**
	 * 医保读卡信息
	 * @param Hpcard_info
	 */
	public void setHpcard_info(String Hpcard_info) {
		setAttrVal("Hpcard_info", Hpcard_info);
	}
}