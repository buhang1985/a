...
package iih.bd.srv.srvpkggrp.d.desc;
 ...
 * 服务包项目分组 DO 元数据信息
 */
public class SrvPkgGrpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.srvpkggrp.d.SrvPkgGrpDO";
	public static final String CLASS_DISPALYNAME = "服务包项目分组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_pkg_grp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvpkggrp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvpkggrpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvpkggrpCDesc(tblDesc));
