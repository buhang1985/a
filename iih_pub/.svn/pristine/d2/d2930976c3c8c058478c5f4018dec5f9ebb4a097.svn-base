 ...
 * 采购发票 DO 元数据信息
 */
public class McStockInvoiceDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.po.stockinvoice.d.McStockInvoiceDO";
	public static final String CLASS_DISPALYNAME = "采购发票";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_INV";
	...
	private void init(){		
		...
		this.add(getInvst_codeADesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getInvst_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Invst_code",  getInvst_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("采购发票单状态编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b9","id_inv_st=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getInvst_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Invst_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("采购发票单状态编码"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("code","Inv_code");
