package iih.pe.pbd.pemultigroup.d;
...
import iih.pe.pbd.pemultigroup.d.desc.PeMultiGroupDODesc;
 ...
 * 
 */
public class PeMultiGroupDO extends BaseDO {
	...
	//申请科室
	public static final String APPLY_UNIT= "Apply_unit";
	//创建人
	...
	public String getApplicant() {
		return ((String) getAttrVal("Applicant"));
	}	
	/**
	 * 申请人
	 * @param Applicant
	...
	public void setApplicant(String Applicant) {
		setAttrVal("Applicant", Applicant);
	}
	/**
	 * 申请科室
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_pemultigroup";
	}
	
	@Override
	public String getTableName() {	  
		return "pe_bd_multigroup";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PeMultiGroupDODesc.class);
	}
