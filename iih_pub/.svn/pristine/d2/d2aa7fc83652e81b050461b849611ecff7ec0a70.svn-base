package iih.ci.mr.middle.nuscore.d;
 ...
 * 
 */
public class CiMrNuScoreMiddleDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_CI_MR_MIDDLE_NUSCORE= "Id_ci_mr_middle_nuscore";
	...
	public static final String CODE_NUS_ITEM= "Code_nus_item";
	public static final String NAME_NUS_ITEM= "Name_nus_item";
	...
	public String getId_ci_mr_middle_nuscore() {
		return ((String) getAttrVal("Id_ci_mr_middle_nuscore"));
	}	
	public void setId_ci_mr_middle_nuscore(String Id_ci_mr_middle_nuscore) {
		setAttrVal("Id_ci_mr_middle_nuscore", Id_ci_mr_middle_nuscore);
	}
	...
	public String getTitle_message() {
		return ((String) getAttrVal("Title_message"));
	}	
	public void setTitle_message(String Title_message) {
		setAttrVal("Title_message", Title_message);
	}
	...
	public String getCode_nus_item() {
		return ((String) getAttrVal("Code_nus_item"));
	}	
	public void setCode_nus_item(String Code_nus_item) {
		setAttrVal("Code_nus_item", Code_nus_item);
	}
	public String getName_nus_item() {
		return ((String) getAttrVal("Name_nus_item"));
	}	
	public void setName_nus_item(String Name_nus_item) {
		setAttrVal("Name_nus_item", Name_nus_item);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_ci_mr_middle_nuscore";
	}
	
	@Override
	public String getTableName() {	  
		return "ci_mr_middle_nuscore";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiMrNuScoreMiddleDODesc.class);
	}
