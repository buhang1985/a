...
public class WsResultIpPatOp implements Serializable {
	...
	// 午别
	@XmlElement(name = "dayslottp")
	private String dayslottp;

	// 上下午
	@XmlElement(name = "dayslotname")
	...
	// 费用状态 （0 -未收费 1 -收费 7 -退费）
	@XmlElement(name = "feeStatus")
	private String feeStatus;

	// 预约状态 （0 -预约 1 -已取号 7 -取消）
	@XmlElement(name = "status")
	private String status;
	
	// 患者支付金额 
	@XmlElement(name = "amtPat")
	private String amtPat;
	...
	public String getAmtPat() {
		return amtPat;
	}

	public void setAmtPat(String amtPat) {
		this.amtPat = amtPat;
	}
