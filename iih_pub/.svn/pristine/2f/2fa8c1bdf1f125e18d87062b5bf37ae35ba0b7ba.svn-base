...
public class IEOpPharmPresDTO extends BaseDTO {
	 ...
	 * @return FDouble
	 */
	public FDouble getPrescriptionmoney() {
		return ((FDouble) getAttrVal("Prescriptionmoney"));
	}	
	/**
	 * 处方金额
	 * @param Prescriptionmoney
	 */
	public void setPrescriptionmoney(FDouble Prescriptionmoney) {
		setAttrVal("Prescriptionmoney", Prescriptionmoney);
	}
	/**
	 * 处方金额单位
	 * @return String
	 */
	public String getPrescriptionmoneyunit() {
		return ((String) getAttrVal("Prescriptionmoneyunit"));
	}	
	/**
	 * 处方金额单位
	 * @param Prescriptionmoneyunit
	 */
	public void setPrescriptionmoneyunit(String Prescriptionmoneyunit) {
		setAttrVal("Prescriptionmoneyunit", Prescriptionmoneyunit);
	}
	/**
	 * 处方有效天数
	 * @return String
	...
	public String getPrescriptioneffectivedays() {
		return ((String) getAttrVal("Prescriptioneffectivedays"));
	}	
	/**
	 * 处方有效天数
	 * @param Prescriptioneffectivedays
	 */
	public void setPrescriptioneffectivedays(String Prescriptioneffectivedays) {
		setAttrVal("Prescriptioneffectivedays", Prescriptioneffectivedays);
	}
	/**
	 * 处方备注
	 * @return String
	...
	public String getPrescriptionnote() {
		return ((String) getAttrVal("Prescriptionnote"));
	}	
	/**
	 * 处方备注
	 * @param Prescriptionnote
	 */
	public void setPrescriptionnote(String Prescriptionnote) {
		setAttrVal("Prescriptionnote", Prescriptionnote);
	}
	/**
	 * 收费标识
	 * @return String
