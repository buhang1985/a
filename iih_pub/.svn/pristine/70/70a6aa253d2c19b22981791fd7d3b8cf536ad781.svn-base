...
package iih.nm.nqm.nqmcstmplgrp.d.desc;
 ...
 * 质控标准模板组 DO 元数据信息
 */
public class NqmcstmplgrpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nqmcstmplgrp.d.NqmcstmplgrpDO";
	public static final String CLASS_DISPALYNAME = "质控标准模板组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_CSTMPL_GRP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_tmpl_grp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_tmpl_grpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nqm_tmpl_grpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_tmpl_grpCDesc(tblDesc));
		tblDesc.add(getId_nqm_tmpl_grpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nqm_tmpl_grpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nqm_tmpl_grp",  getId_nqm_tmpl_grpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("模板组主键");
	...
	private IAttrDesc getName_reg_psnADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b3","id_reg_psn=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nqm_tmpl_grpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nqm_tmpl_grp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("模板组主键"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
