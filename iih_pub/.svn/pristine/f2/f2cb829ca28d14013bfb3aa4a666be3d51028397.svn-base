 ...
 * 
 */
public class DiagCateDO extends BaseDO {
	...
	public static final String CODE_DISTAND= "Code_distand";
	...
	public static final String NAME_INFECTIONTP= "Name_infectiontp";
	...
	public String getCode_distand() {
		return ((String) getAttrVal("Code_distand"));
	}	
	public void setCode_distand(String Code_distand) {
		setAttrVal("Code_distand", Code_distand);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(DiagCateDODesc.class);
	}
