 ...
 * 
 */
public class EntWsTreatDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getEmstreatorddto() {
		return ((FArrayList) getAttrVal("Emstreatorddto"));
	}	
	/**
	 * 医嘱信息
	 * @param Emstreatorddto
	 */
	public void setEmstreatorddto(FArrayList Emstreatorddto) {
		setAttrVal("Emstreatorddto", Emstreatorddto);
	}
}