 ...
 * 实习小组 DO 元数据信息
 */
public class NitPracgrpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nit.nitpracgrp.d.NitPracgrpDO";
	public static final String CLASS_DISPALYNAME = "实习小组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NIT_PRACGRP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pracgrp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pracgrpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pracgrpCDesc(tblDesc));
	...
	private IAttrDesc getGrptp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_grptp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getHead_psn_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b7","id_head_psn=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
