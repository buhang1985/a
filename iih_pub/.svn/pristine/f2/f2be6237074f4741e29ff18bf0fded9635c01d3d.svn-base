 ...
 *
 */
public class IpWardDeotRefModel extends DeptUserRefModel{
	private static final long serialVersionUID = 1L;
	@Override
	public String getRefSql() {
		String refSql =  "  select bd_dep.code,bd_dep.name,bd_dep.id_dep,bd_dep.id_parent,bd_dep.innercode from bd_dep bd_dep where bd_dep.sd_depttp like '02%' and bd_dep.ds ='0' and bd_dep.activestate ='2'  ";
