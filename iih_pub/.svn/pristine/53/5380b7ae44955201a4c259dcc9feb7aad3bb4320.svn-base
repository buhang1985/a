...
package iih.pe.pitm.pesrvitemoptional.d.desc;
...
/**
 * 体检结果常用可选项定义 DO 元数据信息
 */
public class PeSrvItmOptDefDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pitm.pesrvitemoptional.d.PeSrvItmOptDefDO";
	public static final String CLASS_DISPALYNAME = "体检结果常用可选项定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_itm_pesrvitmoptdef";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pesrvitmoptdef";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pesrvitmoptdefADesc(tblDesc));
		...
		this.add(getFg_positiveADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pesrvitmoptdefCDesc(tblDesc));
		...
		tblDesc.add(getFg_positiveCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_positiveADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_positive",  getFg_positiveCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_positiveCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_positive");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pesrvitemopts");
