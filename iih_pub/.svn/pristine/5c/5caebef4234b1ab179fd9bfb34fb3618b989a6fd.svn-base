...
public class Patinfo extends BaseDTO {
	...
	public String getPrepay() {
		return ((String) getAttrVal("Prepay"));
	}
	/**
	 * 预交金金额
	 * @param Prepay
	...
	public String getAcc_lock() {
		return ((String) getAttrVal("Acc_lock"));
	}
	/**
	 * 消费金额
	 * @param Acc_lock
	 ...
	 * @return FArrayList
	 */
	public FArrayList getApplyforms() {
		return ((FArrayList) getAttrVal("Applyforms"));
	}
	/**
	 * 申请单信息集合
	 * @param Applyforms
	 */
	public void setApplyforms(FArrayList Applyforms) {
		setAttrVal("Applyforms", Applyforms);
	}
}