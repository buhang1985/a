...
package iih.bd.mhi.hpentp.d.desc;
 ...
 * 医保产品_就诊类型 DO 元数据信息
 */
public class HpEnTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpentp.d.HpEnTpDO";
	public static final String CLASS_DISPALYNAME = "医保产品_就诊类型";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_MHI_ENTP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpentp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpentpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpentpCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpentp");
