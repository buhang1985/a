...
public interface ICiprintExtService {
	 ...
	 * @throws BizException
	 */
	public abstract OrderRstDTO DeleteAppLisData(String[] idors) throws BizException;
	/**
	 * 删除检验合单数据
	 * @param idors
	 * @param arg
	 ...
	 * @throws BizException
	 */
	public abstract FBoolean DeleteAppBtData(String[] idors) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract FBoolean DeleteAppBuData(String[] idors) throws BizException;
     ...
     * @return
     */
	public abstract String GetReportPrinter_TL(String printTp) throws BizException;
	/**
     * 获得本机设置的小票打印机名称
     * @param printTp 打印类型
     * @return
	 ...
	 * @throws BizException
	 */
	public abstract EmsprntmplAggDO[] GetEmsprntmpl(String sd_entp, String id_psn, String id_dep, String id_grp, String id_org) throws BizException;
