package iih.pi.dic.creditcategory.d;
 ...
 * 
 */
public class PiPatCretDO extends BaseDO {
	...
	public static final String ENCRED= "Encred";
	...
	public FDouble getEncred() {
		return ((FDouble) getAttrVal("Encred"));
	}	
	public void setEncred(FDouble Encred) {
		setAttrVal("Encred", Encred);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PiPatCretDODesc.class);
	}
