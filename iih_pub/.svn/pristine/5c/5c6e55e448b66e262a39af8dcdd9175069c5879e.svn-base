 ...
 * 领用申请单明细 DO 元数据信息
 */
public class McDepReqApItemDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.pl.deprequestap.d.McDepReqApItemDO";
	public static final String CLASS_DISPALYNAME = "领用申请单明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_DA_ITM";
	...
	private IAttrDesc getName_orADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"ci_order a1b7","id_or=id_or","name_or"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getId_dep_mpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"ci_order a1b7","id_or=id_or","id_dep_mp"});
		attrDesc.setRefType(true);
		return attrDesc;
	}
	/**
