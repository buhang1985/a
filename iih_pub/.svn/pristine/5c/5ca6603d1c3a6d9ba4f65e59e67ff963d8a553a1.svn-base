 ...
 * 
 */
public class PeEvalKineIntDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//健康运动评估强度主键标识
	public static final String ID_PEEVALKINEINT= "Id_peevalkineint";
	//健康运动评估定义ID
	 ...
	 * @return String
	 */
	public String getId_peevalkineint() {
		return ((String) getAttrVal("Id_peevalkineint"));
	}	
	/**
	 * 健康运动评估强度主键标识
	 * @param Id_peevalkineint
	 */
	public void setId_peevalkineint(String Id_peevalkineint) {
		setAttrVal("Id_peevalkineint", Id_peevalkineint);
	}
	/**
	 * 健康运动评估定义ID
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_peevalkineint";
	}
	
	@Override
	public String getTableName() {	  
		return "pe_qn_peevalkineint";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PeEvalKineIntDODesc.class);
	}
