 ...
 * 病人信息 DO 元数据信息
 */
public class BgmPatInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.bgm.d.BgmPatInfoDO";
	public static final String CLASS_DISPALYNAME = "病人信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MR_NU_BGM";
