 ...
 * 满意度问卷模板分类 DO 元数据信息
 */
public class NmNcaTmplcaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nca.nmncatmplca.d.NmNcaTmplcaDO";
	public static final String CLASS_DISPALYNAME = "满意度问卷模板分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NCA_TMPLCA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nca_tmplca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nca_tmplcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nca_tmplcaCDesc(tblDesc));
