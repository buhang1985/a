...
import iih.pmp.pay.log.IPmpWsLogService;
import xap.mw.log.logging.Level;
import xap.mw.sf.core.util.ServiceFinder;

public class PmpWsLogUtils {
	private static IPmpWsLogService _logService = ServiceFinder.find(IPmpWsLogService.class);
