...
package iih.bd.srv.srvpkgca.d.desc;
 ...
 * 医疗服务包分类 DO 元数据信息
 */
public class SrvPkgCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.srvpkgca.d.SrvPkgCaDO";
	public static final String CLASS_DISPALYNAME = "医疗服务包分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_pkgca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvpkgca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvpkgcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvpkgcaCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_srvpkgca");
