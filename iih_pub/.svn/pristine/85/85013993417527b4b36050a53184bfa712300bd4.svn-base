...
package iih.syn.common.initca.d.desc;
 ...
 * 初始化分类 DO 元数据信息
 */
public class InitCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.syn.common.initca.d.InitCaDO";
	public static final String CLASS_DISPALYNAME = "初始化分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "syn_init_ca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_init_ca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_init_caADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_init_caCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_init_ca");
