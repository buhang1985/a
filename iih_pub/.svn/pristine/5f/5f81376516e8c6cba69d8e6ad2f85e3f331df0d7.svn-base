...
package iih.pis.phk.phkemp.d.desc;
 ...
 * 患者管家人员信息 DO 元数据信息
 */
public class PhkEmpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pis.phk.phkemp.d.PhkEmpDO";
	public static final String CLASS_DISPALYNAME = "患者管家人员信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "PIS_PHK_EMP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_phkemp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_phkempADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_phkempADesc(tblDesc));
		...
		this.add(getEmp_idADesc(tblDesc));
		this.add(getBirthdayADesc(tblDesc));
		this.add(getMobileADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_phkempCDesc(tblDesc));
		tblDesc.add(getId_phkempCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_phkempADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_phkemp",  getId_phkempCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("患者管家人员主键");
	 ...
	 * @return
	 */
	private IAttrDesc getEmp_idADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Emp_id",  getEmp_idCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b4","id_emp=id_psndoc","id"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getBirthdayADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b4","id_emp=id_psndoc","birthday"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getMobileADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Mobile",  getMobileCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手机");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b4","id_emp=id_psndoc","mobile"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_phkempCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_phkemp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("患者管家人员主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getEmp_idCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Emp_id");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getMobileCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Mobile");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("手机"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_phkemp");
