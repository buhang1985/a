...
package iih.nm.nit.nitvod.d.desc;
 ...
 * 违规违纪 DO 元数据信息
 */
public class NitVodDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nit.nitvod.d.NitVodDO";
	public static final String CLASS_DISPALYNAME = "违规违纪";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NIT_VOD";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nit_vod";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nit_vodADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nit_vodADesc(tblDesc));
		...
		this.add(getEventADesc(tblDesc));
		this.add(getDealcondADesc(tblDesc));
		...
		this.add(getCode_nit_psninfoADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nit_vodCDesc(tblDesc));
		tblDesc.add(getId_nit_vodCDesc(tblDesc));
		...
		tblDesc.add(getEventCDesc(tblDesc));
		tblDesc.add(getDealcondCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nit_vodADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nit_vod",  getId_nit_vodCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("违规违纪id");
	 ...
	 * @return
	 */
	private IAttrDesc getEventADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Event",  getEventCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getDealcondADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dealcond",  getDealcondCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_nit_psninfoADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_nit_psninfo",  getCode_nit_psninfoCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NIT_PSNINFO a0b4","id_nit_psninfo=id_nit_psninfo","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_dep_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NBD_DEP a0b8","id_dep_nur=id_nbd_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nit_vodCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nit_vod");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("违规违纪id"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getEventCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Event");
	 ...
	 * @return
	 */
	private IColumnDesc getDealcondCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dealcond");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_nit_psninfoCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_nit_psninfo");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
