...
public class NmnqmqcmtListener  implements IWfBillExtHandler{
	@Override
	public WfFormInfoCtx[] write(WfFlowInfoCtx flwInfoCtx, WfFormInfoCtx... frmInfoCtx) {
		...
		INmnqmqcmtCudService psnshiftCudService = ServiceFinder.find(INmnqmqcmtCudService.class);
		/*try {
			NmNqmQcmtDO DO= billDo.getTransDo();
			psnshiftCudService.update(new NmNqmQcmtDO[] { billDo.getTransDo() });
