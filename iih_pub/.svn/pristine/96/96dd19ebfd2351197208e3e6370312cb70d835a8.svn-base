 ...
 * 服务价格 DO 元数据信息
 */
public class SrvPriDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.baseprisrv.d.SrvPriDO";
	public static final String CLASS_DISPALYNAME = "服务价格";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_grp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_grpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_grpCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_srvpri");
