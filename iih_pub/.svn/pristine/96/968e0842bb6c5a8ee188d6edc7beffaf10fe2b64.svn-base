 ...
 * 
 */
public class BdHpDrugOrginalDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_HPDRUGORGINAL= "Id_hpdrugorginal";
	...
	public static final String FG_CHILDDURG= "Fg_childdurg";
	//药品名称
	public static final String D_NAME= "D_name";
	//药品拼音码
	public static final String DRUG_PYCODE= "Drug_pycode";
	...
	public String getFg_childdurg() {
		return ((String) getAttrVal("Fg_childdurg"));
	}	
	public void setFg_childdurg(String Fg_childdurg) {
		setAttrVal("Fg_childdurg", Fg_childdurg);
	}
	/**
	 * 药品名称
	 * @return String
	...
	public String getD_name() {
		return ((String) getAttrVal("D_name"));
	}	
	/**
	 * 药品名称
	 * @param D_name
	...
	public void setD_name(String D_name) {
		setAttrVal("D_name", D_name);
	}
	/**
	 * 药品拼音码
	 * @return String
	 */
	public String getDrug_pycode() {
		return ((String) getAttrVal("Drug_pycode"));
	}	
	/**
	 * 药品拼音码
	 * @param Drug_pycode
	 */
	public void setDrug_pycode(String Drug_pycode) {
		setAttrVal("Drug_pycode", Drug_pycode);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_hpdrugorginal";
	}
	
	@Override
	public String getTableName() {	  
		return "BD_HP_DRUG_ORGINAL";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(BdHpDrugOrginalDODesc.class);
	}
