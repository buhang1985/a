 ...
 * 病危患者信息 DO 元数据信息
 */
public class IllPatientDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.critillpatcare.d.IllPatientDO";
	public static final String CLASS_DISPALYNAME = "病危患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_illpat";
