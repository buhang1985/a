...
package iih.mm.qy.stockoutinfo.d.desc;
 ...
 * 物品出库信息查询 DO 元数据信息
 */
public class StockOutQueryViewDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.qy.stockoutinfo.d.StockOutQueryView";
	public static final String CLASS_DISPALYNAME = "物品出库信息查询";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "V_MM_STOUT_QUERY";
	...
	private void init(){		
		...
		this.add(getStout_codeADesc(tblDesc));
		...
		this.add(getAmt_sa_batchADesc(tblDesc));
		this.add(getFg_sa_diffADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getStout_codeCDesc(tblDesc));
		...
		tblDesc.add(getAmt_sa_batchCDesc(tblDesc));
		tblDesc.add(getFg_sa_diffCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getStout_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Stout_code",  getStout_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getAmt_sa_batchADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Amt_sa_batch",  getAmt_sa_batchCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("金额_批次售价");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	/**
	 * 售价是否差异(出库售价和批次售价)属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getFg_sa_diffADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_sa_diff",  getFg_sa_diffCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("售价是否差异(出库售价和批次售价)");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getDep_or_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("开单科室名称名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b17","id_dep_or=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getStout_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Stout_code");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getAmt_sa_batchCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Amt_sa_batch");
		column.setLength(16);
        column.setPrecision(8);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("金额_批次售价"); 
		return column;
	}
	/**
	 * 获取售价是否差异(出库售价和批次售价)表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getFg_sa_diffCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_sa_diff");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("售价是否差异(出库售价和批次售价)"); 
		return column;
	}
	/**
	 * 获取数量总和表列元数据
