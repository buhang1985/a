...
package iih.ci.rcm.pathogen.d.desc;
 ...
 * 病原体 DO 元数据信息
 */
public class PathogenDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.rcm.pathogen.d.PathogenDO";
	public static final String CLASS_DISPALYNAME = "病原体";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_MR_HOS_DSI_PB";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_dis_pb";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_dis_pbADesc(tblDesc));
		...
		this.add(getId_drugallergy_resultADesc(tblDesc));
		this.add(getSd_drugallergy_resultADesc(tblDesc));
		this.add(getName_drugallergy_resultADesc(tblDesc));
		...
		this.add(getDrugallergy_result_codeADesc(tblDesc));
		this.add(getDrugallergy_result_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_dis_pbCDesc(tblDesc));
		...
		tblDesc.add(getId_drugallergy_resultCDesc(tblDesc));
		tblDesc.add(getSd_drugallergy_resultCDesc(tblDesc));
		tblDesc.add(getName_drugallergy_resultCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_drugallergy_resultADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_drugallergy_result",  getId_drugallergy_resultCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_drugallergy_resultADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_drugallergy_result",  getSd_drugallergy_resultCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_drugallergy_resultADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_drugallergy_result",  getName_drugallergy_resultCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getPathogen_species_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_pathogen_species=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getPathogen_species_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_pathogen_species=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getDrugallergy_result_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Drugallergy_result_code",  getDrugallergy_result_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b3","id_drugallergy_result=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getDrugallergy_result_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Drugallergy_result_name",  getDrugallergy_result_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b3","id_drugallergy_result=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_drugallergy_resultCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_drugallergy_result");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getSd_drugallergy_resultCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_drugallergy_result");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_drugallergy_resultCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_drugallergy_result");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getDrugallergy_result_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Drugallergy_result_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getDrugallergy_result_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Drugallergy_result_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_dis_pb");
		iBDDataInfoFldMap.put("id_org","Id_org");
		iBDDataInfoFldMap.put("code","Sd_pathogen_species");
		iBDDataInfoFldMap.put("name","Name_pathogen_species");
