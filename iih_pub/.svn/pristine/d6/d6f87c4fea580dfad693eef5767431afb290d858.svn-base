 ...
 * 护士长手册配置 DO 元数据信息
 */
public class NmNomWbkConfigDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nom.nmnomwbkconfig.d.NmNomWbkConfigDO";
	public static final String CLASS_DISPALYNAME = "护士长手册配置";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NOM_WBK_CONFIG";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nom_wbk_config";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nom_wbk_configADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nom_wbk_configADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getDt_yearADesc(tblDesc));
		...
		this.add(getName_nom_wbkADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nom_wbk_configCDesc(tblDesc));
		tblDesc.add(getId_nom_wbk_configCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getDt_yearCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nom_wbk_configADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nom_wbk_config",  getId_nom_wbk_configCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手册配置主键");
	 ...
	 * @return
	 */
	private IAttrDesc getDt_yearADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_year",  getDt_yearCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getName_nom_wbkADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_nom_wbk",  getName_nom_wbkCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NOM_WBK a0b6","id_nom_wbk=id_nom_wbk","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nom_wbk_configCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nom_wbk_config");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("手册配置主键"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDt_yearCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_year");
		column.setLength(10);
	 ...
	 * @return
	 */
	private IColumnDesc getName_nom_wbkCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_nom_wbk");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
