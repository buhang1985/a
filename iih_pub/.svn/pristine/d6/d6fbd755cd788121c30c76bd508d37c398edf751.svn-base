 ...
 * 护理工作项目数据录入 DO 元数据信息
 */
public class NomWkitmAppDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nom.nomwkitmapp.d.NomWkitmAppDO";
	public static final String CLASS_DISPALYNAME = "护理工作项目数据录入";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NOM_WKITM_APP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nom_wkitm_app";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nom_wkitm_appADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nom_wkitm_appCDesc(tblDesc));
