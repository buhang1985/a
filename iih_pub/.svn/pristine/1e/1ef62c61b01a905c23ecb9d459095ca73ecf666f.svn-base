...
import iih.nm.nbd.nbddepca.d.desc.NbdDepCaDODesc;
 ...
 * 
 */
public class NbdDepCaDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_NBD_DEP_CA= "Id_nbd_dep_ca";
	...
	public String getId_nbd_dep_ca() {
		return ((String) getAttrVal("Id_nbd_dep_ca"));
	}	
	public void setId_nbd_dep_ca(String Id_nbd_dep_ca) {
		setAttrVal("Id_nbd_dep_ca", Id_nbd_dep_ca);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_nbd_dep_ca";
	}
	
	@Override
	public String getTableName() {	  
		return "NM_NBD_DEP_CA";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(NbdDepCaDODesc.class);
	}
