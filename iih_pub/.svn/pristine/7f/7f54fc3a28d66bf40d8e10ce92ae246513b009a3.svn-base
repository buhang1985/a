package iih.pmp.pay.paychannels.d;
 ...
 * 
 */
public class PaychannelsDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_paychannels";
	}
	
	@Override
	public String getTableName() {	  
		return "pmp_paychannels";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PaychannelsDODesc.class);
	}
