...
public class RegformDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.regformfordeliver.d.RegformDO";
	public static final String CLASS_DISPALYNAME = "分娩登记表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MMR_PKUF_REGFORM";
	...
	private void init(){		
		...
		this.add(getSd_anaADesc(tblDesc));
		this.add(getName_anaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getSd_anaCDesc(tblDesc));
		tblDesc.add(getName_anaCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getSd_anaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_ana",  getSd_anaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_anaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_ana",  getName_anaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getSd_anaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_ana");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_anaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_ana");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
