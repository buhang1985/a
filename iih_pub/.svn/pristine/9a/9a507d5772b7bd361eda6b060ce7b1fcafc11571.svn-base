package iih.nmr.pkuf.sporecord.d;
...
import iih.nmr.pkuf.sporecord.d.desc.SporecordDODesc;
import java.math.BigDecimal;

/**
 * 血氧饱和度监测记录单血氧饱和度监测记录单 DO数据 
 * 
 */
public class SporecordDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//血氧饱和度监测主键
	public static final String ID_SPORECORD= "Id_sporecord";
	//组织
	 ...
	 * @return String
	 */
	public String getId_sporecord() {
		return ((String) getAttrVal("Id_sporecord"));
	}	
	/**
	 * 血氧饱和度监测主键
	 * @param Id_sporecord
	 */
	public void setId_sporecord(String Id_sporecord) {
		setAttrVal("Id_sporecord", Id_sporecord);
	}
	/**
	 * 组织
	 * @return String
	 ...
	 * @return FDate
	 */
	public FDate getD_date() {
		return ((FDate) getAttrVal("D_date"));
	}	
	/**
	 * 日期
	 * @param D_date
	 */
	public void setD_date(FDate D_date) {
		setAttrVal("D_date", D_date);
	}
	/**
	 * 时间
	 * @return FTime
...
//	}
	...
	public String getTableName() {	  
		return "NMR_PKUF_SPORECORD";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(SporecordDODesc.class);
	}
