...
package iih.nm.net.examquca.d.desc;
 ...
 * 试题类别 DO 元数据信息
 */
public class ExamQuCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.net.examquca.d.ExamQuCaDO";
	public static final String CLASS_DISPALYNAME = "试题类别";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_EXAM_QU_CA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_qu_ca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_qu_caADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_qu_caCDesc(tblDesc));
	...
	private IAttrDesc getName_parADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"EXAM_QU_CA a0b4","id_par=id_qu_ca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_qu_ca");
