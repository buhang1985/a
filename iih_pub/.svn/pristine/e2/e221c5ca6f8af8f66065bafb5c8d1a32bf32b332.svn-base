...
public class OrdPrintDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getName_orprnADesc(tblDesc));
		this.add(getId_ordsheetADesc(tblDesc));
		...
		this.add(getContent_or_prn_subADesc(tblDesc));
		...
		this.add(getStr_emp_signADesc(tblDesc));
		this.add(getStr_emp_checkADesc(tblDesc));
		this.add(getDt_mpADesc(tblDesc));
		this.add(getId_emp_exeADesc(tblDesc));
		this.add(getName_emp_exeADesc(tblDesc));
		this.add(getId_dep_exeADesc(tblDesc));
		this.add(getName_dep_exeADesc(tblDesc));
		...
		this.add(getFg_skin_prnADesc(tblDesc));
		this.add(getDt_chkADesc(tblDesc));
		this.add(getDt_signADesc(tblDesc));
		this.add(getContent_or_prn_skintestADesc(tblDesc));
		...
		this.add(getCode_emp_chk_cancADesc(tblDesc));
		this.add(getName_emp_chk_cancADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getName_orprnCDesc(tblDesc));
		tblDesc.add(getId_ordsheetCDesc(tblDesc));
		...
		tblDesc.add(getContent_or_prn_subCDesc(tblDesc));
		...
		tblDesc.add(getStr_emp_signCDesc(tblDesc));
		tblDesc.add(getStr_emp_checkCDesc(tblDesc));
		tblDesc.add(getDt_mpCDesc(tblDesc));
		tblDesc.add(getId_emp_exeCDesc(tblDesc));
		tblDesc.add(getName_emp_exeCDesc(tblDesc));
		tblDesc.add(getId_dep_exeCDesc(tblDesc));
		tblDesc.add(getName_dep_exeCDesc(tblDesc));
		...
		tblDesc.add(getFg_skin_prnCDesc(tblDesc));
		tblDesc.add(getDt_chkCDesc(tblDesc));
		tblDesc.add(getDt_signCDesc(tblDesc));
		tblDesc.add(getContent_or_prn_skintestCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_orprnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_orprn",  getName_orprnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("单据名称");
	 ...
	 * @return
	 */
	private IAttrDesc getId_ordsheetADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_ordsheet",  getId_ordsheetCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医嘱单样式ID（自定义档案）");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getContent_or_prn_subADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Content_or_prn_sub",  getContent_or_prn_subCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医嘱内容（成组用法频次）");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getStr_emp_signADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Str_emp_sign",  getStr_emp_signCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("责任医生签字");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getStr_emp_checkADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Str_emp_check",  getStr_emp_checkCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("责任护士签字");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_emp_exeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_emp_exe",  getName_emp_exeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getId_dep_exeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_dep_exe",  getId_dep_exeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_dep_exeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_dep_exe",  getName_dep_exeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_skin_prnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_skin_prn",  getFg_skin_prnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("皮试标识打印标志");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getContent_or_prn_skintestADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Content_or_prn_skintest",  getContent_or_prn_skintestCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getCode_emp_cancADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b22","id_emp_canc=id_psndoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_cancADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b22","id_emp_canc=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_emp_chk_cancADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_emp_chk_canc",  getCode_emp_chk_cancCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("人员编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b23","id_emp_chk_canc=id_psndoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_emp_chk_cancADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_emp_chk_canc",  getName_emp_chk_cancCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("姓名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b23","id_emp_chk_canc=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_orprnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_orprn");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("单据名称"); 
		return column;
	}
	/**
	 * 获取医嘱单样式ID（自定义档案）表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_ordsheetCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_ordsheet");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医嘱单样式ID（自定义档案）"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getContent_or_prn_subCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Content_or_prn_sub");
		column.setLength(4000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医嘱内容（成组用法频次）"); 
		return column;
	}
	/**
	 * 获取生效日期表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getStr_emp_signCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Str_emp_sign");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("责任医生签字"); 
		return column;
	}
	/**
	 * 获取责任护士签字表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getStr_emp_checkCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Str_emp_check");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("责任护士签字"); 
		return column;
	}
	/**
	 * 获取执行时间表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_emp_exeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_emp_exe");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_dep_exeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_dep_exe");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_dep_exeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_dep_exe");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_skin_prnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_skin_prn");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("皮试标识打印标志"); 
		return column;
	}
	/**
	 * 获取核对时间表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getContent_or_prn_skintestCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Content_or_prn_skintest");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_emp_chk_cancCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_emp_chk_canc");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("人员编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_emp_chk_cancCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_emp_chk_canc");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("姓名"); 
		return column;
