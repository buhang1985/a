 ...
 * 体检阳性追踪 DO 元数据信息
 */
public class PePosiTrackDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pps.pepositrack.d.PePosiTrackDO";
	public static final String CLASS_DISPALYNAME = "体检阳性追踪";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_ps_pepositrack";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pepositrack";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pepositrackADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pepositrackCDesc(tblDesc));
	...
	private IAttrDesc getCode_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b4","id_nur=id_psndoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pepositrack");
	}
