...
package iih.mi.mibd.patca.d.desc;
 ...
 * 患者身份 DO 元数据信息
 */
public class PatcaDoDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.patca.d.PatcaDo";
	public static final String CLASS_DISPALYNAME = "患者身份";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_PATCA";
