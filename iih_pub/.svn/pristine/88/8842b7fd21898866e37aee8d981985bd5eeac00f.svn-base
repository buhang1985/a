 ...
 * 
 */
public class EmsLisOrdDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getEmslissrvdto() {
		return ((FArrayList) getAttrVal("Emslissrvdto"));
	}	
	/**
	 * 检验费用信息
	 * @param Emslissrvdto
	 */
	public void setEmslissrvdto(FArrayList Emslissrvdto) {
		setAttrVal("Emslissrvdto", Emslissrvdto);
	}
	/**
	 * 容器类型
	 * @return String
