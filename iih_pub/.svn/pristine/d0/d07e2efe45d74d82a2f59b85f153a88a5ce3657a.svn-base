...
import iih.nmr.ha.tcho.bgm.d.desc.TchoBgmPatInfoDODesc;
 ...
 * 
 */
public class TchoBgmPatInfoDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "NMR_HA_TCHO_BGM";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(TchoBgmPatInfoDODesc.class);
	}
