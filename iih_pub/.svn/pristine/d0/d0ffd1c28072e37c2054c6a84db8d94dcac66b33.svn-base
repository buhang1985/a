...
public interface OrSrvSourceFromEnum {
    ...
    @DmEnumDesc(name="煎法要求关联费用",description="煎法要求关联费用")
	public static final Integer BOILDESRELFEE=14; //煎法要求关联费用
    @DmEnumDesc(name="物品关联药袋费用",description="物品关联药袋费用")
	public static final Integer MMBAGFEE=15; //物品关联药袋费用
}	
