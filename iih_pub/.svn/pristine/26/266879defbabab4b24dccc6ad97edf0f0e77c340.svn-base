 ...
 * 质量控制模板元素 DO 元数据信息
 */
public class NmQctplEleDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.qctplelemaintenance.d.NmQctplEleDO";
	public static final String CLASS_DISPALYNAME = "质量控制模板元素";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_QCTPL_ELE";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_qctpl_ele";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_qctpl_eleADesc(tblDesc));
		...
		this.add(getId_qctpl_eletpADesc(tblDesc));
		this.add(getSd_qctpl_eletpADesc(tblDesc));
		...
		this.add(getName_qctpl_eletpADesc(tblDesc));
		this.add(getCode_qctpl_eletpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_qctpl_eleCDesc(tblDesc));
		...
		tblDesc.add(getId_qctpl_eletpCDesc(tblDesc));
		tblDesc.add(getSd_qctpl_eletpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_qctpl_eletpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_qctpl_eletp",  getId_qctpl_eletpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("模板元素类型id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_qctpl_eletpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_qctpl_eletp",  getSd_qctpl_eletpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("模板元素类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_qctplADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_QCTPL a0b4","id_qctpl=id_qctpl","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_qctpl_eleADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_QCTPL_ELE a0b5","id_par=id_qctpl_ele","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_qctpl_eletpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_qctpl_eletp",  getName_qctpl_eletpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_qctpl_eletp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_qctpl_eletpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_qctpl_eletp",  getCode_qctpl_eletpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_qctpl_eletp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_creatADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b3","id_emp_creat=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_chktargetADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_chktarget=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_chktargetADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_chktarget=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_qctpl_eletpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_qctpl_eletp");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("模板元素类型id"); 
		return column;
	}
	/**
	 * 获取模板元素类型编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_qctpl_eletpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_qctpl_eletp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("模板元素类型编码"); 
		return column;
	}
	/**
	 * 获取分值表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_qctpl_eletpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_qctpl_eletp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_qctpl_eletpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_qctpl_eletp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_qctpl_ele");
