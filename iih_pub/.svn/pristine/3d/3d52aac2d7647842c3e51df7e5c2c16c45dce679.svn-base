...
public class QctplCompListener implements IExecutionListener {
	...
	public void notify(WfEventExecution arg0) throws Exception {
		...
		if (tpldo.gettplDo().getSd_status().equals(INmNurDictCodeConst.SD_QCTPL_STATUS_REJECT)) {
			setupStatus(tpldo, INmNurDictCodeConst.SD_QCTPL_STATUS_SUBMIT);
		} else {
