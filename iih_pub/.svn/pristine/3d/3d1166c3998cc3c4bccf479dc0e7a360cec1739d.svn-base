 ...
 * 事件属性 DO 元数据信息
 */
public class AdbdItmdoclistDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.adbd.adbditmdoc.d.AdbdItmdoclistDO";
	public static final String CLASS_DISPALYNAME = "事件属性";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_ADBD_ITMDOCLIST";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_itmdoclist";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_itmdoclistADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_itmdoclistADesc(tblDesc));
		this.add(getCodeADesc(tblDesc));
		this.add(getNameADesc(tblDesc));
		this.add(getId_ev_tpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getFg_gradeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_itmdoclistCDesc(tblDesc));
		tblDesc.add(getId_itmdoclistCDesc(tblDesc));
		tblDesc.add(getCodeCDesc(tblDesc));
		tblDesc.add(getNameCDesc(tblDesc));
		tblDesc.add(getId_ev_tpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getFg_gradeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_itmdoclistADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_itmdoclist",  getId_itmdoclistCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_gradeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_grade",  getFg_gradeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否分级");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_ev_tpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_ev_tp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_itmdoclistCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_itmdoclist");
		column.setLength(50);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_gradeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_grade");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否分级"); 
		return column;
	}
	/**
	 * 获取状态表列元数据
