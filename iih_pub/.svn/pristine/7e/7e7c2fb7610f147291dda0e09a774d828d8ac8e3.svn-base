...
package iih.sc.att.sctaskexec.d.desc;
 ...
 * 考勤执行 DO 元数据信息
 */
public class SctaskexecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sc.att.sctaskexec.d.SctaskexecDO";
	public static final String CLASS_DISPALYNAME = "考勤执行";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "sc_task_exec";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_taskexec";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_taskexecADesc(tblDesc));
		...
		this.add(getD_period_bADesc(tblDesc));
		this.add(getD_period_eADesc(tblDesc));
		this.add(getName_periodADesc(tblDesc));
		this.add(getName_taskplADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_taskexecCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_periodADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_period",  getId_periodCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("考勤区间");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_emp_creatorADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_emp_creator",  getId_emp_creatorCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getD_period_bADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("D_period_b",  getD_period_bCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDate);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_sctask_peri a0b4","id_period=id_sctaskperi","d_b"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getD_period_eADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("D_period_e",  getD_period_eCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDate);
		attrDesc.setLabel("结束日期");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_sctask_peri a0b4","id_period=id_sctaskperi","d_e"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_periodADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_period",  getName_periodCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_sctask_peri a0b4","id_period=id_sctaskperi","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_taskplADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_taskpl",  getName_taskplCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sc_task_pl a0b5","id_taskpl=id_taskpl","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_createADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b6","id_emp_creator=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_chkADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b7","id_emp_chk=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_periodCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_period");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("考勤区间"); 
		return column;
	}
	/**
	 * 获取考勤计划表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_emp_creatorCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_emp_creator");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("提交人"); 
	 ...
	 * @return
	 */
	private IColumnDesc getD_period_bCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"D_period_b");
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getD_period_eCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"D_period_e");
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("结束日期"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_periodCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_period");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_taskplCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_taskpl");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_taskexec");
