 ...
 * 安徽医保地区字典 DO 元数据信息
 */
public class BdHpRegionOrginalDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.anhuiinsur.d.BdHpRegionOrginalDO";
	public static final String CLASS_DISPALYNAME = "安徽医保地区字典";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_REGION_AH";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpregion";
	 ...
	 * 无参构造函数
	 */
	public BdHpRegionOrginalDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpregionADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_hpregionADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpregionCDesc(tblDesc));
		tblDesc.add(getId_hpregionCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hpregionADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hpregion",  getId_hpregionCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医保计划地区主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_hpregionCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hpregion");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医保计划地区主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpregion");
