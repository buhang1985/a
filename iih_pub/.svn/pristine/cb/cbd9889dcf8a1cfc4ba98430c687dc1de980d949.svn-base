...
import iih.ci.mr.nu.dvtriskass.d.desc.DvtriskassDODesc;
 ...
 * 
 */
public class DvtriskassDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "mr_nu_dvtriskass";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(DvtriskassDODesc.class);
	}
