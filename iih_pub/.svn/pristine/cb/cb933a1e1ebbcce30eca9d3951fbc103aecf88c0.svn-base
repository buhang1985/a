...
package iih.bd.pp.priusg.d.desc;
 ...
 * 用法下费用项目对照 DO 元数据信息
 */
public class PriUsgDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.priusg.d.PriUsgDO";
	public static final String CLASS_DISPALYNAME = "用法下费用项目对照";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_pri_usg";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_priusg";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_priusgADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_priusgADesc(tblDesc));
		...
		this.add(getId_org_scopeADesc(tblDesc));
		...
		this.add(getId_mpdepcalmd_usgADesc(tblDesc));
		this.add(getSd_mpdepcalmd_usgADesc(tblDesc));
		this.add(getName_srvADesc(tblDesc));
		this.add(getDep_nameADesc(tblDesc));
		this.add(getName_unitADesc(tblDesc));
		this.add(getName_mpdepcalmd_usgADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_priusgCDesc(tblDesc));
		tblDesc.add(getId_priusgCDesc(tblDesc));
		...
		tblDesc.add(getId_org_scopeCDesc(tblDesc));
		...
		tblDesc.add(getId_mpdepcalmd_usgCDesc(tblDesc));
		tblDesc.add(getSd_mpdepcalmd_usgCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_priusgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_priusg",  getId_priusgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医嘱用法价格主键");
	 ...
	 * @return
	 */
	private IAttrDesc getId_org_scopeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_org_scope",  getId_org_scopeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("全院对应组织");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_mpdepcalmd_usgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mpdepcalmd_usg",  getId_mpdepcalmd_usgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("关联服务执行流向模式");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_mpdepcalmd_usgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_mpdepcalmd_usg",  getSd_mpdepcalmd_usgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("关联服务执行流向模式编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_unitADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_measdoc a0b6","id_unit=id_measdoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_mpdepcalmd_usgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_mpdepcalmd_usg",  getName_mpdepcalmd_usgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("关联服务执行流向模式名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b10","id_mpdepcalmd_usg=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_priusgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_priusg");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医嘱用法价格主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_org_scopeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_org_scope");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("全院对应组织"); 
		return column;
	}
	/**
	 * 获取病区表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_mpdepcalmd_usgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mpdepcalmd_usg");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("关联服务执行流向模式"); 
		return column;
	}
	/**
	 * 获取关联服务执行流向模式编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_mpdepcalmd_usgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_mpdepcalmd_usg");
		column.setLength(100);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("关联服务执行流向模式编码"); 
		return column;
	}
	/**
	 * 获取服务名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_mpdepcalmd_usgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_mpdepcalmd_usg");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("关联服务执行流向模式名称"); 
		return column;
	}
	/**
	 * 设置IBDataInfo接口映射数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_priusg");
