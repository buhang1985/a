...
package iih.mp.nr.labsampsrv.d.desc;
 ...
 * 标本费用 DO 元数据信息
 */
public class LabSampSrvDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.nr.labsampsrv.d.LabSampSrvDO";
	public static final String CLASS_DISPALYNAME = "标本费用";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_ne_lab_samp_srv";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_labsamp_srv";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_labsamp_srvADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_labsamp_srvADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_labsamp_srvCDesc(tblDesc));
		tblDesc.add(getId_labsamp_srvCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_labsamp_srvADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_labsamp_srv",  getId_labsamp_srvCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本费用");
	 ...
	 * @return
	 */
	private IColumnDesc getId_labsamp_srvCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_labsamp_srv");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标本费用"); 
		return column;
	}
	/**
	 * 获取标本ID表列元数据
