...
package iih.mm.qy.stockinsum.d.desc;
 ...
 * 入库汇总表 DO 元数据信息
 */
public class StockInSumDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.qy.stockinsum.d.StockInSumDO";
	public static final String CLASS_DISPALYNAME = "入库汇总表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MM_QY_IN";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_qyin";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_qyinADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_qyinADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_qyinCDesc(tblDesc));
		tblDesc.add(getId_qyinCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_qyinADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_qyin",  getId_qyinCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("入库汇总表主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_qyinCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_qyin");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("入库汇总表主键"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
