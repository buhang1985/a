package iih.bl.hp.bdhpindicationdto.d;
 ...
 * 
 */
public class BdHpIndicationDTO extends BaseDTO {
	...
	public FArrayList getMutiPayRatioList(){
		return ((FArrayList)getAttrVal("Mutipayratio_list"));
	}
	/**
	 * 设置多比例支付集合
	...
	public void setMutiPayRatioList(FArrayList mutiPayRatioList){
		setAttrVal("Mutipayratio_list",mutiPayRatioList);
	}
	/**
	 * 获取医保限定诊断集合
	 * (BdHpSrvCtrDiDO对象集合)
	 ...
	 * @param des_hislimit
	 */
	public void setDes_dilimit(String des_hislimit){
		setAttrVal("Des_dilimit", des_hislimit);
	}
}