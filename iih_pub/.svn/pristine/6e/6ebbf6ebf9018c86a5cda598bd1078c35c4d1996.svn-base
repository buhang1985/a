...
package iih.mp.mpbd.mprscard.d.desc;
 ...
 * 护士站滚屏卡信息 DO 元数据信息
 */
public class MpRsCardDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.mpbd.mprscard.d.MpRsCardDO";
	public static final String CLASS_DISPALYNAME = "护士站滚屏卡信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MP_RS_CARD";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_rs_card";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_rs_cardADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_rs_cardCDesc(tblDesc));
