package iih.ei.std.d.v1.ci.cancel.d;
 ...
 * 
 */
public class EntWsCancelDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getEmscancelorddto() {
		return ((FArrayList) getAttrVal("Emscancelorddto"));
	}	
	/**
	 * 待作废医嘱信息
	 * @param Emscancelorddto
	 */
	public void setEmscancelorddto(FArrayList Emscancelorddto) {
		setAttrVal("Emscancelorddto", Emscancelorddto);
	}
}