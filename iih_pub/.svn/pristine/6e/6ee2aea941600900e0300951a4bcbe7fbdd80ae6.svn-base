 ...
 * 体检方案定义 DO 元数据信息
 */
public class PeSrvProgDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pitm.pesrvprog.d.PeSrvProgDO";
	public static final String CLASS_DISPALYNAME = "体检方案定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_itm_pesrvprog";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pesrvprog";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pesrvprogADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pesrvprogADesc(tblDesc));
		this.add(getId_pesrvprog_parADesc(tblDesc));
		...
		this.add(getSexlimit_catlogADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pesrvprogCDesc(tblDesc));
		tblDesc.add(getId_pesrvprogCDesc(tblDesc));
		tblDesc.add(getId_pesrvprog_parCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pesrvprog_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pesrvprog_par",  getId_pesrvprog_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检方案定义父ID");
	...
	private IAttrDesc getCode_catlogADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_pesrvbcatlog a0b4","id_pesrvbcatlog=id_pesrvbcatlog","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_catlogADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_pesrvbcatlog a0b4","id_pesrvbcatlog=id_pesrvbcatlog","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getSexlimit_catlogADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sexlimit_catlog",  getSexlimit_catlogCDesc(tblDesc), this);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_itm_pesrvbcatlog a0b4","id_pesrvbcatlog=id_pesrvbcatlog","sexlimit"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_ageADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_bd_peage a0b6","id_peage=id_peage","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_ageADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_bd_peage a0b6","id_peage=id_peage","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_pesrvprog_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pesrvprog_par");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("体检方案定义父ID"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSexlimit_catlogCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sexlimit_catlog");
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pesrvprog");
		iBDDataInfoFldMap.put("pid","Id_pesrvprog_par");
