 ...
 * DVT风险评估单 DO 元数据信息
 */
public class DvtriskassDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.dvtriskass.d.DvtriskassDO";
	public static final String CLASS_DISPALYNAME = "DVT风险评估单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_dvtriskass";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_dvt";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_dvtADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_dvtCDesc(tblDesc));
		...
		tblDesc.add(getName_surgical_siteCDesc(tblDesc));
