 ...
 * 应收付款段_住院 DO 元数据信息
 */
public class BlPropArSegIpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.prop.blproparip.d.BlPropArSegIpDO";
	public static final String CLASS_DISPALYNAME = "应收付款段_住院";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_prop_ar_seg_ip";
	public static final String TABLE_ALIAS_NAME = "${EntityMeta.entityClassMeta.aliasName}";
	public static final String PRIMARYKEY_FIELDNAME="Id_proparsegip";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_proparsegipADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_proparipADesc(tblDesc));
		this.add(getId_proparsegipADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_proparsegipCDesc(tblDesc));
		tblDesc.add(getId_proparsegipCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_proparsegipADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_proparsegip",  getId_proparsegipCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_proparsegipCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_proparsegip");
		column.setLength(20);
