 ...
 * 数据组 DO 元数据信息
 */
public class DeDataGrpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mkr.std.dedg.d.DeDataGrpDO";
	public static final String CLASS_DISPALYNAME = "数据组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_dg";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_dg";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_dgADesc(tblDesc));
		...
		this.add(getId_applyto_dgADesc(tblDesc));
		this.add(getSd_applyto_dgADesc(tblDesc));
		...
		this.add(getParentcodeADesc(tblDesc));
		this.add(getParent_nameADesc(tblDesc));
		this.add(getApplyto_dg_codeADesc(tblDesc));
		this.add(getApplyto_dg_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_dgCDesc(tblDesc));
		...
		tblDesc.add(getId_applyto_dgCDesc(tblDesc));
		tblDesc.add(getSd_applyto_dgCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_applyto_dgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_applyto_dg",  getId_applyto_dgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("数据组适应范围");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_applyto_dgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_applyto_dg",  getSd_applyto_dgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("数据组适应范围编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getParentcodeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Parentcode",  getParentcodeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("数据组编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dg a0b4","id_parent=id_dg","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getParent_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dg a0b4","id_parent=id_dg","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getApplyto_dg_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Applyto_dg_code",  getApplyto_dg_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_applyto_dg=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getApplyto_dg_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Applyto_dg_name",  getApplyto_dg_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_applyto_dg=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_applyto_dgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_applyto_dg");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("数据组适应范围"); 
		return column;
	}
	/**
	 * 获取数据组适应范围编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_applyto_dgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_applyto_dg");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("数据组适应范围编码"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getParentcodeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Parentcode");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("数据组编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getApplyto_dg_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Applyto_dg_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getApplyto_dg_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Applyto_dg_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_dg");
