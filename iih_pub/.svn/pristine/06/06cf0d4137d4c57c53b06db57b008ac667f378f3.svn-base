...
public class NmnhrschedlvConditionSen implements ILogicDecision{

	@Override
	public boolean judge(TaskInstance arg0, SequenceFlow arg1, WfFormInfoCtx... arg2) {
		String userId = Context.get().getUserId();
		
	    ProcessDefinition proDef = ProDefsContainer.getProDefByFlowTypePk(INmNurDictCodeTypeConst.NMNHRSCHEDLV_FLOW_TYPE_PK);
