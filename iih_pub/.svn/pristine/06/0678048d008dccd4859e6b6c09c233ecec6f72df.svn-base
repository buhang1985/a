package iih.nm.nhr.nmnureval.d;
...
import iih.nm.nhr.nmnureval.d.desc.NmNurEvalDODesc;
 ...
 * 
 */
public class NmNurEvalDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_NUR_EVAL= "Id_nur_eval";
	...
	public static final String SEL_EVAL= "Sel_eval";
	public static final String PRA_CLUS= "Pra_clus";
	...
	public static final String NAME_ACT_GRD_LVL= "Name_act_grd_lvl";
	...
	public String getId_nur_eval() {
		return ((String) getAttrVal("Id_nur_eval"));
	}	
	public void setId_nur_eval(String Id_nur_eval) {
		setAttrVal("Id_nur_eval", Id_nur_eval);
	}
	...
	public String getGrade() {
		return ((String) getAttrVal("Grade"));
	}	
	...
	public String getAct_grade() {
		return ((String) getAttrVal("Act_grade"));
	}	
	public void setAct_grade(String Act_grade) {
	...
	public String getSel_eval() {
		return ((String) getAttrVal("Sel_eval"));
	}	
	public void setSel_eval(String Sel_eval) {
		setAttrVal("Sel_eval", Sel_eval);
	}
	public String getPra_clus() {
		return ((String) getAttrVal("Pra_clus"));
	}	
	public void setPra_clus(String Pra_clus) {
		setAttrVal("Pra_clus", Pra_clus);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(NmNurEvalDODesc.class);
	}
