 ...
 * 膳食申请单 DO 元数据信息
 */
public class OrdApDietDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.ord.cior.d.OrdApDietDO";
	public static final String CLASS_DISPALYNAME = "膳食申请单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_ap_diet";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_apdiet";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_apdietADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_apdietADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_apdietCDesc(tblDesc));
		tblDesc.add(getId_apdietCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_apdietADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_apdiet",  getId_apdietCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("膳食申请主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_apdietCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_apdiet");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("膳食申请主键"); 
		return column;
	}
	/**
	 * 获取膳食医嘱ID表列元数据
