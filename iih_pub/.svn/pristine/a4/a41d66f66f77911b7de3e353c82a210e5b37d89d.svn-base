...
package iih.nm.nhr.nhrexpsched.d.desc;
 ...
 * 期望排班 DO 元数据信息
 */
public class NhrExpSchedDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nhrexpsched.d.NhrExpSchedDO";
	public static final String CLASS_DISPALYNAME = "期望排班";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NHR_EXPSCHED";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nhr_expsched";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nhr_expschedADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nhr_expschedADesc(tblDesc));
		...
		this.add(getDt_schedADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nhr_expschedCDesc(tblDesc));
		tblDesc.add(getId_nhr_expschedCDesc(tblDesc));
		...
		tblDesc.add(getDt_schedCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nhr_expschedADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nhr_expsched",  getId_nhr_expschedCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("期望排班");
	 ...
	 * @return
	 */
	private IAttrDesc getDt_schedADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_sched",  getDt_schedCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDate);
		attrDesc.setLabel("期望排班日期");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_nhr_expschedCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nhr_expsched");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("期望排班"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDt_schedCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_sched");
		column.setLength(10);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("期望排班日期"); 
		return column;
	}
	/**
	 * 获取期望排班班次表列元数据
