...
package iih.sfda.aer.aerevcpytuser.d.desc;
 ...
 * 事件抄送人员 DO 元数据信息
 */
public class AerEvCopyUserDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.aer.aerevcpytuser.d.AerEvCopyUserDO";
	public static final String CLASS_DISPALYNAME = "事件抄送人员";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_AER_EV_COPYUSER";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_aer_ev_copyuser";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_aer_ev_copyuserADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_aer_ev_copyuserADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_aer_evADesc(tblDesc));
		this.add(getId_userADesc(tblDesc));
		this.add(getDt_operADesc(tblDesc));
		this.add(getId_oper_userADesc(tblDesc));
		...
		this.add(getName_oper_userADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_aer_ev_copyuserCDesc(tblDesc));
		tblDesc.add(getId_aer_ev_copyuserCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_aer_evCDesc(tblDesc));
		tblDesc.add(getId_userCDesc(tblDesc));
		tblDesc.add(getDt_operCDesc(tblDesc));
		tblDesc.add(getId_oper_userCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_aer_ev_copyuserADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_aer_ev_copyuser",  getId_aer_ev_copyuserCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("抄送人员标识");
	 ...
	 * @return
	 */
	private IAttrDesc getId_oper_userADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_oper_user",  getId_oper_userCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getName_userADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sys_user a0b2","id_user=id_user","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_oper_userADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_oper_user",  getName_oper_userCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("用户名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sys_user a0b3","id_oper_user=id_user","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_aer_ev_copyuserCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_aer_ev_copyuser");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("抄送人员标识"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_oper_userCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_oper_user");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("操作人"); 
	 ...
	 * @return
	 */
	private IColumnDesc getName_oper_userCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_oper_user");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("用户名称"); 
		return column;
