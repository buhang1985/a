 ...
 * 医保特殊病 DO 元数据信息
 */
public class BdHpSpecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.bdhpspec.d.BdHpSpecDO";
	public static final String CLASS_DISPALYNAME = "医保特殊病";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_SPEC";
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpspec");
		iBDDataInfoFldMap.put("id_org","Id_grp");
		iBDDataInfoFldMap.put("code","Code_di");
		iBDDataInfoFldMap.put("name","Code_di");
