 ...
 * 报卡文书DO DO 元数据信息
 */
public class ReportCardDocDoDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.rcm.reportcarddoc.d.ReportCardDocDo";
	...
	private void init(){		
		...
		this.add(getName_tplstmdADesc(tblDesc));
		...
		this.add(getFg_reported_historyADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getName_stateCDesc(tblDesc));
		...
		tblDesc.add(getName_tplstmdCDesc(tblDesc));
		...
		tblDesc.add(getFg_reported_historyCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_tplstmdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_tplstmd",  getName_tplstmdCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("存贮方式名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_reported_historyADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_reported_history",  getFg_reported_historyCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("既往已报标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getName_tplstmdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_tplstmd");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("存贮方式名称"); 
		return column;
	}
	/**
	 * 获取文件地址表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_reported_historyCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_reported_history");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("既往已报标识"); 
		return column;
	}
	/**
	 * 获取报告疾病诊断表列元数据
