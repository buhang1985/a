 ...
 * 
 */
public class CiMrFpOtherCataDO extends BaseDO {
	...
	//最高诊断依据
	public static final String REASON_HIGHTESTDI= "Reason_hightestdi";
	//护理级别
...
//	}
	...
	public String getTableName() {	  
		return "CI_MR_FP_OTHER_CATA";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiMrFpOtherCataDODesc.class);
	}
