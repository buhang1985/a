...
package iih.sc.scbd.scheduleca.d.desc;
 ...
 * 排班分类 DO 元数据信息
 */
public class ScheduleCADODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sc.scbd.scheduleca.d.ScheduleCADO";
	public static final String CLASS_DISPALYNAME = "排班分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "sc_ca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_scca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_sccaADesc(tblDesc));
		...
		this.add(getId_org_nameADesc(tblDesc));
		this.add(getName_sctpADesc(tblDesc));
		this.add(getCode_sctpADesc(tblDesc));
		this.add(getId_cal_nameADesc(tblDesc));
		this.add(getId_cal_codeADesc(tblDesc));
		this.add(getId_dayslottp_nameADesc(tblDesc));
		this.add(getId_dayslottp_codeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_sccaCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_org_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_org_name",  getId_org_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getId_cal_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_cal_name",  getId_cal_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_workcalendar a0b5","id_cal=id_workcalendar","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getId_cal_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_cal_code",  getId_cal_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_workcalendar a0b5","id_cal=id_workcalendar","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getId_dayslottp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_dayslottp_name",  getId_dayslottp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dayslotca a0b6","id_dayslottp=id_dayslotca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getId_dayslottp_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_dayslottp_code",  getId_dayslottp_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dayslotca a0b6","id_dayslottp=id_dayslotca","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_org_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_org_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_cal_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_cal_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_cal_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_cal_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_dayslottp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_dayslottp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_dayslottp_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_dayslottp_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_scca");
