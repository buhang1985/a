...
import iih.nmr.pkuf.nmrdi.d.desc.NmrDiDODesc;
 ...
 * 
 */
public class NmrDiDO extends BaseDO {
	...
	public static final String NAME_DICA= "Name_dica";
	...
	public String getName_dica() {
		return ((String) getAttrVal("Name_dica"));
	}	
	public void setName_dica(String Name_dica) {
		setAttrVal("Name_dica", Name_dica);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(NmrDiDODesc.class);
	}
