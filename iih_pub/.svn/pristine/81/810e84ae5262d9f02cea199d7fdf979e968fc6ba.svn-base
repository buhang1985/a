 ...
 * 
 */
public class HpFreqDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_HPFREQ= "Id_hpfreq";
	...
	public String getId_hpfreq() {
		return ((String) getAttrVal("Id_hpfreq"));
	}	
	public void setId_hpfreq(String Id_hpfreq) {
		setAttrVal("Id_hpfreq", Id_hpfreq);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpFreqDODesc.class);
	}
