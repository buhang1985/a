 ...
 * 护理管理人员小组 DO 元数据信息
 */
public class NmNurGrpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmnurgrp.d.NmNurGrpDO";
	public static final String CLASS_DISPALYNAME = "护理管理人员小组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NUR_GRP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nur_grp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nur_grpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nur_grpCDesc(tblDesc));
