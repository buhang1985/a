...
package iih.bd.mhi.hpditp.d.desc;
 ...
 * 医保计划疾病分类 DO 元数据信息
 */
public class HpDiTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpditp.d.HpDiTpDO";
	public static final String CLASS_DISPALYNAME = "医保计划疾病分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_DI_TP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpditp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpditpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpditpCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpditp");
