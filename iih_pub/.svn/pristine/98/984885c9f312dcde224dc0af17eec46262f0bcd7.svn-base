 ...
 * 执行退费 DO 元数据信息
 */
public class MpRfndDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.ot.rfnd.d.MpRfndDO";
	public static final String CLASS_DISPALYNAME = "执行退费";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_rfnd";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_rfnd";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_rfndADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_rfndADesc(tblDesc));
		...
		this.add(getId_emp_rfndADesc(tblDesc));
		...
		this.add(getName_emp_rfndADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_rfndCDesc(tblDesc));
		tblDesc.add(getId_rfndCDesc(tblDesc));
		...
		tblDesc.add(getId_emp_rfndCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_rfndADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_rfnd",  getId_rfndCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("执行退费ID");
	 ...
	 * @return
	 */
	private IAttrDesc getId_emp_rfndADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_emp_rfnd",  getId_emp_rfndCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_emp_rfndADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_emp_rfnd",  getName_emp_rfndCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b9","id_emp_rfnd=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_operADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b10","id_emp_oper=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_dep_operADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b11","id_dep_oper=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_rfndCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_rfnd");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("执行退费ID"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_emp_rfndCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_emp_rfnd");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("执行人"); 
	 ...
	 * @return
	 */
	private IColumnDesc getName_emp_rfndCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_emp_rfnd");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("姓名"); 
		return column;
