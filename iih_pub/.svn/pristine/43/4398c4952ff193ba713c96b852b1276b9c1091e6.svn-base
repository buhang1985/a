...
import iih.pmp.pay.log.IPmpTaskLogService;
 ...
 *
 */
public class PmpTaskLogUtils {

	private static IPmpTaskLogService _logService = ServiceFinder.find(IPmpTaskLogService.class);
