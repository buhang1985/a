 ...
 * 业务组主表 DO 元数据信息
 */
public class BizgrpMasterDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.res.bizgrp.d.BizgrpMasterDO";
	public static final String CLASS_DISPALYNAME = "业务组主表";
