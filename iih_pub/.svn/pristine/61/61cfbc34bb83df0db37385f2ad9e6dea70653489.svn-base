 ...
 * 
 */
public class StockCheckItmDO extends BaseDO {
	...
	//基本包装单位名称
	public static final String MMPKGU_BASE_NAME= "Mmpkgu_base_name";
	//实际包装单位名称
	public static final String MMPKGU_ACTUAL_NAME= "Mmpkgu_actual_name";
	//大包装单位名称
	 ...
	 * @return String
	 */
	public String getMmpkgu_base_name() {
		return ((String) getAttrVal("Mmpkgu_base_name"));
	}	
	/**
	 * 基本包装单位名称
	 * @param Mmpkgu_base_name
	 */
	public void setMmpkgu_base_name(String Mmpkgu_base_name) {
		setAttrVal("Mmpkgu_base_name", Mmpkgu_base_name);
	}
	/**
	 * 实际包装单位名称
	 * @return String
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(StockCheckItmDODesc.class);
	}
