...
public class OrdApBtDO extends BaseDO {
	...
	public static final String ID_BLOODTYPE_AP= "Id_bloodtype_ap";
	public static final String SD_BLOODTYPE_AP= "Sd_bloodtype_ap";
	public static final String ID_RHD_AP= "Id_rhd_ap";
	public static final String SD_RHD_AP= "Sd_rhd_ap";
	public static final String FG_NEWBORN= "Fg_newborn";
	public static final String ID_BLODQUAN= "Id_blodquan";
