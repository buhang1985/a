...
/**
 * 医嘱_会诊_实际应答人记录 DO 元数据信息
 */
public class CiConsActInviteDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.ord.cons.d.CiConsActInviteDO";
	public static final String CLASS_DISPALYNAME = "医嘱_会诊_实际应答人记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_CONS_ACT_INVITE";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_consacrinvite";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_consacrinviteADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_apconsADesc(tblDesc));
		this.add(getId_consacrinviteADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_consacrinviteCDesc(tblDesc));
		tblDesc.add(getId_consacrinviteCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_consacrinviteADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_consacrinvite",  getId_consacrinviteCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("会诊实际应答人ID");
	...
	private IAttrDesc getName_depADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a2b2","id_dep=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emptitleADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a2b4","id_emptitle=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_cancADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a2b5","id_emp_canc=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_consacrinviteCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_consacrinvite");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("会诊实际应答人ID"); 
		return column;
	}
	/**
	 * 获取会诊医嘱表列元数据
