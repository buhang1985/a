...
import iih.ci.mr.nu.childhealthedu.d.desc.ChildHealthEduDODesc;
 ...
 * 
 */
public class ChildHealthEduDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_childhealthedu";
	}
	
	@Override
	public String getTableName() {	  
		return "ci_mr_ny_childhealthedu";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(ChildHealthEduDODesc.class);
	}
