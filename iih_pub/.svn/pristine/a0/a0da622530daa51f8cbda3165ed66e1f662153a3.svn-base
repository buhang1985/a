 ...
 * 
 */
public class HpRegionDO extends BaseDO {
	...
	public String getId_region() {
		return ((String) getAttrVal("Id_region"));
	}	
	public void setId_region(String Id_region) {
		setAttrVal("Id_region", Id_region);
	}
...
//	}
	...
	public String getTableName() {	  
		return "bd_mhi_region";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpRegionDODesc.class);
	}
