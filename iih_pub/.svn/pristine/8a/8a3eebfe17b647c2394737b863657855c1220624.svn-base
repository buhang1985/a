 ...
 * 评分项目分类 DO 元数据信息
 */
public class NmNqmChkitmcaDoDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nqmchkitm.d.NmNqmChkitmcaDo";
	public static final String CLASS_DISPALYNAME = "评分项目分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_CHKITMCA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_chkitmca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_chkitmcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_chkitmcaCDesc(tblDesc));
	...
	private IAttrDesc getPar_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NQM_CHKITMCA a0b8","id_par=id_nqm_chkitmca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_cs_styleADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标准显示样式");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b7","id_cs_style=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
