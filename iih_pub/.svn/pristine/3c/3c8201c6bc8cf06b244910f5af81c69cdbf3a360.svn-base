 ...
 * 数据同步目标 DO 元数据信息
 */
public class SynUnitTrgDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.syn.common.unittrg.d.SynUnitTrgDO";
	public static final String CLASS_DISPALYNAME = "数据同步目标";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SYN_UNIT_TRG";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_unit_trg";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_unit_trgADesc(tblDesc));
		...
		this.add(getName_serverADesc(tblDesc));
		this.add(getFg_bizdataADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_unit_trgCDesc(tblDesc));
		...
		tblDesc.add(getName_serverCDesc(tblDesc));
		tblDesc.add(getFg_bizdataCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_serverADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_server",  getName_serverCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_bizdataADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_bizdata",  getFg_bizdataCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否业务数据");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_unitADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("数据同步单元名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"SYN_UNIT a0b2","id_unit=id_unit","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_classADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("目标实体名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"dm_class a0b5","id_class=id","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDisplaynameADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("目标实体显示名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"dm_class a0b5","id_class=id","displayname"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_serverCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_server");
	 ...
	 * @return
	 */
	private IColumnDesc getFg_bizdataCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_bizdata");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否业务数据"); 
		return column;
	}
	/**
	 * 获取扩展字段1表列元数据
