...
* 医疗服务基本分类数据维护服务
*/
public interface ISrvcateRService {
	/**
	*  根据id值查找医疗服务基本分类数据
	*/	
	...
	*  根据condition条件查找医疗服务基本分类数据集合
	*/
	public abstract SrvCateDO[] find2(String whereStr,SqlParamDTO sqlParamDTO,String orderStr,FBoolean isLazy) throws BizException;
	...
	*/
	...
	public abstract PagingRtnData<SrvCateDO> findByPageInfo2(PaginationInfo pg, String whereStr, SqlParamDTO sqlParamDTO, String orderStr) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract SrvCateDO[] findByAttrValString(String attr, String value) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract SrvCateDO[] findByAttrValStrings(String attr, String[] values) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract SrvCateDO[] findByAttrValList(String attr, FArrayList values) throws BizException;
	 ...
	 * @throws BizException
	 */
	public PagingRtnData<SrvCateDO> findByQCondAndPageInfo(QryRootNodeDTO qryRootNodeDTO,String orderStr,PaginationInfo pg) throws BizException;
}