...
package iih.pe.papt.pelabsamprel.d.desc;
 ...
 * 体检标本项目关系 DO 元数据信息
 */
public class PeLabSampRealtionDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.papt.pelabsamprel.d.PeLabSampRealtionDO";
	public static final String CLASS_DISPALYNAME = "体检标本项目关系";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_apt_lab_samp_itm_ref";
	 ...
	 * 无参构造函数
	 */
	public PeLabSampRealtionDODesc(){
		init();
	}
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_labsampitmref");
