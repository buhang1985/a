...
public class NitlvRejcListener implements IExecutionListener{
	...
	public void notify(WfEventExecution arg0) throws Exception {
		...
		setupStatus(lvdo, INmNurDictCodeConst.CODE_NMNURLV_BACK_NUM);
	...
	private void setupStatus(NitLVFormDO billDo, String status) throws BizException {
