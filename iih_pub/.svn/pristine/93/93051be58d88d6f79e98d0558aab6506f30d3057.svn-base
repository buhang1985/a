 ...
 * 应收明细_门急体 DO 元数据信息
 */
public class BlPropArItmOepDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.prop.blproparoep.d.BlPropArItmOepDO";
	public static final String CLASS_DISPALYNAME = "应收明细_门急体";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_prop_ar_itm_oep";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_proparitmoep";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_proparitmoepADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_proparoepADesc(tblDesc));
		this.add(getId_proparitmoepADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_proparitmoepCDesc(tblDesc));
		tblDesc.add(getId_proparitmoepCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_proparitmoepADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_proparitmoep",  getId_proparitmoepCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_proparitmoepCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_proparitmoep");
		column.setLength(20);
