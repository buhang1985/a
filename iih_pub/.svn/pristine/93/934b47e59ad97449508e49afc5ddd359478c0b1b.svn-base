...
public class IEOpLisOrItmDTO extends BaseDTO {
	...
	public String getOrdertimetypecode() {
		return ((String) getAttrVal("Ordertimetypecode"));
	}	
	/**
	 * 医嘱时间类型编码
	 * @param Ordertimetypecode
	 */
	public void setOrdertimetypecode(String Ordertimetypecode) {
		setAttrVal("Ordertimetypecode", Ordertimetypecode);
	}
	/**
	 * 医嘱时间类型名称
	 * @return String
	 ...
	 * @return String
	 */
	public String getWeilght_unit() {
		return ((String) getAttrVal("Weilght_unit"));
	}	
	/**
	 * 体重单位
	 * @param Weilght_unit
	 */
	public void setWeilght_unit(String Weilght_unit) {
		setAttrVal("Weilght_unit", Weilght_unit);
	}
	/**
	 * 身高
	 * @return String
