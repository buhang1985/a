 ...
 * 
 */
public class CiRptLabItmHISDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//检验报告单明细历史主键
	public static final String ID_RPTLISITM_HIS= "Id_rptlisitm_his";
	//检验报告单历史主键
	public static final String ID_RPTLAB_HIS= "Id_rptlab_his";
	//检验报告单主键
	 ...
	 * @return String
	 */
	public String getId_rptlisitm_his() {
		return ((String) getAttrVal("Id_rptlisitm_his"));
	}	
	/**
	 * 检验报告单明细历史主键
	 * @param Id_rptlisitm_his
	 */
	public void setId_rptlisitm_his(String Id_rptlisitm_his) {
		setAttrVal("Id_rptlisitm_his", Id_rptlisitm_his);
	}
	/**
	 * 检验报告单历史主键
	 * @return String
	 */
	public String getId_rptlab_his() {
		return ((String) getAttrVal("Id_rptlab_his"));
	}	
	/**
	 * 检验报告单历史主键
	 * @param Id_rptlab_his
	 */
	public void setId_rptlab_his(String Id_rptlab_his) {
		setAttrVal("Id_rptlab_his", Id_rptlab_his);
	}
	/**
	 * 检验报告单主键
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_rptlisitm_his";
	}
	
	@Override
	public String getTableName() {	  
		return "CI_RPT_LAB_ITM_HIS";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiRptLabItmHISDODesc.class);
	}
