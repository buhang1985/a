...
package iih.pe.pitm.pesrvitemroom.d.desc;
 ...
 * 体检诊间项目设定 DO 元数据信息
 */
public class PeSrvitmRoomDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pitm.pesrvitemroom.d.PeSrvitmRoomDO";
	public static final String CLASS_DISPALYNAME = "体检诊间项目设定";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_itm_pesrvitmroom";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pesrvitemroom";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pesrvitemroomADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pesrvitemroomADesc(tblDesc));
		...
		this.add(getCode_pesrvitmADesc(tblDesc));
		this.add(getName_pesrvitmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pesrvitemroomCDesc(tblDesc));
		tblDesc.add(getId_pesrvitemroomCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pesrvitemroomADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pesrvitemroom",  getId_pesrvitemroomCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检诊间项目主键标识");
	...
	private IAttrDesc getCode_depADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_bd_deptset a0b8","id_pedeptset=id_pedeptset","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_depADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_bd_deptset a0b8","id_pedeptset=id_pedeptset","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_pesrvitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_pesrvitm",  getCode_pesrvitmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getName_pesrvitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_pesrvitm",  getName_pesrvitmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getId_pesrvitemroomCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pesrvitemroom");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("体检诊间项目主键标识"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getCode_pesrvitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_pesrvitm");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_pesrvitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_pesrvitm");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pesrvitemroom");
