...
package iih.hr.hbd.psncert.d.desc;
 ...
 * 人员证书 DO 元数据信息
 */
public class HbdPsnCertDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hr.hbd.psncert.d.HbdPsnCertDO";
	public static final String CLASS_DISPALYNAME = "人员证书";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HR_HBD_PSN_CERT";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hbd_psn_cert";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hbd_psn_certADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_hbd_psn_certADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hbd_psn_certCDesc(tblDesc));
		tblDesc.add(getId_hbd_psn_certCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hbd_psn_certADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hbd_psn_cert",  getId_hbd_psn_certCDesc(tblDesc), this);
	...
	private IAttrDesc getName_auditADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b9","id_audit=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_psn_regADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b10","id_psn_reg=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_hbd_psn_certCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hbd_psn_cert");
		column.setLength(20);
