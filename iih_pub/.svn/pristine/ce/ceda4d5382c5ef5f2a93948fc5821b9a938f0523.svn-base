...
/**
 * 医疗单动态指标项目定义 DO 元数据信息
 */
public class MedSrvOfDyncItmDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.medsrv.d.MedSrvOfDyncItm";
	public static final String CLASS_DISPALYNAME = "医疗单动态指标项目定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srvof_dync_itm";
	...
	private void init(){		
		...
		this.add(getSd_srvof_tpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getSd_srvof_tpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getSd_srvof_tpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_srvof_tp",  getSd_srvof_tpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗单类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getSd_srvof_tpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_srvof_tp");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医疗单类型"); 
		return column;
	}
	/**
	 * 设置IBDataInfo接口映射数据
