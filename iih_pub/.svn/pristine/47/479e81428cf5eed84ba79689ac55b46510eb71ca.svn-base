 ...
 * 病人信息 DO 元数据信息
 */
public class TchoBgmPatInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.ha.tcho.bgm.d.TchoBgmPatInfoDO";
	public static final String CLASS_DISPALYNAME = "病人信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_HA_TCHO_BGM";
