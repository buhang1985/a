...
/**
 * 体检慢性病风险因素-主 DO 元数据信息
 */
public class PeChroRiskDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.peevalchrorisk.d.PeChroRiskDO";
	public static final String CLASS_DISPALYNAME = "体检慢性病风险因素-主";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_pechrorisk";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pechrorisk";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pechroriskADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pechroriskADesc(tblDesc));
		this.add(getId_pechrorisk_parADesc(tblDesc));
		...
		this.add(getFg_crtlADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pechroriskCDesc(tblDesc));
		tblDesc.add(getId_pechroriskCDesc(tblDesc));
		tblDesc.add(getId_pechrorisk_parCDesc(tblDesc));
		...
		tblDesc.add(getFg_crtlCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pechrorisk_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pechrorisk_par",  getId_pechrorisk_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_crtlADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_crtl",  getFg_crtlCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("风险可控标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_pechrorisk_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pechrorisk_par");
		column.setLength(20);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_crtlCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_crtl");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("风险可控标识"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pechrorisk");
		iBDDataInfoFldMap.put("pid","Id_pechrorisk_par");
