...
/**
 * 健康评估模型_缺血性冠心病_收缩压 DO 元数据信息
 */
public class PeIcdvModelSbpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.peicdvmodel.d.PeIcdvModelSbpDO";
	public static final String CLASS_DISPALYNAME = "健康评估模型_缺血性冠心病_收缩压";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_peicdvmodelsbp";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_peicdvmodelsbp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_peicdvmodelsbpADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_peicdvmodelADesc(tblDesc));
		this.add(getId_peicdvmodelsbpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_peicdvmodelsbpCDesc(tblDesc));
		tblDesc.add(getId_peicdvmodelsbpCDesc(tblDesc));
	...
	/**
	 * 缺血性冠心病评估模型收缩压主键标识属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getId_peicdvmodelsbpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_peicdvmodelsbp",  getId_peicdvmodelsbpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("缺血性冠心病评估模型收缩压主键标识");
	...
	/**
	 * 获取缺血性冠心病评估模型收缩压主键标识表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_peicdvmodelsbpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_peicdvmodelsbp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("缺血性冠心病评估模型收缩压主键标识"); 
		return column;
	}
	/**
	 * 获取缺血性冠心病ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_peicdvmodelsbp");
	}
