package iih.pe.pbd.peqclevel.d;
...
import iih.pe.pbd.peqclevel.d.desc.PeQcLevelDODesc;
 ...
 * 
 */
public class PeQcLevelDO extends BaseDO {
	...
	public Integer getQclevel() {
		return ((Integer) getAttrVal("Qclevel"));
	}	
	public void setQclevel(Integer Qclevel) {
		setAttrVal("Qclevel", Qclevel);
	}
...
//	}
	...
	public String getTableName() {	  
		return "pe_bd_peqclevel";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PeQcLevelDODesc.class);
	}
