 ...
 * 
 */
public class BlReconciliationQryCondDTO extends BaseDTO {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getDt_transr_start() {
		return ((FDateTime) getAttrVal("Dt_transr_start"));
	}
	/**
	 * 交易时间起
	 * @param Dt_transr_start
	 */
	public void setDt_transr_start(FDateTime Dt_transr_start) {
		setAttrVal("Dt_transr_start", Dt_transr_start);
	}
	/**
	 * 交易时间止
	 * @return FDateTime
	 */
	public FDateTime getDt_transr_last() {
		return ((FDateTime) getAttrVal("Dt_transr_last"));
	}
	/**
	 * 交易时间止
	 * @param Dt_transr_last
	 */
	public void setDt_transr_last(FDateTime Dt_transr_last) {
		setAttrVal("Dt_transr_last", Dt_transr_last);
	}
	/**
	 * 支付渠道id
	 * @return String
