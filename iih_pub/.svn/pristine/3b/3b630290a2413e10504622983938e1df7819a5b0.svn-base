 ...
 * 患者就诊_地点 DO 元数据信息
 */
public class EnPlcDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.en.pv.enres.d.EnPlcDO";
	public static final String CLASS_DISPALYNAME = "患者就诊_地点";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "en_ent_plc";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_entplc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_entplcADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_entplcADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_entplcCDesc(tblDesc));
		tblDesc.add(getId_entplcCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_entplcADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_entplc",  getId_entplcCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("患者就诊地点主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_entplcCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_entplc");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("患者就诊地点主键"); 
		return column;
	}
	/**
	 * 获取就诊表列元数据
