 ...
 * 库存盘点 DO 元数据信息
 */
public class McStockCheckDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.st.stockcheck.d.McStockCheckDO";
	public static final String CLASS_DISPALYNAME = "库存盘点";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_ST_TK";
	...
	private void init(){		
		...
		this.add(getSttktp_codeADesc(tblDesc));
		this.add(getMmca_nameADesc(tblDesc));
		this.add(getPkgutp_nameADesc(tblDesc));
		this.add(getWh_nameADesc(tblDesc));
		this.add(getDep_nameADesc(tblDesc));
		this.add(getSusttk_nameADesc(tblDesc));
		this.add(getSusttk_codeADesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getSttktp_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sttktp_code",  getSttktp_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("库存盘点类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_sttktp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getPkgutp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Pkgutp_name",  getPkgutp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSusttk_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Susttk_name",  getSusttk_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSusttk_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Susttk_code",  getSusttk_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("盘点状态编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_su_sttk=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getEmpsttk_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b9","id_emp_sttk=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getEmpcheck_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b10","id_emp_check=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getSttktp_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sttktp_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("库存盘点类型编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getPkgutp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Pkgutp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getSusttk_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Susttk_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getSusttk_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Susttk_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("盘点状态编码"); 
		return column;
