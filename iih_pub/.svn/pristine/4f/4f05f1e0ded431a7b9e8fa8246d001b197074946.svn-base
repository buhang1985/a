 ...
 * 住院患者信息 DO 元数据信息
 */
public class EvaluateDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.ipevalsigle.d.EvaluateDO";
	public static final String CLASS_DISPALYNAME = "住院患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MR_NU_EVLASGL";
