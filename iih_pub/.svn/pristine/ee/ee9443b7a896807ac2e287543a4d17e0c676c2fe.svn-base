 ...
 * 患者手术史 DO 元数据信息
 */
public class PiPatSugDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pi.overview.overview.d.PiPatSugDO";
	public static final String CLASS_DISPALYNAME = "患者手术史";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pi_pat_sug";
	public static final String TABLE_ALIAS_NAME = "a4";
	public static final String PRIMARYKEY_FIELDNAME="Id_patsug";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_patsugADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_patADesc(tblDesc));
		this.add(getId_patsugADesc(tblDesc));
		...
		this.add(getName_codeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_patsugCDesc(tblDesc));
		tblDesc.add(getId_patsugCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_patsugADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_patsug",  getId_patsugCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("患者手术史ID");
	 ...
	 * @return
	 */
	private IAttrDesc getName_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_code",  getName_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_di_def a4b1","name=id_didef","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_di_def a4b1","name=id_didef","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_patsugCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_patsug");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("患者手术史ID"); 
		return column;
	}
	/**
	 * 获取数据来源表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
