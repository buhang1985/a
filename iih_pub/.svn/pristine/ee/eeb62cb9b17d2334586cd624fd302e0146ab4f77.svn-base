 ...
 * 门急诊发票 DO 元数据信息
 */
public class BlIncOepDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.inc.blincoep.d.BlIncOepDO";
	public static final String CLASS_DISPALYNAME = "门急诊发票";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_inc_oep";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_incoep";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_incoepADesc(tblDesc));
		...
		this.add(getIncca_codeADesc(tblDesc));
		this.add(getIncca_nameADesc(tblDesc));
		this.add(getOep_codeincpkgADesc(tblDesc));
		this.add(getId_emp_inc_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_incoepCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getIncca_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Incca_code",  getIncca_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getIncca_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Incca_name",  getIncca_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getOep_codeincpkgADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Oep_codeincpkg",  getOep_codeincpkgCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("票据包编号");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bl_inc_iss a0b10","code_incpkg=id_inciss","code_incpkg"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getId_emp_inc_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_emp_inc_name",  getId_emp_inc_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b7","id_emp_inc=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getIncca_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Incca_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getIncca_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Incca_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getOep_codeincpkgCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Oep_codeincpkg");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("票据包编号"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getId_emp_inc_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_emp_inc_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("姓名"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_incoep");
