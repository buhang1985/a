...
public class McBlBlanceRefModel extends RefGridModel{
	/**
	 * chma 2019-03-11
	 */
	...
	public String[] getShowFieldCode() {
		return new String[] { "name_wh", "name_mm", "name_fac", "spec", "batch", "date_expi", "name_pkgu", "pri_sa",
				"pri_act", "quan_stock", "code_mm" };
	}

	@Override
	public String[] getShowFieldName() {
		return new String[] { "仓库名称", "耗材名称", "生产厂商", "规格", "批次", "有效期", "单位", "售价", "进价", "结存数量", "耗材编码" };
	}
	...
	private String getBaseSql() {
		...
		sqlBuilder.append("ROUND(MMBL.PRI_SA,4) AS pri_sa,");
		sqlBuilder.append("ROUND(MMBL.PRI_ACT,4) AS pri_act,");
