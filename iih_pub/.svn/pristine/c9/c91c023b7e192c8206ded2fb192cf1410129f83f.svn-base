 ...
 * 不良事件上报患者 DO 元数据信息
 */
public class NmAerPatDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.aer.d.NmAerPatDO";
	public static final String CLASS_DISPALYNAME = "不良事件上报患者";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_AER_PAT";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_aerpat";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_aerpatADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_aerADesc(tblDesc));
		this.add(getId_aerpatADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_aerpatCDesc(tblDesc));
		tblDesc.add(getId_aerpatCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_aerpatADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_aerpat",  getId_aerpatCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("不良事件上报患者ID");
	...
	private IAttrDesc getName_patADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"en_ent a2b6","id_ent=id_ent","name_pat"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_dep_phyADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("所在科室");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a2b2","id_dep_phy=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_aerpatCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_aerpat");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("不良事件上报患者ID"); 
		return column;
	}
	/**
	 * 获取不良事件上报ID表列元数据
