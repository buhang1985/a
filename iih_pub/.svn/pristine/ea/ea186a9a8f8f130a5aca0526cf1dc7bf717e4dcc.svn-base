...
package iih.bl.hp.hpentcodeoep.d.desc;
 ...
 * 门诊医保登记记录 DO 元数据信息
 */
public class HpEntCodeOepDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.hp.hpentcodeoep.d.HpEntCodeOepDO";
	public static final String CLASS_DISPALYNAME = "门诊医保登记记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_hp_entcode_oep";
	...
	private void init(){		
		...
		this.add(getHp_ent_serialnoADesc(tblDesc));
		...
		this.add(getSettle_codeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getHp_ent_serialnoCDesc(tblDesc));
		...
		tblDesc.add(getSettle_codeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getHp_ent_serialnoADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Hp_ent_serialno",  getHp_ent_serialnoCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSettle_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Settle_code",  getSettle_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getHp_ent_serialnoCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Hp_ent_serialno");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getSettle_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Settle_code");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
