 ...
 * 医嘱模板分类 DO 元数据信息
 */
public class OrTplCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.ortpl.d.OrTplCaDO";
	public static final String CLASS_DISPALYNAME = "医嘱模板分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_ortpl_ca";
	...
	private void init(){		
		...
		this.add(getRtcodeADesc(tblDesc));
		this.add(getRtnameADesc(tblDesc));
		...
		this.add(getTpltpcodeADesc(tblDesc));
		this.add(getTpltpnameADesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getRtcodeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Rtcode",  getRtcodeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_srvorrt=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getRtnameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Rtname",  getRtnameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getTpltpcodeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Tpltpcode",  getTpltpcodeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b9","id_ortpltp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getTpltpnameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Tpltpname",  getTpltpnameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医嘱模板类型名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b9","id_ortpltp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getRtcodeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Rtcode");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getRtnameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Rtname");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getTpltpcodeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Tpltpcode");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getTpltpnameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Tpltpname");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("医嘱模板类型名称"); 
		return column;
	}
	/**
	 * 设置IBDataInfo接口映射数据
