 ...
 * 
 */
public class NhrSchedItmStuDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_NHR_SCHED_ITM_STU= "Id_nhr_sched_itm_stu";
	...
	public String getId_nhr_sched_itm_stu() {
		return ((String) getAttrVal("Id_nhr_sched_itm_stu"));
	}	
	public void setId_nhr_sched_itm_stu(String Id_nhr_sched_itm_stu) {
		setAttrVal("Id_nhr_sched_itm_stu", Id_nhr_sched_itm_stu);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_nhr_sched_itm_stu";
	}
	
	@Override
	public String getTableName() {	  
		return "NM_NHR_SCHED_ITM_STU";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(NhrSchedItmStuDODesc.class);
	}
