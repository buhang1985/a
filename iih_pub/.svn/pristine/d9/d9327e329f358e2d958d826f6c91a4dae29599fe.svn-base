 ...
 * 
 */
public class CiMrVSMiddleDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_CI_MR_VS_MIDDLE= "Id_ci_mr_vs_middle";
	...
	public static final String PAT_DEP= "Pat_dep";
	public static final String PAT_NUR= "Pat_nur";
	public static final String CODE_PAT_DEP= "Code_pat_dep";
	public static final String CODE_PAT_NUR= "Code_pat_nur";
	public static final String CODE_EMP_OPERATE= "Code_emp_operate";
	public static final String EMP_OPERATE= "Emp_operate";
	public static final String DT_OPERATE= "Dt_operate";
	public static final String CODE_VS_ITEM= "Code_vs_item";
	public static final String NAME_VS_ITEM= "Name_vs_item";
	public static final String VALUE_VS_ITEM= "Value_vs_item";
	public static final String VALUE_VS_ITEM_HIGH= "Value_vs_item_high";
	public static final String VALUE_VS_ITEM_LOW= "Value_vs_item_low";
	...
	public static final String DT_VS_ITEM= "Dt_vs_item";
	...
	public String getId_ci_mr_vs_middle() {
		return ((String) getAttrVal("Id_ci_mr_vs_middle"));
	}	
	public void setId_ci_mr_vs_middle(String Id_ci_mr_vs_middle) {
		setAttrVal("Id_ci_mr_vs_middle", Id_ci_mr_vs_middle);
	}
	...
	public String getValue_vs_item_high() {
		return ((String) getAttrVal("Value_vs_item_high"));
	}	
	public void setValue_vs_item_high(String Value_vs_item_high) {
		setAttrVal("Value_vs_item_high", Value_vs_item_high);
	}
	public String getValue_vs_item_low() {
		return ((String) getAttrVal("Value_vs_item_low"));
	}	
	public void setValue_vs_item_low(String Value_vs_item_low) {
		setAttrVal("Value_vs_item_low", Value_vs_item_low);
	}
	...
	public FDateTime getDt_vs_item() {
		return ((FDateTime) getAttrVal("Dt_vs_item"));
	}	
	public void setDt_vs_item(FDateTime Dt_vs_item) {
		setAttrVal("Dt_vs_item", Dt_vs_item);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_ci_mr_vs_middle";
	}
	
	@Override
	public String getTableName() {	  
		return "ci_mr_vs_middle";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiMrVSMiddleDODesc.class);
	}
