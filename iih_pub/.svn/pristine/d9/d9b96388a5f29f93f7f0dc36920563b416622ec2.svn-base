...
package iih.bd.mm.stockdealtype.d.desc;
...
/**
 * 医疗物品_库存交易分类 DO 元数据信息
 */
public class StockDealTypeDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mm.stockdealtype.d.StockDealTypeDO";
	public static final String CLASS_DISPALYNAME = "医疗物品_库存交易分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_MM_STCA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mmstca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mmstcaADesc(tblDesc));
		...
		this.add(getSttp_nameADesc(tblDesc));
		this.add(getDirect_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mmstcaCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getSttp_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sttp_name",  getSttp_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b3","id_sttp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getDirect_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Direct_name",  getDirect_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("出入库方向");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_direct=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getSttp_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sttp_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("类型"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getDirect_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Direct_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("出入库方向"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mmstca");
