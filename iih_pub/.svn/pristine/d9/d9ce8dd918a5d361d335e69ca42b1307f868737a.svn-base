package iih.mi.mibd.admstatus.d;
 ...
 * 
 */
public class AdmStatusDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "MI_BD_ADMSTATUS";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(AdmStatusDODesc.class);
	}
