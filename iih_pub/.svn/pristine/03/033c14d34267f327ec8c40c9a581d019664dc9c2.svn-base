...
import iih.ci.mr.nu.obstetrics.criticallyill.d.desc.CriticallyCustDODesc;
 ...
 * 
 */
public class CriticallyCustDO extends BaseDO {
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CriticallyCustDODesc.class);
	}
