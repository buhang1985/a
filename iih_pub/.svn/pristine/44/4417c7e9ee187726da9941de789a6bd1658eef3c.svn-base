 ...
 * 住院患者信息 DO 元数据信息
 */
public class TchoEvaluateDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.ha.tcho.ipevalsigle.d.TchoEvaluateDO";
	public static final String CLASS_DISPALYNAME = "住院患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_HA_TCHO_EVLASGL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_evalsgl";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_evalsglADesc(tblDesc));
		...
		this.add(getCode_evalsglADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_evalsglCDesc(tblDesc));
		tblDesc.add(getId_evalsglCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getCode_evalsglCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getCode_evalsglADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_evalsgl",  getCode_evalsglCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("评价单编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_evalsglCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_evalsgl");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("评价单编码"); 
		return column;
	}
	/**
	 * 获取患者ID表列元数据
