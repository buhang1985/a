...
package iih.nm.nhr.nurrewards.d.desc;
 ...
 * 人员奖惩 DO 元数据信息
 */
public class NmNurRewardsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nurrewards.d.NmNurRewardsDO";
	public static final String CLASS_DISPALYNAME = "人员奖惩";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NUR_REWARDS";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nur_rewards";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nur_rewardsADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nur_rewardsADesc(tblDesc));
		...
		this.add(getName_nur_sraADesc(tblDesc));
		this.add(getName_nur_acADesc(tblDesc));
		this.add(getName_nur_atcADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nur_rewardsCDesc(tblDesc));
		tblDesc.add(getId_nur_rewardsCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nur_rewardsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nur_rewards",  getId_nur_rewardsCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getName_nur_sraADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_nur_sra",  getName_nur_sraCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR_SRA a0b11","id_nur_sra=id_nur_sra","name_sub"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_nur_acADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_nur_ac",  getName_nur_acCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("学术会议名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR_AC a0b13","id_nur_ac=id_nur_ac","name_confrec"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_nur_atcADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_nur_atc",  getName_nur_atcCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR_ATC a0b12","id_nur_atc=id_nur_atc","name_atc"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_honortpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b10","id_honortp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_honor_levelADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_honor_level=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_honor_srcADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_honor_src=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_regADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("登记人员姓名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b14","id_emp_reg=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_auditADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("审核人员姓名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b15","id_emp_audit=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nur_rewardsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nur_rewards");
		column.setLength(50);
	 ...
	 * @return
	 */
	private IColumnDesc getName_nur_sraCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_nur_sra");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_nur_acCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_nur_ac");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("学术会议名称"); 
		return column;
	}
	/**
	 * 获取论文名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_nur_atcCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_nur_atc");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
