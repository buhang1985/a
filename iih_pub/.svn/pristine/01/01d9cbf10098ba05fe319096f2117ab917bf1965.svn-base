...
package iih.sfda.aer.sfdaaerevnoth.d.desc;
 ...
 * 其他事件 DO 元数据信息
 */
public class SfdaAerEvNothDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.aer.sfdaaerevnoth.d.SfdaAerEvNothDO";
	public static final String CLASS_DISPALYNAME = "其他事件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_AER_EV_NOTH";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_aer_ev_noth";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_aer_ev_nothADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_aer_ev_nothADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_aer_ev_nothCDesc(tblDesc));
		tblDesc.add(getId_aer_ev_nothCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_aer_ev_nothADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_aer_ev_noth",  getId_aer_ev_nothCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("其他事件主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_aer_ev_nothCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_aer_ev_noth");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("其他事件主键"); 
		return column;
	}
	/**
	 * 获取护理安全事件外键表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_aer_ev_noth");
