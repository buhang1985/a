 ...
 * 患者就诊_人员 DO 元数据信息
 */
public class EnPsnDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.en.pv.enres.d.EnPsnDO";
	public static final String CLASS_DISPALYNAME = "患者就诊_人员";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "en_ent_emp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_entemp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_entempADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_entempADesc(tblDesc));
		this.add(getId_entADesc(tblDesc));
		this.add(getId_empADesc(tblDesc));
		this.add(getId_emproleADesc(tblDesc));
		this.add(getSd_emproleADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_entempCDesc(tblDesc));
		tblDesc.add(getId_entempCDesc(tblDesc));
		tblDesc.add(getId_entCDesc(tblDesc));
		tblDesc.add(getId_empCDesc(tblDesc));
		tblDesc.add(getId_emproleCDesc(tblDesc));
		tblDesc.add(getSd_emproleCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_entempADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_entemp",  getId_entempCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("患者就诊人员主键");
	 ...
	 * @return
	 */
	private IAttrDesc getId_emproleADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_emprole",  getId_emproleCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_emproleADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_emprole",  getSd_emproleCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getNameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_emprole=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_entempCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_entemp");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("患者就诊人员主键"); 
		return column;
	}
	/**
	 * 获取就诊表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_emproleCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_emprole");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("角色"); 
	 ...
	 * @return
	 */
	private IColumnDesc getSd_emproleCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_emprole");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
