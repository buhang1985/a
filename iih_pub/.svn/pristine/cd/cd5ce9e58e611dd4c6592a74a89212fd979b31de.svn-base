...
package iih.mc.po.stockinvinrel.d.desc;
...
/**
 * 采购发票入库单关联关系 DO 元数据信息
 */
public class McStockInvInRelDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.po.stockinvinrel.d.McStockInvInRelDO";
	public static final String CLASS_DISPALYNAME = "采购发票入库单关联关系";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_INV_REL";
