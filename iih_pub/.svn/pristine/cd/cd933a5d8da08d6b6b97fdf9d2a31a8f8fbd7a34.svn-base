...
package iih.nm.nit.nitlv.d.desc;
 ...
 * 实习生请假 DO 元数据信息
 */
public class NitLvDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nit.nitlv.d.NitLvDO";
	public static final String CLASS_DISPALYNAME = "实习生请假";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NIT_LV";
	...
	private void init(){		
		...
		this.add(getName_id_nit_sroADesc(tblDesc));
		this.add(getName_id_nit_sro_bchADesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_id_nit_sroADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_id_nit_sro",  getName_id_nit_sroCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("院校名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_id_nit_sro_bchADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_id_nit_sro_bch",  getName_id_nit_sro_bchCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getName_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NIT_PSNINFO a0b6","id_nur=id_nit_psninfo","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_id_nit_sroCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_id_nit_sro");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("院校名称"); 
		return column;
	}
	/**
	 * 获取批次名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_id_nit_sro_bchCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_id_nit_sro_bch");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
