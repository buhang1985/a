package iih.mm.bl.snapshotstockbl.d;
...
import iih.mm.bl.snapshotstockbl.d.desc.SnapshotStockBlDODesc;
 ...
 * 
 */
public class SnapshotStockBlDO extends BaseDO {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getDt_current() {
		return ((FDateTime) getAttrVal("Dt_current"));
	}	
	/**
	 * 快照时间
	 * @param Dt_current
	 */
	public void setDt_current(FDateTime Dt_current) {
		setAttrVal("Dt_current", Dt_current);
	}
	/**
	 * 创建人
	 * @return String
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(SnapshotStockBlDODesc.class);
	}
