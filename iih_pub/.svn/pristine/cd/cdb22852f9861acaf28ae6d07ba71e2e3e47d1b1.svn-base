...
package iih.mi.mc.unlimitdrug.d.desc;
 ...
 * 不限量药品 DO 元数据信息
 */
public class MiMcUnlimitDrugDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mc.unlimitdrug.d.MiMcUnlimitDrugDO";
	public static final String CLASS_DISPALYNAME = "不限量药品";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mi_mc_unlimit_drug";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mcunlimitdrug";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mcunlimitdrugADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_mcunlimitdrugADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mcunlimitdrugCDesc(tblDesc));
		tblDesc.add(getId_mcunlimitdrugCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_mcunlimitdrugADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mcunlimitdrug",  getId_mcunlimitdrugCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_mcunlimitdrugCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mcunlimitdrug");
		column.setLength(20);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mcunlimitdrug");
