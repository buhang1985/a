 ...
 * 基础数据校验服务表 DO 元数据信息
 */
public class BDErrorInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.medvalidate.d.BDErrorInfoDO";
	public static final String CLASS_DISPALYNAME = "基础数据校验服务表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_errorinfo";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_errorinfo";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_errorinfoADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_errorinfoCDesc(tblDesc));
