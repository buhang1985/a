...
package iih.mi.mibd.dischargedstatus.d.desc;
 ...
 * 出院状态 DO 元数据信息
 */
public class DischargedStatusDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.dischargedstatus.d.DischargedStatusDO";
	public static final String CLASS_DISPALYNAME = "出院状态";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_DISCHARGEDSTATUS";
