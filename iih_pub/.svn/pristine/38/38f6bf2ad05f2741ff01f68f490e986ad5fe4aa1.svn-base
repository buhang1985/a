 ...
 * 病案编目中医诊断 DO 元数据信息
 */
public class CiMrFpZYDiCataDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mrm.cimrfpdicatado.d.CiMrFpZYDiCataDO";
	public static final String CLASS_DISPALYNAME = "病案编目中医诊断";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_MR_FP_ZYDI_Cata";
	...
	private IAttrDesc getId_mrfpzydiADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("住院病案编目中医诊断ID");
