 ...
 * 负责质量标准 DO 元数据信息
 */
public class NqmQcgrpCsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nqmqcgrp.d.NqmQcgrpCsDO";
	public static final String CLASS_DISPALYNAME = "负责质量标准";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_QCGRP_CS";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_qcgrp_cs";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_qcgrp_csADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_nqm_qcgrpADesc(tblDesc));
		this.add(getId_nqm_qcgrp_csADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_qcgrp_csCDesc(tblDesc));
		tblDesc.add(getId_nqm_qcgrp_csCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nqm_qcgrp_csADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nqm_qcgrp_cs",  getId_nqm_qcgrp_csCDesc(tblDesc), this);
	...
	private IAttrDesc getNameADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("负责标准");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NQM_CS a2b2","id_nqm_cs=id_nqm_cs","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nqm_qcgrp_csCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nqm_qcgrp_cs");
		column.setLength(50);
