...
package iih.mi.mibd.entp.d.desc;
 ...
 * 就诊类型 DO 元数据信息
 */
public class EnTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.entp.d.EnTpDO";
	public static final String CLASS_DISPALYNAME = "就诊类型";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_ENTP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_entp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_entpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_entpCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_entp");
