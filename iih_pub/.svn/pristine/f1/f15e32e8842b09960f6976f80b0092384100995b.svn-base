package iih.ei.std.d.v1.mp.pacedata.d;
 ...
 * 
 */
public class ApObsDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getPricedetaildtos() {
		return ((FArrayList) getAttrVal("Pricedetaildtos"));
	}	
	/**
	 * 收费项目
	 * @param Pricedetaildtos
	 */
	public void setPricedetaildtos(FArrayList Pricedetaildtos) {
		setAttrVal("Pricedetaildtos", Pricedetaildtos);
	}
}