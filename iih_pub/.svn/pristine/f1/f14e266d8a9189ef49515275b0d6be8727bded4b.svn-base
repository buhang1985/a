...
package iih.bd.mhi.hpdischargedstatus.d.desc;
 ...
 * 医保产品_出院状态 DO 元数据信息
 */
public class HpDischargedStatusDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpdischargedstatus.d.HpDischargedStatusDO";
	public static final String CLASS_DISPALYNAME = "医保产品_出院状态";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_HPDISCHARGEDSTATUS";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_dischargedstatus";
	 ...
	 * 无参构造函数
	 */
	public HpDischargedStatusDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_dischargedstatusADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_dischargedstatusCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_dischargedstatus");
