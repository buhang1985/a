...
package iih.nm.nhr.nhrresignrec.d.desc;
 ...
 * 人员辞职记录 DO 元数据信息
 */
public class NhrResignRecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nhrresignrec.d.NhrResignRecDO";
	public static final String CLASS_DISPALYNAME = "人员辞职记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NHR_RESIGNREC";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nhr_resignrec";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nhr_resignrecADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nhr_resignrecADesc(tblDesc));
		...
		this.add(getDt_resignADesc(tblDesc));
		this.add(getResionADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nhr_resignrecCDesc(tblDesc));
		tblDesc.add(getId_nhr_resignrecCDesc(tblDesc));
		...
		tblDesc.add(getDt_resignCDesc(tblDesc));
		tblDesc.add(getResionCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nhr_resignrecADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nhr_resignrec",  getId_nhr_resignrecCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("离职记录主键");
	 ...
	 * @return
	 */
	private IAttrDesc getDt_resignADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_resign",  getDt_resignCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getResionADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Resion",  getResionCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("离职原因");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b5","id_nur=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_nhr_resignrecCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nhr_resignrec");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("离职记录主键"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDt_resignCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_resign");
		column.setLength(10);
	 ...
	 * @return
	 */
	private IColumnDesc getResionCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Resion");
		column.setLength(300);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("离职原因"); 
		return column;
	}
	/**
	 * 获取备注表列元数据
