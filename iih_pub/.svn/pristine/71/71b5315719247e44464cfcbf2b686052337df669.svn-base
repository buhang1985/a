...
public class EmsItemInCons extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getName_org_manual() {
		return ((String) getAttrVal("Name_org_manual"));
	}
	/**
	 * 手动录入的受邀机构名称
	 * @param Name_org_manual
	 */
	public void setName_org_manual(String Name_org_manual) {
		setAttrVal("Name_org_manual", Name_org_manual);
	}
	/**
	 * 手动录入的受邀科室名称
	 * @return String
	 */
	public String getName_dep_manual() {
		return ((String) getAttrVal("Name_dep_manual"));
	}
	/**
	 * 手动录入的受邀科室名称
	 * @param Name_dep_manual
	 */
	public void setName_dep_manual(String Name_dep_manual) {
		setAttrVal("Name_dep_manual", Name_dep_manual);
	}
	/**
	 * 手动录入的受邀人员名称
	 * @return String
	 */
	public String getName_emp_manual() {
		return ((String) getAttrVal("Name_emp_manual"));
	}
	/**
	 * 手动录入的受邀人员名称
	 * @param Name_emp_manual
	 */
	public void setName_emp_manual(String Name_emp_manual) {
		setAttrVal("Name_emp_manual", Name_emp_manual);
	}
}