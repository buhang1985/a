package iih.ci.mr.nu.hoscareass.d;
...
import iih.ci.mr.nu.hoscareass.d.desc.HosCareAssDODesc;
 ...
 * 
 */
public class HosCareAssDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_HOSCAREASS= "Id_hoscareass";
	...
	public static final String BRE_DEV_OTHER= "Bre_dev_other";
	public static final String DES_FETAL_MOVE= "Des_fetal_move";
	public static final String DES_MED= "Des_med";
	public static final String DES_PREBL= "Des_prebl";
	public static final String TIMES_ABORTION= "Times_abortion";
	public static final String TIMES_OBS= "Times_obs";
	public static final String TIMES_PRE= "Times_pre";
	public static final String NUM_WEIGHTLIF_SUIT= "Num_weightlif_suit";
	public static final String NUM_FUNDAL_HEIGHT= "Num_fundal_height";
	public static final String LMP= "Lmp";
	public static final String DT_EXCHILDBIRTH= "Dt_exchildbirth";
	public static final String EU_UTERINECONTRAC= "Eu_uterinecontrac";
	public static final String EU_CAUL= "Eu_caul";
	public static final String EU_BLOOD_VAGINA= "Eu_blood_vagina";
	public static final String URIN= "Urin";
	public static final String EDEMA_CON= "Edema_con";
	public static final String BRE_DEV= "Bre_dev";
	public static final String UT_CON= "Ut_con";
	public static final String FETAL_MOVE= "Fetal_move";
	public static final String MED_PRE= "Med_pre";
	public static final String BLOOD_PRE= "Blood_pre";
	...
	public static final String NUM_FH= "Num_fh";
	public static final String BREASTFEEDING_KNOWLEDGE= "Breastfeeding_knowledge";
	...
	public static final String ID_ADDLEVEL= "Id_addlevel";
	public static final String SD_ADDLEVEL= "Sd_addlevel";
	...
	public static final String NAME_ATTITUDE= "Name_attitude";
	public static final String NAME_ADDLEVEL= "Name_addlevel";
	...
	public String getId_hoscareass() {
		return ((String) getAttrVal("Id_hoscareass"));
	}	
	public void setId_hoscareass(String Id_hoscareass) {
		setAttrVal("Id_hoscareass", Id_hoscareass);
	}
	...
	public String getDiabetes() {
		return ((String) getAttrVal("Diabetes"));
	}	
	public void setDiabetes(String Diabetes) {
		setAttrVal("Diabetes", Diabetes);
	}
	public String getBre_dev_other() {
		return ((String) getAttrVal("Bre_dev_other"));
	}	
	public void setBre_dev_other(String Bre_dev_other) {
		setAttrVal("Bre_dev_other", Bre_dev_other);
	}
	public String getDes_fetal_move() {
		return ((String) getAttrVal("Des_fetal_move"));
	}	
	public void setDes_fetal_move(String Des_fetal_move) {
		setAttrVal("Des_fetal_move", Des_fetal_move);
	}
	public String getDes_med() {
		return ((String) getAttrVal("Des_med"));
	}	
	public void setDes_med(String Des_med) {
		setAttrVal("Des_med", Des_med);
	}
	public String getDes_prebl() {
		return ((String) getAttrVal("Des_prebl"));
	}	
	public void setDes_prebl(String Des_prebl) {
		setAttrVal("Des_prebl", Des_prebl);
	}
	public Integer getTimes_abortion() {
		return ((Integer) getAttrVal("Times_abortion"));
	}	
	public void setTimes_abortion(Integer Times_abortion) {
		setAttrVal("Times_abortion", Times_abortion);
	}
	public Integer getTimes_obs() {
		return ((Integer) getAttrVal("Times_obs"));
	}	
	public void setTimes_obs(Integer Times_obs) {
		setAttrVal("Times_obs", Times_obs);
	}
	public Integer getTimes_pre() {
		return ((Integer) getAttrVal("Times_pre"));
	}	
	public void setTimes_pre(Integer Times_pre) {
		setAttrVal("Times_pre", Times_pre);
	}
	public FDouble getNum_weightlif_suit() {
		return ((FDouble) getAttrVal("Num_weightlif_suit"));
	}	
	public void setNum_weightlif_suit(FDouble Num_weightlif_suit) {
		setAttrVal("Num_weightlif_suit", Num_weightlif_suit);
	}
	public FDouble getNum_fundal_height() {
		return ((FDouble) getAttrVal("Num_fundal_height"));
	}	
	public void setNum_fundal_height(FDouble Num_fundal_height) {
		setAttrVal("Num_fundal_height", Num_fundal_height);
	}
	public FDate getLmp() {
		return ((FDate) getAttrVal("Lmp"));
	}	
	public void setLmp(FDate Lmp) {
		setAttrVal("Lmp", Lmp);
	}
	public FDate getDt_exchildbirth() {
		return ((FDate) getAttrVal("Dt_exchildbirth"));
	}	
	public void setDt_exchildbirth(FDate Dt_exchildbirth) {
		setAttrVal("Dt_exchildbirth", Dt_exchildbirth);
	}
	public Integer getEu_uterinecontrac() {
		return ((Integer) getAttrVal("Eu_uterinecontrac"));
	}	
	public void setEu_uterinecontrac(Integer Eu_uterinecontrac) {
		setAttrVal("Eu_uterinecontrac", Eu_uterinecontrac);
	}
	public Integer getEu_caul() {
		return ((Integer) getAttrVal("Eu_caul"));
	}	
	public void setEu_caul(Integer Eu_caul) {
		setAttrVal("Eu_caul", Eu_caul);
	}
	public Integer getEu_blood_vagina() {
		return ((Integer) getAttrVal("Eu_blood_vagina"));
	}	
	public void setEu_blood_vagina(Integer Eu_blood_vagina) {
		setAttrVal("Eu_blood_vagina", Eu_blood_vagina);
	}
	public Integer getUrin() {
		return ((Integer) getAttrVal("Urin"));
	}	
	public void setUrin(Integer Urin) {
		setAttrVal("Urin", Urin);
	}
	public Integer getEdema_con() {
		return ((Integer) getAttrVal("Edema_con"));
	}	
	public void setEdema_con(Integer Edema_con) {
		setAttrVal("Edema_con", Edema_con);
	}
	public Integer getBre_dev() {
		return ((Integer) getAttrVal("Bre_dev"));
	}	
	public void setBre_dev(Integer Bre_dev) {
		setAttrVal("Bre_dev", Bre_dev);
	}
	public Integer getUt_con() {
		return ((Integer) getAttrVal("Ut_con"));
	}	
	public void setUt_con(Integer Ut_con) {
		setAttrVal("Ut_con", Ut_con);
	}
	public Integer getFetal_move() {
		return ((Integer) getAttrVal("Fetal_move"));
	}	
	public void setFetal_move(Integer Fetal_move) {
		setAttrVal("Fetal_move", Fetal_move);
	}
	public Integer getMed_pre() {
		return ((Integer) getAttrVal("Med_pre"));
	}	
	public void setMed_pre(Integer Med_pre) {
		setAttrVal("Med_pre", Med_pre);
	}
	public Integer getBlood_pre() {
		return ((Integer) getAttrVal("Blood_pre"));
	}	
	public void setBlood_pre(Integer Blood_pre) {
		setAttrVal("Blood_pre", Blood_pre);
	}
	...
	public Integer getNum_fh() {
		return ((Integer) getAttrVal("Num_fh"));
	}	
	public void setNum_fh(Integer Num_fh) {
		setAttrVal("Num_fh", Num_fh);
	}
	public Integer getBreastfeeding_knowledge() {
		return ((Integer) getAttrVal("Breastfeeding_knowledge"));
	}	
	public void setBreastfeeding_knowledge(Integer Breastfeeding_knowledge) {
		setAttrVal("Breastfeeding_knowledge", Breastfeeding_knowledge);
	}
	...
	public String getId_addlevel() {
		return ((String) getAttrVal("Id_addlevel"));
	}	
	public void setId_addlevel(String Id_addlevel) {
		setAttrVal("Id_addlevel", Id_addlevel);
	}
	public String getSd_addlevel() {
		return ((String) getAttrVal("Sd_addlevel"));
	}	
	public void setSd_addlevel(String Sd_addlevel) {
		setAttrVal("Sd_addlevel", Sd_addlevel);
	}
	...
	public String getName_attitude() {
		return ((String) getAttrVal("Name_attitude"));
	}	
	public void setName_attitude(String Name_attitude) {
		setAttrVal("Name_attitude", Name_attitude);
	}
	public String getName_addlevel() {
		return ((String) getAttrVal("Name_addlevel"));
	}	
	public void setName_addlevel(String Name_addlevel) {
		setAttrVal("Name_addlevel", Name_addlevel);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_hoscareass";
	}
	
	@Override
	public String getTableName() {	  
		return "CI_MR_NU_HOSCAREASS";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HosCareAssDODesc.class);
	}
