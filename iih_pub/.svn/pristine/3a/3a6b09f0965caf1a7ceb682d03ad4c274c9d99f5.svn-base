...
package iih.bd.srv.mrtplstream.d.desc;
 ...
 * 医疗记录模板流数据 DO 元数据信息
 */
public class EmrTplStreamDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.mrtplstream.d.EmrTplStreamDO";
	public static final String CLASS_DISPALYNAME = "医疗记录模板流数据";
