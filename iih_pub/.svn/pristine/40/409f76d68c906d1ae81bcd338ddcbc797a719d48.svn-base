...
/**
 * 医疗费用门急体结算应收明细 DO 元数据信息
 */
public class BlStArItmOepDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.st.blstaroep.d.BlStArItmOepDO";
	public static final String CLASS_DISPALYNAME = "医疗费用门急体结算应收明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_st_ar_itm_oep";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_staritm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_staritmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_starADesc(tblDesc));
		this.add(getId_staritmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_staritmCDesc(tblDesc));
		tblDesc.add(getId_staritmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_staritmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_staritm",  getId_staritmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("结算应收明细主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_staritmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_staritm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("结算应收明细主键"); 
		return column;
	}
	/**
	 * 获取结算应收表列元数据
