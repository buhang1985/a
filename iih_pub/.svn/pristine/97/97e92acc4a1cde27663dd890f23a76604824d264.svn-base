 ...
 * 收费包固定收费明细 DO 元数据信息
 */
public class FixedChargePkgItmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.srvdc.d.FixedChargePkgItmDO";
	public static final String CLASS_DISPALYNAME = "收费包固定收费明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_dc_itm";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvdcitm";
	 ...
	 * 无参构造函数
	 */
	public FixedChargePkgItmDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvdcitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_srvdcADesc(tblDesc));
		this.add(getId_srvdcitmADesc(tblDesc));
		this.add(getId_srvdcADesc(tblDesc));
		this.add(getId_srvADesc(tblDesc));
		this.add(getQuanADesc(tblDesc));
		this.add(getId_mmADesc(tblDesc));
		this.add(getId_unitADesc(tblDesc));
		this.add(getSrvdc_codeADesc(tblDesc));
		this.add(getSrvdc_nameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvdcitmCDesc(tblDesc));
		tblDesc.add(getId_srvdcitmCDesc(tblDesc));
		tblDesc.add(getId_srvdcCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvdcitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvdcitm",  getId_srvdcitmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("固定收费包项目主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvdcADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvdc",  getId_srvdcCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("固定收费包");
	 ...
	 * @return
	 */
	private IAttrDesc getSrvdc_codeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Srvdc_code",  getSrvdc_codeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv_dc a1b1","id_srvdc=id_srvdc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getSrvdc_nameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Srvdc_name",  getSrvdc_nameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv_dc a1b1","id_srvdc=id_srvdc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvdcitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvdcitm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("固定收费包项目主键标识"); 
		return column;
	}
	/**
	 * 获取固定收费包表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvdcCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvdc");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("固定收费包"); 
		return column;
	}
	/**
	 * 获取服务表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSrvdc_codeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Srvdc_code");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getSrvdc_nameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Srvdc_name");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Quan",new xap.mw.coreitf.d.FDouble(1));
	}
