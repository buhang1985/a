 ...
 * 常规医嘱分类 DO 元数据信息
 */
public class RegularOrCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.ortpl.d.RegularOrCaDO";
	public static final String CLASS_DISPALYNAME = "常规医嘱分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_regularor_ca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_regularorca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_regularorcaADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_regularorcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_regularorcaCDesc(tblDesc));
		tblDesc.add(getId_regularorcaCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_regularorcaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_regularorca",  getId_regularorcaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("常规医嘱分类主键标识");
	...
	private IAttrDesc getName_parentADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv_regularor_ca a0b4","id_parent=id_regularorca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_parentADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv_regularor_ca a0b4","id_parent=id_regularorca","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_regularorcaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_regularorca");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("常规医嘱分类主键标识"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_regularorca");
