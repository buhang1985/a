...
import iih.nmr.nm.bch.evaluation.d.desc.EvaluatDODesc;
 ...
 * 
 */
public class EvaluatDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "NRM_NM_BCH_EVLASGL";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(EvaluatDODesc.class);
	}
