...
import iih.mm.qy.estimate.d.desc.StockEstimateQueryViewDesc;
 ...
 * 
 */
public class StockEstimateQueryView extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "V_MM_ESTIMATE_QUERY";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(StockEstimateQueryViewDesc.class);
	}
