 ...
 * 实习科室轮转计划 DO 元数据信息
 */
public class NmDepplDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmdeppl.d.NmDepplDO";
	public static final String CLASS_DISPALYNAME = "实习科室轮转计划";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_DEP_PL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_dep_pl";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_dep_plADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_dep_plCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_dep_pl");
