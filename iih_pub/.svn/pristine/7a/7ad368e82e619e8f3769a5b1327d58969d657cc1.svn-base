 ...
 * 满意度问卷模板 DO 元数据信息
 */
public class NmNcaTpmlDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nca.nmncatmpl.d.NmNcaTpmlDO";
	public static final String CLASS_DISPALYNAME = "满意度问卷模板";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NCA_TMPL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nca_tmpl";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nca_tmplADesc(tblDesc));
		...
		this.add(getName_tmplcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nca_tmplCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_tmplcaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_tmplca",  getName_tmplcaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("模板分类名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NCA_TMPLCA a0b7","id_nca_tmplca=id_nca_tmplca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_psn_regADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b6","id_psn_reg=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_tmplcaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_tmplca");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("模板分类名称"); 
		return column;
	}
	/**
	 * 获取修订人表列元数据
