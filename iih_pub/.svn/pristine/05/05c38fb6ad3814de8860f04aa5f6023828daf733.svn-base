...
package iih.nmr.pkuf.childinout.d.desc;
...
/**
 * 儿童医院护理记录单出入量总结 DO 元数据信息
 */
public class ChildInoutDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.childinout.d.ChildInoutDO";
	public static final String CLASS_DISPALYNAME = "儿童医院护理记录单出入量总结";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_PKUF_CHILDINOUT";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_childinout";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_childinoutADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_childinoutADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_childinoutCDesc(tblDesc));
		tblDesc.add(getId_childinoutCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_childinoutADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_childinout",  getId_childinoutCDesc(tblDesc), this);
	...
	private IAttrDesc getName_iotypeADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("统计类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_iotype=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_childinoutCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_childinout");
		column.setLength(20);
