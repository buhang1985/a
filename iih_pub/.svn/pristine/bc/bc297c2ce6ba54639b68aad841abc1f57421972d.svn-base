 ...
 * 护士长手册分类 DO 元数据信息
 */
public class NmNomWbkCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nom.nmnomwbkitm.d.NmNomWbkCaDO";
	public static final String CLASS_DISPALYNAME = "护士长手册分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NOM_WBK_CA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nom_wbk_ca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nom_wbk_caADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nom_wbk_caCDesc(tblDesc));
	...
	private IAttrDesc getName_reg_psnADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b5","id_reg_psn=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
