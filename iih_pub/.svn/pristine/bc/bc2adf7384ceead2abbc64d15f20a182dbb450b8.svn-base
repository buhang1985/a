 ...
 * 手术室患者信息 DO 元数据信息
 */
public class PrescforDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.prescforoper.d.PrescforDO";
	public static final String CLASS_DISPALYNAME = "手术室患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_prescfor";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_prescfor";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_prescforADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_prescforCDesc(tblDesc));
