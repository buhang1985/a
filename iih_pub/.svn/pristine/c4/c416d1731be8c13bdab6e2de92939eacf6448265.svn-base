 ...
 * 手术台与科室关系 DO 元数据信息
 */
public class OptDepDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.res.opt.d.OptDepDO";
	public static final String CLASS_DISPALYNAME = "手术台与科室关系";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_opt_dep";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_optdep";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_optdepADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_optADesc(tblDesc));
		this.add(getId_optdepADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_optdepCDesc(tblDesc));
		tblDesc.add(getId_optdepCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_optdepADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_optdep",  getId_optdepCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手术台与科室主键");
	...
	private IAttrDesc getGrp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_grp a2b1","id_grp=id_grp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getOpt_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_opt a2b3","id_opt=id_opt","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDep_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a2b4","id_dep=id_dep","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_optdepCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_optdep");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("手术台与科室主键"); 
		return column;
	}
	/**
	 * 获取集团表列元数据
