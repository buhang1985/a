 ...
 * 查询条件 DO 元数据信息
 */
public class QryCondDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pbd.qrycond.d.QryCondDO";
	public static final String CLASS_DISPALYNAME = "查询条件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "PE_PBD_QYR_COND";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_qry_cond";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_qry_condADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_qry_condCDesc(tblDesc));
