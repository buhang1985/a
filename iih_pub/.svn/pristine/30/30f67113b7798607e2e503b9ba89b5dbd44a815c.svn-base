...
package iih.mp.mpbd.hdvdef.d.desc;
 ...
 * 班次定义 DO 元数据信息
 */
public class HdvDefDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.mpbd.hdvdef.d.HdvDefDO";
	public static final String CLASS_DISPALYNAME = "班次定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_hdv_def";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hdv_def";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hdv_defADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hdv_defCDesc(tblDesc));
		...
		tblDesc.add(getHourCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getHourADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Hour",  getHourCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("班次时长");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getHourCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Hour");
		column.setLength(10);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("班次时长"); 
		return column;
	}
	/**
	 * 获取交班时间表列元数据
