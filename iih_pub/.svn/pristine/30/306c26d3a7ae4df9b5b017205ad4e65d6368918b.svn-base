 ...
 * 排班释放规则 DO 元数据信息
 */
public class ScReleaseRuleDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sc.scbd.screleaserule.d.ScReleaseRuleDO";
	public static final String CLASS_DISPALYNAME = "排班释放规则";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "sc_release_rule";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_release_rule";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_release_ruleADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_release_ruleCDesc(tblDesc));
	...
	private IAttrDesc getSd_sctpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sc_ca a0b2","id_scca=id_scca","sd_sctp"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_sccaADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sc_ca a0b2","id_scca=id_scca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_release_rule");
