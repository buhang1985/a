...
import iih.ci.mr.nu.prescforoper.d.desc.PrescforDODesc;
 ...
 * 
 */
public class PrescforDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "mr_nu_prescfor";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PrescforDODesc.class);
	}
