package iih.ci.ord.cirptobshis.d;
 ...
 * 
 */
public class CiRptObsHisDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//历史检查报告主键
	public static final String ID_RPTOBS_HIS= "Id_rptobs_his";
	//检验报告ID
	 ...
	 * @return String
	 */
	public String getId_rptobs_his() {
		return ((String) getAttrVal("Id_rptobs_his"));
	}	
	/**
	 * 历史检查报告主键
	 * @param Id_rptobs_his
	 */
	public void setId_rptobs_his(String Id_rptobs_his) {
		setAttrVal("Id_rptobs_his", Id_rptobs_his);
	}
	/**
	 * 检验报告ID
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_rptobs_his";
	}
	
	@Override
	public String getTableName() {	  
		return "CI_RPT_OBS_HIS";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiRptObsHisDODesc.class);
	}
