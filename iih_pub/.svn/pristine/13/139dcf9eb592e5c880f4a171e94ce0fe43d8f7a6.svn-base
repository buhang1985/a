...
public class CiMrRecallDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getFg_updateADesc(tblDesc));
		...
		this.add(getId_psn_deptauditADesc(tblDesc));
		this.add(getDt_deptauditADesc(tblDesc));
		...
		this.add(getCode_psn_deptauditADesc(tblDesc));
		this.add(getName_psn_deptauditADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getFg_updateCDesc(tblDesc));
		...
		tblDesc.add(getId_psn_deptauditCDesc(tblDesc));
		tblDesc.add(getDt_deptauditCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_updateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_update",  getFg_updateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
	 ...
	 * @return
	 */
	private IAttrDesc getId_psn_deptauditADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_psn_deptaudit",  getId_psn_deptauditCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("科室审核人id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getDt_deptauditADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Dt_deptaudit",  getDt_deptauditCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDateTime);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_psn_deptauditADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_psn_deptaudit",  getCode_psn_deptauditCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("人员编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b11","id_psn_deptaudit=id_psndoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_psn_deptauditADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_psn_deptaudit",  getName_psn_deptauditCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("姓名");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b11","id_psn_deptaudit=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getFg_updateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_update");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getId_psn_deptauditCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_psn_deptaudit");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("科室审核人id"); 
		return column;
	}
	/**
	 * 获取科室审核时间表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getDt_deptauditCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Dt_deptaudit");
		column.setLength(16);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_psn_deptauditCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_psn_deptaudit");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("人员编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_psn_deptauditCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_psn_deptaudit");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("姓名"); 
		return column;
