...
package iih.bd.srv.itmsnd.d.desc;
 ...
 * 质控项目二级分类 DO 元数据信息
 */
public class ItmSndDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.itmsnd.d.ItmSndDO";
	public static final String CLASS_DISPALYNAME = "质控项目二级分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_qa_itm_snd";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_snd";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_sndADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_sndCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_snd");
		iBDDataInfoFldMap.put("pid","Id_fst");
