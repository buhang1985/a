...
package iih.nm.nhr.nmnurplc.d.desc;
 ...
 * 护理管理_政治面貌 DO 元数据信息
 */
public class NmNurPlcDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmnurplc.d.NmNurPlcDO";
	public static final String CLASS_DISPALYNAME = "护理管理_政治面貌";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NUR_PLC";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nur_plc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nur_plcADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_nur_plcADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nur_plcCDesc(tblDesc));
		tblDesc.add(getId_nur_plcCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nur_plcADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nur_plc",  getId_nur_plcCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_nur_plcCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nur_plc");
		column.setLength(20);
