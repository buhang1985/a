...
package iih.bd.mhi.hpregion.d.desc;
 ...
 * 医保产品_地区目录 DO 元数据信息
 */
public class HpRegionDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpregion.d.HpRegionDO";
	public static final String CLASS_DISPALYNAME = "医保产品_地区目录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mhi_region";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_region";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_regionADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_regionADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_regionCDesc(tblDesc));
		tblDesc.add(getId_regionCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_regionADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_region",  getId_regionCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("地区主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_regionCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_region");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("地区主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_region");
