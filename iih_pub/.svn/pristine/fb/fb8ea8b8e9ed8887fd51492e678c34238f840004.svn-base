 ...
 * ICU患者信息 DO 元数据信息
 */
public class PatientInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.icupatientcare.d.PatientInfoDO";
	public static final String CLASS_DISPALYNAME = "ICU患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_nu_icupatientinfo";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_patinfor";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_patinforADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_patinforCDesc(tblDesc));
