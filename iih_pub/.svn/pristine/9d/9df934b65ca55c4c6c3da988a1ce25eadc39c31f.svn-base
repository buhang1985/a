...
package iih.mc.po.settlebackrel.d.desc;
...
/**
 * 采购结算回冲关联关系表 DO 元数据信息
 */
public class SettleBackRelDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.po.settlebackrel.d.SettleBackRelDO";
	public static final String CLASS_DISPALYNAME = "采购结算回冲关联关系表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_BANL_IN_REL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_settleinrel";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_settleinrelADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_settleinrelADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_settleinrelCDesc(tblDesc));
		tblDesc.add(getId_settleinrelCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_settleinrelADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_settleinrel",  getId_settleinrelCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_settleinrelCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_settleinrel");
		column.setLength(20);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_settleinrel");
