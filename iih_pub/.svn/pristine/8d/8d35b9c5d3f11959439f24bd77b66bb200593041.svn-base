 ...
 * 安徽医保交易记录 DO 元数据信息
 */
public class HpTransActAhDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.hp.hptransactah.d.HpTransActAhDO";
	public static final String CLASS_DISPALYNAME = "安徽医保交易记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "hp_transact_neusoft_ah";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_transactneusoftah";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_transactneusoftahADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_transactneusoftahCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_transactneusoftah");
