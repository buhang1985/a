...
public class CiMrRecallDO extends BaseDO {
	...
	public static final String ID_PSN_DEPTAUDIT= "Id_psn_deptaudit";
	public static final String DT_DEPTAUDIT= "Dt_deptaudit";
	...
	public static final String CODE_PSN_DEPTAUDIT= "Code_psn_deptaudit";
	public static final String NAME_PSN_DEPTAUDIT= "Name_psn_deptaudit";
	...
	public String getId_psn_deptaudit() {
		return ((String) getAttrVal("Id_psn_deptaudit"));
	}	
	public void setId_psn_deptaudit(String Id_psn_deptaudit) {
		setAttrVal("Id_psn_deptaudit", Id_psn_deptaudit);
	}
	public FDateTime getDt_deptaudit() {
		return ((FDateTime) getAttrVal("Dt_deptaudit"));
	}	
	public void setDt_deptaudit(FDateTime Dt_deptaudit) {
		setAttrVal("Dt_deptaudit", Dt_deptaudit);
	}
	...
	public String getCode_psn_deptaudit() {
		return ((String) getAttrVal("Code_psn_deptaudit"));
	}	
	public void setCode_psn_deptaudit(String Code_psn_deptaudit) {
		setAttrVal("Code_psn_deptaudit", Code_psn_deptaudit);
	}
	public String getName_psn_deptaudit() {
		return ((String) getAttrVal("Name_psn_deptaudit"));
	}	
	public void setName_psn_deptaudit(String Name_psn_deptaudit) {
		setAttrVal("Name_psn_deptaudit", Name_psn_deptaudit);
	}
