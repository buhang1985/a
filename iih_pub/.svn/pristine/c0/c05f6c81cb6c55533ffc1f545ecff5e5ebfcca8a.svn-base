...
package iih.bd.mhi.hptreat.d.desc;
 ...
 * 医保产品_诊疗项目 DO 元数据信息
 */
public class HpTreatDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hptreat.d.HpTreatDO";
	public static final String CLASS_DISPALYNAME = "医保产品_诊疗项目";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_TREAT";
