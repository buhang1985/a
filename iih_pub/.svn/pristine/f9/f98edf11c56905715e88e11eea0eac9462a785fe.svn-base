package iih.ci.mr.middle.nmr.d;
 ...
 * 
 */
public class CiMrMiddleNmrDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_CI_MR_MIDDLE_NMR= "Id_ci_mr_middle_nmr";
	...
	public String getId_ci_mr_middle_nmr() {
		return ((String) getAttrVal("Id_ci_mr_middle_nmr"));
	}	
	public void setId_ci_mr_middle_nmr(String Id_ci_mr_middle_nmr) {
		setAttrVal("Id_ci_mr_middle_nmr", Id_ci_mr_middle_nmr);
	}
	...
	public String getValue_text() {
		return ((String) getAttrVal("Value_text"));
	}	
	public void setValue_text(String Value_text) {
		setAttrVal("Value_text", Value_text);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_ci_mr_middle_nmr";
	}
	
	@Override
	public String getTableName() {	  
		return "ci_mr_middle_nmr";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiMrMiddleNmrDODesc.class);
	}
