...
import iih.pe.pqn.peqatp.d.desc.PeQaTpDefDODesc;
 ...
 * 
 */
public class PeQaTpDefDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "pe_qn_peqatpdef";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PeQaTpDefDODesc.class);
	}
