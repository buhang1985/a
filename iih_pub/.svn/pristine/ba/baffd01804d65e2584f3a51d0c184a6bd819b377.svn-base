...
public class OrdSrvMmDODesc extends DODesc {
	...
	private IAttrDesc getId_herbpreparationtpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM a0b2","id_mm=id_mm","id_herbpreparationtp"});
		attrDesc.setRefType(true);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSd_herbpreparationtpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM a0b2","id_mm=id_mm","sd_herbpreparationtp"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_unit_curADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_measdoc a0b16","id_medu_cur=id_measdoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
