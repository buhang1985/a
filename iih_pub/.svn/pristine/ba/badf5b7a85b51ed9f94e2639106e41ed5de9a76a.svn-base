...
package iih.bd.pp.hpdidict.d.desc;
 ...
 * 医保诊断 DO 元数据信息
 */
public class HpDiDictDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.hpdidict.d.HpDiDictDO";
	public static final String CLASS_DISPALYNAME = "医保诊断";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_hp_di_dict";
