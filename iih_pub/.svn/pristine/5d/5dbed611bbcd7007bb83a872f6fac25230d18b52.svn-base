...
package iih.mi.bd.miudidoc.d.desc;
 ...
 * 医保档案 DO 元数据信息
 */
public class MiUdidocDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.bd.miudidoc.d.MiUdidocDO";
	public static final String CLASS_DISPALYNAME = "医保档案";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mi_udidoc";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_miudidoc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_miudidocADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_miudidocCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_miudidoc");
