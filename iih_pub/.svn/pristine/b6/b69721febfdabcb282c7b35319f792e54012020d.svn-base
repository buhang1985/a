...
package iih.sfda.aer.aerevwarn.d.desc;
 ...
 * 事件更新提醒 DO 元数据信息
 */
public class AerEvWarnDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.aer.aerevwarn.d.AerEvWarnDO";
	public static final String CLASS_DISPALYNAME = "事件更新提醒";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_AER_EV_WARN";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_aer_ev_warn";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_aer_ev_warnADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_aer_ev_warnADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_aer_ev_warnCDesc(tblDesc));
		tblDesc.add(getId_aer_ev_warnCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_aer_ev_warnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_aer_ev_warn",  getId_aer_ev_warnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("事件提醒标识");
	 ...
	 * @return
	 */
	private IColumnDesc getId_aer_ev_warnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_aer_ev_warn");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("事件提醒标识"); 
		return column;
	}
	/**
	 * 获取事件标识表列元数据
