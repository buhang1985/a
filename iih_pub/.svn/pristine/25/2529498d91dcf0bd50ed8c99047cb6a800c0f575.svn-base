...
package iih.pe.pbd.peappttladder.d.desc;
 ...
 * 体检预约时间段定义 DO 元数据信息
 */
public class PeAppttLadderDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pbd.peappttladder.d.PeAppttLadderDO";
	public static final String CLASS_DISPALYNAME = "体检预约时间段定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_bd_peappttladder";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_peappttladder";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_peappttladderADesc(tblDesc));
		...
		this.add(getPsnlimitADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_peappttladderCDesc(tblDesc));
		...
		tblDesc.add(getPsnlimitCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getPsnlimitADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Psnlimit",  getPsnlimitCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("开放人数");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getPsnlimitCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Psnlimit");
		column.setLength(10);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("开放人数"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_peappttladder");
