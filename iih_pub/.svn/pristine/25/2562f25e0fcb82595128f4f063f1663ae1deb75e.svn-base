...
/**
 * 健康评估模型_缺血性冠心病_总胆固醇 DO数据 
 * 
 */
public class PeIcdvModelTcDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//缺血性冠心病评估模型总胆固醇主键标识
	public static final String ID_PEICDVMODELTC= "Id_peicdvmodeltc";
	//缺血性冠心病ID
	 ...
	 * @return String
	 */
	public String getId_peicdvmodeltc() {
		return ((String) getAttrVal("Id_peicdvmodeltc"));
	}	
	/**
	 * 缺血性冠心病评估模型总胆固醇主键标识
	 * @param Id_peicdvmodeltc
	 */
	public void setId_peicdvmodeltc(String Id_peicdvmodeltc) {
		setAttrVal("Id_peicdvmodeltc", Id_peicdvmodeltc);
	}
	/**
	 * 缺血性冠心病ID
	 * @return String
...
//	}
	...
	public String getPKFieldName() {
		return "Id_peicdvmodeltc";
	}
	
	@Override
	public String getTableName() {	  
		return "pe_qn_peicdvmodeltc";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PeIcdvModelTcDODesc.class);
	}
