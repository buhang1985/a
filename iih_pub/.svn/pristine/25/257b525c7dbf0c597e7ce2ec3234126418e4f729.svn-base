 ...
 * 会议参与人员 DO 元数据信息
 */
public class NomMeetPsnDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nom.nommeet.d.NomMeetPsnDO";
	public static final String CLASS_DISPALYNAME = "会议参与人员";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NOM_MEET_PSN";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_nom_meet_psn";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nom_meet_psnADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_nom_meetADesc(tblDesc));
		this.add(getId_nom_meet_psnADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nom_meet_psnCDesc(tblDesc));
		tblDesc.add(getId_nom_meet_psnCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nom_meet_psnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nom_meet_psn",  getId_nom_meet_psnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("会议参与人员主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_nom_meet_psnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nom_meet_psn");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("会议参与人员主键"); 
		return column;
	}
	/**
	 * 获取会议主键表列元数据
