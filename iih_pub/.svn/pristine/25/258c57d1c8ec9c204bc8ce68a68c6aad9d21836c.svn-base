 ...
 * 住院发票明细 DO 元数据信息
 */
public class BlIncItmIpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.inc.blincip.d.BlIncItmIpDO";
	public static final String CLASS_DISPALYNAME = "住院发票明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_inc_itm_ip";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_incitmip";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_incitmipADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_incipADesc(tblDesc));
		this.add(getId_incitmipADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_incitmipCDesc(tblDesc));
		tblDesc.add(getId_incitmipCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_incitmipADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_incitmip",  getId_incitmipCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_incitmipCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_incitmip");
		column.setLength(20);
