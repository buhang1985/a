...
package iih.mi.mibd.medtp.d.desc;
 ...
 * 医疗类型 DO 元数据信息
 */
public class MedTpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.medtp.d.MedTpDO";
	public static final String CLASS_DISPALYNAME = "医疗类型";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_MEDTP";
