...
public class IEPharmWcOrDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getXy_zcy_order_seq_num() {
		return ((String) getAttrVal("Xy_zcy_order_seq_num"));
	}	
	/**
	 * 医嘱序号
	 * @param Xy_zcy_order_seq_num
	 */
	public void setXy_zcy_order_seq_num(String Xy_zcy_order_seq_num) {
		setAttrVal("Xy_zcy_order_seq_num", Xy_zcy_order_seq_num);
	}
	/**
	 * 就诊流水号
	 * @return String
	 */
	public String getXy_zcy_visit_ord_no() {
		return ((String) getAttrVal("Xy_zcy_visit_ord_no"));
	}	
	/**
	 * 就诊流水号
	 * @param Xy_zcy_visit_ord_no
	 */
	public void setXy_zcy_visit_ord_no(String Xy_zcy_visit_ord_no) {
		setAttrVal("Xy_zcy_visit_ord_no", Xy_zcy_visit_ord_no);
	}
	/**
	 * 就诊类别编码
	 * @return String
	 */
	public String getXy_zcy_visit_type_code() {
		return ((String) getAttrVal("Xy_zcy_visit_type_code"));
	}	
	/**
	 * 就诊类别编码
	 * @param Xy_zcy_visit_type_code
	 */
	public void setXy_zcy_visit_type_code(String Xy_zcy_visit_type_code) {
		setAttrVal("Xy_zcy_visit_type_code", Xy_zcy_visit_type_code);
	}
	/**
	 * 就诊类别名称
	 * @return String
	 */
	public String getXy_zcy_visit_type_name() {
		return ((String) getAttrVal("Xy_zcy_visit_type_name"));
	}	
	/**
	 * 就诊类别名称
	 * @param Xy_zcy_visit_type_name
	 */
	public void setXy_zcy_visit_type_name(String Xy_zcy_visit_type_name) {
		setAttrVal("Xy_zcy_visit_type_name", Xy_zcy_visit_type_name);
	}
	/**
	 * 医嘱时间类型编码
	 * @return String
	 */
	public String getXy_zcy_ord_date_type_code() {
		return ((String) getAttrVal("Xy_zcy_ord_date_type_code"));
	}	
	/**
	 * 医嘱时间类型编码
	 * @param Xy_zcy_ord_date_type_code
	 */
	public void setXy_zcy_ord_date_type_code(String Xy_zcy_ord_date_type_code) {
		setAttrVal("Xy_zcy_ord_date_type_code", Xy_zcy_ord_date_type_code);
	}
	/**
	 * 医嘱时间类型名称
	 * @return String
	 */
	public String getXy_zcy_ord_date_type_name() {
		return ((String) getAttrVal("Xy_zcy_ord_date_type_name"));
	}	
	/**
	 * 医嘱时间类型名称
	 * @param Xy_zcy_ord_date_type_name
	 */
	public void setXy_zcy_ord_date_type_name(String Xy_zcy_ord_date_type_name) {
		setAttrVal("Xy_zcy_ord_date_type_name", Xy_zcy_ord_date_type_name);
	}
	/**
	 * 药物名称 
	 * @return String
	 */
	public String getXy_zcy_yw_name() {
		return ((String) getAttrVal("Xy_zcy_yw_name"));
	}	
	/**
	 * 药物名称 
	 * @param Xy_zcy_yw_name
	 */
	public void setXy_zcy_yw_name(String Xy_zcy_yw_name) {
		setAttrVal("Xy_zcy_yw_name", Xy_zcy_yw_name);
	}
	/**
	 * 医嘱组号
	 * @return String
	...
	public String getOrder_group_id() {
		return ((String) getAttrVal("Order_group_id"));
	}	
	/**
	 * 医嘱组号
	 * @param Order_group_id
	 */
	public void setOrder_group_id(String Order_group_id) {
		setAttrVal("Order_group_id", Order_group_id);
	}
}