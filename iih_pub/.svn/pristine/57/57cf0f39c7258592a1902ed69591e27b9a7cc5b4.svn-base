 ...
 * 常规医嘱关联服务 DO 元数据信息
 */
public class RegularOrRelSrvDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.ortpl.d.RegularOrRelSrvDO";
	public static final String CLASS_DISPALYNAME = "常规医嘱关联服务";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_regularor_rel";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_regularorrel";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_regularorrelADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_regularorrelADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_regularorrelCDesc(tblDesc));
		tblDesc.add(getId_regularorrelCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_regularorrelADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_regularorrel",  getId_regularorrelCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("常规医嘱关联服务主键标识");
	...
	private IAttrDesc getCode_caADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv_regularor_ca a0b3","id_regularorca=id_regularorca","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_caADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv_regularor_ca a0b3","id_regularorca=id_regularorca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_regularorrelCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_regularorrel");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("常规医嘱关联服务主键标识"); 
		return column;
	}
	/**
	 * 获取常规医嘱分类表列元数据
