 ...
 * 病危(病重)患者信息 DO 元数据信息
 */
public class TchoIllPatientDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.ha.tcho.tchoillpatientcare.d.TchoIllPatientDO";
	public static final String CLASS_DISPALYNAME = "病危(病重)患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "nmr_ha_tcho_illpat";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_illpat";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_illpatADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_illpatCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_illpat");
