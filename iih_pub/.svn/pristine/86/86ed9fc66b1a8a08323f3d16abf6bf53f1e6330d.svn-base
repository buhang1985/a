...
package iih.bd.mhi.admstatus.d.desc;
...
public class AdmStatusDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.admstatus.d.AdmStatusDO";
	public static final String CLASS_DISPALYNAME = "入院状态";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_ADMSTATUS";
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_admstatus");
