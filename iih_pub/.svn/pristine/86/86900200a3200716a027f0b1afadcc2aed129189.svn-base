 ...
 * 
 */
public class MpRefundChargeSetDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getEu_rfdmode() {
		return ((String) getAttrVal("Eu_rfdmode"));
	}
	/**
	 * 退记账模式
	 * @param Eu_rfdmode
	 */
	public void setEu_rfdmode(String Eu_rfdmode) {
		setAttrVal("Eu_rfdmode", Eu_rfdmode);
	}
}