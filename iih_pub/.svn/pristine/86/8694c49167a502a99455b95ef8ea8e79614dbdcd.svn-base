...
public class IEOpRisOrEnDTO extends BaseDTO {
	...
	public String getMain_suit() {
		return ((String) getAttrVal("Main_suit"));
	}	
	/**
	 * 主诉
	 * @param Main_suit
	...
	public void setMain_suit(String Main_suit) {
		setAttrVal("Main_suit", Main_suit);
	}
	/**
	 * 现病史
	 * @return String
	 */
	public String getNow_diease() {
		return ((String) getAttrVal("Now_diease"));
	}	
	/**
	 * 现病史
	 * @param Now_diease
	 */
	public void setNow_diease(String Now_diease) {
		setAttrVal("Now_diease", Now_diease);
	}
	/**
	 * 健康卡号
	 * @return String
	 ...
	 * @return FArrayList2
	 */
	public FArrayList2 getId_contacters() {
		return ((FArrayList2) getAttrVal("Id_contacters"));
	}	
	/**
	 * 联系人集合
	 * @param Id_contacters
	 */
	public void setId_contacters(FArrayList2 Id_contacters) {
		setAttrVal("Id_contacters", Id_contacters);
	}
	/**
	 * 交互类型
	 * @return String
