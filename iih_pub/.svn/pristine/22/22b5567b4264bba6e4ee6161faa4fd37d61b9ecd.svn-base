...
import iih.hr.hsc.hscschedweek.d.desc.HscSchedWeekDODesc;
 ...
 * 
 */
public class HscSchedWeekDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_hsc_sched_week";
	}
	
	@Override
	public String getTableName() {	  
		return "HR_HSC_SCHED_WEEK";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HscSchedWeekDODesc.class);
	}
