...
/**
 * 健康评估模型_糖尿病_腰围 DO 元数据信息
 */
public class PeDiabModelWaistDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pqn.pediabmodel.d.PeDiabModelWaistDO";
	public static final String CLASS_DISPALYNAME = "健康评估模型_糖尿病_腰围";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_qn_pediabmodelwaist";
	public static final String TABLE_ALIAS_NAME = "a5";
	public static final String PRIMARYKEY_FIELDNAME="Id_pediabmodelwaist";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pediabmodelwaistADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_pediabmodelADesc(tblDesc));
		this.add(getId_pediabmodelwaistADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pediabmodelwaistCDesc(tblDesc));
		tblDesc.add(getId_pediabmodelwaistCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_pediabmodelwaistADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pediabmodelwaist",  getId_pediabmodelwaistCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("糖尿病模型腰围主键标识");
	 ...
	 * @return
	 */
	private IColumnDesc getId_pediabmodelwaistCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pediabmodelwaist");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("糖尿病模型腰围主键标识"); 
		return column;
	}
	/**
	 * 获取糖尿病模型ID表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pediabmodelwaist");
	}
