...
* 对照分类数据维护服务
*/
public interface IHealthsystemCudService {
	/**
	*  对照分类数据真删除
	*/
	...
	*/
	 ...
	 */
	public ContrastClassifyDO[] enableWithoutFilter(ContrastClassifyDO[] dos) throws BizException ;

	/**
	 * 批量启用：可部分启用成功；
	 * 启用成功的记录可通过返回值的getDos方法得到，启用不成功的记录附加日志可通过返回值的getErrLogList方法得到
	 */
	public DOWithErrLog enableDO(ContrastClassifyDO[] dos) throws BizException ;

	/**
	 * 批量停用：要不全部都停用；或者出现异常，停用全部失败
	 */
	public ContrastClassifyDO[] disableVOWithoutFilter(ContrastClassifyDO[] dos) throws BizException;
	 ...
	 */
	public DOWithErrLog disableDO(ContrastClassifyDO[] dos) throws BizException ;
}
