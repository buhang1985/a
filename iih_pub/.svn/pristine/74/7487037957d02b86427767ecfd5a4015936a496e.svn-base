 ...
 * 付款策略_费用包 DO 元数据信息
 */
public class BdPriPkgDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.bdpripkg.d.BdPriPkgDO";
	public static final String CLASS_DISPALYNAME = "付款策略_费用包";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_pri_pkg";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pripkg";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pripkgADesc(tblDesc));
		...
		this.add(getRate_defaultADesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getRate_defaultADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Rate_default",  getRate_defaultCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("调价计算比例");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getRate_defaultCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Rate_default");
		column.setLength(12);
        column.setPrecision(4);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("调价计算比例"); 
		return column;
	}
	/**
	 * 获取创建人表列元数据
