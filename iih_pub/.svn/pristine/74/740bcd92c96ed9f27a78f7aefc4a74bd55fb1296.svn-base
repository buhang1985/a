...
package iih.pe.pitm.pechinesedris.d.desc;
...
/**
 * 体检中国居民膳食营养素参考日摄入量 DO 元数据信息
 */
public class PeChineseDRISDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.pitm.pechinesedris.d.PeChineseDRISDO";
	public static final String CLASS_DISPALYNAME = "体检中国居民膳食营养素参考日摄入量";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_itm_pechinesedris";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pechinesedris";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pechinesedrisADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pechinesedrisADesc(tblDesc));
		this.add(getId_pechinesedris_parADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pechinesedrisCDesc(tblDesc));
		tblDesc.add(getId_pechinesedrisCDesc(tblDesc));
		tblDesc.add(getId_pechinesedris_parCDesc(tblDesc));
	...
	/**
	 * 体检膳食营养素参考日摄入量主键标识属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getId_pechinesedrisADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pechinesedris",  getId_pechinesedrisCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检膳食营养素参考日摄入量主键标识");
	...
	/**
	 * 体检膳食营养素参考日摄入量父ID属性元数据
	 * @param tblDesc
	 * @return
	 */
	private IAttrDesc getId_pechinesedris_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pechinesedris_par",  getId_pechinesedris_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检膳食营养素参考日摄入量父ID");
	...
	/**
	 * 获取体检膳食营养素参考日摄入量主键标识表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_pechinesedrisCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pechinesedris");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("体检膳食营养素参考日摄入量主键标识"); 
		return column;
	}
	/**
	 * 获取体检膳食营养素参考日摄入量父ID表列元数据
	 * @param tblDesc
	 * @return
	 */
	private IColumnDesc getId_pechinesedris_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pechinesedris_par");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("体检膳食营养素参考日摄入量父ID"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pechinesedris");
		iBDDataInfoFldMap.put("pid","Id_pechinesedris_par");
