...
public class ContagionDODesc extends DODesc {
	...
	private void init(){		
		...
		this.add(getId_dep_submitADesc(tblDesc));
		this.add(getEmp_audit_codeADesc(tblDesc));
		this.add(getEmp_audit_nameADesc(tblDesc));
		this.add(getCode_crbflADesc(tblDesc));
		this.add(getName_crbflADesc(tblDesc));
		...
		this.add(getCode_emp_auditADesc(tblDesc));
		this.add(getCode_dep_auditADesc(tblDesc));
		this.add(getName_dep_auditADesc(tblDesc));
		this.add(getCode_dep_submitADesc(tblDesc));
		this.add(getName_dep_submitADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getId_dep_submitCDesc(tblDesc));
		tblDesc.add(getEmp_audit_codeCDesc(tblDesc));
		tblDesc.add(getEmp_audit_nameCDesc(tblDesc));
		tblDesc.add(getCode_crbflCDesc(tblDesc));
		tblDesc.add(getName_crbflCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_dep_submitADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_dep_submit",  getId_dep_submitCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_crbflADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_crbfl",  getCode_crbflCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("传染病分类code");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_crbflADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_crbfl",  getName_crbflCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("传染病分类name");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getRef_des_eu_jlcrbADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Ref_des_eu_jlcrb",  getRef_des_eu_jlcrbCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b14","eu_jlcrb=id_udidoc","des"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getRef_des_eu_ylcrbADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Ref_des_eu_ylcrb",  getRef_des_eu_ylcrbCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标准编码描述");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b15","eu_ylcrb=id_udidoc","des"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getRef_des_eu_blcrbADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Ref_des_eu_blcrb",  getRef_des_eu_blcrbCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标准编码描述");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b12","eu_blcrb=id_udidoc","des"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getOther_diseases_desADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Other_diseases_des",  getOther_diseases_desCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标准编码描述");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b19","id_other_diseases=id_udidoc","des"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getProvince_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a0b4","id_province=id_mr_area","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getProvince_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a0b4","id_province=id_mr_area","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getBirth_place_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a0b20","residence_addr=id_mr_area","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getBirth_place_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mr_area a0b20","residence_addr=id_mr_area","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_emp_auditADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sys_user a0b24","id_emp_audit=id_user","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_emp_auditADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_emp_audit",  getCode_emp_auditCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sys_user a0b24","id_emp_audit=id_user","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_dep_auditADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b25","id_dep_audit=id_dep","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_dep_auditADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b25","id_dep_audit=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getCode_dep_submitADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_dep_submit",  getCode_dep_submitCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b26","id_dep_submit=id_dep","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_dep_submitADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_dep_submit",  getName_dep_submitCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b26","id_dep_submit=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_dep_submitCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_dep_submit");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_crbflCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_crbfl");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("传染病分类code"); 
		return column;
	}
	/**
	 * 获取传染病分类name表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_crbflCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_crbfl");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("传染病分类name"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getRef_des_eu_jlcrbCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Ref_des_eu_jlcrb");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getRef_des_eu_ylcrbCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Ref_des_eu_ylcrb");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标准编码描述"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getRef_des_eu_blcrbCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Ref_des_eu_blcrb");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标准编码描述"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getOther_diseases_desCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Other_diseases_des");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标准编码描述"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getCode_emp_auditCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_emp_audit");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_dep_submitCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_dep_submit");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("编码"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_dep_submitCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_dep_submit");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
