...
package iih.bd.pp.prisrvsetmu.d.desc;
 ...
 * 服务套数量加收 DO 元数据信息
 */
public class PriSrvSetMuDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.prisrvsetmu.d.PriSrvSetMuDO";
	public static final String CLASS_DISPALYNAME = "服务套数量加收";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_pri_srv_setmu";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_prisrvsetmu";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_prisrvsetmuADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_prisrvsetmuADesc(tblDesc));
		this.add(getId_srvsetADesc(tblDesc));
		this.add(getSortnoADesc(tblDesc));
		this.add(getQuan_minADesc(tblDesc));
		this.add(getQuan_maxADesc(tblDesc));
		this.add(getId_srvaddADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_prisrvsetmuCDesc(tblDesc));
		tblDesc.add(getId_prisrvsetmuCDesc(tblDesc));
		tblDesc.add(getId_srvsetCDesc(tblDesc));
		tblDesc.add(getSortnoCDesc(tblDesc));
		tblDesc.add(getQuan_minCDesc(tblDesc));
		tblDesc.add(getQuan_maxCDesc(tblDesc));
		tblDesc.add(getId_srvaddCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_prisrvsetmuADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_prisrvsetmu",  getId_prisrvsetmuCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("服务套数量加收主键");
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvaddADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvadd",  getId_srvaddCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getSrv_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b2","id_srvadd=id_srv","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSrv_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a0b2","id_srvadd=id_srv","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_prisrvsetmuCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_prisrvsetmu");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("服务套数量加收主键"); 
		return column;
	}
	/**
	 * 获取服务套项目表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvaddCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvadd");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
