...
public class DiagDefRefModel extends RefGridModel {
...
//		wherePartBuilder.append(" (");
//		wherePartBuilder.append("lower(").append(this.getTableName()).append(".Name) like '%");
//		wherePartBuilder.append(blurValue + "%'");
//
//		wherePartBuilder.append(" or ");
//		wherePartBuilder.append("lower(").append(this.getTableName()).append(".Code) like '");
//		wherePartBuilder.append(blurValue + "%'");
//
//		wherePartBuilder.append(" or ");
//		wherePartBuilder.append("lower(").append(this.getTableName()).append(".Mnecode) like '");
//		wherePartBuilder.append(blurValue + "%'");
//
//		if ("1".equals(sd_inputmethod.substring(1))) {
//			wherePartBuilder.append(" or ");
//			wherePartBuilder.append("lower(").append(this.getTableName()).append(".Pycode) like '");
//			wherePartBuilder.append(blurValue + "%'");
//		}
//
//		if (sd_inputmethod.startsWith("1")) {
//			wherePartBuilder.append(" or ");
//			wherePartBuilder.append("lower(").append(this.getTableName()).append(".Wbcode) like '");
//			wherePartBuilder.append(blurValue + "%'");
//		}
//
//		wherePartBuilder.append(") ");
	...
	public String getRefSql() {
		/*
		 * String wherePart = ""; String dis=(String)
		 * this.getExtendAttributeValue("Dis"); if(dis!=null && !dis.equals("")){
		 * wherePart+="id_didef in ("+dis+")"; } if(wherePart!=null &&
		 * !wherePart.equals("")){ this.addWherePart(wherePart); } String sql = null;
		 * try { sql = super.getRefSql(); sql = sql; } finally {
		...
		str.append("left join bd_cdsys bd_cdsys on bd_cdsys.id_cdsys = bd_di_def.id_cdsys ");
...
//		str.append("nvl(bsw.cnt,0),length(bd_di_def.Name),bd_di_def.Name desc ");
		str.append("length(bd_di_def.Name),bd_di_def.Name desc ");
