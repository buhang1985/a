 ...
 * 
 */
public class CiOrdQryItemDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getEu_verify_pharm() {
		return ((String) getAttrVal("Eu_verify_pharm"));
	}
	/**
	 * 药师审核状态
	 * @param Eu_verify_pharm
	 */
	public void setEu_verify_pharm(String Eu_verify_pharm) {
	 ...
	 * @return String
	 */
	public String getEu_hpindicjudge() {
		return ((String) getAttrVal("Eu_hpindicjudge"));
	}
	/**
	 * 医保适应症判断标识枚举
	 * @param Eu_hpindicjudge
	 */
	public void setEu_hpindicjudge(String Eu_hpindicjudge) {
	 ...
	 * @return String
	 */
	public String getEu_uncporjudge() {
		return ((String) getAttrVal("Eu_uncporjudge"));
	}
	/**
	 * 非径内医嘱判断标识枚举
	 * @param Eu_uncporjudge
	 */
	public void setEu_uncporjudge(String Eu_uncporjudge) {
	 ...
	 * @return String
	 */
	public String getEu_feereversetp() {
		return ((String) getAttrVal("Eu_feereversetp"));
	}
	/**
	 * 费用冲账类型
	 * @param Eu_feereversetp
	 */
	public void setEu_feereversetp(String Eu_feereversetp) {
	 ...
	 * @return FDouble
	 */
	public FDouble getAcount_amount() {
		return ((FDouble) getAttrVal("Acount_amount"));
	}
	/**
	 * 记账金额
	 * @param Acount_amount
	 */
	public void setAcount_amount(FDouble Acount_amount) {
		setAttrVal("Acount_amount", Acount_amount);
	}
	/**
	 * 患者姓名
	 * @return String
