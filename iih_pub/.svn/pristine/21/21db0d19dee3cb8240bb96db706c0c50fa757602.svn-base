 ...
 * 体检健康管理群体定义 DO 元数据信息
 */
public class PeHmGroupDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.phm.pehmgroup.d.PeHmGroupDO";
	public static final String CLASS_DISPALYNAME = "体检健康管理群体定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_hm_pehmgroup";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pehmgroup";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pehmgroupADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_pehmgroupADesc(tblDesc));
		this.add(getId_pehmgroup_parADesc(tblDesc));
		...
		this.add(getFg_riskruleADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pehmgroupCDesc(tblDesc));
		tblDesc.add(getId_pehmgroupCDesc(tblDesc));
		tblDesc.add(getId_pehmgroup_parCDesc(tblDesc));
		...
		tblDesc.add(getFg_riskruleCDesc(tblDesc));
	...
	private IAttrDesc getId_pehmgroupADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("体检健康群体定义主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getId_pehmgroup_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_pehmgroup_par",  getId_pehmgroup_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体检健康群体定义父ID");
	 ...
	 * @return
	 */
	private IAttrDesc getFg_riskruleADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_riskrule",  getFg_riskruleCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("规则检索标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getCode_ruleADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_hm_riskrule a0b7","id_riskrule=id_riskrule","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_ruleADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_hm_riskrule a0b7","id_riskrule=id_riskrule","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_pehmgroup_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_pehmgroup_par");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("体检健康群体定义父ID"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_riskruleCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_riskrule");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("规则检索标识"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pehmgroup");
		iBDDataInfoFldMap.put("pid","Id_pehmgroup_par");
