 ...
 * 交接班患者 DO 元数据信息
 */
public class HdvEntDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.nr.nurhdv.d.HdvEntDO";
	public static final String CLASS_DISPALYNAME = "交接班患者";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_hdv_ent";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hdv_ent";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hdv_entADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hdv_entCDesc(tblDesc));
