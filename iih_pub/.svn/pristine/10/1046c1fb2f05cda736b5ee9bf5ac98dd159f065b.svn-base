 ...
 * 文书采集记录 DO 元数据信息
 */
public class NmrCollDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.nmrcoll.d.NmrCollDO";
	public static final String CLASS_DISPALYNAME = "文书采集记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_DOC_COLL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nmr_doc_coll";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nmr_doc_collADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nmr_doc_collCDesc(tblDesc));
	...
	private IAttrDesc getName_docADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NMR_DOC a0b10","id_nmr_doc=id_nmr_doc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getId_setADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NMR_DOC a0b10","id_nmr_doc=id_nmr_doc","id_set"});
		attrDesc.setRefType(true);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getFun_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NMR_DOC a0b10","id_nmr_doc=id_nmr_doc","fun_code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
