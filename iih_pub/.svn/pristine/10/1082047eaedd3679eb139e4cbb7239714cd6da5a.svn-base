...
/**
 * 护理文书_移动_数据组 DO 元数据信息
 */
public class NmrDocMbdgDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.pkuf.nmrdocmbdg.d.NmrDocMbdgDO";
	public static final String CLASS_DISPALYNAME = "护理文书_移动_数据组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NMR_DOC_MBDG";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nmr_doc_mbdg";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nmr_doc_mbdgADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nmr_doc_mbdgCDesc(tblDesc));
	...
	private IAttrDesc getName_nmr_docADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("护理文书名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NMR_DOC a0b2","id_nmr_doc=id_nmr_doc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
