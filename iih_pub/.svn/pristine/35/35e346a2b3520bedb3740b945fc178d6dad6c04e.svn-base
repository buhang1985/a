 ...
 * 健康干预个人计划 DO 元数据信息
 */
public class PeIntervenePlanDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.phm.peinterveneplan.d.PeIntervenePlanDO";
	public static final String CLASS_DISPALYNAME = "健康干预个人计划";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_hm_peinterveneplan";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_peinterveneplan";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_peinterveneplanADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_peinterveneplanADesc(tblDesc));
		this.add(getId_peinterveneplan_parADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_peinterveneplanCDesc(tblDesc));
		tblDesc.add(getId_peinterveneplanCDesc(tblDesc));
		tblDesc.add(getId_peinterveneplan_parCDesc(tblDesc));
	...
	private IAttrDesc getId_peinterveneplanADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("健康干预个人计划主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getId_peinterveneplan_parADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_peinterveneplan_par",  getId_peinterveneplan_parCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("健康干预个人计划父ID");
	 ...
	 * @return
	 */
	private IColumnDesc getId_peinterveneplan_parCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_peinterveneplan_par");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("健康干预个人计划父ID"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_peinterveneplan");
		iBDDataInfoFldMap.put("pid","Id_peinterveneplan_par");
