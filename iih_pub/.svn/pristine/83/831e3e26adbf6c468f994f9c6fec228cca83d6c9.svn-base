 ...
 * 
 */
public class CiMrFpIntencareCataDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "CI_MR_FP_INTENCARE_CATA";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiMrFpIntencareCataDODesc.class);
	}
