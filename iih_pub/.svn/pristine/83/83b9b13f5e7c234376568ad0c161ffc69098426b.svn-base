 ...
 * 健康生活方式评估 DO 元数据信息
 */
public class PeHmLifestyleDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.phm.pehmlifestyle.d.PeHmLifestyleDO";
	public static final String CLASS_DISPALYNAME = "健康生活方式评估";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_hm_lifestyle";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_lifestyle";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_lifestyleADesc(tblDesc));
		...
		this.add(getAge_healthADesc(tblDesc));
		this.add(getAge_idealADesc(tblDesc));
		this.add(getAge_extendADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_lifestyleCDesc(tblDesc));
		...
		tblDesc.add(getAge_healthCDesc(tblDesc));
		tblDesc.add(getAge_idealCDesc(tblDesc));
		tblDesc.add(getAge_extendCDesc(tblDesc));
	...
	private IAttrDesc getId_lifestyleADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("健康生活方式评估主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getAge_healthADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Age_health",  getAge_healthCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("健康年龄");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAge_idealADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Age_ideal",  getAge_idealCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("理想年龄");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getAge_extendADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Age_extend",  getAge_extendCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FDouble);
		attrDesc.setLabel("延长年龄");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getCode_appraiserADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b6","appraiser=id_psndoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_appraiserADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b6","appraiser=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getAge_healthCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Age_health");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("健康年龄"); 
		return column;
	}
	/**
	 * 获取理想年龄表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAge_idealCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Age_ideal");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("理想年龄"); 
		return column;
	}
	/**
	 * 获取延长年龄表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getAge_extendCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Age_extend");
		column.setLength(16);
        column.setPrecision(2);
        column.setSqlType(Types.DECIMAL);
		column.setNullable(true);
		column.setLabel("延长年龄"); 
		return column;
	}
	/**
	 * 获取预约日期表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_lifestyle");
