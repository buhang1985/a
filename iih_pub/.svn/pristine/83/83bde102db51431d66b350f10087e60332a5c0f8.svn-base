 ...
 * 护理单元分类 DO 元数据信息
 */
public class NbdDepCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nbd.nbddepca.d.NbdDepCaDO";
	public static final String CLASS_DISPALYNAME = "护理单元分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NBD_DEP_CA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nbd_dep_ca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nbd_dep_caADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nbd_dep_caCDesc(tblDesc));
	...
	private IAttrDesc getName_parentADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("父级分类名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NBD_DEP_CA a0b4","id_parent=id_nbd_dep_ca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
