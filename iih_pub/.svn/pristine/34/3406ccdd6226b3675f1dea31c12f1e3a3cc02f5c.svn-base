 ...
 * 
 */
public class ObsPatinfoDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public FArrayList getApobsdtos() {
		return ((FArrayList) getAttrVal("Apobsdtos"));
	}	
	/**
	 * 申请单信息
	 * @param Apobsdtos
	 */
	public void setApobsdtos(FArrayList Apobsdtos) {
		setAttrVal("Apobsdtos", Apobsdtos);
	}
}