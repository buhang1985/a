...
public class DgDicDataParamBeanList implements Serializable{
	...
	private DgDicDataParamBean[] _dgDicDataParamBean;
	 ...
	 * @return
	 */
	public DgDicDataParamBean[] get_dgDicDataParamBean() {
		return _dgDicDataParamBean;
	}

	/**
	 * 药品字典信息
	 * @param _dgDicDataParamBean
	 */
	public void set_dgDicDataParamBean(DgDicDataParamBean[] _dgDicDataParamBean) {
		this._dgDicDataParamBean = _dgDicDataParamBean;
	}
}
