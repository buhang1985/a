package iih.pis.ivx.pisivxtrainee.d;
...
import iih.pis.ivx.pisivxtrainee.d.desc.PisIvxTraineeDODesc;
 ...
 * 
 */
public class PisIvxTraineeDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//微信培训生主键标识
	public static final String ID_PISIVXTRAINEE= "Id_pisivxtrainee";
	//微信账户ID
	...
	//账户类型
	public static final String ACCTP= "Acctp";
	 ...
	 * @return String
	 */
	public String getId_pisivxtrainee() {
		return ((String) getAttrVal("Id_pisivxtrainee"));
	}	
	/**
	 * 微信培训生主键标识
	 * @param Id_pisivxtrainee
	 */
	public void setId_pisivxtrainee(String Id_pisivxtrainee) {
		setAttrVal("Id_pisivxtrainee", Id_pisivxtrainee);
	}
	/**
	 * 微信账户ID
	 * @return String
	...
	public Integer getAcctp() {
		return ((Integer) getAttrVal("Acctp"));
	}	
	/**
	 * 账户类型
	 * @param Acctp
...
//	}
	...
	public String getPKFieldName() {
		return "Id_pisivxtrainee";
	}
	
	@Override
	public String getTableName() {	  
		return "pis_ivx_trainee";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(PisIvxTraineeDODesc.class);
	}
