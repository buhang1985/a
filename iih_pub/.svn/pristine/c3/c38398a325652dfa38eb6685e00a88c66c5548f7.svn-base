...
package iih.bd.srv.mropgrouppowerdetail.d.desc;
...
/**
 * 病历业务组权限配置明细 DO 元数据信息
 */
public class MrOpGroupPowerDetailDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.mropgrouppowerdetail.d.MrOpGroupPowerDetailDO";
	public static final String CLASS_DISPALYNAME = "病历业务组权限配置明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_opgroup_power_detail";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Idmropgrouppowerdetail";
	 ...
	 * 无参构造函数
	 */
	public MrOpGroupPowerDetailDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getIdmropgrouppowerdetailADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getIdmropgrouppowerdetailADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getIdmropgrouppowerdetailCDesc(tblDesc));
		tblDesc.add(getIdmropgrouppowerdetailCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getIdmropgrouppowerdetailADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Idmropgrouppowerdetail",  getIdmropgrouppowerdetailCDesc(tblDesc), this);
	...
	private IAttrDesc getCode_deptADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a0b6","id_dept=id_dep","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_pwADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"mr_opgroup_power a0b7","idmropgrouppower=idmropgrouppower","name_pw"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCode_pwADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"mr_opgroup_power a0b7","idmropgrouppower=idmropgrouppower","code_pw"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getMrca_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mrca_ctm a0b8","id_mrca_ctm=id_mrcactm","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getMrca_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mrca_ctm a0b8","id_mrca_ctm=id_mrcactm","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_mrdeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"CI_MR_ELE_DE a0b10","id_de=id_mrde","name_mrde"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getValADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"CI_MR_ELE_DE a0b10","id_de=id_mrde","val"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getIdmropgrouppowerdetailCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Idmropgrouppowerdetail");
		column.setLength(50);
