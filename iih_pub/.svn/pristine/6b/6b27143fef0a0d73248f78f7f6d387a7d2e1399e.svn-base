...
public class OrdSrvDODesc extends DODesc {
	...
	private IAttrDesc getFg_propcADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("是否预防用药(flase治疗，true预防)");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_dep_whADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_dep a1b32","id_dep_wh=id_dep","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_researchprojectADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_rsc_project a1b36","id_researchproject=id_researchproject","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IColumnDesc getFg_propcCDesc(ITableDesc tblDesc){
        ...
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("是否预防用药(flase治疗，true预防)"); 
		return column;
	}
	/**
	 * 获取是否自备药表列元数据
	...
	private void setDefaultValueMap(){
		...
		defaultValueMap.put("Fg_skintest",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Id_skintest_skip_reason","~");
		defaultValueMap.put("Fg_skintest_rst",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Id_primd","~");
		defaultValueMap.put("Fg_hpindicjudged",0);
		...
		defaultValueMap.put("Fg_extdispense",new xap.mw.coreitf.d.FBoolean("N"));
		defaultValueMap.put("Id_pripat","~");
