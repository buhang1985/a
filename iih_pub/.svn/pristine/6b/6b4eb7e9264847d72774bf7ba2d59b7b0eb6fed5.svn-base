...
package iih.hr.hbd.psncontact.d.desc;
 ...
 * 人员联系人 DO 元数据信息
 */
public class HbdPsnContactDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hr.hbd.psncontact.d.HbdPsnContactDO";
	public static final String CLASS_DISPALYNAME = "人员联系人";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HR_HBD_PSN_CONTACT";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hbd_psn_contact";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hbd_psn_contactADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_hbd_psn_contactADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_psndocADesc(tblDesc));
		this.add(getName_contractADesc(tblDesc));
		...
		this.add(getFg_primADesc(tblDesc));
		...
		this.add(getName_contact_nurADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hbd_psn_contactCDesc(tblDesc));
		tblDesc.add(getId_hbd_psn_contactCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_psndocCDesc(tblDesc));
		tblDesc.add(getName_contractCDesc(tblDesc));
		...
		tblDesc.add(getFg_primCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hbd_psn_contactADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hbd_psn_contact",  getId_hbd_psn_contactCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("联系人主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getName_contractADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_contract",  getName_contractCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_primADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_prim",  getFg_primCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("主要联系人标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_contact_nurADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_contact_nur",  getName_contact_nurCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b3","id_conttp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_hbd_psn_contactCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hbd_psn_contact");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("联系人主键标识"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_contractCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_contract");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_primCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_prim");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("主要联系人标识"); 
		return column;
	}
	/**
	 * 获取登记人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_contact_nurCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_contact_nur");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
