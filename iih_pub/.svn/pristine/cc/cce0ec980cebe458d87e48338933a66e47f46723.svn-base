 ...
 * 调拨申请单明细 DO 元数据信息
 */
public class McTrReqApItemDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.pl.trrequestap.d.McTrReqApItemDO";
	public static final String CLASS_DISPALYNAME = "调拨申请单明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_TRAP_ITM";
