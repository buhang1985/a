...
package iih.bd.pp.hpmedkindah.d.desc;
 ...
 * 医疗类别字典 DO 元数据信息
 */
public class HpMedKindAhDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.hpmedkindah.d.HpMedKindAhDO";
	public static final String CLASS_DISPALYNAME = "医疗类别字典";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_hp_med_kind_ah";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpmedkindah";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpmedkindahADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_hpmedkindahADesc(tblDesc));
		...
		this.add(getFg_etADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hpmedkindahCDesc(tblDesc));
		tblDesc.add(getId_hpmedkindahCDesc(tblDesc));
		...
		tblDesc.add(getFg_etCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_hpmedkindahADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_hpmedkindah",  getId_hpmedkindahCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_etADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_et",  getFg_etCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
	 ...
	 * @return
	 */
	private IColumnDesc getId_hpmedkindahCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_hpmedkindah");
		column.setLength(20);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_etCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_et");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("急诊"); 
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpmedkindah");
