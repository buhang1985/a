...
/**
 * 医疗记录_护理文书分类 DO 元数据信息
 */
public class NurCustomcaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.nurcustomca.d.NurCustomcaDO";
	public static final String CLASS_DISPALYNAME = "医疗记录_护理文书分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_MR_NU_CA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mr_nu_ca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mr_nu_caADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mr_nu_caCDesc(tblDesc));
