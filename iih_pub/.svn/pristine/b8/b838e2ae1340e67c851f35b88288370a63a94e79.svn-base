 ...
 * 医疗记录_数据集 DO 元数据信息
 */
public class MedicalRecordSetDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nmr.common.medicrecord.d.MedicalRecordSetDO";
	public static final String CLASS_DISPALYNAME = "医疗记录_数据集";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_MR_SET";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mrset";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mrsetADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mrsetCDesc(tblDesc));
