...
package iih.bd.srv.notice.d.desc;
 ...
 * 医疗注意事项 DO 元数据信息
 */
public class MedNoticeDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.notice.d.MedNoticeDO";
	public static final String CLASS_DISPALYNAME = "医疗注意事项";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_notice";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_notice";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_noticeADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_noticeADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_noticecaADesc(tblDesc));
		this.add(getCodeADesc(tblDesc));
		this.add(getNameADesc(tblDesc));
		this.add(getId_cdsystpADesc(tblDesc));
		this.add(getSd_cdsystpADesc(tblDesc));
		this.add(getId_noticetpADesc(tblDesc));
		this.add(getSd_noticetpADesc(tblDesc));
		this.add(getId_srvcaADesc(tblDesc));
		this.add(getEu_reltpADesc(tblDesc));
		this.add(getId_srvADesc(tblDesc));
		this.add(getId_mmADesc(tblDesc));
		this.add(getWbcodeADesc(tblDesc));
		this.add(getPycodeADesc(tblDesc));
		this.add(getMnecodeADesc(tblDesc));
		this.add(getFg_patiADesc(tblDesc));
		this.add(getFg_orpsnADesc(tblDesc));
		this.add(getFg_mppsnADesc(tblDesc));
		this.add(getFg_blpsnADesc(tblDesc));
		...
		this.add(getName_cdsystpADesc(tblDesc));
		this.add(getName_noticetpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_noticeCDesc(tblDesc));
		tblDesc.add(getId_noticeCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_noticecaCDesc(tblDesc));
		tblDesc.add(getCodeCDesc(tblDesc));
		tblDesc.add(getNameCDesc(tblDesc));
		tblDesc.add(getId_cdsystpCDesc(tblDesc));
		tblDesc.add(getSd_cdsystpCDesc(tblDesc));
		tblDesc.add(getId_noticetpCDesc(tblDesc));
		tblDesc.add(getSd_noticetpCDesc(tblDesc));
		tblDesc.add(getId_srvcaCDesc(tblDesc));
		tblDesc.add(getEu_reltpCDesc(tblDesc));
		tblDesc.add(getId_srvCDesc(tblDesc));
		tblDesc.add(getId_mmCDesc(tblDesc));
		tblDesc.add(getWbcodeCDesc(tblDesc));
		tblDesc.add(getPycodeCDesc(tblDesc));
		tblDesc.add(getMnecodeCDesc(tblDesc));
		tblDesc.add(getFg_patiCDesc(tblDesc));
		tblDesc.add(getFg_orpsnCDesc(tblDesc));
		tblDesc.add(getFg_mppsnCDesc(tblDesc));
		tblDesc.add(getFg_blpsnCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_noticeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_notice",  getId_noticeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("注意事项主键");
	 ...
	 * @return
	 */
	private IAttrDesc getId_noticecaADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_noticeca",  getId_noticecaCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("注意事项分类");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_noticetpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_noticetp",  getId_noticetpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("注意事项类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_noticetpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_noticetp",  getSd_noticetpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("注意事项类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getEu_reltpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Eu_reltp",  getEu_reltpCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_patiADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_pati",  getFg_patiCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("患者注意");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_orpsnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_orpsn",  getFg_orpsnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("开单注意");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_mppsnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_mppsn",  getFg_mppsnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("执行注意");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getFg_blpsnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_blpsn",  getFg_blpsnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("收费注意");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_cdsystpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_cdsystp",  getName_cdsystpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
	 ...
	 * @return
	 */
	private IAttrDesc getName_noticetpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_noticetp",  getName_noticetpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b9","id_noticetp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_noticeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_notice");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("注意事项主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_noticecaCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_noticeca");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("注意事项分类"); 
		return column;
	}
	/**
	 * 获取编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_noticetpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_noticetp");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("注意事项类型"); 
		return column;
	}
	/**
	 * 获取注意事项类型编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_noticetpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_noticetp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("注意事项类型编码"); 
		return column;
	}
	/**
	 * 获取医疗服务分类表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getEu_reltpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Eu_reltp");
		column.setLength(50);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_patiCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_pati");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("患者注意"); 
		return column;
	}
	/**
	 * 获取开单注意表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_orpsnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_orpsn");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("开单注意"); 
		return column;
	}
	/**
	 * 获取执行注意表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_mppsnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_mppsn");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("执行注意"); 
		return column;
	}
	/**
	 * 获取收费注意表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getFg_blpsnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_blpsn");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("收费注意"); 
		return column;
	}
	/**
	 * 获取客户扩展字段1表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_cdsystpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_cdsystp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_noticetpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_noticetp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_notice");
