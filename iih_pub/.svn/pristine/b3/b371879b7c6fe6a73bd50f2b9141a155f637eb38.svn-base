...
package iih.mp.orm.instrumentca.d.desc;
 ...
 * 器械分类 DO 元数据信息
 */
public class InstrumentCaDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.orm.instrumentca.d.InstrumentCaDO";
	public static final String CLASS_DISPALYNAME = "器械分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MP_ORM_MMCA";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_omca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_omcaADesc(tblDesc));
		...
		this.add(getId_omtpADesc(tblDesc));
		this.add(getSd_omtpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_omcaCDesc(tblDesc));
		tblDesc.add(getId_omcaCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_omtpCDesc(tblDesc));
		tblDesc.add(getSd_omtpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_omtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_omtp",  getId_omtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手术物品类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_omtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_omtp",  getSd_omtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手术物品类型编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getTp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b4","id_omtp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getCa_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("父级分类");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"MP_ORM_MMCA a0b5","id_parent=id_omca","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_omtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_omtp");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("手术物品类型"); 
		return column;
	}
	/**
	 * 获取手术物品类型编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_omtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_omtp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("手术物品类型编码"); 
		return column;
	}
	/**
	 * 获取基本分类编码表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_omca");
