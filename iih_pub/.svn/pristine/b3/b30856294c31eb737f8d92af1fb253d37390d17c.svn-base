package iih.mm.st.stockaplrel.d;
...
import iih.mm.st.stockaplrel.d.desc.StockAplRelDODesc;
 ...
 * 
 */
public class StockAplRelDO extends BaseDO {
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(StockAplRelDODesc.class);
	}
