 ...
 * 事件属性项目 DO 元数据信息
 */
public class AdbdItmdocDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.adbd.adbditmdoc.d.AdbdItmdocDO";
	public static final String CLASS_DISPALYNAME = "事件属性项目";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_ADBD_ITMDOC";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_itmdoc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_itmdocADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_itmdoclistADesc(tblDesc));
		this.add(getId_itmdocADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_itmdocCDesc(tblDesc));
		tblDesc.add(getId_itmdocCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_itmdocADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_itmdoc",  getId_itmdocCDesc(tblDesc), this);
	...
	private IAttrDesc getName_parentADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("父级项目");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"SFDA_ADBD_ITMDOC a1b4","id_parent=id_itmdoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_itmdocCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_itmdoc");
		column.setLength(50);
