package iih.mi.biz.insureprop.ruraltmp.d;
 ...
 * 
 */
public class MiHpPropRuralIpTmpDO extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "mi_prop_arip_ruraltmp";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MiHpPropRuralIpTmpDODesc.class);
	}
