...
/**
 * 患者就诊_扩展_移动入科 DO 元数据信息
 */
public class EnMobAdmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.en.pv.inpatient.d.EnMobAdmDO";
	public static final String CLASS_DISPALYNAME = "患者就诊_扩展_移动入科";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "en_ext_mobile_adm";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ent_mobadm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ent_mobadmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_ent_mobadmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ent_mobadmCDesc(tblDesc));
		tblDesc.add(getId_ent_mobadmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_ent_mobadmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_ent_mobadm",  getId_ent_mobadmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("就诊移动入科主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_ent_mobadmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_ent_mobadm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("就诊移动入科主键"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_ent_mobadm");
		iBDDataInfoFldMap.put("pid","Id_ent_mobadm");
