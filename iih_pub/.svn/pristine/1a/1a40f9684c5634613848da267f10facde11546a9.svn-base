...
package iih.bd.mhi.hpmedorglevel.d.desc;
...
/**
 * 医保产品_医疗机构级别 DO 元数据信息
 */
public class HpMedorgLevelDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mhi.hpmedorglevel.d.HpMedorgLevelDO";
	public static final String CLASS_DISPALYNAME = "医保产品_医疗机构级别";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_MEDORGLEVEL";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_medorglevel";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_medorglevelADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_medorglevelADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_medorglevelCDesc(tblDesc));
		tblDesc.add(getId_medorglevelCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_medorglevelADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_medorglevel",  getId_medorglevelCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗机构级别主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_medorglevelCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_medorglevel");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医疗机构级别主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_medorglevel");
