...
public class CiMrPatInfoDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getResi_village() {
		return ((String) getAttrVal("Resi_village"));
	}
	/**
	 * 户籍地址-村
	 * @param Resi_village
	 */
	public void setResi_village(String Resi_village) {
		setAttrVal("Resi_village", Resi_village);
	}
	/**
	 * 户籍地址-门牌号
	 * @return String
	 */
	public String getResi_housenum() {
		return ((String) getAttrVal("Resi_housenum"));
	}
	/**
	 * 户籍地址-门牌号
	 * @param Resi_housenum
	 */
	public void setResi_housenum(String Resi_housenum) {
		setAttrVal("Resi_housenum", Resi_housenum);
	}
	/**
	 * 填卡日期
	 * @return FDateTime
	 ...
	 * @return String
	 */
	public FArrayList getLs_contagionmsg() {
		return ((FArrayList) getAttrVal("Ls_contagionmsg"));
	}	
	/**
	 * 传染病副卡消息
	 * @param Ls_patient
	 */
	public void setLs_contagionmsg(FArrayList Ls_contagionmsg) {
		setAttrVal("Ls_contagionmsg", Ls_contagionmsg);
	}
}