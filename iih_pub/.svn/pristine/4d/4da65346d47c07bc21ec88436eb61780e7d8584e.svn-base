 ...
 * 患者价格分类 DO 元数据信息
 */
public class PriPatDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.pripat.d.PriPatDO";
	public static final String CLASS_DISPALYNAME = "患者价格分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_pri_pat";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_pripat";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_pripatADesc(tblDesc));
		...
		this.add(getFg_syncpriADesc(tblDesc));
		this.add(getEu_pi_pricamdADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_pripatCDesc(tblDesc));
		...
		tblDesc.add(getFg_syncpriCDesc(tblDesc));
		tblDesc.add(getEu_pi_pricamdCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getFg_syncpriADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Fg_syncpri",  getFg_syncpriCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.FBoolean);
		attrDesc.setLabel("正在同步价格标识");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getEu_pi_pricamdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Eu_pi_pricamd",  getEu_pi_pricamdCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("价格分类模式");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getFg_syncpriCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Fg_syncpri");
		column.setLength(1);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("正在同步价格标识"); 
		return column;
	}
	/**
	 * 获取价格分类模式表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getEu_pi_pricamdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Eu_pi_pricamd");
		column.setLength(50);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("价格分类模式"); 
		return column;
	}
	/**
	 * 获取价格比例模式表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_pripat");
