...
package iih.hr.hbd.psnfiles.d.desc;
 ...
 * 人员文件 DO 元数据信息
 */
public class HbdPsnFilesDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hr.hbd.psnfiles.d.HbdPsnFilesDO";
	public static final String CLASS_DISPALYNAME = "人员文件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HR_HBD_PSN_FILES";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_psn_file";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_psn_fileADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_psn_fileADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_psn_fileCDesc(tblDesc));
		tblDesc.add(getId_psn_fileCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_psn_fileADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_psn_file",  getId_psn_fileCDesc(tblDesc), this);
	...
	private IAttrDesc getName_nurADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b2","id_psn_upload=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_psn_fileCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_psn_file");
		column.setLength(20);
