 ...
 * 专科护理质量标准 DO 元数据信息
 */
public class NmNqmSpcsDoDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nqm.nmnqmspcs.d.NmNqmSpcsDo";
	public static final String CLASS_DISPALYNAME = "专科护理质量标准";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NQM_SPCS";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nqm_spcs";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nqm_spcsADesc(tblDesc));
		...
		this.add(getName_oper_psnADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nqm_spcsCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_oper_psnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_oper_psn",  getName_oper_psnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"sys_user a0b4","id_oper_psn=id_user","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_oper_psnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_oper_psn");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
