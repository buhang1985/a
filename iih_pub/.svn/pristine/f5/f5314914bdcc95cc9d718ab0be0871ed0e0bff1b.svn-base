...
package iih.bd.srv.mrtplsec.d.desc;
...
/**
 * 医疗记录模板片段流数据 DO 元数据信息
 */
public class MrTplSegFsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.mrtplsec.d.MrTplSegFsDO";
	public static final String CLASS_DISPALYNAME = "医疗记录模板片段流数据";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mrtpl_sec_fs";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mrtplsecfs";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mrtplsecfsADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_mrtplsecfsADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mrtplsecfsCDesc(tblDesc));
		tblDesc.add(getId_mrtplsecfsCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_mrtplsecfsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mrtplsecfs",  getId_mrtplsecfsCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗记录模板片段主键标识");
	 ...
	 * @return
	 */
	private IColumnDesc getId_mrtplsecfsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mrtplsecfs");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医疗记录模板片段主键标识"); 
		return column;
	}
	/**
	 * 获取医疗记录模板片段表列元数据
