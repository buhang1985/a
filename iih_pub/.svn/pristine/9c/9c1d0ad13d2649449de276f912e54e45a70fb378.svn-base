...
package iih.sfda.aer.sfdaaerevmsug.d.desc;
 ...
 * 医疗手术事件 DO 元数据信息
 */
public class SfdaAerEvMsugDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.sfda.aer.sfdaaerevmsug.d.SfdaAerEvMsugDO";
	public static final String CLASS_DISPALYNAME = "医疗手术事件";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "SFDA_AER_EV_MSUG";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_aer_ev_msug";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_aer_ev_msugADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_aer_ev_msugADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_aer_ev_msugCDesc(tblDesc));
		tblDesc.add(getId_aer_ev_msugCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_aer_ev_msugADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_aer_ev_msug",  getId_aer_ev_msugCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("医疗手术事件主键");
	...
	private IAttrDesc getName_err_tpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b5","id_err_tp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_acc_injyADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b6","id_acc_injy=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_aer_ev_msugCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_aer_ev_msug");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("医疗手术事件主键"); 
		return column;
	}
	/**
	 * 获取护理安全事件外键表列元数据
