 ...
 * 生命体征 DO 元数据信息
 */
public class MpSkdVsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.mpbd.mpskd.d.MpSkdVsDO";
	public static final String CLASS_DISPALYNAME = "生命体征";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_skd_vs";
	public static final String TABLE_ALIAS_NAME = "a4";
	public static final String PRIMARYKEY_FIELDNAME="Id_skd_vs";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_skd_vsADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_skdADesc(tblDesc));
		this.add(getId_skd_vsADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_skd_vsCDesc(tblDesc));
		tblDesc.add(getId_skd_vsCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_skd_vsADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_skd_vs",  getId_skd_vsCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("体征规则");
	...
	private IAttrDesc getName_skdADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"mp_skd a4b2","id_skd=id_skd","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_srvADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a4b3","id_srv=id_srv","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_skd_vsCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_skd_vs");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("体征规则"); 
		return column;
	}
	/**
	 * 获取护理任务表列元数据
