 ...
 * 护理管理_实习小组 DO 元数据信息
 */
public class NmNitGrpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nit.nmnitgrp.d.NmNitGrpDO";
	public static final String CLASS_DISPALYNAME = "护理管理_实习小组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NIT_GRP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_nit_grp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nit_grpADesc(tblDesc));
		...
		this.add(getName_grgtpADesc(tblDesc));
		this.add(getName_head_psnADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nit_grpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_grgtpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_grgtp",  getName_grgtpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
	 ...
	 * @return
	 */
	private IAttrDesc getName_head_psnADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_head_psn",  getName_head_psnCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getName_emp_regADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_NUR a0b7","id_emp_reg=id_nur","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_grgtpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_grgtp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("名称"); 
		return column;
	 ...
	 * @return
	 */
	private IColumnDesc getName_head_psnCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_head_psn");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
