package iih.nmr.nm.critically.d;
...
import iih.nmr.nm.critically.d.desc.CriticallyRecordDODesc;
...
public class CriticallyRecordDO extends BaseDO {
	...
	public static final String NAME_DIA= "Name_dia";
	...
	public String getName_dia() {
		return ((String) getAttrVal("Name_dia"));
	}	
	public void setName_dia(String Name_dia) {
		setAttrVal("Name_dia", Name_dia);
	}
