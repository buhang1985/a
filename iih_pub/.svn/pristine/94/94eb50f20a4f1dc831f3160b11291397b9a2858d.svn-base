...
package iih.pe.papt.pelabsamp.d.desc;
 ...
 * 体检检验标本 DO 元数据信息
 */
public class PeLabSampDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.pe.papt.pelabsamp.d.PeLabSampDO";
	public static final String CLASS_DISPALYNAME = "体检检验标本";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "pe_apt_labsamp";
	...
	private void init(){		
		...
		this.add(getName_lab_peADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getName_lab_peCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getName_lab_peADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_lab_pe",  getName_lab_peCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本体检名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_psnADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pe_apt_pepsnappt a0b5","id_ent=id_pepsnappt","name_psn"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_staADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_labsta=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getName_lab_peCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_lab_pe");
		column.setLength(600);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标本体检名称"); 
		return column;
	}
	/**
	 * 获取客户姓名表列元数据
