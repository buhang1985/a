...
package iih.bd.pp.bdprisamp.d.desc;
 ...
 * 标本采集费用对照 DO 元数据信息
 */
public class BdPriSampDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.bdprisamp.d.BdPriSampDO";
	public static final String CLASS_DISPALYNAME = "标本采集费用对照";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_pri_samp";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_prisamp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_prisampADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_prisampADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_prisampCDesc(tblDesc));
		tblDesc.add(getId_prisampCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_prisampADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_prisamp",  getId_prisampCDesc(tblDesc), this);
	...
	private IAttrDesc getSamptp_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_samptp=id_udidoc","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getSamptp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_samptp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_prisampCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_prisamp");
		column.setLength(20);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_prisamp");
