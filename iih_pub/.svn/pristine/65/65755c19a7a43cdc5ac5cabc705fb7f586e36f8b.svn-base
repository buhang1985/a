...
public class OrderPresSplitDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getCode_entp_ext() {
		return ((String) getAttrVal("Code_entp_ext"));
	}
	/**
	 * 就诊类型编码扩展
	 * @param Code_entp_ext
	 */
	public void setCode_entp_ext(String Code_entp_ext) {
		setAttrVal("Code_entp_ext", Code_entp_ext);
	}
	/**
	 * 参考价格
	 * @return FDouble
