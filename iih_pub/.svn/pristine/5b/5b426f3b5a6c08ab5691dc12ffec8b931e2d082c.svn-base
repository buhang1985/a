...
package iih.mi.mibd.medkind.d.desc;
 ...
 * 医疗类别 DO 元数据信息
 */
public class MedkindDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mibd.medkind.d.MedkindDO";
	public static final String CLASS_DISPALYNAME = "医疗类别";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MI_BD_MEDKIND";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_medkind";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_medkindADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_medkindCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_medkind");
