 ...
 * 医保计划_险种 DO 元数据信息
 */
public class BdHpKindDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.hp.d.BdHpKindDO";
	public static final String CLASS_DISPALYNAME = "医保计划_险种";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_HP_KIND";
	public static final String TABLE_ALIAS_NAME = "a9";
	public static final String PRIMARYKEY_FIELDNAME="Id_hpkind";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hpkindADesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hpkind");
		iBDDataInfoFldMap.put("id_org","Id_org");
		iBDDataInfoFldMap.put("code","Code_hpkind");
		iBDDataInfoFldMap.put("name","Name_hpkind");
