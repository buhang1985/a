 ...
 * 医保药品记录差异 DO 元数据信息
 */
public class MedInsurDrugRecDiffDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.medinsurrecdiff.d.MedInsurDrugRecDiffDO";
	public static final String CLASS_DISPALYNAME = "医保药品记录差异";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_AHMEDIDIFF_DRUG";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_drugdiff";
	 ...
	 * 无参构造函数
	 */
	public MedInsurDrugRecDiffDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_drugdiffADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_diffADesc(tblDesc));
		this.add(getId_drugdiffADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_drugdiffCDesc(tblDesc));
		tblDesc.add(getId_drugdiffCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_drugdiffADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_drugdiff",  getId_drugdiffCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("药品差异主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_drugdiffCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_drugdiff");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("药品差异主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_drugdiff");
