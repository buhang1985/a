...
package iih.nm.nbd.nmntplapp.d.desc;
 ...
 * 护理管理应用文档 DO 元数据信息
 */
public class NmNtplAppDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nbd.nmntplapp.d.NmNtplAppDO";
	public static final String CLASS_DISPALYNAME = "护理管理应用文档";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NTPL_APP";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ntpl_app";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ntpl_appADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ntpl_appCDesc(tblDesc));
	...
	private IAttrDesc getName_nbd_ntpltpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_nbd_ntpltp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
