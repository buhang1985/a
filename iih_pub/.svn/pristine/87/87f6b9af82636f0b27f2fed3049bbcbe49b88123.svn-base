 ...
 * 部门领用申请单 DO 元数据信息
 */
public class DepartReqOrderDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mm.pl.departrequest.d.DepartReqOrderDO";
	public static final String CLASS_DISPALYNAME = "部门领用申请单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MM_DA";
