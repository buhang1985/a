 ...
 * 班次明细所带学生 DO 元数据信息
 */
public class NhrSchedItmStuDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nhrscheditm.d.NhrSchedItmStuDO";
	public static final String CLASS_DISPALYNAME = "班次明细所带学生";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NHR_SCHED_ITM_STU";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_nhr_sched_itm_stu";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_nhr_sched_itm_stuADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_nhr_schedADesc(tblDesc));
		this.add(getId_nhr_sched_itm_stuADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_nhr_sched_itm_stuCDesc(tblDesc));
		tblDesc.add(getId_nhr_sched_itm_stuCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_nhr_sched_itm_stuADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_nhr_sched_itm_stu",  getId_nhr_sched_itm_stuCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_nhr_sched_itm_stuCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_nhr_sched_itm_stu");
		column.setLength(50);
