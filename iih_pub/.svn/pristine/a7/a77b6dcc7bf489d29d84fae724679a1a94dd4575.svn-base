...
public interface IConsrptRService {
	 ...
	 */
	public abstract PagingRtnData<CiOrdConsRptDO> findByPageInfo(PaginationInfo pg, String wherePart,
	 ...
	 * @throws BizException
	 */
	public abstract CiOrdConsRptDO[] findByAttrValString(String attr, String value) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract CiOrdConsRptDO[] findByAttrValStrings(String attr, String[] values) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract CiOrdConsRptDO[] findByAttrValList(String attr, FArrayList values) throws BizException;
	 ...
	 * @throws BizException
	 */
	public PagingRtnData<CiOrdConsRptDO> findByQCondAndPageInfo(QryRootNodeDTO qryRootNodeDTO, String orderStr,
