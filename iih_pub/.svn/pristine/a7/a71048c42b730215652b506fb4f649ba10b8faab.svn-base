 ...
 * 试卷段落 DO 元数据信息
 */
public class ExamppSecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.net.exampp.d.ExamppSecDO";
	public static final String CLASS_DISPALYNAME = "试卷段落";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_EXAM_PP_SEC";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_ppsec";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ppsecADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_ppADesc(tblDesc));
		this.add(getId_ppsecADesc(tblDesc));
		this.add(getId_ppADesc(tblDesc));
		this.add(getTitle_noADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ppsecCDesc(tblDesc));
		tblDesc.add(getId_ppsecCDesc(tblDesc));
		tblDesc.add(getId_ppCDesc(tblDesc));
		tblDesc.add(getTitle_noCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getTitle_noADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Title_no",  getTitle_noCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("段落标题号");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	...
	private IAttrDesc getName_parADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("上级段落名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"NM_EXAM_PP_SEC a1b3","id_par=id_ppsec","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getTitle_noCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Title_no");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("段落标题号"); 
		return column;
	}
	/**
	 * 获取段落序号表列元数据
