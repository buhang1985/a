 ...
 * 
 */
public class HpMedTpDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_MEDTP= "Id_medtp";
	...
	public String getId_medtp() {
		return ((String) getAttrVal("Id_medtp"));
	}	
	public void setId_medtp(String Id_medtp) {
		setAttrVal("Id_medtp", Id_medtp);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpMedTpDODesc.class);
	}
