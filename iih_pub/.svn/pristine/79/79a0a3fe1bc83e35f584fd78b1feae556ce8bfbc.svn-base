...
public interface ICirptlabCudService {
	...
	*/
	 ...
	 *  根据主DO对组件数据真删除
	 */
	public abstract void deleteByParentDO(CiRptLabDO[] mainDos) throws BizException;
	
	/**
	 *  根据主DO对组件数据逻辑删除
	 */
	public abstract void logicDeleteByParentDO(CiRptLabDO[] mainDos) throws BizException;
}
