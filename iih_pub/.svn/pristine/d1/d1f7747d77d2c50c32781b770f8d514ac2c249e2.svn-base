...
public class EntInfo4BenDTO {
	 ...
	 * @param 
	 */
	public void setSortno_called(Integer getSortno_called) {
		this.Sortno_called = getSortno_called;
	}
}
