 ...
 * 
 */
public class TchoSurgeryIpDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_SUGERYIP= "Id_sugeryip";
	...
	public String getId_sugeryip() {
		return ((String) getAttrVal("Id_sugeryip"));
	}	
	public void setId_sugeryip(String Id_sugeryip) {
		setAttrVal("Id_sugeryip", Id_sugeryip);
	}
...
//	}
	...
	public String getTableName() {	  
		return "NMR_HA_TCHO_SURGERYIP";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(TchoSurgeryIpDODesc.class);
	}
