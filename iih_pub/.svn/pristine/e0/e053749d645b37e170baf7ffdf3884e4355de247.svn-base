 ...
 * 生命体征测量项目 DO 元数据信息
 */
public class MrtplVtItmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.mrtplvt.d.MrtplVtItmDO";
	public static final String CLASS_DISPALYNAME = "生命体征测量项目";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mrtpl_vt_itm";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_mrtplvtitm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mrtplvtitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_mrtplvtADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mrtplvtitmCDesc(tblDesc));
	...
	private IAttrDesc getId_mrtplvtitmADesc(ITableDesc tblDesc){
		...
		attrDesc.setLabel("生命体征测量项目主键标识");
	...
	private IAttrDesc getFreq_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_freq a1b5","id_freq=id_freq","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
