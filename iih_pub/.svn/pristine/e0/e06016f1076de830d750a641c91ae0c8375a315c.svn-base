...
import iih.ci.mr.nu.bgm.d.desc.BgmPatInfoDODesc;
 ...
 * 
 */
public class BgmPatInfoDO extends BaseDO {
	...
	public FDate getDt_check() {
		return ((FDate) getAttrVal("Dt_check"));
	}	
	public void setDt_check(FDate Dt_check) {
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(BgmPatInfoDODesc.class);
	}
