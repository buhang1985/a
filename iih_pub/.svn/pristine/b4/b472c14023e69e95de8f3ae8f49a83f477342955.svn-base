 ...
 * 
 */
public class EmsPrnTmplCaDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_EMSPRNTMPLCA= "Id_emsprntmplca";
	...
	public String getId_emsprntmplca() {
		return ((String) getAttrVal("Id_emsprntmplca"));
	}	
	public void setId_emsprntmplca(String Id_emsprntmplca) {
		setAttrVal("Id_emsprntmplca", Id_emsprntmplca);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_emsprntmplca";
	}
	
	@Override
	public String getTableName() {	  
		return "bd_ems_prntmpl_ca";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(EmsPrnTmplCaDODesc.class);
	}
