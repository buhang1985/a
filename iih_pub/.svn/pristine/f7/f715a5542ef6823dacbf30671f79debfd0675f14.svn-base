...
package iih.bd.srv.mropgroup.d.desc;
 ...
 * 病历业务组 DO 元数据信息
 */
public class MrOpGroupDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.mropgroup.d.MrOpGroupDO";
	public static final String CLASS_DISPALYNAME = "病历业务组";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mr_op_group";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Idmropgroup";
	...
	private void init(){		
		...
		this.setKeyDesc(getIdmropgroupADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getIdmropgroupCDesc(tblDesc));
