...
package iih.mp.dg.ebsifacemid.d.desc;
 ...
 * EBS中间表   DO 元数据信息
 */
public class EBSIFaceMidDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.dg.ebsifacemid1.d.EBSIFaceMidDO";
	public static final String CLASS_DISPALYNAME = "EBS中间表  ";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CUX_INV_EBS_MEDIC_IFACE";
	...
	private void init(){		
		...
		this.add(getIstateADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.add(getIstateCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getIstateADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Istate",  getIstateCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
	 ...
	 * @return
	 */
	private IColumnDesc getIstateCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Istate");
		column.setLength(10);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
