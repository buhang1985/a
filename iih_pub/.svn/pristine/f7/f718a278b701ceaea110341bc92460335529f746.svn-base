...
package iih.mc.st.mcstockaplrel.d.desc;
 ...
 * 耗材出库申请关联 DO 元数据信息
 */
public class McStockAplRelDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mc.st.mcstockaplrel.d.McStockAplRelDO";
	public static final String CLASS_DISPALYNAME = "耗材出库申请关联";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "MC_DA_REL";
