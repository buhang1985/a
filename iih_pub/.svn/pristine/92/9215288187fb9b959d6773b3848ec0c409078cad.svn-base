 ...
 * 床位特征值定义 DO 元数据信息
 */
public class BedAttrDefDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.res.bed.d.BedAttrDefDO";
	public static final String CLASS_DISPALYNAME = "床位特征值定义";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_BED_ATTR_DEF";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_bedattrdef";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_bedattrdefADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_bedattrdefADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_bedattrdefCDesc(tblDesc));
		tblDesc.add(getId_bedattrdefCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_bedattrdefADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_bedattrdef",  getId_bedattrdefCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("床位特征id");
	...
	private IAttrDesc getName_attrADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b2","id_bedattr_tp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_bedattrdefCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_bedattrdef");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("床位特征id"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_bedattrdef");
