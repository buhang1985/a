 ...
 * 
 */
public class EnMobAdmDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_ENT_MOBADM= "Id_ent_mobadm";
	...
	public String getId_ent_mobadm() {
		return ((String) getAttrVal("Id_ent_mobadm"));
	}	
	public void setId_ent_mobadm(String Id_ent_mobadm) {
		setAttrVal("Id_ent_mobadm", Id_ent_mobadm);
	}
...
//	}
	...
	public String getPKFieldName() {
		return "Id_ent_mobadm";
	}
	
	@Override
	public String getTableName() {	  
		return "en_ext_mobile_adm";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(EnMobAdmDODesc.class);
	}
