 ...
 * 中药煎法要求 DO 元数据信息
 */
public class CHerbBoilDesDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.cherbboilmd.d.CHerbBoilDesDO";
	public static final String CLASS_DISPALYNAME = "中药煎法要求";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_boil_des";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_boildes";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_boildesADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_boilADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_boildesCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_boildes");
