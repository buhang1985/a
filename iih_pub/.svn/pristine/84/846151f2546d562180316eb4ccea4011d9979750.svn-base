...
package iih.mi.mc.mimcpatspecdrugaquando.d.desc;
 ...
 * 患者特殊病药品增量表 DO 元数据信息
 */
public class MiMcPatSpecDrugAQuanDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mi.mc.mimcpatspecdrugaquando.d.MiMcPatSpecDrugAQuanDO";
	public static final String CLASS_DISPALYNAME = "患者特殊病药品增量表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mi_mc_pat_spec_drugAQuan";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mimcpatspecdrugaquan";
	 ...
	 * 无参构造函数
	 */
	public MiMcPatSpecDrugAQuanDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mimcpatspecdrugaquanADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_mimcpatspecdrugaquanADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mimcpatspecdrugaquanCDesc(tblDesc));
		tblDesc.add(getId_mimcpatspecdrugaquanCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_mimcpatspecdrugaquanADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mimcpatspecdrugaquan",  getId_mimcpatspecdrugaquanCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("患者特殊病药品增量表主键");
	...
	private IAttrDesc getId_hppatspecADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bl_hp_pat_spec_di a0b2","id_mimcpatspecdi=id_hppatspecdi","id_hppatspec"});
		attrDesc.setRefType(true);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getDesADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM a0b4","id_mm=id_mm","des"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_unit_pkgbaseADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"BD_MM a0b4","id_mm=id_mm","name_unit_pkgbase"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_mimcpatspecdrugaquanCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mimcpatspecdrugaquan");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("患者特殊病药品增量表主键"); 
		return column;
	}
	/**
	 * 获取医保特殊病患者诊断表列元数据
