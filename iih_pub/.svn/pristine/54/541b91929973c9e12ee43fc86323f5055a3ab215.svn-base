 ...
 * 医保诊疗记录差异 DO 元数据信息
 */
public class MedInsurTreatRecDiffDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.medinsurrecdiff.d.MedInsurTreatRecDiffDO";
	public static final String CLASS_DISPALYNAME = "医保诊疗记录差异";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_AHMEDIDIFF_TREAT";
	public static final String TABLE_ALIAS_NAME = "a2";
	public static final String PRIMARYKEY_FIELDNAME="Id_treatdiff";
	 ...
	 * 无参构造函数
	 */
	public MedInsurTreatRecDiffDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_treatdiffADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_diffADesc(tblDesc));
		this.add(getId_treatdiffADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_treatdiffCDesc(tblDesc));
		tblDesc.add(getId_treatdiffCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_treatdiffADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_treatdiff",  getId_treatdiffCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("诊疗差异主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_treatdiffCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_treatdiff");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("诊疗差异主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_treatdiff");
