...
public class EmsOpitemDO extends OrCommonFieldsDTO {
	 ...
	 * @return FDouble
	 */
	public FDouble getTime_sup_plan() {
		return ((FDouble) getAttrVal("Time_sup_plan"));
	}
	/**
	 * 预期手术时长
	 * @param Time_sup_plan
	 */
	public void setTime_sup_plan(FDouble Time_sup_plan) {
	 ...
	 * @return FBoolean
	 */
	public FBoolean getEu_anseca() {
		return ((FBoolean) getAttrVal("Eu_anseca"));
	}
	/**
	 * 麻醉分类
	 * @param Eu_anseca
	 */
	public void setEu_anseca(FBoolean Eu_anseca) {
	...
	public String getName81() {
		return ((String) getAttrVal("Name81"));
	}
	/**
	 * displaynam81
	 * @param Name81
