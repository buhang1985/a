...
package iih.bl.inc.blincoeppaper.d.desc;
 ...
 * 门急诊纸质发票 DO 元数据信息
 */
public class BlIncOepPaperDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.inc.blincoeppaper.d.BlIncOepPaperDO";
	public static final String CLASS_DISPALYNAME = "门急诊纸质发票";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_inc_oep_paper";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_incoeppaper";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_incoeppaperADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_incoeppaperADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_incoeppaperCDesc(tblDesc));
		tblDesc.add(getId_incoeppaperCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_incoeppaperADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_incoeppaper",  getId_incoeppaperCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("门诊纸质发票主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_incoeppaperCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_incoeppaper");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("门诊纸质发票主键"); 
		return column;
	}
	/**
	 * 获取门急诊发票id表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_incoeppaper");
