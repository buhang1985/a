 ...
 * 
 */
public class CiMrFpDTO extends BaseDTO {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getSv_pat() {
		return ((FDateTime) getAttrVal("Sv_pat"));
	}
	/**
	 * 患者信息sv
	 * @param Sv_pat
	 */
	public void setSv_pat(FDateTime Sv_pat) {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getSv_other() {
		return ((FDateTime) getAttrVal("Sv_other"));
	}
	/**
	 * 其他sv
	 * @param Sv_other
	 */
	public void setSv_other(FDateTime Sv_other) {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getSv_othert() {
		return ((FDateTime) getAttrVal("Sv_othert"));
	}
	/**
	 * 附页sv
	 * @param Sv_othert
	 */
	public void setSv_othert(FDateTime Sv_othert) {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getSv_bl() {
		return ((FDateTime) getAttrVal("Sv_bl"));
	}
	/**
	 * 费用sv
	 * @param Sv_bl
	 */
	public void setSv_bl(FDateTime Sv_bl) {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getSv_di() {
		return ((FDateTime) getAttrVal("Sv_di"));
	}
	/**
	 * 诊断sv
	 * @param Sv_di
	 */
	public void setSv_di(FDateTime Sv_di) {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getSv_mrfp() {
		return ((FDateTime) getAttrVal("Sv_mrfp"));
	}
	/**
	 * 主表更新时间
	 * @param Sv_mrfp
	 */
	public void setSv_mrfp(FDateTime Sv_mrfp) {
	 ...
	 * @return FBoolean
	 */
	public FBoolean getFg_cata() {
		return ((FBoolean) getAttrVal("Fg_cata"));
	}
	/**
	 * 是否完成编目
	 * @param Fg_cata
	 */
	public void setFg_cata(FBoolean Fg_cata) {
		setAttrVal("Fg_cata", Fg_cata);
	}
	/**
	 * 门急诊医师(id)
	 * @return String
	 ...
	 * @return String
	 */
	public String getPat_sort() {
		return ((String) getAttrVal("Pat_sort"));
	}
	/**
	 * 患者分类
	 * @param Pat_sort
	 */
	public void setPat_sort(String Pat_sort) {
		setAttrVal("Pat_sort", Pat_sort);
	}
	/**
	 * 病例分型name
	 * @return String
