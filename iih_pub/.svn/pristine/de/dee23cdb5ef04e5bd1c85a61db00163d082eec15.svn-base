package iih.pe.pip.dto.peippsninfodto.d;
 ...
 * 
 */
public class PeIpPsninfoDTO extends BaseDTO {
	...
	public String getId_room() {
		return ((String) getAttrVal("Id_room"));
	}
	/**
	 * 体检诊室
	 * @param Id_room
	...
	public void setId_room(String Id_room) {
		setAttrVal("Id_room", Id_room);
	}
	/**
	 * 体检诊室编码
	 * @return String
	 */
	public String getSd_room() {
		return ((String) getAttrVal("Sd_room"));
	}
	/**
	 * 体检诊室编码
	 * @param Sd_room
	 */
	public void setSd_room(String Sd_room) {
		setAttrVal("Sd_room", Sd_room);
	}
}