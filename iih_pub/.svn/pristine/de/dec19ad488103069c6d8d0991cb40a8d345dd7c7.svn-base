...
package iih.bd.srv.srvortplcate.d.desc;
 ...
 * 医疗服务医嘱模板分类 DO 元数据信息
 */
public class SrvOrTplCateDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.srvortplcate.d.SrvOrTplCateDO";
	public static final String CLASS_DISPALYNAME = "医疗服务医嘱模板分类";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_tpl_ca";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvortplca";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvortplcaADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvortplcaCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_srvortplca");
