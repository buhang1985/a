 ...
 * 数据集 DO 元数据信息
 */
public class DeDataSetDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mkr.std.deset.d.DeDataSetDO";
	public static final String CLASS_DISPALYNAME = "数据集";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_set";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_set";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_setADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_setCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_set");
