 ...
 * 服务开立权限项目 DO 元数据信息
 */
public class SrvRtItmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.srvrtctl.d.SrvRtItmDO";
	public static final String CLASS_DISPALYNAME = "服务开立权限项目";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_srv_rt_itm";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_srvrtitm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_srvrtitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_srvrtADesc(tblDesc));
		this.add(getId_srvrtitmADesc(tblDesc));
		this.add(getId_srvrtADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_srvADesc(tblDesc));
		this.add(getId_mmADesc(tblDesc));
		this.add(getIdsrvitmcodeADesc(tblDesc));
		this.add(getIdsrvitmnameADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_srvrtitmCDesc(tblDesc));
		tblDesc.add(getId_srvrtitmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_srvrtitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_srvrtitm",  getId_srvrtitmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("开立权限项目主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getIdsrvitmcodeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Idsrvitmcode",  getIdsrvitmcodeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv_rt a1b1","id_srvrt=id_srvrt","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getIdsrvitmnameADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Idsrvitmname",  getIdsrvitmnameCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv_rt a1b1","id_srvrt=id_srvrt","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getId_srvtpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a1b2","id_srv=id_srv","id_srvtp"});
		attrDesc.setRefType(true);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getFg_mmADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_srv a1b2","id_srv=id_srv","fg_mm"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_srvrtitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_srvrtitm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("开立权限项目主键标识"); 
		return column;
	}
	/**
	 * 获取开立权限表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getIdsrvitmcodeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Idsrvitmcode");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getIdsrvitmnameCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Idsrvitmname");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
