...
public class CiMrRecallResultDTO extends BaseDTO {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getDt_en_in() {
		return ((FDateTime) getAttrVal("Dt_en_in"));
	}
	/**
	 * 入院日期
	 * @param Dt_en_in
	 */
	public void setDt_en_in(FDateTime Dt_en_in) {
		setAttrVal("Dt_en_in", Dt_en_in);
	}
	/**
	 * 出院日期
	 * @return FDateTime
	 */
	public FDateTime getDt_en_out() {
		return ((FDateTime) getAttrVal("Dt_en_out"));
	}
	/**
	 * 出院日期
	 * @param Dt_en_out
	 */
	public void setDt_en_out(FDateTime Dt_en_out) {
		setAttrVal("Dt_en_out", Dt_en_out);
	}
	/**
	 * 住院号
	 * @return String
