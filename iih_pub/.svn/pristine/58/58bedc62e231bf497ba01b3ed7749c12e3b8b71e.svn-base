...
package iih.ci.mr.middle.cons.d.desc;
 ...
 * 病历中间表会诊记录 DO 元数据信息
 */
public class CiMrMiddleConsDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.middle.cons.d.CiMrMiddleConsDO";
	public static final String CLASS_DISPALYNAME = "病历中间表会诊记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_mr_middle_cons";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ci_mr_middle_cons";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ci_mr_middle_consADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_ci_mr_middle_consADesc(tblDesc));
		...
		this.add(getValue_textADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ci_mr_middle_consCDesc(tblDesc));
		tblDesc.add(getId_ci_mr_middle_consCDesc(tblDesc));
		...
		tblDesc.add(getValue_textCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_ci_mr_middle_consADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_ci_mr_middle_cons",  getId_ci_mr_middle_consCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getValue_textADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Value_text",  getValue_textCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("内容文本");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_ci_mr_middle_consCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_ci_mr_middle_cons");
		column.setLength(20);
	 ...
	 * @return
	 */
	private IColumnDesc getValue_textCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Value_text");
		column.setLength(5000);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("内容文本"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
