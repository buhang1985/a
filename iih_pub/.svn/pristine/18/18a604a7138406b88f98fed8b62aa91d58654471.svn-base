 ...
 * 医保特殊病患者 DO 元数据信息
 */
public class BlHpPatSpecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.hp.blhppatspec.d.BlHpPatSpecDO";
	public static final String CLASS_DISPALYNAME = "医保特殊病患者";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_hp_pat_spec";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_hppatspec";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_hppatspecADesc(tblDesc));
		...
		this.add(getTel_patADesc(tblDesc));
		this.add(getCreatedbyADesc(tblDesc));
		this.add(getCreatedtimeADesc(tblDesc));
		this.add(getModifiedbyADesc(tblDesc));
		this.add(getModifiedtimeADesc(tblDesc));
		this.add(getCode_otherADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_hppatspecCDesc(tblDesc));
		...
		tblDesc.add(getTel_patCDesc(tblDesc));
		tblDesc.add(getCreatedbyCDesc(tblDesc));
		tblDesc.add(getCreatedtimeCDesc(tblDesc));
		tblDesc.add(getModifiedbyCDesc(tblDesc));
		tblDesc.add(getModifiedtimeCDesc(tblDesc));
		tblDesc.add(getCode_otherCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getTel_patADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Tel_pat",  getTel_patCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_otherADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_other",  getCode_otherCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("集成平台主键");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getTel_patCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Tel_pat");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_otherCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_other");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("集成平台主键"); 
		return column;
	}
	/**
	 * 获取医保计划编码表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_hppatspec");
