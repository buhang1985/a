...
package iih.nm.nhr.nmnureval.d.desc;
 ...
 * 护理人员评定 DO 元数据信息
 */
public class NmNurEvalDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.nm.nhr.nmnureval.d.NmNurEvalDO";
	public static final String CLASS_DISPALYNAME = "护理人员评定";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "NM_NUR_EVAL";
