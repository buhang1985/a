...
import iih.ci.rcm.reportcarddocfs.d.desc.ReportCardDocTplDoDesc;
 ...
 * 
 */
public class ReportCardDocTplDo extends BaseDO {
...
//	}
	...
	public String getTableName() {	  
		return "ci_rcm_rd _fs";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(ReportCardDocTplDoDesc.class);
	}
