...
package iih.bd.mm.mmgrpitm.d.desc;
 ...
 * 物品组明细 DO 元数据信息
 */
public class MmGrpItmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.mm.mmgrpitm.d.MmGrpItmDO";
	public static final String CLASS_DISPALYNAME = "物品组明细";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_mmgrp_itm";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mmgrpitm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mmgrpitmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_mmgrpitmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mmgrpitmCDesc(tblDesc));
		tblDesc.add(getId_mmgrpitmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_mmgrpitmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_mmgrpitm",  getId_mmgrpitmCDesc(tblDesc), this);
	...
	private IAttrDesc getGrp_codeADesc(ITableDesc tblDesc){
		...
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("分组编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mmgrp a0b2","id_mmgrp=id_mmgrp","code"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getGrp_nameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_mmgrp a0b2","id_mmgrp=id_mmgrp","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_mmgrpitmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_mmgrpitm");
		column.setLength(20);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_mmgrpitm");
