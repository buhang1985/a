...
public class CiEmsSrvDTO extends BaseDTO {
	 ...
	 * @param Des_bl
	 */
	public void setDes_bl(String Des_bl) {
	 ...
	 * @return FBoolean
	 */
	public FBoolean getFg_skintest_mm() {
		return ((FBoolean) getAttrVal("Fg_skintest_mm"));
	}	
	/**
	 * 物品在定义态时的皮试标志
	 * @param Fg_skintest_mm
	 */
	public void setFg_skintest_mm(FBoolean Fg_skintest_mm) {
		setAttrVal("Fg_skintest_mm", Fg_skintest_mm);
	}
	/**
	 * 医保校验结果
	 * @return FArrayList
	 ...
	 * @return FDouble
	 */
	public FDouble getFactor_medu_cur() {
		return ((FDouble) getAttrVal("Factor_medu_cur"));
	}	
	/**
	 * 当前剂量换算系数
	 * @param Factor_medu_cur
	 */
	public void setFactor_medu_cur(FDouble Factor_medu_cur) {
		setAttrVal("Factor_medu_cur", Factor_medu_cur);
	}
	 ...
	 * @return String
	 */
	public String getName_unit_medu_cur() {
		return ((String) getAttrVal("Name_unit_medu_cur"));
	}	
	/**
	 * 当前单位名称
	 * @param Name_unit_med
	 */
	public void setName_unit_medu_cur(String Name_unit_medu_cur) {
		setAttrVal("Name_unit_medu_cur", Name_unit_medu_cur);
	}
	 ...
	 * @return String
	 */
	public String getRtn_result() {
		return ((String) getAttrVal("Rtn_result"));
	}	
	/**
	 * 退药原因
	 * @param Rtn_result
	 */
	public void setRtn_result(String Rtn_result) {
		setAttrVal("Rtn_result", Rtn_result);
	}
	/**
	 * 退药关联原医嘱ID
	 * @return String
