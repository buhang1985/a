...
package iih.bd.pp.medinsurdrugrec.d.desc;
 ...
 * 医保药品记录 DO 元数据信息
 */
public class MedInsurDrugRecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.pp.medinsurdrugrec.d.MedInsurDrugRecDO";
	public static final String CLASS_DISPALYNAME = "医保药品记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BD_ANMEDI_DRUG_REC";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_drugrec";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_drugrecADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_drugrecADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_drugrecCDesc(tblDesc));
		tblDesc.add(getId_drugrecCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_drugrecADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_drugrec",  getId_drugrecCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("药品记录主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_drugrecCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_drugrec");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("药品记录主键"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_drugrec");
