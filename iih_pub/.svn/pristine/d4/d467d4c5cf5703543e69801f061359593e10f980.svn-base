...
package iih.bd.srv.connonationitm.d.desc;
 ...
 * 内涵质控项目 DO 元数据信息
 */
public class ConnonationItmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bd.srv.connonationitm.d.ConnonationItmDO";
	public static final String CLASS_DISPALYNAME = "内涵质控项目";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bd_qa_connonation_itm";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_connonation_req";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_connonation_reqADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_connonation_reqADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_connonation_reqCDesc(tblDesc));
		tblDesc.add(getId_connonation_reqCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_connonation_reqADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_connonation_req",  getId_connonation_reqCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_connonation_reqCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_connonation_req");
		column.setLength(50);
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("name","Req_conno");
