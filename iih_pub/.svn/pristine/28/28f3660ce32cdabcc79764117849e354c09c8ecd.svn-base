 ...
 * 诊疗计划元素模板对照 DO 元数据信息
 */
public class HpCpElemTplMapDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.hp.cp.eletpl.d.HpCpElemTplMapDO";
	public static final String CLASS_DISPALYNAME = "诊疗计划元素模板对照";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "HP_CP_ELE_TPL_MAP";
