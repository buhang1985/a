...
public class NqmImprovKpiFormDO implements WfFormInfoCtx {

	private static final long serialVersionUID = 1L;
	private final String TITLE_FIELD = "NqmImproveKpi_title";

	private NqmImprovKpiDO _transDo;

	public void setTransDo(NqmImprovKpiDO transDO) {
		this._transDo = transDO;
	}

	public NqmImprovKpiDO getTransDo() {
	...
	public String getFrmInsPk() {
		...
		return _transDo.getId_nqm_improv_kpi();
	}
	...
	public Object getAttributeValue(String attrbute) {
		if (TITLE_FIELD.equalsIgnoreCase(attrbute)) {
			String plName = "护理单元(" + this._transDo.getName_dep_nur() + ")";
			...
			title.append("用户[" + createUserName + "]" + opt + "了[" + plName + "] 的持续改进项目");
