 ...
 * 
 */
public class EmstreatOrdDTO extends EmsCommonOrdDTO {
	 ...
	 * @return String
	 */
	public String getTimes_cur_or() {
		return ((String) getAttrVal("Times_cur_or"));
	}
	/**
	 * 医嘱次数
	 * @param Times_cur_or
	 */
	public void setTimes_cur_or(String Times_cur_or) {
		setAttrVal("Times_cur_or", Times_cur_or);
	}
	/**
	 * 医嘱总量
	 * @return String
	 */
	public String getQuan_cur_or() {
		return ((String) getAttrVal("Quan_cur_or"));
	}
	/**
	 * 医嘱总量
	 * @param Quan_cur_or
	 */
	public void setQuan_cur_or(String Quan_cur_or) {
		setAttrVal("Quan_cur_or", Quan_cur_or);
	}
	/**
	 * 单位支付标志
	 * @return String
	 ...
	 */
	public List<EmstreatSrvDTO> getSrvtreatList() {
		return ((List<EmstreatSrvDTO>) getAttrVal("SrvList"));
	}
	/**
	 * 诊疗DTO_第三方系统回传
	 * @param PresList
	 */
	public void setSrvtreatList(List<EmstreatSrvDTO> srvlist) {
