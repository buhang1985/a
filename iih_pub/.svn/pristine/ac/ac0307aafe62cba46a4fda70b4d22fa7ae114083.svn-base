...
package iih.mp.nr.dbsign.d.desc;
 ...
 * 执行双签 DO 元数据信息
 */
public class MpOrSignDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.mp.nr.dbsign.d.MpOrSignDO";
	public static final String CLASS_DISPALYNAME = "执行双签";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "mp_or_sign";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_or_sign";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_or_signADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_or_signADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_or_prADesc(tblDesc));
		this.add(getId_orADesc(tblDesc));
		this.add(getId_emp_signADesc(tblDesc));
		this.add(getId_dbsign_tpADesc(tblDesc));
		this.add(getSd_dbsign_tpADesc(tblDesc));
		...
		this.add(getName_dbsigntpADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_or_signCDesc(tblDesc));
		tblDesc.add(getId_or_signCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_or_prCDesc(tblDesc));
		tblDesc.add(getId_orCDesc(tblDesc));
		tblDesc.add(getId_emp_signCDesc(tblDesc));
		tblDesc.add(getId_dbsign_tpCDesc(tblDesc));
		tblDesc.add(getSd_dbsign_tpCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_or_signADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_or_sign",  getId_or_signCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("双签ID");
	 ...
	 * @return
	 */
	private IAttrDesc getId_dbsign_tpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_dbsign_tp",  getId_dbsign_tpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("双签类型");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_dbsign_tpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_dbsign_tp",  getSd_dbsign_tpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("双签编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_dbsigntpADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_dbsigntp",  getName_dbsigntpCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("双签类型名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b10","id_dbsign_tp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_or_signCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_or_sign");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("双签ID"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_dbsign_tpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_dbsign_tp");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("双签类型"); 
		return column;
	}
	/**
	 * 获取双签编码表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_dbsign_tpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_dbsign_tp");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("双签编码"); 
		return column;
	}
	/**
	 * 获取操作人表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_dbsigntpCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_dbsigntp");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("双签类型名称"); 
		return column;
	}
	/**
	 * 获取操作人姓名表列元数据
