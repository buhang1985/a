...
import iih.mi.biz.mihptransact.d.desc.MiHpTransActDODesc;
 ...
 * 
 */
public class MiHpTransActDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_hptransact";
	}
	
	@Override
	public String getTableName() {	  
		return "mi_hptransact";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MiHpTransActDODesc.class);
	}
