package iih.bd.pp.medinsursrvfacrec.d;
 ...
 * 
 */
public class MedInsurSrvFacRecDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_SRVFACREC= "Id_srvfacrec";
	...
	public MedInsurSrvFacRecDO () {
		super();
	}
	
	public String getId_srvfacrec() {
		return ((String) getAttrVal("Id_srvfacrec"));
	}	
	public void setId_srvfacrec(String Id_srvfacrec) {
		setAttrVal("Id_srvfacrec", Id_srvfacrec);
	}
...
//	}
	...
	public String getTableName() {	  
		return "BD_ANMEDI_SRVFAC_REC";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MedInsurSrvFacRecDODesc.class);
	}
