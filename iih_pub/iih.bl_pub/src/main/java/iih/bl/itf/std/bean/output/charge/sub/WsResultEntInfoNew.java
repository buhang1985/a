...
public class WsResultEntInfoNew implements Serializable {
	...
	private List<WsResultPresInfoNew> entPresList;
	...
	public List<WsResultPresInfoNew> getEntPresList() {
		return entPresList;
	}

	public void setEntPresList(List<WsResultPresInfoNew> entPresList) {
