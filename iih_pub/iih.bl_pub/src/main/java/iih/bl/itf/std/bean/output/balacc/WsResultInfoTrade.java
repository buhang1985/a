...
public class WsResultInfoTrade extends WsResultInfoWithCustom {
	...
	//根据订单号查询的票据号
	@XmlElement(name = "orIncCode")
	private String orIncCode;
	...
	public String getOrIncCode() {
		return orIncCode;
	}

	public void setOrIncCode(String orIncCode) {
		this.orIncCode = orIncCode;
	}
