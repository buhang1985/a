...
public class WsResultPresInfo implements Serializable {
	...
	private List<WsResultItem> presItem;
	...
	public List<WsResultItem> getPresItem() {
		return presItem;
	}

	public void setPresItem(List<WsResultItem> presItem) {
