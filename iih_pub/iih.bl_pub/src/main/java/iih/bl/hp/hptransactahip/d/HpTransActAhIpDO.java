 ...
 * 
 */
public class HpTransActAhIpDO extends BaseDO {
...
//	}
	...
	public String getPKFieldName() {
		return "Id_transactneusoftahip";
	}
	
	@Override
	public String getTableName() {	  
		return "hp_transact_neusoft_ahip";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(HpTransActAhIpDODesc.class);
	}
