...
package iih.bl.hp.hptranactoep.d.desc;
 ...
 * 交易记录 DO 元数据信息
 */
public class HpTransactOepDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.hp.hptranactoep.d.HpTransactOepDO";
	public static final String CLASS_DISPALYNAME = "交易记录";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "hp_transact_oep";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_trans_oep";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_trans_oepADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_trans_oepADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_trans_oepCDesc(tblDesc));
		tblDesc.add(getId_trans_oepCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_trans_oepADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_trans_oep",  getId_trans_oepCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IColumnDesc getId_trans_oepCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_trans_oep");
		column.setLength(20);
