...
package iih.bl.hp.blinterfaceacttime.d.desc;
 ...
 * 接口业务时间表 DO 元数据信息
 */
public class BlInterfaceActTimeDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.hp.blinterfaceacttime.d.BlInterfaceActTimeDO";
	public static final String CLASS_DISPALYNAME = "接口业务时间表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "BL_INTERFACE_ACT_TIME";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_interfaceacttime";
	 ...
	 * 无参构造函数
	 */
	public BlInterfaceActTimeDODesc(){
		init();
	}
	...
	private void init(){		
		...
		this.setKeyDesc(getId_interfaceacttimeADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.add(getId_interfaceacttimeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_interfaceacttimeCDesc(tblDesc));
		tblDesc.add(getId_interfaceacttimeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_interfaceacttimeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_interfaceacttime",  getId_interfaceacttimeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("接口业务时间主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_interfaceacttimeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_interfaceacttime");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("接口业务时间主键"); 
		return column;
	}
	/**
	 * 获取组织表列元数据
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_interfaceacttime");
