 ...
 *
 */
public class BlEIncOutParam implements Serializable{
	...
	private List<BlEIncOutOtherInfoParam> otherInfo;//其它扩展信息列表
	private List<BlEIncOutOtherMedicalListParam> otherMedicalList;//其它医保信息列表
	private List<BlEIncOutPayChannelDetailParam> payChannelDetail;//交费渠道列表
	private String eBillRelateNo;//业务票据关联号
	private List<BlEIncOutChargeDetailParam> chargeDetail;//收费项目明细
	private List<BlEIncOutListDetailParam> listDetail;//清单项目明细
	...
	public List<BlEIncOutOtherInfoParam> getOtherInfo() {
		return otherInfo;
	}

	public void setOtherInfo(List<BlEIncOutOtherInfoParam> otherInfo) {
	...
	public List<BlEIncOutOtherMedicalListParam> getOtherMedicalList() {
		return otherMedicalList;
	}

	public void setOtherMedicalList(List<BlEIncOutOtherMedicalListParam> otherMedicalList) {
		this.otherMedicalList = otherMedicalList;
	}

	public List<BlEIncOutPayChannelDetailParam> getPayChannelDetail() {
		return payChannelDetail;
	}

	public void setPayChannelDetail(List<BlEIncOutPayChannelDetailParam> payChannelDetail) {
	...
	public List<BlEIncOutChargeDetailParam> getChargeDetail() {
		return chargeDetail;
	}

	public void setChargeDetail(List<BlEIncOutChargeDetailParam> chargeDetail) {
		this.chargeDetail = chargeDetail;
	}

	public List<BlEIncOutListDetailParam> getListDetail() {
		return listDetail;
	}

	public void setListDetail(List<BlEIncOutListDetailParam> listDetail) {
