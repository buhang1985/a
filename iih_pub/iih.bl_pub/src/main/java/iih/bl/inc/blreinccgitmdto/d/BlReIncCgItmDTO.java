package iih.bl.inc.blreinccgitmdto.d;
 ...
 * 
 */
public class BlReIncCgItmDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getId_cg_itm() {
		return ((String) getAttrVal("Id_cg_itm"));
	}
	/**
	 * 记账明细ID
	 * @param Id_cg_itm
	 */
	public void setId_cg_itm(String Id_cg_itm) {
		setAttrVal("Id_cg_itm", Id_cg_itm);
	}
	/**
	 * 医嘱ID
	 * @return String
