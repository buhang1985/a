package iih.bl.inc.blincoeppaper.d;
 ...
 * 
 */
public class BlIncOepPaperDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	//门诊纸质发票主键
	public static final String ID_INCOEPPAPER= "Id_incoeppaper";
	//门急诊发票id
	...
	//电子发票号
	public static final String EC_INCNO= "Ec_incno";
	//票据包编码
	 ...
	 * @return String
	 */
	public String getId_incoeppaper() {
		return ((String) getAttrVal("Id_incoeppaper"));
	}	
	/**
	 * 门诊纸质发票主键
	 * @param Id_incoeppaper
	 */
	public void setId_incoeppaper(String Id_incoeppaper) {
		setAttrVal("Id_incoeppaper", Id_incoeppaper);
	}
	/**
	 * 门急诊发票id
	 * @return String
	 ...
	 * @return String
	 */
	public String getEc_incno() {
		return ((String) getAttrVal("Ec_incno"));
	}	
	/**
	 * 电子发票号
	 * @param Ec_incno
	 */
	public void setEc_incno(String Ec_incno) {
		setAttrVal("Ec_incno", Ec_incno);
	}
	/**
	 * 票据包编码
	 * @return String
	...
	public String getInc_code() {
		return ((String) getAttrVal("Inc_code"));
	}	
	/**
	 * 纸质票据代码
	 * @param Inc_code
...
//	}
	...
	public String getPKFieldName() {
		return "Id_incoeppaper";
	}
	
	@Override
	public String getTableName() {	  
		return "bl_inc_oep_paper";
	}
	
	@Override
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(BlIncOepPaperDODesc.class);
	}
