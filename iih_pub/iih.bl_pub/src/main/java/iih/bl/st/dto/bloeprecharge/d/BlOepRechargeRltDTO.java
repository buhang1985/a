...
/**
 * 门诊重划重收结果dto(接口出参) DTO数据 
 * 
 */
public class BlOepRechargeRltDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getId_increcharge() {
		return ((String) getAttrVal("Id_increcharge"));
	}
	/**
	 * 重收发票id
	 * @param Id_increcharge
	 */
	public void setId_increcharge(String Id_increcharge) {
