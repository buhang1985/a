 ...
 * 应收明细_住院 DO 元数据信息
 */
public class BlStarItmIpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.prop.blproparip.d.BlStarItmIpDO";
	public static final String CLASS_DISPALYNAME = "应收明细_住院";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_st_ar_itm_ip";
	public static final String TABLE_ALIAS_NAME = "${EntityMeta.entityClassMeta.aliasName}";
	public static final String PRIMARYKEY_FIELDNAME="Id_proparitmip";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_proparitmipADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();
		this.setDefaultValueMap();
		this.setFKeyDesc(getId_proparipADesc(tblDesc));
		this.add(getId_proparitmipADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_proparitmipCDesc(tblDesc));
		tblDesc.add(getId_proparitmipCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_proparitmipADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_proparitmip",  getId_proparitmipCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("应收明细主键");
	 ...
	 * @return
	 */
	private IColumnDesc getId_proparitmipCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_proparitmip");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("应收明细主键"); 
		return column;
	}
	/**
	 * 获取应收表列元数据
