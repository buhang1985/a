...
package iih.bl.prop.blpropip.d.desc;
 ...
 * 分摊_住院 DO 元数据信息
 */
public class BlPropIpDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.bl.prop.blpropip.d.BlPropIpDO";
	public static final String CLASS_DISPALYNAME = "分摊_住院";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "bl_prop_ip";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_propip";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_propipADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_propipCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_propip");
