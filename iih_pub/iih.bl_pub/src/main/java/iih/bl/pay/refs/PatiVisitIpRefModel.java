...
public class PatiVisitIpRefModel extends RefGridModel {

	// 住院就诊参照模型，用于住院日清单节点的参照模型
	...
	public String getRefSql() {
		...
		sb.append(" PI_PAT.code pat_code, ");
		// 入科时间，DT_ACPT是登记时间
		...
		sb.append(" LEFT OUTER JOIN EN_ENT_IP ON EN_ENT.ID_ENT = EN_ENT_IP.ID_ENT ");
		sb.append(" join bd_pri_pat on en_ent.id_pripat=bd_pri_pat.id_pripat ");
		...
		sb.append(" WHERE 1 = 1 AND en_ent.code_entp in ('10','11') AND EN_ENT.FG_CANC='N' ");
		sb.append(" and ").append(BlGroupControlUtils.getGroupControlFitler(new PatDODesc(), "en_ent"));
		String sqlContext = " and " + EnvContextUtil.processEnvContext("", new PatiVisitDO(), "en_ent");//增加组织隔离
