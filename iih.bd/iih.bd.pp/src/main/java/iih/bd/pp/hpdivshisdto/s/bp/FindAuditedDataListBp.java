...
import iih.bd.pp.hpdivshisdto.s.bp.sql.FindAuditedDataListSql;
 ...
 *
 */
public class FindAuditedDataListBp {
	 ...
	 * @throws BizException
	 */
	public PagingRtnData<HpDiVsHisDTO> exec(QryRootNodeDTO qryRootNodeDto, String hpId, PaginationInfo pg) throws BizException {
		String wherePart = GetWherePart(qryRootNodeDto);
		String idRef = getIdRef(hpId);
		FindAuditedDataListSql sql = new FindAuditedDataListSql(wherePart, hpId, idRef);
