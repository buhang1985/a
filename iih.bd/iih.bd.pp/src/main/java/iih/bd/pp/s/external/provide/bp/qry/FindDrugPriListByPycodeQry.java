 ...
 *
 */
public class FindDrugPriListByPycodeQry implements ITransQry {
	...
	public FindDrugPriListByPycodeQry(String pyCode) {
		this._pyCode = pyCode;
	}
	...
	private String GetBaseSql() {
		StringBuilder sqlBuilder = new StringBuilder();
		sqlBuilder.append("SELECT MM.CODE,");
		...
		sqlBuilder.append("LEFT JOIN BD_SRV_DRUG SRVDRUG ");
