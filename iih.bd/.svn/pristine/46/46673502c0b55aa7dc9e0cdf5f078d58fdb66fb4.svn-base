 ...
 *
 */
public class FindAuditedDrugPagingDataBp {
	/**
	 ...
	 * @throws BizException
	 */
	public PagingRtnData<HpsrvorcaDTO> exec(QryRootNodeDTO qryRootNodeDto, String hpId, PaginationInfo pg) throws BizException {
	...
	private String GetWherePart(QryRootNodeDTO qryRootNodeDto) throws BizException {
		...
		//wherePartBuilder.append("SRVORCA.EU_HPSRVTP = '1' AND SRVORCA.ID_MM <> '~'");
