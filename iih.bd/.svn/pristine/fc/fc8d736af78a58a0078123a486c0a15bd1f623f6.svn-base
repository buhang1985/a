...
public class MeasdocDeleteEventListener extends AbstractMeasdocListener{

	@SuppressWarnings("unchecked")
	@Override
	protected void doYourActionAfter(MeasDocDO[] ors) throws BizException {
		MeasdocEventBp bp = new MeasdocEventBp();
		MeasdocDTO[] meaDTO = bp.setMeasDTO(ors,IEventType.TYPE_DELETE_AFTER);	
		...
		BusinessEvent bizEvent = new BusinessEvent(MeasDocDODesc.CLASS_FULLNAME,IEventType.TYPE_DELETE_AFTER,buo);
