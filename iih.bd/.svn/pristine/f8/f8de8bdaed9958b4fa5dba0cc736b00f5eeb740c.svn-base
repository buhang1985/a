 ...
 *
 */
public class DisableMaterialNamesBp {
	...
	public MaterialNamesDO[] exec(MaterialNamesDO[] materialNamesDOs) throws BizException {
		...
		MaterialNamesDO[] result = DisableMaterialNames(materialNamesDOs);
	 ...
	 * @throws BizException
	 */
	private MaterialNamesDO[] DisableMaterialNames(MaterialNamesDO[] materialNamesDOs) throws BizException {
		MedSrvDO[] medSrvDOs = ConvertToMedSrvList(materialNamesDOs);

		MedSrvDO[] result = DisableMedSrv(medSrvDOs);
	 ...
	 * @throws BizException
	 */
	private MedSrvDO[] DisableMedSrv(MedSrvDO[] medSrvDOs) throws BizException {
		IMedSrvEnableService medSrvDisableService = ServiceFinder.find(IMedSrvEnableService.class);
		MedSrvDO[] result = medSrvDisableService.Disable(medSrvDOs);
		return result;
	}
