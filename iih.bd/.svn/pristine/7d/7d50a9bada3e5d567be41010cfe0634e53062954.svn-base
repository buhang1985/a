 ...
 *
 */
public class DeleteFwssCompSql implements ITransQry {

	private String _wherePart;

	public DeleteFwssCompSql(String wherePart) {
	...
	private String GetBaseSql() {
		...
		sqlBuilder.append("UPDATE BD_HP_SRVORCA SET ID_SRV = NULL, EU_STATUS = ? ");
