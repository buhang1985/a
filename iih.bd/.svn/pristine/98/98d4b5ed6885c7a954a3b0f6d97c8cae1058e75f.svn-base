...
public class EnableMaterialBp {
	 ...
	 * @param materials
	 */
	private void CheckMaterialBeforeEnable(MeterialDO[] materials) throws BizException {
		CheckMaterialBeforeEnableBp bp = new CheckMaterialBeforeEnableBp();
		bp.exec(materials);
	}
