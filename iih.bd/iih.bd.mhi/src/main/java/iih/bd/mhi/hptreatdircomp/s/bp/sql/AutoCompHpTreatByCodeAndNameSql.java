 ...
 *
 */
public class AutoCompHpTreatByCodeAndNameSql implements ITransQry{

	private String _hpId;

	public AutoCompHpTreatByCodeAndNameSql(String hpId) {
		this._hpId = hpId;
	}
	...
	public String getQrySQLStr() {
		...
		baseSQL.append("   (SELECT BD_HP_TREAT.CODE,	       ");
		...
		baseSQL.append("   GROUP BY BD_HP_TREAT.CODE,	       ");
		baseSQL.append("     BD_HP_TREAT.NAME		       ");
