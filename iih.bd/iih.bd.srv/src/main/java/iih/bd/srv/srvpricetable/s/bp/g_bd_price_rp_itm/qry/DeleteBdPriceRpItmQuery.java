 ...
 *
 */
public class DeleteBdPriceRpItmQuery implements ITransQry {

	private String condType;
	private String[] condValues;

	public DeleteBdPriceRpItmQuery(String condType, String[] condValues) {
	...
	private StringBuilder getbaseSql() {
		return new StringBuilder("DELETE BD_PRICE_RP_ITM");
	}
