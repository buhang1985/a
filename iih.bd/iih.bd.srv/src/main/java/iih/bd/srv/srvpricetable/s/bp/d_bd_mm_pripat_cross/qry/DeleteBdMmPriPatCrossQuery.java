 ...
 *
 */
public class DeleteBdMmPriPatCrossQuery implements ITransQry {

	private String condType;
	private String[] condValues;

	public DeleteBdMmPriPatCrossQuery(String condType, String[] condValues) {
	...
	private StringBuilder getbaseSql() {
		return new StringBuilder("DELETE BD_MM_PRIPAT_CROSS");
	}
