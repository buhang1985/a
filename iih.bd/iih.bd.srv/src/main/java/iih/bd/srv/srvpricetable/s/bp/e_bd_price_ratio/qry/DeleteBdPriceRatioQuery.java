 ...
 *
 */
public class DeleteBdPriceRatioQuery implements ITransQry {

	private String condType;
	private String[] condValues;

	public DeleteBdPriceRatioQuery(String condType, String[] condValues) {
	...
	private StringBuilder getbaseSql() {
		return new StringBuilder("DELETE BD_PRICE_RATIO");
	}
