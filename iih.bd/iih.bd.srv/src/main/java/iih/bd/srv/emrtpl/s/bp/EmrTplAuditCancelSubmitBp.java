 ...
 *
 */
public class EmrTplAuditCancelSubmitBp {
	...
	public EmrTplDO[] exec(EmrTplDO[] emrTplArray) throws BizException {
		...
		EmrTplDO[] result = CancelSubmit(emrTplArray);
		return result;
	}
	 ...
	 * @throws BizException
	 */
	private EmrTplDO[] CancelSubmit(EmrTplDO[] emrTplArray) throws BizException {
		UdidocDO submitState = GetNewState();
	 ...
	 * @throws BizException
	 */
	private UdidocDO GetNewState() throws BizException {
