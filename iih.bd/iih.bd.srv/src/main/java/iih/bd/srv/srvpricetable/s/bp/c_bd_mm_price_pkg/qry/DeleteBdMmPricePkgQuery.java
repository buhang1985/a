 ...
 *
 */
public class DeleteBdMmPricePkgQuery implements ITransQry {

	private String condType;
	private String[] condValues;

	public DeleteBdMmPricePkgQuery(String condType, String[] condValues) {
	...
	private StringBuilder getbaseSql() {
		return new StringBuilder("DELETE BD_MM_PRICE_PKG");
	}
