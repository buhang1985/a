...
public class SupplierDeleteEventListener extends AbstractSupDelAfterListener{
	...
	protected void doYourActionAfter(SupplierDO[] ors) throws BizException {
		...
		SupplierDO[] orsList = bp.getSupList(ors);	
		
		SuppliersDTO[] supDTO = bp.setSupliDTO(orsList,IEventType.TYPE_DELETE_AFTER);	
		...
		BusinessEvent bizEvent = new BusinessEvent(IMmIEEventConst.EVENT_IE_BDMM_SUPPLIER,IMmIEEventConst.EVENT_IE_BDMM_UPDATE_SUP,buo);
