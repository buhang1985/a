...
public class MeasdocAddEventListener extends AbstractMeaAddListener{
	...
	protected void doYourActionAfter(MeasDocDO[] ors) throws BizException {
		...
		MeasdocDTO[] meaDTO = bp.setMeasDTO(ors,IEventType.TYPE_INSERT_AFTER);	
		...
		BusinessEvent bizEvent = new BusinessEvent(MeasDocDODesc.CLASS_FULLNAME,IEventType.TYPE_INSERT_AFTER,buo);
