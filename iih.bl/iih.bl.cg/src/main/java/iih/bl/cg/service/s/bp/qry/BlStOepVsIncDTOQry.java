...
public class BlStOepVsIncDTOQry implements ITransQry {
	 ...
	 * 获取退款导入时的相关收款数据
	 */
	public BlStOepVsIncDTOQry(String id_pat, String dt_b, String dt_e) {
	 ...
	 * @param idStOeps
	 */
	public BlStOepVsIncDTOQry(String id_pat, String[] idStOeps, String dt_b, String dt_e,String fg_canc) {
		this.id_pat = id_pat;
		this.dt_b = dt_b;
		this.dt_e = dt_e;
	...
	public BlStOepVsIncDTOQry(String id_pat, FBoolean isMerged, String dt_b, String dt_e) {
		this.id_pat = id_pat;
		this.dt_b = dt_b;
		this.dt_e = dt_e;
		this.eu_direct = 1;
	 ...
	 */
	public BlStOepVsIncDTOQry(String id_pat, String codest, String incno, String nullKey) {
		this.id_pat = id_pat;
		this.codest = codest;
		this.incno = incno;
		this.eu_direct = 1;
	 ...
	 * 获取相关异常数据 导入
	 */
	public BlStOepVsIncDTOQry(String id_stoep) {
	...
	public String getQrySQLStr() {
		...
		sql.append(" ,C.sd_pttp ,A.id_patca,patca.name Name_patca, pri.name Name_patpritp,incp.incno p_incno ");
		...
		sql.append(" left join bl_inc_oep_paper incp on B.id_incoep = incp.id_incoep ");
