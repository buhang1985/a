...
public class GetBlStOepVsIncBp {
	...
	public BlStOepVsIncDTO[] exec(String id_pat, String dt_b, String dt_e) throws BizException {
		...
		blStOepVsIncDTOArr = (BlStOepVsIncDTO[]) AppFwUtil.getDORstWithDao(new BlStOepVsIncDTOQry(id_pat, dt_b, dt_e), BlStOepVsIncDTO.class);
	...
	public BlStOepVsIncDTO[] exec2(String id_pat, String dt_b, String dt_e, String[] idStOeps,String fg_canc) throws BizException {
		BlStOepVsIncDTO[] blStOepVsIncDTOArr = (BlStOepVsIncDTO[]) AppFwUtil.getDORstWithDao(new BlStOepVsIncDTOQry(id_pat,idStOeps, dt_b, dt_e,fg_canc), BlStOepVsIncDTO.class);
		return blStOepVsIncDTOArr;
	}
	...
	public BlStOepVsIncDTO[] exec(String id_pat, String dt_b, String dt_e, FBoolean isMerged) throws BizException {
		BlStOepVsIncDTO[] blStOepVsIncDTOArr = (BlStOepVsIncDTO[]) AppFwUtil.getDORstWithDao(new BlStOepVsIncDTOQry(id_pat,isMerged, dt_b, dt_e), BlStOepVsIncDTO.class);
		return blStOepVsIncDTOArr;
	}
}
