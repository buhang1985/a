...
public class BlCvtXmlToDTOSBp {
	 ...
	 * @throws BizException
	 */
	public <T extends BaseDTO> BaseDTO[] exec(String param, Class<T> classInfo, String nodeName) throws BizException {
	 ...
	 * @throws BizException
	 */
	public BaseDTO[] execRef(String param, Class<? extends BaseDTO> classInfo, Class<? extends BaseDTO> classInfoSub, Map<String, String> nodeMap) throws BizException {

		// 1、基础校验
		validation(param);

		// 2、解析Xml
		BaseDTO[] rtns = parseXmlRef(param, classInfo, classInfoSub, nodeMap);
	 ...
	 * @throws BizException
	 */
	private BaseDTO[] parseXmlRef(String xmlStr, Class<?> classInfo, Class<?> classInfoSub, Map<String, String> nodeMap) throws BizException {
