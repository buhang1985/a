...
public class GetPatDayListQry implements ITransQry {
	String patCode;
	Integer times;
	String startDate;
	String endDate;

	public GetPatDayListQry(String patCode, Integer times,String startDate, String endDate) {
	...
	public String getQrySQLStr() {
		...
		sql.append("0.00 as dayAmt, ");
		sql.append("e.code_or as orderNo, ");
		...
		sql.append("left join ci_order e on c.id_or = e.id_or and c.id_pat = e.id_pat ");
