package iih.bl.pay.service.s.bp;
 ...
 *
 */
public class FindPatInfoByPageInfoBP {

	public PagingRtnData<PatInfoQryDTO> exec(PaginationInfo pg, String wherePart,String orderByPart) throws BizException{
	...
	//	sql1.append("and udi.id_udidoclist='@@@@ZZ20000000000035'         ");
	    ...
	    sql1.append(wherePart);
		
		
		PagingRtnData<PatInfoQryDTO> patInfoData = new PagingRtnData<PatInfoQryDTO>();
		PagingServiceImpl<PatInfoQryDTO> service =new PagingServiceImpl();
		
		patInfoData=service.findByPageInfo(new PatInfoQryDTO(), pg, sql1.toString(), "", null);
