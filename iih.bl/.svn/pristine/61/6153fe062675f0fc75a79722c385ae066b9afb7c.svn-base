...
public class BlHpIsSpecDiBP {
	...
	public FBoolean exec(String hpId,String hpNo) throws BizException{
		...
		sqlSb.append("from bl_hp_pat_spec spec ");
		sqlSb.append("inner join bl_hp_pat_spec_di specdi ");
		sqlSb.append("on spec.id_hppatspec = specdi.id_hppatspec ");
		sqlSb.append("where ");
