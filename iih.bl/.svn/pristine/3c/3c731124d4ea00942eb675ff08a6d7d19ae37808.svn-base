 ...
 * @Date 2017-09-26
 */
public class GetIpBillItmDtosQry implements ITransQry{
	...
	private String[] idCgIps;//指定的记账数据
	
	public GetIpBillItmDtosQry(String strIdEnt,String idStip,FBoolean isUpload,String uploadMode) throws BizException
	{
		//判断母婴是否合并结算
	...
	public GetIpBillItmDtosQry(String strIdEnt,String idStip,String[] idCgIps,FBoolean isUpload,String uploadMode) throws BizException
	{
		this(strIdEnt,idStip,isUpload,uploadMode);
		this.idCgIps = idCgIps;
	}
	...
	public String getQrySQLStr() {		
		...
		sqlBF.append(" mpdep.id_dep id_dep_mp,mpdep.name Name_dep_mp,mpdep.code Code_dep_mp,  CGIP.fg_refund,");
		...
		if(ArrayUtils.isNotEmpty(this.idCgIps)){
			sqlBF.append(" and cgip.id_cgip in (").append(SqlUtils.arrayToStr(idCgIps)).append(")");
		}
		...
		if(this.isUploaded.booleanValue()) {
			sqlBF.append("  ORDER BY CGIP.CODE_SRV,cgip.eu_direct ,CGIP.DT_CG,cgip.id_par ");
		} else {
			sqlBF.append("  ORDER BY CGIP.CODE_SRV,cgip.eu_direct desc, CGIP.DT_CG,cgip.id_par ");
		}
