...
public class GetDetailsUploadDTOsToIpQry implements ITransQry {

	String patid;
	String entid;

	public GetDetailsUploadDTOsToIpQry(String patid, String entid) {
	...
	public String getQrySQLStr() {
		...
		sqlb.append(" '无' srvgrade ");
		sqlb.append(" FROM BL_CG_IP ITMOEP ");
